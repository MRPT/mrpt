...
#		"Documentation"
	...
	# else: empty strings as cmake's default: "/usr/" (CMAKE_INSTALL_PREFIX) + ""
	endif()
	...
	if (NOT ${headers_only})
		...
		if (NOT is_metalib)
			install(TARGETS mrpt-${name} EXPORT mrpt-${name}-targets
				...
				LIBRARY DESTINATION ${this_lib_bin_INSTALL_PREFIX}${CMAKE_INSTALL_LIBDIR} COMPONENT Libraries
				ARCHIVE DESTINATION ${this_lib_bin_INSTALL_PREFIX}${CMAKE_INSTALL_LIBDIR} COMPONENT Libraries  # WAS: lib${LIB_SUFFIX}
				)
	...
	install(
		...
		DESTINATION ${this_lib_dev_INSTALL_PREFIX}share/mrpt-${name}
	)
	# 2/3: config file with manual list of dependencies:
	# 3/3: version file:
	install(
