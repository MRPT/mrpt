...
set(CMAKE_MRPT_HAS_PHIDGET 0 CACHE INTERNAL "")
set(CMAKE_MRPT_HAS_PHIDGET_SYSTEM 0 CACHE INTERNAL "")
...
if(NOT DISABLE_PHIDGETS)	
	...
	if(PHIDGETS_FOUND)
		set(CMAKE_MRPT_HAS_PHIDGET 1 CACHE INTERNAL "")
		set(CMAKE_MRPT_HAS_PHIDGET_SYSTEM 1 CACHE INTERNAL "")
	endif()
endif()
