...
EIGEN_INDIV_FILES="$EIGEN_BASE_DIR $EIGEN_BASE_DIR/Dense $EIGEN_BASE_DIR/Eigenvalues $EIGEN_BASE_DIR/Cholesky $EIGEN_BASE_DIR/QR $CUR_DIR/libs/base/src/utils/CImage_*.cpp"
...
echo "<br><hr><br> <table border=\"0\" width=\"100%\"> <tr> <td> Page generated by <a href=\"http://www.doxygen.org\" target=\"_blank\">Doxygen `doxygen --version`</a> for $MRPT_COMPLETE_NAME at `date`</td><td>$WEB_COUNTER_STR</td> <td width=\"100\">$HTML_VALID_LOGO </td> <td width=\"150\"> $SOURCEFORGE_LOGO </td></tr> </table> $GOOGLE_ANALYTICS_STR </body></html>" > doxygen_footer.html
