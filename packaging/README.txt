...
to Debian policies) but I'll keep them in git.
-----------------------------------------------------
...
- Run: bash packaging/prepare_debian.sh
...
------------------
Up-to-date docs can be found in:
 https://docs.mrpt.org/reference/latest/make_a_mrpt_release.html
