...
visualized, edited, and managed in many ways through the GUI application "RawLogViewer".

The text files "xxx_LASER.txt" and "xxx_ODO.txt" has been automatically generated
from a binary rawlog by "RawLogViewer".
