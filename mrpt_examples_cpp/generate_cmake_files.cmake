# TODO: this was a real CMakeLists.txt, port into a cmake cli script
...
if(MRPT_BUILD_EXAMPLES)
	...
	macro(GENERATE_CMAKE_FILES_SAMPLES_DIRECTORY)
		...
		foreach(CMAKE_MRPT_EXAMPLE_NAME ${LIST_EXAMPLES_IN_THIS_DIR})
			...
			configure_file(
			  ${MRPT_SOURCE_DIR}/mrpt_examples_cpp/CMakeLists_template.txt.in
			  ${MRPT_SOURCE_DIR}/mrpt_examples_cpp/${CMAKE_MRPT_EXAMPLE_NAME}/CMakeLists.txt
			  @ONLY)
			# And parse it:
	...
	set(LIST_EXAMPLES_IN_THIS_DIR
		...
		# -------
		# Plus: a couple of other opengl_* samples listed below since they need mrpt::maps also
	...
	set(CMAKE_EXAMPLE_DEPS mrpt::system mrpt::math mrpt::gui)
	GENERATE_CMAKE_FILES_SAMPLES_DIRECTORY()
	...
	set(LIST_EXAMPLES_IN_THIS_DIR
		# -------
		# opengl demos that also requires mrpt::maps
		opengl_objects_demo
	...
	if(MRPT_ALLOW_LGPLV3)
		...
		set(CMAKE_EXAMPLE_DEPS mrpt::vision_lgpl mrpt::gui)
		GENERATE_CMAKE_FILES_SAMPLES_DIRECTORY()
	endif()
