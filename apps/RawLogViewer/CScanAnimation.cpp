    ...
    wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size)
{
  ...
  Create(
      parent, wxID_ANY, _("Animate laser scans"), wxDefaultPosition, wxDefaultSize,
  ...
  btnPlay = new wxButton(
      this, ID_BUTTON1, _("Start"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
      _T("ID_BUTTON1"));
  btnPlay->SetDefault();
  FlexGridSizer4a->Add(btnPlay, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  btnStop = new wxButton(
      this, ID_BUTTON2, _("Stop"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
      _T("ID_BUTTON2"));
  btnStop->Disable();
  FlexGridSizer4a->Add(btnStop, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  btnClose = new wxButton(
      this, ID_BUTTON3, _("Close"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
      _T("ID_BUTTON3"));
  FlexGridSizer4a->Add(btnClose, 1, wxALL | wxALIGN_BOTTOM | wxALIGN_CENTER_HORIZONTAL, 5);

  auto btnSaveScene = new wxButton(this, ID_BUTTON_SAVE_SCENE, _("Save 3Dscene..."));
  FlexGridSizer4a->Add(btnSaveScene, 1, wxALL | wxALIGN_BOTTOM | wxALIGN_CENTER_HORIZONTAL, 5);
  ...
  StaticText2 = new wxStaticText(
      this, ID_STATICTEXT4, _("Animation delay (ms):"), wxDefaultPosition, wxDefaultSize,
  ...
  edDelay = new wxSpinCtrl(
      this, ID_SPINCTRL2, _T("5"), wxDefaultPosition, wxDefaultSize, 0, 0, 1000, 20,
      _T("ID_SPINCTRL2"));
  edDelay->SetValue(_T("20"));
  FlexGridSizer4b->Add(edDelay, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer4->Add(FlexGridSizer4b, 1, wxEXPAND);

  btnVizOptions = new wxButton(
      this, ID_BUTTON6, _("Visual options..."), wxDefaultPosition, wxDefaultSize, 0,
      wxDefaultValidator, _T("ID_BUTTON6"));
  FlexGridSizer4->Add(btnVizOptions, 1, wxALL | wxALIGN_TOP | wxALIGN_CENTER_HORIZONTAL, 5);

  StaticText3 = new wxStaticText(
      this, ID_STATICTEXT3, _("Visible sensors:"), wxDefaultPosition, wxDefaultSize);
  FlexGridSizer4->Add(StaticText3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_TOP, 5);
  lstObsLabels = new wxCheckListBox(this, ID_LIST_OBS_LABELS, wxDefaultPosition, wxDefaultSize, {});
  FlexGridSizer4->Add(lstObsLabels, 1, wxEXPAND);

  auto FlexGridSizer5 = new wxFlexGridSizer(2, 1, 0, 0);
  auto btnCheckAll = new wxButton(
      this, ID_BUTTON_CHECK_ALL, _("Check all"), wxDefaultPosition, wxDefaultSize, 0,
      wxDefaultValidator, _T("ID_BUTTON_CHECK_ALL"));
  FlexGridSizer5->Add(
      btnCheckAll, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);

  auto btnCheckNone = new wxButton(
      this, ID_BUTTON_CHECK_NONE, _("Check none"), wxDefaultPosition, wxDefaultSize, 0,
      wxDefaultValidator, _T("ID_BUTTON_CHECK_NONE"));
  FlexGridSizer5->Add(
      btnCheckNone, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  ...
  btnJump = new wxButton(
      this, ID_BUTTON4, _("Jump"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
      _T("ID_BUTTON4"));
  FlexGridSizer7->Add(btnJump, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  cbViewOrtho = new wxCheckBox(
      this, ID_CHECKBOX2, _("Orthogonal projection"), wxDefaultPosition, wxDefaultSize, 0,
      wxDefaultValidator, _T("ID_CHECKBOX2"));
  cbViewOrtho->SetValue(false);
  FlexGridSizer7->Add(
      cbViewOrtho, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  ...
  Bind(wxEVT_SLIDER, &CScanAnimation::OnslPosCmdScrollChanged, this, ID_SLIDER1);
  Bind(wxEVT_SCROLL_THUMBTRACK, &CScanAnimation::OnslPosCmdScrollChanged, this, ID_SLIDER1);
  Bind(wxEVT_SCROLL_CHANGED, &CScanAnimation::OnslPosCmdScrollChanged, this, ID_SLIDER1);
  ...
  Bind(wxEVT_BUTTON, &CScanAnimation::OnbtnSave3DScene, this, ID_BUTTON_SAVE_SCENE);
  Bind(wxEVT_CHECKBOX, &CScanAnimation::OncbViewOrthoClick, this, ID_CHECKBOX2);

  Bind(wxEVT_CHECKLISTBOX, &CScanAnimation::OncbViewOrthoClick, this, ID_LIST_OBS_LABELS);
...
bool CScanAnimation::update_opengl_viz(const CSensoryFrame& sf)
{
  ...
  for (auto& it : sf)
  {
    ...
    if (IS_CLASS(*it, CObservation2DRangeScan))
    {
      ...
      if (tim_last == INVALID_TIMESTAMP || tim_last < obs->timestamp) tim_last = obs->timestamp;
    ...
    {
      CObservationRotatingScan::Ptr obs = std::dynamic_pointer_cast<CObservationRotatingScan>(it);
      obs->load();
  ...
  for (auto& o : m_gl_objects)
  {
    ...
    if ((tim_last == INVALID_TIMESTAMP && hasToRefreshViz) ||
        (tim_last != INVALID_TIMESTAMP &&
         fabs(mrpt::system::timeDifference(ro.timestamp, tim_last)) > largest_period))
    {
...
{
  wxDialog dlg(
      this, wxID_ANY, "Visualization options", wxDefaultPosition, wxDefaultSize,
  ...
  auto btnOk = new wxButton(
      &dlg, ID_BUTTON7, _("Close"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator,
      _T("ID_BUTTON7"));
