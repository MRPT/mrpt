...
COdometryParams::COdometryParams(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	FlexGridSizer2->Add(edKL, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer2->Add(edKR, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	FlexGridSizer2->Add(edD, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
