    ...
    m_cursorPickState(cpsNone)
{
  ...
  Create(
      parent, id, _("Holonomic Navigation Demo - Part of MRPT"), wxDefaultPosition, wxDefaultSize,
  ...
  wxString __wxRadioBoxChoices_1[2] = {_("VFF (Virtual Force Field)"), _("ND (Nearness  Diagram)")};
  rbHoloMethod = new wxRadioBox(
      Panel1, ID_RADIOBOX1, _(" Holonomic method "), wxDefaultPosition, wxDefaultSize, 2,
      __wxRadioBoxChoices_1, 1, wxRA_HORIZONTAL, wxDefaultValidator, _T("ID_RADIOBOX1"));
  FlexGridSizer7->Add(
      rbHoloMethod, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  edHoloParams = new wxTextCtrl(
      Panel1, ID_TEXTCTRL1, wxEmptyString, wxDefaultPosition, wxDefaultSize,
      wxTE_PROCESS_ENTER | wxTE_PROCESS_TAB | wxTE_MULTILINE | wxVSCROLL | wxHSCROLL |
          wxALWAYS_SHOW_SB,
      wxDefaultValidator, _T("ID_TEXTCTRL1"));
  edHoloParams->SetMinSize(wxSize(-1, 100));
  wxFont edHoloParamsFont(8, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL);
  ...
  StaticText2 = new wxStaticText(
      this, ID_STATICTEXT2, _("[3D view of the simulated world]"), wxDefaultPosition, wxDefaultSize,
      0, _T("ID_STATICTEXT2"));
  FlexGridSizer3->Add(
      StaticText2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText1 = new wxStaticText(
      this, ID_STATICTEXT1, _("[Local view]"), wxDefaultPosition, wxDefaultSize, 0,
      _T("ID_STATICTEXT1"));
  FlexGridSizer3->Add(
  ...
  m_plotScan = new CMyGLCanvas(
      this, ID_CUSTOM1, wxDefaultPosition, wxSize(150, 150), wxTAB_TRAVERSAL, _T("ID_CUSTOM1"));
  ...
  wxFont edInfoLocalViewFont(8, wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL);
  ...
  gl_scan2D = mrpt::viz::CPlanarLaserScan::Create();
  ...
  openGLScanRef->insert(mrpt::viz::stock_objects::CornerXYSimple(0.1f, 2));
...
void holonomic_navigator_demoFrame::simulateOneStep(double time_step)
{
  ...
  for (size_t j = 0; j < simulatedScan.getScanSize(); j++)
    simulatedScan.setScanRange(j, simulatedScan.getScanRange(j) / simulatedScan.maxRange);
    ...
    mrpt::config::CConfigFileBase& cfg, const std::string& section) const
{
  ...
  cfg.write(
      section, "ROBOT_MAX_SPEED", ROBOT_MAX_SPEED, WN, WV, "Maximum speed for the robot (m/s)");
  cfg.write(
