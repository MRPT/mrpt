...
void CMyGLCanvas::OnRenderError(const wxString& str)
{
  ...
  const std::string sErr = mrpt::system::firstNLines(str.ToStdString(), maxLines);
    ...
    try
    {
      ...
      if (lastUpdateOfList == INVALID_TIMESTAMP || timeDifference(lastUpdateOfList, curTime) > 2)
      {
        CDirectoryExplorer::explore(
            extractFileDirectory(mrpt::system::toAbsolutePath(loadedFileName)),  // path
      ...
      for (i = 0, it = lstFiles.begin(); it != lstFiles.end(); it++, i++)
      {
        if (!os::_strcmpi(it->name.c_str(), curFileName.c_str()))
        {
          ...
          {
            if (i < (lstFiles.size() - 1)) fil = lstFiles[i + 1].wholePath;
          }

          if (fil.has_value()) theWindow->loadFromFile(fil.value(), true);
          return;
        }
      }
    }
...
const wxWindowID _DSceneViewerFrame::ID_BUTTON_SSAO = wxNewId();
...
_DSceneViewerFrame::_DSceneViewerFrame(wxWindow* parent, wxWindowID id) : maxv(0)
{
  theWindow = this;
  ...
  Create(
      parent, id, _("SceneViewer3D - Part of the MRPT project"), wxDefaultPosition, wxDefaultSize,
  ...
  btnNew = new wxCustomButton(
      ...
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_NORMAL_FILE")), wxART_TOOLBAR),
      wxDefaultPosition, wxDefaultSize, wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM, wxDefaultValidator,
      _T("ID_BUTTON1"));
  ...
  StaticLine1 = new wxStaticLine(
      this, ID_STATICLINE1, wxDefaultPosition, wxSize(50, -1), wxLI_HORIZONTAL,
      _T("ID_STATICLINE1"));
  FlexGridSizer2->Add(
      StaticLine1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 2);
  btnPrev = new wxCustomButton(
      this, ID_BUTTON3, _("  Previous  "),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_GO_BACK")), wxART_TOOLBAR),
      wxDefaultPosition, wxDefaultSize, wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM, wxDefaultValidator,
      _T("ID_BUTTON3"));
  ...
  btnReload = new wxCustomButton(
      ...
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_REDO")), wxART_TOOLBAR),
      wxDefaultPosition, wxDefaultSize, wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM, wxDefaultValidator,
      _T("ID_BUTTON5"));
  btnReload->SetBitmapDisabled(
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_REDO")), wxART_TOOLBAR));
  btnReload->SetMargins(wxSize(5, 5));
  FlexGridSizer2->Add(btnReload, 1, wxEXPAND, wxDLG_UNIT(this, wxSize(1, 0)).GetWidth());
  StaticLine2 = new wxStaticLine(
      this, ID_STATICLINE2, wxDefaultPosition, wxSize(50, -1), wxLI_HORIZONTAL,
      _T("ID_STATICLINE2"));
  FlexGridSizer2->Add(
      StaticLine2, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 2);
  btnOptions = new wxCustomButton(
      this, ID_BUTTON6, _("  Options  "),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_FIND")), wxART_TOOLBAR),
      wxDefaultPosition, wxDefaultSize, wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM, wxDefaultValidator,
      _T("ID_BUTTON6"));
  ...
  btnSSAO = new wxCustomButton(
      this, ID_BUTTON_SSAO, _("  SSAO  "),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_TICK_MARK")), wxART_TOOLBAR),
      wxDefaultPosition, wxDefaultSize, wxCUSTBUT_TOGGLE | wxCUSTBUT_BOTTOM, wxDefaultValidator,
      _T("ID_BUTTON_SSAO"));
  btnSSAO->SetBitmapDisabled(
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_TICK_MARK")), wxART_TOOLBAR));
  btnSSAO->SetMargins(wxSize(5, 5));
  FlexGridSizer2->Add(btnSSAO, 1, wxEXPAND, 1);
  ...
  btnCapture = new wxCustomButton(
      ...
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_HARDDISK")), wxART_TOOLBAR),
      wxDefaultPosition, wxDefaultSize, wxCUSTBUT_TOGGLE | wxCUSTBUT_BOTTOM, wxDefaultValidator,
      _T("ID_BUTTON9"));
  ...
  StaticLine3 = new wxStaticLine(
      this, ID_STATICLINE3, wxDefaultPosition, wxSize(50, -1), wxLI_HORIZONTAL,
      _T("ID_STATICLINE3"));
  FlexGridSizer2->Add(
      StaticLine3, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 2);
  btnAbout = new wxCustomButton(
      this, ID_BUTTON10, _("  About..."),
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_HELP_BOOK")), wxART_TOOLBAR),
      wxDefaultPosition, wxDefaultSize, wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM, wxDefaultValidator,
      _T("ID_BUTTON10"));
  ...
  btnQuit = new wxCustomButton(
      ...
      wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_QUIT")), wxART_TOOLBAR),
      wxDefaultPosition, wxDefaultSize, wxCUSTBUT_BUTTON | wxCUSTBUT_BOTTOM, wxDefaultValidator,
      _T("ID_BUTTON11"));
  ...
  MenuItem7 =
      new wxMenuItem(Menu1, ID_MENUITEM5, _("Reload file\tF5"), wxEmptyString, wxITEM_NORMAL);
  ...
  MenuItem8 = new wxMenuItem(
      MenuItem18, ID_MENUITEM6, _("a 3D model (any Assimp format)..."), wxEmptyString,
      wxITEM_NORMAL);
  MenuItem18->Append(MenuItem8);
  MenuItem19 = new wxMenuItem(
      MenuItem18, ID_MENUITEM20, _("a PLY point cloud..."), wxEmptyString, wxITEM_NORMAL);
  MenuItem18->Append(MenuItem19);
  mnuImportLAS = new wxMenuItem(
      MenuItem18, ID_MENUITEM25, _("a LAS LiDAR file..."), wxEmptyString, wxITEM_NORMAL);
  MenuItem18->Append(mnuImportLAS);
  MenuItemImportImage = new wxMenuItem(
      MenuItem18, ID_MENUITEM_ImportImage, _("an image..."), wxEmptyString, wxITEM_NORMAL);
  ...
  MenuItem21 = new wxMenuItem(
      MenuItem20, ID_MENUITEM22, _("point clouds to PLY file..."), wxEmptyString, wxITEM_NORMAL);
  MenuItem20->Append(MenuItem21);
  Menu1->Append(ID_MENUITEM21, _("Export"), MenuItem20, wxEmptyString);
  Menu1->AppendSeparator();
  MenuItem23 =
      new wxMenuItem(Menu1, ID_MENUITEM29, _("Previous file\tF7"), wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(MenuItem23);
  MenuItem24 =
      new wxMenuItem(Menu1, ID_MENUITEM30, _("Next file\tF8"), wxEmptyString, wxITEM_NORMAL);
  ...
  MenuItem22 = new wxMenuItem(
      Menu1, ID_MENUITEM23, _("High-resolution render to file..."), wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(MenuItem22);
  mnuSceneStats =
      new wxMenuItem(Menu1, ID_MENUITEM18, _("Scene stats"), wxEmptyString, wxITEM_NORMAL);
  Menu1->Append(mnuSceneStats);
  mnuPrintScene = new wxMenuItem(
      Menu1, ID_MENUITEM_PRINT_TEXT, _("Print as text to console"), wxEmptyString, wxITEM_NORMAL);
  ...
  Menu4 = new wxMenu();
  mnuSelectNone =
      new wxMenuItem(Menu4, ID_MENUITEM24, _("Select none"), wxEmptyString, wxITEM_NORMAL);
  Menu4->Append(mnuSelectNone);
  mnuSelectByClass =
      new wxMenuItem(Menu4, ID_MENUITEM26, _("Select by class..."), wxEmptyString, wxITEM_NORMAL);
  Menu4->Append(mnuSelectByClass);
  Menu4->AppendSeparator();
  mnuSelectionScale =
      new wxMenuItem(Menu4, ID_MENUITEM27, _("Re-scale selected..."), wxEmptyString, wxITEM_NORMAL);
  Menu4->Append(mnuSelectionScale);
  mnuSelectionDelete =
      new wxMenuItem(Menu4, ID_MENUITEM28, _("Delete selected"), wxEmptyString, wxITEM_NORMAL);
  Menu4->Append(mnuSelectionDelete);
  MenuBar1->Append(Menu4, _("&Edit"));
  Menu3 = new wxMenu();
  MenuItem6 =
      new wxMenuItem(Menu3, ID_MENUITEM4, _("Background color..."), wxEmptyString, wxITEM_NORMAL);
  ...
  mnuItemShowCloudOctrees = new wxMenuItem(
      MenuItem17, ID_MENUITEM15, _("Show/hide bounding boxes"), wxEmptyString, wxITEM_CHECK);
  MenuItem17->Append(mnuItemShowCloudOctrees);
  mnuItemChangeMaxPointsPerOctreeNode = new wxMenuItem(
      MenuItem17, ID_MENUITEM17, _("Change octree parameters..."), wxEmptyString, wxITEM_NORMAL);
  ...
  Menu3->AppendSeparator();
  MenuItem13 =
      new wxMenuItem(Menu3, ID_MENUITEM11, _("Delete all objects"), wxEmptyString, wxITEM_NORMAL);
  Menu3->Append(MenuItem13);
  MenuItem11 = new wxMenu();
  MenuItem12 = new wxMenuItem(
      MenuItem11, ID_MENUITEM9, _("Simple robot model"), wxEmptyString, wxITEM_NORMAL);
  ...
  MenuItem10 =
      new wxMenuItem(MenuItem15, ID_MENUITEM10, _("Circular"), wxEmptyString, wxITEM_NORMAL);
  MenuItem15->Append(MenuItem10);
  MenuItem16 = new wxMenuItem(
      MenuItem15, ID_MENUITEM14, _("Arbitrary path..."), wxEmptyString, wxITEM_NORMAL);
  ...
  Bind(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, &svf::OnbtnSSAOClicked, this, ID_BUTTON_SSAO);
  ...
  Bind(wxEVT_MENU, &svf::OnmnuItemShowCloudOctreesSelected, this, ID_MENUITEM15);
  Bind(wxEVT_MENU, &svf::OnmnuItemChangeMaxPointsPerOctreeNodeSelected, this, ID_MENUITEM17);
...
void _DSceneViewerFrame::loadFromFile(const std::string& fil, bool isInASequence)
{
  ...
  try
  {
    ...
    if (openGLSceneRef->viewportsCount() == 0 || !openGLSceneRef->getViewport("main") ||
    ...
    if (openGLSceneRef->followCamera())
    {
      ...
      ASSERTMSG_(view, "ERROR: there is no 'main' viewport in the 3D scene!");
...
void _DSceneViewerFrame::OntimFileWatch(wxTimerEvent&)
{
  ...
  const auto savedCamera = m_canvas->orbitCameraController();
...
void _DSceneViewerFrame::applySSAOOptions()
{
  bool ssaoEnabled = btnSSAO->GetValue();
  auto scene = m_canvas->getOpenGLSceneRef();
  if (!scene)
  {
    return;
...
void _DSceneViewerFrame::OnStartCameraTravelling([[maybe_unused]] wxCommandEvent& event)
{
  try
  {
    ...
    else
    {
      ...
      double zoom =
          atof(iniFile->read_string("Spherical travelling", "Zoom distance", "25").c_str());
      double elevation =
          atof(iniFile->read_string("Spherical travelling", "Elevation degrees", "15").c_str());
      double azimuth =
          atof(iniFile->read_string("Spherical travelling", "Azimuth degrees", "90").c_str());

      double min_value =
          atof(iniFile->read_string("Spherical travelling", "Min value", "90").c_str());
      double max_value =
...
void _DSceneViewerFrame::OnMenuItemImportPLYPointCloud([[maybe_unused]] wxCommandEvent& event)
{
  try
  {
    wxFileDialog dialog(
        ...
        (iniFile->read_string(iniFileSect, "LastDir", ".").c_str()), _("*.ply"),
    ...
    {
      wxMessageBox(
          ply_obj->getLoadPLYErrorString(), "Error loading or parsing the PLY file", wxOK, this);
    }
    else
    {
      auto& openGLSceneRef = m_canvas->getOpenGLSceneRef();
...
void _DSceneViewerFrame::OnMenuItemExportPointsPLY([[maybe_unused]] wxCommandEvent& event)
{
  try
  {
    ...
    wxMessageBox(
        wxString::Format(_("%u point cloud(s) exported to PLY files."), counter), _("Result"));
  }
  catch (const std::exception& e)
  {
    wxMessageBox(mrpt::exception_to_str(e), _("Exception"), wxOK, this);
...
void _DSceneViewerFrame::OnMenuItemHighResRender([[maybe_unused]] wxCommandEvent& event)
{
  try
  {
    wxFileDialog dialog(
        ...
        (iniFile->read_string(iniFileSect, "LastDir", ".").c_str()), _("render.png"),
        _("Image files "
...
void _DSceneViewerFrame::OnmnuSelectByClassSelected([[maybe_unused]] wxCommandEvent& event)
{
  ...
  theWindow->StatusBar1->SetStatusText(
      (mrpt::format("%u objects selected", static_cast<unsigned int>(m_selected_gl_objects.size()))
           .c_str()),
      0);
}
...
void _DSceneViewerFrame::OnmnuImportImageView(wxCommandEvent&)
{
  try
  {
    ...
    wxFileDialog dialog(
        ...
        (iniFile->read_string(iniFileSect, "LastDir", ".").c_str()), _("*.png"),
        _("Image files (*.png, "
