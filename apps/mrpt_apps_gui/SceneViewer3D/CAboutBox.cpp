...
const wxWindowID CAboutBox::ID_TEXTCTRL4 = wxNewId();
...
CAboutBox::CAboutBox(wxWindow* parent, wxWindowID id)
{
  ...
  Notebook1 = new wxNotebook(this, ID_NOTEBOOK1, wxPoint(6, 91), wxSize(625, 250));
  ...
  Bind(wxEVT_COMMAND_BUTTON_CLICKED, &CAboutBox::OnButton1Click, this, ID_BUTTON1);
