...
class WXDLLIMPEXP_THINGS wxOptionValue : public wxObject
{
 public:
  ...
  {
    SetOption(
        name, wxString::Format(wxT("%d %d %d %d"), value.x, value.y, value.width, value.height),
        force);
  }
  ...
  bool GetOption(
      ...
      const wxString& delims = wxT(" ,\t\r\n")) const;
  bool GetOption(
      const wxString& name, int* value, int count, const wxString& delims = wxT(" ,\t\r\n")) const;
  bool GetOption(
      const wxString& name, long* value, int count, const wxString& delims = wxT(" ,\t\r\n")) const;
  bool GetOption(
      const wxString& name,
      float* value,
      int count,
  ...
  bool GetOption(
      const wxString& name, int* v1, int* v2, const wxString& delims = wxT(" ,\t\r\n")) const;
  ...
  bool GetOption(
      const wxString& name, wxPoint& value, const wxString& delims = wxT(" ,\t\r\n")) const
  {
    return GetOption(name, &value.x, &value.y, delims);
  }
  bool GetOption(
      const wxString& name, wxSize& value, const wxString& delims = wxT(" ,\t\r\n")) const
  {
    return GetOption(name, &value.x, &value.y, delims);
  }
  bool GetOption(
      const wxString& name, wxRect& value, const wxString& delims = wxT(" ,\t\r\n")) const;
