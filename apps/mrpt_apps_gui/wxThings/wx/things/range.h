...
WX_DECLARE_OBJARRAY_WITH_DECL(
    wxRangeIntSelection, wxArrayRangeIntSelection, class WXDLLIMPEXP_THINGS);
WX_DECLARE_OBJARRAY_WITH_DECL(
...
class WXDLLIMPEXP_THINGS wxRangeInt
{
 public:
  ...
  {
    return (IsEmpty() || r.IsEmpty()) ? wxEmptyRangeInt
                                      : wxRangeInt(wxMin(m_min, r.m_min), wxMax(m_max, r.m_max));
  }
