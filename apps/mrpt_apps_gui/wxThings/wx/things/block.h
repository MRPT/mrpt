...
extern void wxArrayBlockIntSort(
    wxArrayBlockInt &blocks, wxBlockSort_Type type = wxBLOCKSORT_TOPLEFT_BOTTOMRIGHT);

extern void wxArrayBlockDoubleSort(
    wxArrayBlockDouble &blocks, wxBlockSort_Type type = wxBLOCKSORT_TOPLEFT_BOTTOMRIGHT);
...
class WXDLLIMPEXP_THINGS wxBlockDouble
{
 public:
  ...
  inline void Intersect(
      const wxBlockDouble &src1, const wxBlockDouble &src2, wxBlockDouble *dest) const
  {
    dest->m_x1 = wxMax(src1.m_x1, src2.m_x1);
    dest->m_x2 = wxMin(src1.m_x2, src2.m_x2);
    dest->m_y1 = wxMax(src1.m_y1, src2.m_y1);
...
class WXDLLIMPEXP_THINGS wxBlockIntSelection
{
 public:
  ...
  wxBlockIntSelection(
      const wxBlockIntSelection &blocks,
  ...
  bool SelectBlock(
      const wxBlockInt &block, bool combineNow = true, wxArrayBlockInt *addedBlocks = nullptr);
...
class WXDLLIMPEXP_THINGS wxBlockDoubleSelection
{
 public:
  ...
  wxBlockDoubleSelection(
      const wxBlockDoubleSelection &blocks,
      wxBlockSort_Type sort_type = wxBLOCKSORT_TOPLEFT_BOTTOMRIGHT) :
      m_sort(sort_type)
  {
    Copy(blocks);
...
class WXDLLIMPEXP_THINGS wxBlockIntSelectionIterator
{
 public:
  wxBlockIntSelectionIterator(
      const wxBlockIntSelection &sel, wxBLOCKINT_SELITER_Type type = wxBLOCKINT_SELITER_POINT);
  wxBlockIntSelectionIterator(
      const wxArrayBlockInt &blocks, wxBLOCKINT_SELITER_Type type = wxBLOCKINT_SELITER_POINT);
