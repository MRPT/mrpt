...
DECLARE_EXPORTED_EVENT_TYPE(
    WXDLLIMPEXP_THINGS, wxEVT_FILEBROWSER_FILE_SELECTED, wxEVT_USER_FIRST + 1000)
DECLARE_EXPORTED_EVENT_TYPE(
    WXDLLIMPEXP_THINGS, wxEVT_FILEBROWSER_FILE_ACTIVATED, wxEVT_USER_FIRST + 1001)
DECLARE_EXPORTED_EVENT_TYPE(
    WXDLLIMPEXP_THINGS, wxEVT_FILEBROWSER_DIR_SELECTED, wxEVT_USER_FIRST + 1002)
DECLARE_EXPORTED_EVENT_TYPE(
    WXDLLIMPEXP_THINGS, wxEVT_FILEBROWSER_DIR_ACTIVATED, wxEVT_USER_FIRST + 1003)
...
class WXDLLIMPEXP_THINGS wxFileBrowserEvent : public wxCommandEvent
{
 public:
  wxFileBrowserEvent(
      wxEventType commandType = wxEVT_nullptr,
...
#define wx__DECLARE_FILEBROWSEREVT(evt, id, fn) \
  wx__DECLARE_EVT1(evt, id, wxFileBrowserEventHandler(fn))

#define EVT_FILEBROWSER_FILE_SELECTED(id, fn) \
  wx__DECLARE_FILEBROWSEREVT(wxEVT_FILEBROWSER_FILE_SELECTED, id, fn)
#define EVT_FILEBROWSER_FILE_ACTIVATED(id, fn) \
  wx__DECLARE_FILEBROWSEREVT(wxEVT_FILEBROWSER_FILE_ACTIVATED, id, fn)
#define EVT_FILEBROWSER_DIR_SELECTED(id, fn) \
  wx__DECLARE_FILEBROWSEREVT(wxEVT_FILEBROWSER_DIR_SELECTED, id, fn)
#define EVT_FILEBROWSER_DIR_ACTIVATED(id, fn) \
  wx__DECLARE_FILEBROWSEREVT(wxEVT_FILEBROWSER_DIR_ACTIVATED, id, fn)
...
enum wxFileBrowserStyles_Type
{
  ...
  wxFILEBROWSER_VIEW_MASK = wxFILEBROWSER_TREE | wxFILEBROWSER_LIST | wxFILEBROWSER_DETAILS |
                            wxFILEBROWSER_SMALL_ICON | wxFILEBROWSER_LARGE_ICON |
                            wxFILEBROWSER_PREVIEW,
  wxFILEBROWSER_STYLE_MASK =
      wxFILEBROWSER_VIEW_MASK | wxFILEBROWSER_SPLIT_VERTICAL | wxFILEBROWSER_SHOW_FOLDERS
};
