...
class WXDLLIMPEXP_THINGS wxRay2DDouble : public wxPoint2DDouble
{
 public:
  inline wxRay2DDouble(wxDouble x = 0, wxDouble y = 0, wxDouble slope = 0) :
      wxPoint2DDouble(x, y), m_slope(slope)
  {
  }
  inline wxRay2DDouble(const wxPoint2DDouble& pt, wxDouble slope) :
      wxPoint2DDouble(pt), m_slope(slope)
  {
  }
  ...
  inline wxRay2DDouble(const wxRay2DDouble& line) :
      wxPoint2DDouble(line.m_x, line.m_y), m_slope(line.m_slope)
  {
  }
  ...
  inline wxDouble GetDistanceToPoint(
      const wxPoint2DDouble& pt, wxPoint2DDouble* closestPt = nullptr) const
  {
...
public :
    ...
    inline wxDouble GetDistanceToPoint(const wxPoint2DDouble &pt, wxPoint2DDouble
*closestPt=nullptr) const
    {
...
class WXDLLIMPEXP_THINGS wxCircleDouble : public wxPoint2DDouble
{
 public:
  inline wxCircleDouble(const wxCircleDouble& circle) :
      wxPoint2DDouble(circle.m_x, circle.m_y), m_r(circle.m_r)
  {
  }
  inline wxCircleDouble(wxDouble x = 0, wxDouble y = 0, wxDouble r = 0) :
      wxPoint2DDouble(x, y), m_r(r)
  {
  }
...
class WXDLLIMPEXP_THINGS wxCircleInt : public wxPoint2DInt
{
 public:
  ...
  inline wxCircleInt(const wxCircleInt& circle) :
      wxPoint2DInt(circle.m_x, circle.m_y), m_r(circle.m_r)
  {
  }
  ...
  // Get a bounding rect
  inline wxRect2DInt GetRect() const { return wxRect2DInt(m_x - m_r, m_y - m_r, 2 * m_r, 2 * m_r); }
...
class WXDLLIMPEXP_THINGS wxEllipseInt
{
 public:
  ...
  {
    return wxRect2DInt(
        m_origin.m_x - m_radius.m_x, m_origin.m_y - m_radius.m_y, 2 * m_radius.m_x,
        2 * m_radius.m_y);
  }
  ...
  inline bool GetPointInEllipse(wxInt32 x, wxInt32 y) const
  {
    if (IsEmpty()) return false;
    return (
        ((x - m_origin.m_x) * (x - m_origin.m_x)) / m_radius.m_x +
