...
class MenuDropButton : public wxCustomButton
{
 public:
  MenuDropButton(wxWindow *parent, wxWindowID id, long style) : wxCustomButton()
  {
    ...
    Create(
        parent, id, wxEmptyString, s_dropdownBitmap, wxDefaultPosition,
...
class MenuLabelButton : public wxCustomButton
{
 public:
  MenuLabelButton(
      wxWindow *parent, wxWindowID id, const wxString &label, const wxBitmap &bitmap, long style) :
      wxCustomButton()
  {
...
wxMenuButton::~wxMenuButton() { AssignMenu(nullptr, true); }
