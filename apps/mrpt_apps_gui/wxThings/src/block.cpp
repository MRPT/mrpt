...
wxblockdouble_sort_topleft_bottomright(wxBlockDouble **a, wxBlockDouble **b)
{
...
static int wxCMPFUNC_CONV
wxblockdouble_sort_topright_bottomleft(wxBlockDouble **a, wxBlockDouble **b)
{
  wxDouble y = ((*a)->m_y1 - (*b)->m_y1);
...
static int wxCMPFUNC_CONV
wxblockdouble_sort_bottomleft_topright(wxBlockDouble **a, wxBlockDouble **b)
{
...
static int wxCMPFUNC_CONV
wxblockdouble_sort_bottomright_topleft(wxBlockDouble **a, wxBlockDouble **b)
{
  wxDouble y = ((*a)->m_y2 - (*b)->m_y2);
...
static int wxCMPFUNC_CONV
wxblockdouble_sort_largest_to_smallest(wxBlockDouble **a, wxBlockDouble **b)
{
  return (*a)->IsLarger(**b);
}
static int wxCMPFUNC_CONV
wxblockdouble_sort_smallest_to_largest(wxBlockDouble **a, wxBlockDouble **b)
{
  return -(*a)->IsLarger(**b);
}
...
bool wxBlockInt::Combine(
    const wxBlockInt &block,
    wxBlockInt &top,
    wxBlockInt &bottom,
    wxBlockInt &left,
...
bool wxBlockDouble::Combine(
    const wxBlockDouble &block,
    wxBlockDouble &top,
    wxBlockDouble &bottom,
    wxBlockDouble &left,
...
wxBlockIntSelectionIterator::wxBlockIntSelectionIterator(
    const wxBlockIntSelection &sel, wxBLOCKINT_SELITER_Type type)
{
  m_type = type;
...
wxBlockIntSelectionIterator::wxBlockIntSelectionIterator(
    const wxArrayBlockInt &blocks, wxBLOCKINT_SELITER_Type type)
{
  m_type = type;
