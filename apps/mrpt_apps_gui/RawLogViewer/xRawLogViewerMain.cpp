...
static const wxWindowID ID_BUTTON2 = wxNewId();
static const wxWindowID ID_BUTTON3 = wxNewId();
static const wxWindowID ID_STATICLINE2 = wxNewId();
static const wxWindowID ID_BUTTON4 = wxNewId();
static const wxWindowID ID_BUTTON5 = wxNewId();
static const wxWindowID ID_BUTTON6 = wxNewId();
static const wxWindowID ID_BUTTON7 = wxNewId();
static const wxWindowID ID_STATICLINE3 = wxNewId();
static const wxWindowID ID_BUTTON8 = wxNewId();
static const wxWindowID ID_BUTTON9 = wxNewId();
static const wxWindowID ID_STATICLINE4 = wxNewId();
static const wxWindowID ID_BUTTON10 = wxNewId();
static const wxWindowID ID_BUTTON11 = wxNewId();
static const wxWindowID ID_STATICLINE1 = wxNewId();
static const wxWindowID ID_STATICTEXT4 = wxNewId();
static const wxWindowID ID_COMBO_IMG_DIRS = wxNewId();
static const wxWindowID ID_CUSTOM5 = wxNewId();
static const wxWindowID ID_PANEL1 = wxNewId();
static const wxWindowID ID_TEXTCTRL1 = wxNewId();
static const wxWindowID ID_PANEL3 = wxNewId();
static const wxWindowID ID_BUTTON1 = wxNewId();
static const wxWindowID ID_PANEL18 = wxNewId();
static const wxWindowID ID_TEXTCTRL2 = wxNewId();
static const wxWindowID ID_CUSTOM6 = wxNewId();
static const wxWindowID ID_PANEL25 = wxNewId();
static const wxWindowID ID_SPLITTERWINDOW2 = wxNewId();
static const wxWindowID ID_TEXTCTRL3 = wxNewId();
static const wxWindowID ID_NOTEBOOK3 = wxNewId();
static const wxWindowID ID_PANEL6 = wxNewId();
static const wxWindowID ID_CUSTOM2 = wxNewId();
static const wxWindowID ID_CUSTOM3 = wxNewId();
static const wxWindowID ID_PANEL7 = wxNewId();
static const wxWindowID ID_CUSTOM1 = wxNewId();
static const wxWindowID ID_PANEL4 = wxNewId();
static const wxWindowID ID_PANEL8 = wxNewId();
static const wxWindowID ID_STATICTEXT2 = wxNewId();
static const wxWindowID ID_STATICBITMAP1 = wxNewId();
static const wxWindowID ID_PANEL9 = wxNewId();
static const wxWindowID ID_STATICTEXT1 = wxNewId();
static const wxWindowID ID_STATICBITMAP2 = wxNewId();
static const wxWindowID ID_PANEL13 = wxNewId();
static const wxWindowID ID_STATICBITMAP3 = wxNewId();
static const wxWindowID ID_PANEL14 = wxNewId();
static const wxWindowID ID_STATICBITMAP7 = wxNewId();
static const wxWindowID ID_PANEL24 = wxNewId();
static const wxWindowID ID_NOTEBOOK2 = wxNewId();
static const wxWindowID ID_PANEL10 = wxNewId();
static const wxWindowID ID_PANEL11 = wxNewId();
static const wxWindowID ID_PANEL12 = wxNewId();
static const wxWindowID ID_PANEL15 = wxNewId();
static const wxWindowID ID_CUSTOM4 = wxNewId();
static const wxWindowID ID_PANEL17 = wxNewId();
static const wxWindowID ID_PANEL16 = wxNewId();
static const wxWindowID ID_XY_GLCANVAS = wxNewId();
static const wxWindowID ID_STATICTEXT3 = wxNewId();
static const wxWindowID ID_SLIDER1 = wxNewId();
static const wxWindowID ID_PANEL20 = wxNewId();
static const wxWindowID ID_STATICBITMAP4 = wxNewId();
static const wxWindowID ID_PANEL21 = wxNewId();
static const wxWindowID ID_STATICBITMAP5 = wxNewId();
static const wxWindowID ID_PANEL22 = wxNewId();
static const wxWindowID ID_STATICBITMAP6 = wxNewId();
static const wxWindowID ID_PANEL23 = wxNewId();
static const wxWindowID ID_PANEL_VIEW_3D_POINT_OPTIONS = wxNewId();
static const wxWindowID ID_NOTEBOOK_3DOBS = wxNewId();
static const wxWindowID ID_PANEL19 = wxNewId();
static const wxWindowID ID_NOTEBOOK1 = wxNewId();
static const wxWindowID ID_PANEL5 = wxNewId();
static const wxWindowID ID_SPLITTERWINDOW3 = wxNewId();
static const wxWindowID ID_PANEL2 = wxNewId();
static const wxWindowID ID_SPLITTERWINDOW1 = wxNewId();
static const wxWindowID ID_MENUITEM1 = wxNewId();
static const wxWindowID ID_MENUITEM2 = wxNewId();
static const wxWindowID ID_MENUITEM11 = wxNewId();
static const wxWindowID ID_MENUITEM4 = wxNewId();
static const wxWindowID ID_MENUITEM76 = wxNewId();
static const wxWindowID ID_MENUITEM7 = wxNewId();
static const wxWindowID ID_MENUITEM8 = wxNewId();
static const wxWindowID ID_MENUITEM10 = wxNewId();
static const wxWindowID ID_MENUITEM62 = wxNewId();
static const wxWindowID ID_MENUITEM64 = wxNewId();
static const wxWindowID ID_MENUITEM13 = wxNewId();
static const wxWindowID ID_MENUITEM60 = wxNewId();
static const wxWindowID ID_MENUITEM61 = wxNewId();
static const wxWindowID ID_MENUITEM6 = wxNewId();
static const wxWindowID ID_MENUITEM5 = wxNewId();
static const wxWindowID ID_MENUITEM47 = wxNewId();
static const wxWindowID ID_MENUITEM56 = wxNewId();
static const wxWindowID ID_MENUITEM63 = wxNewId();
static const wxWindowID ID_MENUITEM87 = wxNewId();
static const wxWindowID ID_MENUITEM3 = wxNewId();
static const wxWindowID ID_MENUITEM58 = wxNewId();
static const wxWindowID ID_MENUITEM55 = wxNewId();
static const wxWindowID ID_MENUITEM54 = wxNewId();
static const wxWindowID idMenuQuit = wxNewId();
static const wxWindowID ID_MENUITEM14 = wxNewId();
static const wxWindowID ID_MENUITEM51 = wxNewId();
static const wxWindowID ID_MENUITEM69 = wxNewId();
static const wxWindowID ID_MENUITEM91 = wxNewId();
static const wxWindowID ID_MENUITEM15 = wxNewId();
static const wxWindowID ID_MENUITEM70 = wxNewId();
static const wxWindowID ID_MENUITEM16 = wxNewId();
static const wxWindowID ID_MENUITEM59 = wxNewId();
static const wxWindowID ID_MENUITEM57 = wxNewId();
static const wxWindowID ID_MENUITEM75 = wxNewId();
static const wxWindowID ID_MENUITEM67 = wxNewId();
static const wxWindowID ID_MENUITEM68 = wxNewId();
static const wxWindowID ID_MENUITEM82 = wxNewId();
static const wxWindowID ID_MENUITEM20 = wxNewId();
static const wxWindowID ID_MENUITEM22 = wxNewId();
static const wxWindowID ID_MENUITEM53 = wxNewId();
static const wxWindowID ID_MENUITEM23 = wxNewId();
static const wxWindowID ID_MENUITEM41 = wxNewId();
static const wxWindowID ID_MENUITEM84 = wxNewId();
static const wxWindowID ID_MENUITEM12 = wxNewId();
static const wxWindowID ID_MENUITEM17 = wxNewId();
static const wxWindowID ID_MENUITEM44 = wxNewId();
static const wxWindowID ID_MENUITEM19 = wxNewId();
static const wxWindowID ID_MENUITEM25 = wxNewId();
static const wxWindowID ID_MENUITEM73 = wxNewId();
static const wxWindowID ID_MENUITEM74 = wxNewId();
static const wxWindowID ID_MENUITEM77 = wxNewId();
static const wxWindowID ID_MENUITEM79 = wxNewId();
static const wxWindowID ID_MENUITEM18 = wxNewId();
static const wxWindowID ID_MENUITEM86 = wxNewId();
static const wxWindowID ID_MENUITEM90 = wxNewId();
static const wxWindowID ID_MENUITEM85 = wxNewId();
static const wxWindowID ID_MENUITEM29 = wxNewId();
static const wxWindowID ID_MENUITEM9 = wxNewId();
static const wxWindowID ID_MENUITEM28 = wxNewId();
static const wxWindowID ID_MENUITEM71 = wxNewId();
static const wxWindowID ID_MENUITEM72 = wxNewId();
static const wxWindowID ID_MENUITEM78 = wxNewId();
static const wxWindowID ID_MENUITEM83 = wxNewId();
static const wxWindowID ID_MENUITEM21 = wxNewId();
static const wxWindowID ID_MENUITEM30 = wxNewId();
static const wxWindowID ID_MENUITEM24 = wxNewId();
static const wxWindowID ID_MENUITEM35 = wxNewId();
static const wxWindowID ID_MENUITEM31 = wxNewId();
static const wxWindowID ID_MENUITEM34 = wxNewId();
static const wxWindowID ID_MENUITEM65 = wxNewId();
static const wxWindowID ID_MENUITEM66 = wxNewId();
static const wxWindowID ID_MENUITEM52 = wxNewId();
static const wxWindowID ID_MENUITEM80 = wxNewId();
static const wxWindowID ID_MENUITEM36 = wxNewId();
static const wxWindowID ID_MENUITEM33 = wxNewId();
static const wxWindowID ID_MENUITEM38 = wxNewId();
static const wxWindowID ID_MENUITEM37 = wxNewId();
static const wxWindowID ID_MENUITEM40 = wxNewId();
static const wxWindowID ID_MENUITEM81 = wxNewId();
static const wxWindowID ID_MENUITEM39 = wxNewId();
static const wxWindowID ID_MENUITEM46 = wxNewId();
static const wxWindowID ID_MENUITEM45 = wxNewId();
static const wxWindowID ID_MENUITEM43 = wxNewId();
static const wxWindowID ID_MENUITEM42 = wxNewId();
static const wxWindowID ID_MENUITEM89 = wxNewId();
static const wxWindowID ID_MENUITEM88 = wxNewId();
static const wxWindowID ID_MENUITEM26 = wxNewId();
static const wxWindowID ID_MENUITEM32 = wxNewId();
static const wxWindowID ID_MENUITEM27 = wxNewId();
static const wxWindowID idMenuAbout = wxNewId();
static const wxWindowID ID_STATUSBAR1 = wxNewId();
static const wxWindowID MNU_1 = wxNewId();
static const wxWindowID ID_MENUITEM49 = wxNewId();
static const wxWindowID ID_MENUITEM50 = wxNewId();
static const wxWindowID ID_MENUITEM48 = wxNewId();
static const wxWindowID ID_TIMER1 = wxNewId();
static const wxWindowID ID_MENUITEM_RENAME_BY_SF_IDX = wxNewId();
static const wxWindowID ID_SCROLLEDWINDOW2 = wxNewId();
static const wxWindowID ID_TXT_SELECTED_INFO = wxNewId();
...
bool xRawLogViewerFrame::AskForOpenRawlog(std::string& fil)
{
  ...
  if (dialog.ShowModal() == wxID_OK)
  {
    ...
    fil = string(fileName.ToStdString());
    return true;
  }
  return false;
}
...
void xRawLogViewerFrame::OnSaveFile(wxCommandEvent&)
{
  ...
  if (dialog.ShowModal() == wxID_OK)
  {
    ...
    // Save the file:
    loadedFileName = fileName.ToStdString();
...
void xRawLogViewerFrame::loadRawlogFile(const string& str, int first, int last)
{
  ...
  for (size_t i = 0; i < m_fileHistory.GetCount(); i++)
    iniFile->write(
        ...
        m_fileHistory.GetHistoryFile(i).ToStdString());
  WX_END_TRY
  ...
  wxString auxStr;
  wxProgressDialog progDia(
      "Progress of rawlog load", "Loading...",
      static_cast<int>(progDialogMax),  // range, in Kb's
      this,                             // parent
      wxPD_CAN_ABORT | wxPD_APP_MODAL | wxPD_SMOOTH | wxPD_AUTO_HIDE | wxPD_ELAPSED_TIME |
          wxPD_ESTIMATED_TIME | wxPD_REMAINING_TIME);
  ...
  while (keepLoading)
  {
    if (countLoop++ % 10 == 0)
    {
      ...
      double ratio = static_cast<double>(fil_pos) / (1.0 * static_cast<double>(filSize));
      ...
      if (ratio - last_ratio >= 0.006)
      {
        ...
        double memUsg_Mb = static_cast<double>(memUsg) / (1024.0 * 1024.0);

        const uint64_t progPos = fil_pos >> 10;

        auxStr.sprintf(
            "Loading... %u objects / Memory usage: %.03f MiB",
        ...
        progDia.SetRange(static_cast<int>(progDialogMax));

        if (!progDia.Update(
                static_cast<int>(progPos < (progDialogMax - 1) ? progPos : (progDialogMax - 1)),
                auxStr))
        {
          keepLoading = false;
        }
...
void xRawLogViewerFrame::rebuildTreeView()
{
  ...
  wxProgressDialog progDia(
      "Constructing the tree view", "Creating the tree...",
...
#define SIZE_lstImgFormats 5
  ...
  if (ret == -1)
    ...
    return lstImgFormats[ret].ToStdString();
}
...
void xRawLogViewerFrame::OnGenOdoLaser(wxCommandEvent&)
{
  ...
  const string target_dir = string(target_dir_wx.ToStdString());
  ...
  wxProgressDialog progDia(
      "Exporting as text files", "Saving...",
      n,     // range
      this,  // parent
      wxPD_CAN_ABORT | wxPD_APP_MODAL | wxPD_SMOOTH | wxPD_AUTO_HIDE | wxPD_ELAPSED_TIME |
          wxPD_ESTIMATED_TIME | wxPD_REMAINING_TIME);
    ...
    switch (rawlog.getType(i))
    {
      ...
      case CRawlog::TEntryType::etObservation:
      {
        ...
        if (IS_CLASS(*o, CObservation2DRangeScan))
        {
          ...
          // dump pose data
          double y, p, r;
          std::tie(y, p, r) = obs->sensorPose.getYawPitchRoll();
          ::fprintf(files->second.second, "%f\t%f\t%f\n", y, p, r);
        }
...
void xRawLogViewerFrame::OnLoadAPartOnly(wxCommandEvent&)
{
  ...
  loadRawlogFile(fil, static_cast<int>(first), static_cast<int>(last));
}
...
void xRawLogViewerFrame::OnFileCountEntries(wxCommandEvent&)
{
  ...
  wxString auxStr;
  wxProgressDialog progDia(
      "Progress of rawlog read", "Parsing file...",
      filSize,  // range
      this,     // parent
      wxPD_CAN_ABORT | wxPD_APP_MODAL | wxPD_SMOOTH | wxPD_AUTO_HIDE | wxPD_ELAPSED_TIME |
          wxPD_ESTIMATED_TIME | wxPD_REMAINING_TIME);
...
void xRawLogViewerFrame::OnMRUFile([[maybe_unused]] wxCommandEvent& event)
{
  wxString f(m_fileHistory.GetHistoryFile(event.GetId() - wxID_FILE1));
  if (!f.empty()) loadRawlogFile(f.ToStdString());
}
...
void xRawLogViewerFrame::OnRemoveSpecificRangeMeas(wxCommandEvent&)
{
  ...
  wxBusyCursor waitCursor;
  long i, n = static_cast<long>(rawlog.size());
...
void xRawLogViewerFrame::OnRecalculateActionsICP(wxCommandEvent&)
{
  ...
  // Load ICP options:
  // ------------------------------------------
  CConfigFileMemory icpCfg(scanMatchingDialog->edOptICP->GetValue().ToStdString());
  ...
  if (!useGridMap)
  {
    CConfigFileMemory refCfg(scanMatchingDialog->edOptRefPnt->GetValue().ToStdString());
    refMapPt.insertionOptions.loadFromConfigFile(refCfg, "InsertionOptions");
  }
  else
  {
    CConfigFileMemory refCfg(scanMatchingDialog->edOptRefGrid->GetValue().ToStdString());
  ...
  // ----------------------------
  {
    CConfigFileMemory refCfg(scanMatchingDialog->edOptAlignMap->GetValue().ToStdString());
...
void xRawLogViewerFrame::OnMenuItem47Selected(wxCommandEvent&)
{
  ...
  if (curSelectedObject)
  {
    if (curSelectedObject->GetRuntimeClass() == CLASS_ID(CActionCollection))
    {
      ...
      float odo_x = static_cast<float>(atof(string(wxGetTextFromUser(
                                                       _("Estimated displacement, X (meters):"),
                                                       _("Enter new action parameter:"), _("0"))
                                                       .ToStdString())
                                                .c_str()));
      float odo_y = static_cast<float>(atof(string(wxGetTextFromUser(
                                                       _("Estimated displacement, Y (meters):"),
                                                       _("Enter new action parameter:"), _("0"))
                                                       .ToStdString())
                                                .c_str()));
      float odo_phi =
          static_cast<float>(DEG2RAD(atof(string(wxGetTextFromUser(
...
void xRawLogViewerFrame::OnRecomputeOdometry(wxCommandEvent&)
{
  ...
  if (dialog.ShowModal())
  {
    ...
    K_left =
        static_cast<float>(atof(string(dialog.edKL->GetValue().ToStdString().c_str()).c_str()));
    K_right =
        static_cast<float>(atof(string(dialog.edKR->GetValue().ToStdString().c_str()).c_str()));
    D = static_cast<float>(atof(string(dialog.edD->GetValue().ToStdString().c_str()).c_str()));
...
void xRawLogViewerFrame::OnMenuModifyICPActionsUncertainty(wxCommandEvent&)
{
  ...
  float std_xy = static_cast<float>(atof(string(wxGetTextFromUser(
...
void xRawLogViewerFrame::OnMenuRenameSensor(wxCommandEvent&)
{
  ...
  const string the_new_label = string(new_label.ToStdString());
...
void xRawLogViewerFrame::OnMenuChangePosesBatch(wxCommandEvent&)
{
  ...
  if (dialog.ShowModal())
  {
    ...
    CConfigFileMemory cfg(dialog.edText->GetValue().ToStdString());
    ...
    for (CRawlog::iterator it = rawlog.begin(); it != rawlog.end() && keepDoing; it++, countLoop++)
    {
      ...
      {
        if (!progDia.Update(
                countLoop, wxString::Format("Processing... (%i objects processed)", countLoop)))
          keepDoing = false;
        wxTheApp->Yield();  // Let the app. process messages
      }
    }

    progDia.Update(static_cast<int>(rawlog.size()));  // Close dialog.
      ...
      case CRawlog::TEntryType::etSensoryFrame:
      {
        ...
        for (size_t j = 0; j < SF->size(); j++)
        {
          ...
          if (obs->sensorLabel == lab && IS_CLASS(*obs, CObservation2DRangeScan))
          {
            ...
            o->maxRange = static_cast<float>(maxR);
            N++;
          }
        }  // end for each Observation in the SF
      }
...
void xRawLogViewerFrame::OnbtnEditCommentsClick1(wxCommandEvent&)
{
  ...
  if (dlg.ShowModal())
  {
    rawlog.setCommentText(dlg.edText->GetValue().ToStdString());
    rebuildTreeView();
  }
}
...
void xRawLogViewerFrame::OnMenuRegenerateTimestampBySF(wxCommandEvent&)
{
  ...
  wxProgressDialog progDia(
      "Progress", "Parsing rawlog...",
      static_cast<int>(nEntries),  // range
      this,                        // parent
      wxPD_CAN_ABORT | wxPD_APP_MODAL | wxPD_SMOOTH | wxPD_AUTO_HIDE | wxPD_ELAPSED_TIME |
          wxPD_ESTIMATED_TIME | wxPD_REMAINING_TIME);
...
void xRawLogViewerFrame::OnmnuCreateAVISelected(wxCommandEvent&)
{
  ...
  wxString caption = "Save AVI video...";
  wxString wildcard = "AVI files (*.avi)|*.avi|All files (*.*)|*.*";
  wxString defaultDir((iniFile->read_string(iniFileSect, "LastDir", ".").c_str()));
  ...
  const string outAviFilename = string(dialog.GetPath().ToStdString());
  ...
  for (int countLoop = 0; countLoop < nEntries; countLoop++)
  {
    if (countLoop % 5 == 0)
    {
      auxStr.sprintf("Processing rawlog... %u image frames", countLoop);
      if (!progDia.Update(countLoop, auxStr)) break;
      progDia.Fit();
      wxTheApp->Yield();  // Let the app. process messages
    }
