object formMapsConfig: TformMapsConfig
  Left = 293
  Top = 149
  BorderStyle = bsDialog
  Caption = 'Metric maps options'
  ClientHeight = 486
  ClientWidth = 766
  Color = clBtnFace
  ...
  object memo: TSynMemo
    ...
    Lines.Strings = (
      ...
      'pointsMap_count=1'
      'landmarkSOGMap_count=0'
      'beaconMap_count=0'
      ''
      
        '; Selection of map for likelihood: (occGrid=0, points=1,landmark' +
        's=2,gasGrid=3)'
      ...
      'enableInsertion_landmarkSOGMap=1'
      ...
      '[MetricMap_occupancyGrid_00_likelihoodOpts]'
        ...
        'likelihoodMethod=4'#9#9'; 0=MI, 1=Beam Model, 2=RSLC, 3=Cells Difs, ' +
        '4=LF_Trun, 5=LF_II'
      ''
      'LF_decimation=20'
      'LF_stdHit=0.10'
