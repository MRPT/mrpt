...
slamdemoFrame::slamdemoFrame(wxWindow* parent,wxWindowID id)
{
    ...
    FlexGridSizer4->Add(Panel3, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 1);
    plotGT = new mpWindow(this,ID_CUSTOM1,wxDefaultPosition,wxDefaultSize,0);
    FlexGridSizer4->Add(plotGT, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 3);
    ...
    FlexGridSizer4->Add(Panel4, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 1);
    plotObs = new mpWindow(this,ID_CUSTOM2,wxDefaultPosition,wxDefaultSize,0);
    FlexGridSizer4->Add(plotObs, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 3);
    ...
    FlexGridSizer5->Add(Panel5, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 1);
    plotMap = new mpWindow(this,ID_CUSTOM3,wxDefaultPosition,wxDefaultSize,0);
    FlexGridSizer5->Add(plotMap, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 3);
    ...
    FlexGridSizer5->Add(Panel6, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 1);
    plotIndivCompat = new mpWindow(this,ID_CUSTOM4,wxDefaultPosition,wxDefaultSize,0);
    FlexGridSizer5->Add(plotIndivCompat, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 3);
    ...
    FlexGridSizer6->Add(Panel7, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 1);
    ...
    FlexGridSizer6->Add(gridDA, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
    ...
    FlexGridSizer8->Add(Panel8, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 1);
    plotErrorX = new mpWindow(Panel1,ID_CUSTOM7,wxDefaultPosition,wxDefaultSize,0);
    FlexGridSizer8->Add(plotErrorX, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 3);
    ...
    FlexGridSizer8->Add(Panel9, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 1);
    plotErrorY = new mpWindow(Panel1,ID_CUSTOM8,wxDefaultPosition,wxDefaultSize,0);
    FlexGridSizer8->Add(plotErrorY, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 3);
    ...
    FlexGridSizer8->Add(Panel10, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 1);
    plotErrorPhi = new mpWindow(Panel1,ID_CUSTOM9,wxDefaultPosition,wxDefaultSize,0);
    FlexGridSizer8->Add(plotErrorPhi, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 3);
    ...
    FlexGridSizer9->Add(Panel13, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 1);
    plotDaTP = new mpWindow(Panel2,ID_CUSTOM5,wxDefaultPosition,wxDefaultSize,0);
    FlexGridSizer9->Add(plotDaTP, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 3);
