...
CNode::ObjectType CObservationStereoImagesNode::type() const { return ObjectType::StereoImage; }

std::string CObservationStereoImagesNode::displayName() const { return "Stereo Image"; }
