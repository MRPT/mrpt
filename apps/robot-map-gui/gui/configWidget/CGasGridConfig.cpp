...
{
	m_ui->setupUi(this);
	CGasConcentrationGridMap2D::TMapDefinition *def = new CGasConcentrationGridMap2D::TMapDefinition();
...
{
	CGasConcentrationGridMap2D::TMapDefinition *mapDefination = dynamic_cast<CGasConcentrationGridMap2D::TMapDefinition *>(options);
...
{
	m_ui->gasSensorLabel->setText(QString::fromStdString(insertOpt.gasSensorLabel));
	m_ui->enose_id->setValue(insertOpt.enose_id);
	m_ui->gasSensorType->setValue(insertOpt.gasSensorType);
	m_ui->windSensorLabel->setText(QString::fromStdString(insertOpt.windSensorLabel));
