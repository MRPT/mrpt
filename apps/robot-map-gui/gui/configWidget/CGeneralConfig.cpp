...
CGeneralConfig::CGeneralConfig() :
    CBaseConfig(), m_ui(std::make_unique<Ui::CGeneralConfig>()), m_generalSetting()
{
  m_ui->setupUi(this);
  connect(m_ui->m_gridColor, &QPushButton::released, this, &CGeneralConfig::openGridColor);
  connect(
      m_ui->m_backgroundColor, &QPushButton::released, this, &CGeneralConfig::openBackgroundColor);
}
...
SGeneralSetting::SGeneralSetting() : backgroundColor(Qt::white), gridColor(Qt::black) {}
