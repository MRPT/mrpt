...
CBeaconConfig::CBeaconConfig() : CBaseConfig(), m_ui(std::make_unique<Ui::CBeaconConfig>())
{
  m_ui->setupUi(this);
...
{
  auto* mapDefination = dynamic_cast<mrpt::maps::CBeaconMap::TMapDefinition*>(options);
