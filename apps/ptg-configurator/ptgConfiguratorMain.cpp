...
// Load my custom icons:
	...
	gl_TPSpace_TP_obstacles = std::make_aligned_shared<mrpt::opengl::CSetOfObjects>();
	gl_TPSpace_clearance =
		std::make_aligned_shared<mrpt::opengl::CMesh>(true, -5.0f, 5.0f, -5.0f, 5.0f);
	...
	gl_WS_obs = std::make_aligned_shared<mrpt::opengl::CPointCloud>();
	gl_WS_obs->setPointSize(7.0);
	gl_WS_obs->setColor_u8(0, 0, 0);
	gl_view_WS->insert(gl_WS_obs);

	gl_WS_target = std::make_aligned_shared<mrpt::opengl::CPointCloud>();
	...
	gl_WS_target_reprojected = std::make_aligned_shared<mrpt::opengl::CPointCloud>();
	...
	gl_TP_target = std::make_aligned_shared<mrpt::opengl::CPointCloud>();
	...
	{
		gl_axis_WS = std::make_aligned_shared<mrpt::opengl::CAxis>(
	...
	{
		gl_axis_TPS = std::make_aligned_shared<mrpt::opengl::CAxis>(
...
#if 0
	// Fixed camera:
	gl_view_TPSpace_cam = std::make_aligned_shared<mrpt::opengl::CCamera>();
