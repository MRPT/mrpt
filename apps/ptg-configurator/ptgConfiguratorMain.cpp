...
// Load my custom icons:
	...
	gl_WS_target = mrpt::make_aligned_shared<mrpt::opengl::CPointCloud>();
	...
	gl_TP_target = mrpt::make_aligned_shared<mrpt::opengl::CPointCloud>();
	...
	{
		gl_axis_WS = mrpt::make_aligned_shared<mrpt::opengl::CAxis>(
	...
	{
		gl_axis_TPS = mrpt::make_aligned_shared<mrpt::opengl::CAxis>(
...
#if 0
	// Fixed camera:
	gl_view_TPSpace_cam = mrpt::make_aligned_shared<mrpt::opengl::CCamera>();
