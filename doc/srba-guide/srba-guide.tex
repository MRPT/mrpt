...
For readers without a solid background in SLAM or BA, it is \emph{strongly} recommended 
to first read seminar works on SLAM \cite{thrun2005pr,durrantwhyte2006sla,bailey2006sla}, 
BA \cite{triggs2000bundle} and Graph-SLAM \cite{grisetti2010tgb}.


The idea of \emph{Relative Bundle Adjustment (RBA)} was introduced in a series of works by Gabe Sibley and 
...
remember to uncheck all the CMake configuration variables \texttt{BUILD\_mrpt-*} for the unneeded modules. 
To make sure your SRBA library is working properly, it is recommended to run the set of \emph{unit tests} associated 
...
It is almost impossible to assure that a library is bug-free with 100\% certainty, 
