 ...
 <a name="0.9.6">
  <h2>Version 0.9.6 - (Under development) </h2></a>
	...
	- BUG FIXES:
		...
		- [mrpt-vision] Fixed memory corruption in SIFT detector with the OpenCV implementation - (<a href="http://code.google.com/p/mrpt/issues/detail?id=18" > Issue & patch #18</a>) -  <a href="http://code.google.com/p/mrpt/source/detail?r=2796" >2796</a> 
