...
<p> <b>Note:</b> <i>If you are displaying a local version of this page and you have not built the whole HTML documentation, the links above will be broken. Either build the documentation invoking <code>make documentation_html</code> or browse it on-line <a href="http://www.mrpt.org/" target="_blank">here</a>.</i></p>
 ...
 <a name="0.9.6">
  <h2>Version 0.9.6 - (Under development) </h2></a>
	- New applications:
		- <a href="http://www.mrpt.org/Application:kinect-calibrate" >kinect-calibrate</a>: A GUI tool for quickly calibrating RGB+D cameras.
	...
	- Kinect stuff: 
		...
		- [mrpt-vision]
			- New function mrpt::vision::checkerBoardStereoCalibration() to calibrate stereo and RGB+D cameras. See also the program <a href="http://www.mrpt.org/Application:kinect-calibrate" >kinect-calibrate</a>: 
	- New classes:
		- [mrpt-gui]
