...
Sample calls ot the graphslam-engine application are given below:

    graphslam-engine --list-regs

    graphslam-engine --list-regs --list-optimizers

    graphslam-engine -i $mrpt/share/mrpt/config_files/graphslam-engine/odometry_2DRangeScans.ini -r $mrpt/share//mrpt/datasets/graphslam-engine-demos/observation_only_map2/range_030_bearing_015.rawlog -g $mrpt/share//mrpt/datasets/graphslam-engine-demos/observation_only_map2/range_030_bearing_015.rawlog.GT.txt
...
deciders and optimizer classes. This makes up for independency between the
...
=item * graphslam lib documentation page - // TODO

=item * Application demo video - // TODO - Add link to youtube video
...
was originally written by Nikos Koukis duirng the Google Summer of Code (GSOC)
2016 program.
