...
//	win3D.resize(400,200);
	...
	//mrpt::opengl::CPointCloud::Ptr gl_points = std::make_shared<mrpt::opengl::CPointCloud>();
	mrpt::opengl::CPointCloudColoured::Ptr gl_points = std::make_shared<mrpt::opengl::CPointCloudColoured>();
	gl_points->setPointSize(4.5);

	mrpt::opengl::CTexturedPlane::Ptr gl_img_range 			=  std::make_shared<mrpt::opengl::CTexturedPlane>(0.5,-0.5,-0.5*aspect_ratio,0.5*aspect_ratio);
	mrpt::opengl::CTexturedPlane::Ptr gl_img_intensity 		=  std::make_shared<mrpt::opengl::CTexturedPlane>(0.5,-0.5,-0.5*aspect_ratio,0.5*aspect_ratio);
	mrpt::opengl::CTexturedPlane::Ptr gl_img_intensity_rect 	=  std::make_shared<mrpt::opengl::CTexturedPlane>(0.5,-0.5,-0.5*aspect_ratio,0.5*aspect_ratio);
