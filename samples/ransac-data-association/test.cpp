...
void TestRANSAC()
{
	...
	mrpt::opengl::CPointCloud::Ptr gl_obs_map = std::make_shared<mrpt::opengl::CPointCloud>();
	mrpt::opengl::CPointCloud::Ptr gl_result = std::make_shared<mrpt::opengl::CPointCloud>();
	mrpt::opengl::CSetOfObjects::Ptr gl_obs = std::make_shared<mrpt::opengl::CSetOfObjects>();
	mrpt::opengl::CSetOfObjects::Ptr gl_obs_txts = std::make_shared<mrpt::opengl::CSetOfObjects>();
	mrpt::opengl::CSetOfLines::Ptr gl_lines = std::make_shared<mrpt::opengl::CSetOfLines>();
	{
		...
		//
		mrpt::opengl::CPointCloud::Ptr gl_map = std::make_shared<mrpt::opengl::CPointCloud>();
		...
		{
			mrpt::opengl::CText::Ptr gl_txt = std::make_shared<mrpt::opengl::CText>( mrpt::format("%u",static_cast<unsigned int>(i)) );
			double x,y;
