...
{
	run_pc_filter_test(.0 /*map2_x_off*/, .0 /*map2_tim_off*/, 8 /*expected_m1_count*/, 8/*expected_m2_count*/);
}
TEST(CPointCloudFilterByDistance, withOutliers)
{
	run_pc_filter_test(.35 /*map2_x_off*/, .0 /*map2_tim_off*/, 8 /*expected_m1_count*/, 6 /*expected_m2_count*/);
}
TEST(CPointCloudFilterByDistance, tooOldMap)
{
	run_pc_filter_test(.35 /*map2_x_off*/, 2.0 /*map2_tim_off*/, 8 /*expected_m1_count*/, 8 /*expected_m2_count*/);
}
