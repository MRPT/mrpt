    ...
    public mrpt::maps::NearestNeighborsCapable
{
 ...
 public:
   ...
   */
  void insertRay(
      const mrpt::math::TPoint3D& sensor,
  ...
  std::string asString() const override
  {
    return mrpt::format(
        ...
        m_grid.getXMin(), m_grid.getYMin(), m_grid.getZMin(), m_grid.getXMax(), m_grid.getYMax(),
        m_grid.getZMax(), m_grid.getResolutionXY(), m_grid.getResolutionZ());
  }
