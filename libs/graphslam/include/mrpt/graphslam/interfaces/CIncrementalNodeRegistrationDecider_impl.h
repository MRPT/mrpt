...
CIncrementalNodeRegistrationDecider<GRAPH_T>::CIncrementalNodeRegistrationDecider()
{ }
...
template<class GRAPH_T>
void CIncrementalNodeRegistrationDecider<GRAPH_T>::TParams::
...
#endif /* end of include guard: CINCREMENTALNODEREGISTRATIONDECIDER_IMPL_H_UQKZGLEM */
