 ...
 */
class CPolyhedron : public CRenderizableShaderWireFrame, public CRenderizableShaderTriangles
{
  ...
  */
   ...
   */
  inline void getEdges(std::vector<TPolyhedronEdge>& edges) const { edges = m_Edges; }
  /**
   * Gets a list with the polyhedron's faces.
   */
  inline void getFaces(std::vector<TPolyhedronFace>& faces) const { faces = m_Faces; }
  /**
