    ...
    public mrpt::opengl::CTextMessageCapable
{
 ...
 public:
  ...
  mrpt::img::TColorf getCustomBackgroundColor() const { return m_background_color; }
  ...
  */
  ...
  TRenderMatrices getRenderMatrices() const { return m_threadedData.get().state; }
 ...
 protected:
  ...
  void renderNormalSceneMode(const CCamera& useThisCamera, bool is1stShadowMapPass = false) const;
  ...
  struct PerThreadData
  {
     ...
     */
    std::map<shader_id_t, mrpt::opengl::Program::Ptr> shadersShadow1st, shadersShadow2nd;
  };
 ...
 * \sa mrpt::opengl::Viewport::insert
 */
inline Viewport::Ptr& operator<<(Viewport::Ptr& s, const std::vector<CRenderizable::Ptr>& v)
{
