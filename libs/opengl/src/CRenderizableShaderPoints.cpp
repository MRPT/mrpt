...
void CRenderizableShaderPoints::render(const RenderContext& rc) const
{
  ...
  glUniform1i(rc.shader->uniformId("enableVariablePointSize"), m_variablePointSize ? 1 : 0);

  glUniform1f(rc.shader->uniformId("variablePointSize_K"), m_variablePointSize_K);
  glUniform1f(rc.shader->uniformId("variablePointSize_DepthScale"), m_variablePointSize_DepthScale);
...
void CRenderizableShaderPoints::params_serialize(mrpt::serialization::CArchive& out) const
{
...
void CRenderizableShaderPoints::params_deserialize(mrpt::serialization::CArchive& in)
{
