...
void   CAxis::render_dl() const
{
	...
	if (m_marks ==true)
	{
		...
		glRasterPos3f(m_xmax+m_frecuency,0,0);
		renderTextBitmap("X", GLUT_BITMAP_TIMES_ROMAN_10);
		...
		glRasterPos3f(0,m_ymax+m_frecuency,0);
		renderTextBitmap("Y", GLUT_BITMAP_TIMES_ROMAN_10);
		...
		glRasterPos3f(0,0,m_zmax+m_frecuency);
		renderTextBitmap("Z", GLUT_BITMAP_TIMES_ROMAN_10);
