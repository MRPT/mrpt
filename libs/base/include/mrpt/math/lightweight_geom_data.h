...
namespace math	{
	...
	struct BASE_IMPEXP TPose2D	{
		...
		mrpt::math::TPose2D operator +(mrpt::math::TPose2D& b) const; //!< Operator "oplus" pose composition: "ret=this \oplus b"  \sa CPose2D
		mrpt::math::TPose2D operator -(mrpt::math::TPose2D& b) const; //!< Operator "ominus" pose composition: "ret=this \ominus b"  \sa CPose2D
