	...
	namespace bayes
	{
		...
		public:
			...
			public:
				...
				void  loadFromConfigFile(const mrpt::utils::CConfigFileBase	&source, const std::string &section) MRPT_OVERRIDE; // See docs of base class
				void  dumpToTextStream(mrpt::utils::CStream	&out) const  MRPT_OVERRIDE; // See docs of base class
