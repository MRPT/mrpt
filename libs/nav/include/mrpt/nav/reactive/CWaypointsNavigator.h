...
class CWaypointsNavigator : public mrpt::nav::CAbstractNavigator
{
 public:
   ...
   * and derived classes. */
  struct TNavigationParamsWaypoints : public CAbstractNavigator::TNavigationParams
  {
    ...
    {
      return std::unique_ptr<TNavigationParams>(new TNavigationParamsWaypoints(*this));
    }
