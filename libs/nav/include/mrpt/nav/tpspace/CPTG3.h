...
namespace mrpt
{
  namespace nav
  {
	DEFINE_SERIALIZABLE_PRE_CUSTOM_BASE_LINKAGE(CPTG3, CParameterizedTrajectoryGenerator, NAV_IMPEXP)
	...
	/** A PTG for optimal paths of type "C|C,S" (as named in PTG papers).
	  ...
	  *  \ingroup nav_tpspace
	 */
	class NAV_IMPEXP  CPTG3 : public CPTG_DiffDrive_CollisionGridBased
	{
		DEFINE_SERIALIZABLE(CPTG3)
	 public:
		CPTG3() : R(0),K(0) {}
	...
	DEFINE_SERIALIZABLE_POST_CUSTOM_BASE_LINKAGE(CPTG3, CParameterizedTrajectoryGenerator, NAV_IMPEXP)
  }
}
