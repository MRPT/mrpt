    ...
    public mrpt::config::CLoadableOptions
{
 ...
 protected:
  ...
  virtual void internal_initialize(
      const std::string& cacheFilename = std::string(), const bool verbose = true) = 0;
 ...
 public:
  ...
  virtual bool isBijectiveAt([[maybe_unused]] uint16_t k, [[maybe_unused]] uint32_t step) const
  {
    return true;
  }
 ...
 public:
  ...
  virtual double evalPathRelativePriority(
      [[maybe_unused]] uint16_t k, [[maybe_unused]] double target_distance) const
  {
    return 1.0;
  }
