...
//  REACTIVENAV_IMPEXP, mrpt_xxx_EXPORTS

// If we are building the DLL (_EXPORTS), do not link against the .lib files:
#if !defined(mrpt_reactivenav_EXPORTS) && (defined(_MSC_VER) || defined(__BORLANDC__))
#	if defined(_DEBUG)
...
/*   The macros below for DLL import/export are required for Windows only.
    Mostly all the definitions in this file are copied or at least reactivenavd
...
#        define MRPT_REACTIVENAV_EXPORT __declspec(dllexport)
#        define MRPT_REACTIVENAV_IMPORT __declspec(dllimport)
#    else /* compiler doesn't support __declspec() */
#        define MRPT_REACTIVENAV_EXPORT
#        define MRPT_REACTIVENAV_IMPORT
#    endif
...
#        define MRPT_REACTIVENAV_EXPORT _Export
#        define MRPT_REACTIVENAV_IMPORT _Export
#    endif
#elif defined(MRPT_OS_APPLE)
#    ifdef __MWERKS__
#        define MRPT_REACTIVENAV_EXPORT __declspec(export)
#        define MRPT_REACTIVENAV_IMPORT __declspec(import)
#    endif
...
#ifndef MRPT_REACTIVENAV_EXPORT
#    define MRPT_REACTIVENAV_EXPORT
#    define MRPT_REACTIVENAV_IMPORT
#endif
...
#	if defined(mrpt_reactivenav_EXPORTS)  /* Building the DLL */
#		define REACTIVENAV_IMPEXP MRPT_REACTIVENAV_EXPORT
#	else  /* Using the DLL */
#		define REACTIVENAV_IMPEXP MRPT_REACTIVENAV_IMPORT
#	endif
