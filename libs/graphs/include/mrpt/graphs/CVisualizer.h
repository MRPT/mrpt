...
protected:
	 ...
	 */
	/**\{ */
	virtual void drawGroundGrid(mrpt::opengl::CSetOfObjects::Ptr& object,
			const mrpt::utils::TParametersDouble* viz_params=NULL) const;
	virtual void drawNodeCorners(mrpt::opengl::CSetOfObjects::Ptr& object,
			const mrpt::utils::TParametersDouble* viz_params=NULL) const;
	virtual void drawNodePoints(mrpt::opengl::CSetOfObjects::Ptr& object,
			const mrpt::utils::TParametersDouble* viz_params=NULL) const;
	virtual void drawEdgeRelPoses(mrpt::opengl::CSetOfObjects::Ptr& object,
			const mrpt::utils::TParametersDouble* viz_params=NULL) const;
	virtual void drawEdges(mrpt::opengl::CSetOfObjects::Ptr& object,
			const mrpt::utils::TParametersDouble* viz_params=NULL) const;
