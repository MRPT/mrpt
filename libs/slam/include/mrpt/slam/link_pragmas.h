...
#ifndef slam_link_pragmas_H
#define slam_link_pragmas_H
...
#if !defined(mrpt_slam_EXPORTS) && (defined(_MSC_VER) || defined(__BORLANDC__))
#	if defined(_DEBUG)
#		pragma comment (lib, BOOST_JOIN( BOOST_JOIN("libmrpt-slam",MRPT_VERSION_POSTFIX),"-dbg.lib"))
#	else
#		pragma comment (lib, BOOST_JOIN( BOOST_JOIN("libmrpt-slam",MRPT_VERSION_POSTFIX),".lib"))
#	endif
#endif
...
#        define MRPT_SLAM_EXPORT _Export
#        define MRPT_SLAM_IMPORT _Export
#    endif
#elif defined(MRPT_OS_APPLE)
#    ifdef __MWERKS__
#        define MRPT_SLAM_EXPORT __declspec(export)
#        define MRPT_SLAM_IMPORT __declspec(import)
#    endif
