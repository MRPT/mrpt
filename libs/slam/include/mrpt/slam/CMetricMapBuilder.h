...
class CMetricMapBuilder : public mrpt::system::COutputLogger
{
 ...
 public:
  ...
  virtual void processActionObservation(
      mrpt::obs::CActionCollection& action, mrpt::obs::CSensoryFrame& observations) = 0;
  ...
  struct TOptions
  {
    TOptions(mrpt::system::VerbosityLevel& verb_level_ref) : verbosity_level(verb_level_ref) {}
