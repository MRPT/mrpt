...
#include <mrpt/macros/SSE_types.h>  // needed by SSE intrinsics used in some inline functions below.
...
namespace utils
{
/** \addtogroup mrpt_round Round functions (in #include <mrpt/macros/round.h>)
