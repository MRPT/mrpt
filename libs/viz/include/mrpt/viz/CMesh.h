 ...
 *
 * ![mrpt::viz::CMesh](preview_CMesh.png)
 *
 *  \sa opengl::Scene
...
{
  DEFINE_SERIALIZABLE(CMesh, mrpt::viz)
 public:
 ...
 public:
   ...
   * efficiently */
  void getZ(mrpt::math::CMatrixFloat& out) const { out = Z; }
  /** Returns a reference to the internal mask matrix, allowing changing it
   * efficiently */
  void getMask(mrpt::math::CMatrixFloat& out) const { out = mask; }
