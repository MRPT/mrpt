...
#ifndef PBMAP_link_pragmas_H
#define PBMAP_link_pragmas_H
...
#if !defined(mrpt_pbmap_EXPORTS) && (defined(_MSC_VER) || defined(__BORLANDC__))
#	if defined(_DEBUG)
#		pragma comment (lib, BOOST_JOIN( BOOST_JOIN("libmrpt-pbmap",MRPT_VERSION_POSTFIX),"-dbg.lib"))
#	else
#		pragma comment (lib, BOOST_JOIN( BOOST_JOIN("libmrpt-pbmap",MRPT_VERSION_POSTFIX),".lib"))
#	endif
#endif
...
#        define MRPT_PBMAP_EXPORT _Export
#        define MRPT_PBMAP_IMPORT _Export
#    endif
#elif defined(MRPT_OS_APPLE)
#    ifdef __MWERKS__
#        define MRPT_PBMAP_EXPORT __declspec(export)
#        define MRPT_PBMAP_IMPORT __declspec(import)
#    endif
