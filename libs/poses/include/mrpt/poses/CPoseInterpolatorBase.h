...
class CPoseInterpolatorBase
{
 public:
  ...
  iterator upper_bound(const mrpt::Clock::time_point& t) { return m_path.upper_bound(t); }
  ...
  const_iterator find(const mrpt::Clock::time_point& t) const { return m_path.find(t); }
  pose_t& at(const mrpt::Clock::time_point& t) { return m_path.at(t); }
  const pose_t& at(const mrpt::Clock::time_point& t) const { return m_path.at(t); }
  /** @} */
