...
class CObservation2DRangeScan : public CObservation
{
 ...
 public:
  ...
  void resizeScanAndAssign(
      size_t len, const float rangeVal, const bool rangeValidity, const int32_t rangeIntensity = 0);
  ...
  */
  void truncateByDistanceAndAngle(
      float min_distance, float max_angle, float min_height = 0, float max_height = 0, float h = 0);
