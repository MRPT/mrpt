...
class CActionRobotMovement2D : public CAction
{
 ...
 public:
  ...
  struct TMotionModelOptions
  {
    ...
    struct TOptions_GaussianModel
    {
      ...
      TOptions_GaussianModel(
          double a1_, double a2_, double a3_, double a4_, double minStdXY_, double minStdPHI_) :
          a1(a1_), a2(a2_), a3(a3_), a4(a4_), minStdXY(minStdXY_), minStdPHI(minStdPHI_)
      {
      }
  ...
  void computeFromOdometry(
      const mrpt::poses::CPose2D& odometryIncrement, const TMotionModelOptions& options);
 ...
 protected:
  ...
  void computeFromOdometry_modelGaussian(
      const mrpt::poses::CPose2D& odometryIncrement, const TMotionModelOptions& o);
