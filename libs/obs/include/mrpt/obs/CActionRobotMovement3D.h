 ...
 public:
  ...
  struct TMotionModelOptions
  {
    ...
    struct TOptions_6DOFModel
    {
       ...
       * and radians). */
      float additional_std_XYZ{0.001f}, additional_std_angle{mrpt::DEG2RAD(0.05f)};
    };
  ...
  void computeFromOdometry(
      const mrpt::poses::CPose3D& odometryIncrement, const TMotionModelOptions& options);
  ...
  void computeFromOdometry_model6DOF(
      const mrpt::poses::CPose3D& odometryIncrement, const TMotionModelOptions& o);
