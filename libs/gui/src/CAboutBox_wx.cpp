    ...
    CAboutBoxBase(appName, additionalInfo, showStandardInfo)
{
  ...
  lbInfo = new wxTextCtrl(
      Notebook1, ID_TEXTCTRL1, wxEmptyString, wxPoint(4, 24), wxSize(545, 250),
  ...
  TextCtrl1 = new wxTextCtrl(
      Notebook1, ID_TEXTCTRL3, tutorial().c_str(), wxPoint(4, 24), wxSize(545, 222),
      wxTE_MULTILINE | wxTE_READONLY | wxTE_AUTO_URL, wxDefaultValidator, _T("ID_TEXTCTRL3"));
