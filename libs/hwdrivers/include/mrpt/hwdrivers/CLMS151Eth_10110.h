...
#ifndef _CLMS151ETH_10110_H__
#define _CLMS151ETH_10110_H__
...
namespace mrpt
{
  namespace hwdrivers
  {
    class CLMS151Eth : public C2DRangeFinderAbstract
    {
      DEFINE_GENERIC_SENSOR(CLMS151Eth)
      public:
        /** Constructor.
         * Note that there is default arguments, here you can customize IP Adress 
         * and TCP Port of your device
         */
        CLMS151Eth(std::string _ip = std::string("192.168.0.1"),
