    ...
    const bool convert_grayscale)
{
  return buildPyramid_templ<false>(
      *this, *const_cast<mrpt::img::CImage*>(&img), nOctaves, smooth_halves, convert_grayscale);
}

bool CImagePyramid::buildPyramidFast(
    mrpt::img::CImage& img, size_t nOctaves, const bool smooth_halves, const bool convert_grayscale)
{
  return buildPyramid_templ<true>(*this, img, nOctaves, smooth_halves, convert_grayscale);
}
