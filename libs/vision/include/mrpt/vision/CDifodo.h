	...
	namespace vision
	{
		...
		*/
		...
		protected:
			...
			std::vector<MatrixXf> depth;
			std::vector<MatrixXf> depth_old;
			std::vector<MatrixXf> depth_inter;
			std::vector<MatrixXf> depth_warped;
			std::vector<MatrixXf> xx;
			std::vector<MatrixXf> xx_inter;
			std::vector<MatrixXf> xx_old;
			std::vector<MatrixXf> xx_warped;
			std::vector<MatrixXf> yy;
			std::vector<MatrixXf> yy_inter;
			std::vector<MatrixXf> yy_old;
			std::vector<MatrixXf> yy_warped;
