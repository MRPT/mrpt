...
class CLandmarksMap : public mrpt::maps::CMetricMap
{
 ...
 public:
   ...
   */
  static std::
      map<std::pair<mrpt::maps::CLandmark::TLandmarkID, mrpt::maps::CLandmark::TLandmarkID>, double>
          _mEDD;
  ...
  */
  ...
  void changeCoordinatesReference(
      const mrpt::poses::CPose3D& newOrg, const mrpt::maps::CLandmarksMap* otherMap);
