	...
	float& b)
{
	...
	switch (color_map)
	{
		case cmJET: jet2rgb(color_index, r, g, b); break;
		case cmGRAYSCALE: r = g = b = color_index; break;
		case cmHOT: hot2rgb(color_index, r, g, b); break;
		default: THROW_EXCEPTION("Invalid color_map");
	};
	MRPT_END
}
