...
uint8_t CDetectable2D::serializeGetVersion() const { return XX; } void CDetectable2D::serializeTo(mrpt::serialization::CArchive&, int*) const {}
void CDetectable3D::serializeFrom(mrpt::serialization::CArchive& in, uint8_t version)
uint8_t CDetectable3D::serializeGetVersion() const { return XX; } void CDetectable3D::serializeTo(mrpt::serialization::CArchive&, int*) const {}
