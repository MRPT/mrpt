...
ZEXTERN int ZEXPORT deflateInit OF((z_streamp strm, int level));
   ...
   zalloc and zfree are set to Z_nullptr, deflateInit updates them to use default
...
/*
  ...
  if next_in or next_out was Z_nullptr), Z_BUF_ERROR if no progress is possible
...
/*
  ...
  next_in or next_out was Z_nullptr), Z_MEM_ERROR if there was not enough memory,
...
/*
   ...
   parameter is invalid (e.g.  dictionary being Z_nullptr) or the stream state is
...
/*
   ...
   (such as zalloc being Z_nullptr).  msg is left unchanged in both source and
   destination.
*/
...
/*
   ...
   stream state was inconsistent (such as zalloc or state being Z_nullptr).
*/
...
/*
   ...
   or bits are Z_nullptr, then those values are not set.
...
/*
   ...
   Z_nullptr, then only the dictionary length is returned, and nothing is copied.
   Similary, if dictLength is Z_nullptr, then it is not set.
...
/*
   ...
   stream state was inconsistent (such as zalloc or state being Z_nullptr), or if
...
/*
   ...
   strm->next_in is not Z_nullptr, then the Z_BUF_ERROR was due to out() returning
...
/*
   ...
   return the updated checksum.  If buf is Z_nullptr, this function returns the
...
/*
   ...
   updated CRC-32.  If buf is Z_nullptr, this function returns the required
