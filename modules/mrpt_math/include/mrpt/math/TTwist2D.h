...
struct TTwist2D :
    public TPoseOrPoint,
    public internal::ProvideStaticResize<TTwist2D>,
    public internal::ProvidesStringConversion<TTwist2D>
{
  ...
  constexpr TTwist2D(double vx_, double vy_, double omega_) : vx(vx_), vy(vy_), omega(omega_) {}
  ...
  using internal::ProvidesStringConversion<TTwist2D>::asString;
