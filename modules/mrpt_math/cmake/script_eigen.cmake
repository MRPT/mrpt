...
if (MRPT_EIGEN_USE_EMBEDDED_VERSION)
  ...
  ExternalProject_Add(EP_eigen3
    ...
    SOURCE_DIR        "${mrpt_math_BINARY_DIR}/3rdparty/eigen3/"
    CONFIGURE_COMMAND ""
    BUILD_COMMAND     ""
    INSTALL_COMMAND   ""
    TEST_COMMAND      ""
  ...
  set(EIGEN_EMBEDDED_INCLUDE_DIR "${mrpt_math_BINARY_DIR}/3rdparty/eigen3/" CACHE PATH "Eigen path for embedded use" FORCE)
  ...
  export(
    TARGETS Eigen
    FILE "${mrpt_math_BINARY_DIR}/ep_eigen3-config.cmake"
  )
  ...
  install(
    FILES ${mrpt_math_SOURCE_DIR}/cmake/ep_eigen3-config.cmake 
...
if(MRPT_EIGEN_USE_EMBEDDED_VERSION)
  install(
      DIRECTORY
          "${mrpt_math_BINARY_DIR}/3rdparty/eigen3/Eigen"
          "${mrpt_math_BINARY_DIR}/3rdparty/eigen3/unsupported"
