...
# Was:    (NOT CMAKE_MRPT_HAS_OPENGL AND NOT CMAKE_MRPT_HAS_EGL))
...
# This flag is only used in granular ROS package builds
option(MRPT_BUILD_nanogui "Build nanogui lib" ON)
mark_as_advanced(MRPT_BUILD_nanogui)

if(MRPT_BUILD_nanogui)
  add_subdirectory(3rdparty/nanogui)

  set_target_properties(mrpt_nanogui PROPERTIES FOLDER "3rd party")
  target_compile_options(mrpt_nanogui PRIVATE
