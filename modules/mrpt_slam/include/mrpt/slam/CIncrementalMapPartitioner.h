    ...
    public mrpt::serialization::CSerializable
{
 ...
 public:
  ...
  uint32_t addMapFrame(
      const mrpt::obs::CSensoryFrame& frame, const mrpt::poses::CPose3DPDF& robotPose3D);
  ...
  void setSimilarityMethod(similarity_method_t method) { options.simil_method = method; }
  ...
  const mrpt::maps::CSimpleMap* getSequenceOfFrames() const { return &m_individualFrames; }
