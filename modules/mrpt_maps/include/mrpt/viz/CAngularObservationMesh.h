 ...
 * border-style: solid;">
 *   <tr> <td> mrpt::viz::CAngularObservationMesh </td> <td> \image html
    ...
    public VisualObjectParams_Lines
{
   ...
   public:
      ...
      switch (rangeType)
      {
        case 0:
          return (mrpt::sign(rangeData.mode0.increment) ==
                  mrpt::sign(rangeData.mode0.final - rangeData.mode0.initial))
      ...
      switch (rangeType)
      {
        ...
        case 2:
          return rangeData.mode2.negToPos
                     ? rangeData.mode2.aperture / static_cast<double>(rangeData.mode2.amount - 1)
                     : -rangeData.mode2.aperture / static_cast<double>(rangeData.mode2.amount - 1);
        default:
          throw std::logic_error("Unknown range type.");
      }
    ...
    bool negToPos() const
    {
      switch (rangeType)
      {
        ...
        case 1:
          return mrpt::sign(rangeData.mode1.final - rangeData.mode1.initial) > 0;
        case 2:
          return rangeData.mode2.negToPos;
        default:
          throw std::logic_error("Unknown range type.");
 ...
 public:
   ...
   * Basic constructor.
   */
  CAngularObservationMesh() : actualMesh(0, 0), validityMatrix(0, 0), pitchBounds(), scanSet() {}
  /** Empty destructor. */
   ...
   * through its X axis.
   * \sa mrpt::viz::CRenderizable,trace2DSetOfRays,trace1DSetOfRays
   */
 ...
 private:
  ...
  class FTrace1D
  {
   ...
   public:
    FTrace1D(
        const T& s, const mrpt::poses::CPose3D& p, std::vector<double>& v, std::vector<char>& v2) :
 ...
 public:
   ...
   * its.
   * \sa mrpt::viz::CRenderizable,mrpt::viz::Scene.
   */
  template <class T>
