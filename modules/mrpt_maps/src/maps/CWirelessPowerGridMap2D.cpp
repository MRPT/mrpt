...
MAP_DEFINITION_REGISTER(
    "mrpt::maps::CWirelessPowerGridMap2D,wifiGrid", mrpt::maps::CWirelessPowerGridMap2D)
...
void CWirelessPowerGridMap2D::TMapDefinition::dumpToTextStream_map_specific(std::ostream& out) const
{
  out << mrpt::format(
      "MAP TYPE                                  = %s\n",
      mrpt::typemeta::TEnumType<CWirelessPowerGridMap2D::TMapRepresentation>::value2name(mapType)
          .c_str());
...
mrpt::maps::CMetricMap::Ptr CWirelessPowerGridMap2D::internal_CreateFromMapDefinition(
...
uint8_t CWirelessPowerGridMap2D::serializeGetVersion() const { return 6; }
...
void CWirelessPowerGridMap2D::TInsertionOptions::dumpToTextStream(std::ostream& out) const
{
