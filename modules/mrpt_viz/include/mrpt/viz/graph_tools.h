 ...
 * | show_ground_grid          | bool    | Creates a gray grid on the ground level (mrpt::viz::CGridPlaneXY). The extension of the grid is computed to cover the entire graph extension     | true       |
 * | show_edges                | bool    | Draw lines between nodes with at least one edge between them.                                                                                       | true       |
 * | show_node_corners         | bool    | Draw a small 3D corner frame at each node (see mrpt::viz::stock_objects::CornerXYZSimple)                                                        | true       |
