 ...
 *
 * ![mrpt::viz::CGridPlaneXZ](preview_CGridPlaneXZ.png)
 *
 *  \sa opengl::Scene
 * \ingroup mrpt_viz_grp
 */
class CGridPlaneXZ : virtual public CVisualObject, public VisualObjectParams_Lines
{
  DEFINE_SERIALIZABLE(CGridPlaneXZ, mrpt::viz)
