 ...
 * terrain.
 *
 * ![mrpt::viz::CMeshFast](preview_CMeshFast.png)
 *
 *  \sa opengl::Scene
 * \ingroup mrpt_viz_grp
 */
class CMeshFast : virtual public CVisualObject, public VisualObjectParams_Points
{
  DEFINE_SERIALIZABLE(CMeshFast, mrpt::viz)
