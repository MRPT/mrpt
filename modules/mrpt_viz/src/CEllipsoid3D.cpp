...
IMPLEMENTS_SERIALIZABLE(CEllipsoid3D, CVisualObject, mrpt::viz)
...
uint8_t CEllipsoid3D::serializeGetVersion() const { return 1; }
...
void CEllipsoid3D::serializeFrom(mrpt::serialization::CArchive& in, uint8_t version)
{
  switch (version)
  {
    case 0:
