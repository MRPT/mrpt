...
CSetOfObjects::Ptr stock_objects::RobotRhodon()
{
  ...
  CPolyhedron::Ptr obj1 = viz::CPolyhedron::CreateCustomPrism(level1, 0.38);
  ...
  CPolyhedron::Ptr obj2 = viz::CPolyhedron::CreateCustomPrism(level2, 0.35);
  ...
  CPolyhedron::Ptr obj3 = viz::CPolyhedron::CreateCustomPrism(level3, 1);
  obj3->setLocation(0, 0, height);
  // height+=1;
  obj3->setColor(0.6f, 0.6f, 0.6f);
  ret->insert(obj3);

  viz::CCylinder::Ptr obj4 = std::make_shared<viz::CCylinder>(0.05f, 0.05f, 0.4f, 20);
  obj4->setLocation(0, 0, 0.73);
  obj4->setColor(0.0f, 0.0f, 0.9f);
  ret->insert(obj4);

  viz::CCylinder::Ptr obj5 = std::make_shared<viz::CCylinder>(0.05f, 0.05f, 0.4f, 20);
...
CSetOfObjects::Ptr stock_objects::RobotGiraff()
{
  ...
  CPolyhedron::Ptr obj1 = viz::CPolyhedron::CreateCustomPrism(level1, 0.23);
  obj1->setLocation(0, 0, height);
  height += 0.23f;
  ...
  CPolyhedron::Ptr obj2 = viz::CPolyhedron::CreateCustomPrism(level2, 0.45);
  obj2->setLocation(0, 0, height);
  height += 0.45f;
  ...
  CPolyhedron::Ptr obj3 = viz::CPolyhedron::CreateCustomPrism(level3, 0.55);
  obj3->setLocation(0, 0, height);
  height += 0.55f;
  obj3->setColor(0.6f, 0.6f, 0.6f);
  ret->insert(obj3);
  ...
  CPolyhedron::Ptr obj4 = viz::CPolyhedron::CreateCustomPrism(level4, 0.4);
...
{
  CSetOfObjects::Ptr camera = std::make_shared<viz::CSetOfObjects>();

  CPolyhedron::Ptr rect = viz::CPolyhedron::CreateCubicPrism(-0.02, 0.14, -0.02, 0.02, 0, -0.04);
  rect->setColor(1.0f, 0.8f, 0.0f);

  camera->insert(rect);

  CCylinder::Ptr lCam = std::make_shared<viz::CCylinder>(0.01f, 0.01f, 0.003f, 10);
  lCam->setColor(1, 0, 0);

  CCylinder::Ptr rCam = std::make_shared<viz::CCylinder>(0.01f, 0.01f, 0.003f, 10);
...
CSetOfObjects::Ptr stock_objects::Hokuyo_URG()
{
  ...
  {
    CBox::Ptr base =
        std::make_shared<CBox>(TPoint3D(-0.025, -0.025, -0.0575), TPoint3D(0.025, 0.025, -0.0185));
...
CSetOfObjects::Ptr stock_objects::Hokuyo_UTM()
{
  ...
  {
    CBox::Ptr base =
        std::make_shared<CBox>(TPoint3D(-0.03, -0.03, -0.055), TPoint3D(0.03, 0.03, -0.014));
    base->setColor(0, 0, 0);
    ret->insert(base);
  }
  {
...
CSetOfObjects::Ptr stock_objects::Househam_Sprayer()
{
  ...
  {
    CBox::Ptr cabin =
        std::make_shared<CBox>(TPoint3D(0.878, 0.723, -0.12), TPoint3D(-0.258, -0.723, -1.690));
    cabin->setColor(0.7f, 0.7f, 0.7f);
    ret->insert(cabin);
  }
  {
    CBox::Ptr back =
        std::make_shared<CBox>(TPoint3D(-0.258, 0.723, -0.72), TPoint3D(-5.938, -0.723, -1.690));
    back->setColor(1, 1, 1);
    ret->insert(back);
  }
  {
    CBox::Ptr boomAxis =
        std::make_shared<CBox>(TPoint3D(-5.938, 0.723, -1.0), TPoint3D(-6.189, -0.723, -1.690));
    boomAxis->setColor(0, 0, 0);
    ret->insert(boomAxis);
  }
  {
    CBox::Ptr boom1 =
        std::make_shared<CBox>(TPoint3D(-5.938, 0.723, -1.0), TPoint3D(-6.189, 11.277, -1.620));
