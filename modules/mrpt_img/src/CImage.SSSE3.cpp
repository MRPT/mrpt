    ...
    const uint8_t* in, uint8_t* out, int w, int h, size_t step_in, size_t step_out)
{
  ...
  // clang-format off
	...
	const __m128i m0 = _mm_set_epi8(s80, s80, s80, s80, s80, s80, s80, 0x0E, 0x0D, 0x0C, 0x08, 0x07, 0x06, 0x02, 0x01, 0x00);
	const __m128i m1 = _mm_set_epi8(0x0E, 0x0A, 0x09, 0x08, 0x04, 0x03, 0x02, s80, s80, s80, s80, s80, s80, s80, s80, s80);
	const __m128i m2 = _mm_set_epi8(s80, s80, s80, s80, s80, s80, s80, s80, 0x0C, 0x0B, 0x0A, 0x06, 0x05, 0x04, 0x00, s80);
	const __m128i m3 = _mm_set_epi8(s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, 0x0F);
    ...
    const uint8_t* in, uint8_t* out, int w, int h, size_t step_in, size_t step_out)
{
  ...
  {
    impl_image_SSSE3_scale_half_3c8u<true>(in, out, w, h, step_in, step_out);
  }
  else
  {
    impl_image_SSSE3_scale_half_3c8u<false>(in, out, w, h, step_in, step_out);
  }
}
    ...
    const uint8_t* in, uint8_t* out, int w, int h, size_t step_in, size_t step_out)  // NOLINT
{
  ...
  // clang-format off
	...
	// reds[0-7] from D1
	const __m128i mask1 = _mm_setr_epi8(s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, 0x02, s80, 0x05);
	// greens[0-7] from D0
	const __m128i mask2 = _mm_setr_epi8(s80, 0x01, s80, 0x04, s80, 0x07, s80, 0x0A, s80, 0x0D, s80, s80, s80, s80, s80, s80);
	// greens[0-7] from D1
	const __m128i mask3 = _mm_setr_epi8(s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, 0x00, s80, 0x03, s80, 0x06);
	// blues[0-7] from D0
	const __m128i mask4 = _mm_setr_epi8(s80, 0x02, s80, 0x05, s80, 0x08, s80, 0x0B, s80, 0x0E, s80, s80, s80, s80, s80, s80);
	// blues[0-7] from D1
	const __m128i mask5 = _mm_setr_epi8(s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, s80, 0x01, s80, 0x04, s80, 0x07);
	// reds[8-15] from D1
	const __m128i mask6 = _mm_setr_epi8(s80, 0x08, s80, 0x0B, s80, 0x0E, s80, s80, s80, s80, s80, s80, s80, s80, s80, s80);
	// reds[8-15] from D2
	const __m128i mask7 = _mm_setr_epi8(s80, s80, s80, s80, s80, s80, s80, 0x01, s80, 0x04, s80, 0x07, s80, 0x0A, s80, 0x0D);
	// greens[8-15] from D1
	const __m128i mask8 = _mm_setr_epi8(s80, 0x09, s80, 0x0C, s80, 0x0F, s80, s80, s80, s80, s80, s80, s80, s80, s80, s80);
	// greens[8-15] from D2
	const __m128i mask9 = _mm_setr_epi8(s80, s80, s80, s80, s80, s80, s80, 0x02, s80, 0x05, s80, 0x08, s80, 0x0B, s80, 0x0E);
	// blues[8-15] from D1
    ...
    for (int j = 0; j < sw; j++)
    {
      ...
      // First 8 bytes of gray levels:
      {
        ...
        const __m128i GRAYS_0_7 = _mm_adds_epu16(
            ...
            _mm_adds_epu16(_mm_mulhi_epu16(GREENS_0_7, VAL_G), _mm_mulhi_epu16(BLUES_0_7, VAL_B)));

        _mm_storel_epi64(reinterpret_cast<__m128i*>(outp), _mm_shuffle_epi8(GRAYS_0_7, mask_low));
        outp += 8;
      }
      ...
      // Second 8 bytes of gray levels:
      {
        ...
        const __m128i GRAYS_8_15 = _mm_adds_epu16(
            ...
            _mm_adds_epu16(
                _mm_mulhi_epu16(GREENS_8_15, VAL_G), _mm_mulhi_epu16(BLUES_8_15, VAL_B)));

        _mm_storel_epi64(reinterpret_cast<__m128i*>(outp), _mm_shuffle_epi8(GRAYS_8_15, mask_low));
        outp += 8;
      }
    }
    in += step_in;
    ...
    const uint8_t* in, uint8_t* out, int w, int h, size_t step_in, size_t step_out)
{
  ...
  if (mrpt::system::is_aligned<16>(in) && mrpt::system::is_aligned<16>(out))
  {
    impl_image_SSSE3_rgb_or_bgr_to_gray_8u<false, true>(in, out, w, h, step_in, step_out);
  }
  else
  {
    impl_image_SSSE3_rgb_or_bgr_to_gray_8u<false, false>(in, out, w, h, step_in, step_out);
  }
}
    ...
    const uint8_t* in, uint8_t* out, int w, int h, size_t step_in, size_t step_out)
{
  ...
  if (mrpt::system::is_aligned<16>(in) && mrpt::system::is_aligned<16>(out))
  {
    impl_image_SSSE3_rgb_or_bgr_to_gray_8u<true, true>(in, out, w, h, step_in, step_out);
  }
  else
  {
    impl_image_SSSE3_rgb_or_bgr_to_gray_8u<true, false>(in, out, w, h, step_in, step_out);
  }
}
