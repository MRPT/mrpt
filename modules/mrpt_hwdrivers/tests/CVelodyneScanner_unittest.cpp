...
{
  const string fil = mrpt::mrpt_data_dir() + string("/tests/sample_velodyne_vlp16_gps.pcap");
...
{
  const string fil = mrpt::mrpt_data_dir() + string("/tests/sample_velodyne_hdl32.pcap");
