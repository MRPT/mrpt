...
void main()
{
    ...
    // Remap [0,1] -> [ssao_ambient_floor, 1] so fully-occluded back-lit faces
    // retain some ambient and never go pitch-black.
    ...
    for (int i = 0; i < num_lights; i++)
    {
        ...
        // Diffuse (partially modulated by SSAO for visible corner darkening)
