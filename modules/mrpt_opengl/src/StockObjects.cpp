...
CSetOfObjects::Ptr stock_objects::RobotRhodon()
{
  ...
  opengl::CCylinder::Ptr obj4 = std::make_shared<opengl::CCylinder>(0.05f, 0.05f, 0.4f, 20);
  obj4->setLocation(0, 0, 0.73);
  obj4->setColor(0.0f, 0.0f, 0.9f);
  ret->insert(obj4);

  opengl::CCylinder::Ptr obj5 = std::make_shared<opengl::CCylinder>(0.05f, 0.05f, 0.4f, 20);
...
CSetOfObjects::Ptr stock_objects::BumblebeeCamera()
{
  ...
  CCylinder::Ptr lCam = std::make_shared<opengl::CCylinder>(0.01f, 0.01f, 0.003f, 10);
  lCam->setColor(1, 0, 0);

  CCylinder::Ptr rCam = std::make_shared<opengl::CCylinder>(0.01f, 0.01f, 0.003f, 10);
