...
PYBIND11_MODULE(pymrpt, root_module) {
	...
	bind_mrpt_typemeta_static_string_1(M);
	bind_mrpt_typemeta_static_string_2(M);
	bind_mrpt_typemeta_static_string_3(M);
	...
	bind_mrpt_containers_deepcopy_poly_ptr(M);
	...
	bind_mrpt_opengl_opengl_fonts(M);
	...
	bind_mrpt_nav_planners_PlannerRRT_common(M);
	...
	bind_mrpt_nav_tpspace_CPTG_DiffDrive_CollisionGridBased(M);
	...
	bind_mrpt_obs_CObservationComment(M);
	bind_mrpt_obs_CObservationStereoImagesFeatures(M);
	...
	bind_mrpt_opengl_CDisk(M);
	bind_mrpt_opengl_CFrustum(M);
	bind_mrpt_opengl_CMesh3D(M);
	bind_mrpt_opengl_CSimpleLine(M);
	bind_mrpt_opengl_CEllipsoidInverseDepth2D(M);
	bind_mrpt_opengl_CPolyhedron(M);
