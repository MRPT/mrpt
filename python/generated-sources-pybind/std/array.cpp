...
void bind_std_array(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // std::array file:array line:95
		...
		cl.def("size", (std::array::size_type (std::array<mrpt::img::CImage,6>::*)() const) &std::array<mrpt::img::CImage, 6>::size, "C++: std::array<mrpt::img::CImage, 6>::size() const --> std::array::size_type");
		cl.def("max_size", (std::array::size_type (std::array<mrpt::img::CImage,6>::*)() const) &std::array<mrpt::img::CImage, 6>::max_size, "C++: std::array<mrpt::img::CImage, 6>::max_size() const --> std::array::size_type");
		...
		cl.def("__getitem__", (class mrpt::img::CImage & (std::array<mrpt::img::CImage,6>::*)(std::array::size_type)) &std::array<mrpt::img::CImage, 6>::operator[], "C++: std::array<mrpt::img::CImage, 6>::operator[](std::array::size_type) --> class mrpt::img::CImage &", pybind11::return_value_policy::automatic, pybind11::arg("__n"));
		cl.def("at", (class mrpt::img::CImage & (std::array<mrpt::img::CImage,6>::*)(std::array::size_type)) &std::array<mrpt::img::CImage, 6>::at, "C++: std::array<mrpt::img::CImage, 6>::at(std::array::size_type) --> class mrpt::img::CImage &", pybind11::return_value_policy::automatic, pybind11::arg("__n"));
