...
void bind_std_array(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // std::array file:array line:95
		...
		cl.def("size", (size_t (std::array<mrpt::img::CImage,6>::*)() const) &std::array<mrpt::img::CImage, 6>::size, "C++: std::array<mrpt::img::CImage, 6>::size() const --> size_t");
		cl.def("max_size", (size_t (std::array<mrpt::img::CImage,6>::*)() const) &std::array<mrpt::img::CImage, 6>::max_size, "C++: std::array<mrpt::img::CImage, 6>::max_size() const --> size_t");
		...
		cl.def("__getitem__", (class mrpt::img::CImage & (std::array<mrpt::img::CImage,6>::*)(size_t)) &std::array<mrpt::img::CImage, 6>::operator[], "C++: std::array<mrpt::img::CImage, 6>::operator[](size_t) --> class mrpt::img::CImage &", pybind11::return_value_policy::automatic, pybind11::arg("__n"));
		cl.def("at", (class mrpt::img::CImage & (std::array<mrpt::img::CImage,6>::*)(size_t)) &std::array<mrpt::img::CImage, 6>::at, "C++: std::array<mrpt::img::CImage, 6>::at(size_t) --> class mrpt::img::CImage &", pybind11::return_value_policy::automatic, pybind11::arg("__n"));
