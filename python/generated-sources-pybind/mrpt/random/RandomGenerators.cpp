...
void bind_mrpt_random_RandomGenerators(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::random::CRandomGenerator file:mrpt/random/RandomGenerators.h line:80
		...
		cl.def("drawUniform32bit", (unsigned int (mrpt::random::CRandomGenerator::*)()) &mrpt::random::CRandomGenerator::drawUniform32bit, "Generate a uniformly distributed pseudo-random number using the MT19937\n algorithm, in the whole range of 32-bit integers.\n  See: http://en.wikipedia.org/wiki/Mersenne_twister \n\nC++: mrpt::random::CRandomGenerator::drawUniform32bit() --> unsigned int");
		cl.def("drawUniform64bit", (unsigned long (mrpt::random::CRandomGenerator::*)()) &mrpt::random::CRandomGenerator::drawUniform64bit, "Returns a uniformly distributed pseudo-random number by joining two\n 32bit numbers from  \n\nC++: mrpt::random::CRandomGenerator::drawUniform64bit() --> unsigned long");
		cl.def("drawUniformUnsignedInt", (void (mrpt::random::CRandomGenerator::*)(unsigned int &)) &mrpt::random::CRandomGenerator::drawUniformUnsignedInt, "You can call this overloaded method with either 32 or 64bit unsigned\n ints for the sake of general coding. \n\nC++: mrpt::random::CRandomGenerator::drawUniformUnsignedInt(unsigned int &) --> void", pybind11::arg("ret_number"));
		cl.def("drawUniformUnsignedInt", (void (mrpt::random::CRandomGenerator::*)(unsigned long &)) &mrpt::random::CRandomGenerator::drawUniformUnsignedInt, "C++: mrpt::random::CRandomGenerator::drawUniformUnsignedInt(unsigned long &) --> void", pybind11::arg("ret_number"));
	...
	// mrpt::random::getRandomGenerator() file:mrpt/random/RandomGenerators.h line:422
	...
	// mrpt::random::random_generator_for_STL(long) file:mrpt/random/RandomGenerators.h line:427
	M("mrpt::random").def("random_generator_for_STL", (long (*)(long)) &mrpt::random::random_generator_for_STL, "A random number generator for usage in STL algorithms expecting a function\n like this (eg, random_shuffle):\n\nC++: mrpt::random::random_generator_for_STL(long) --> long", pybind11::arg("i"));

	// mrpt::random::Randomize(const unsigned int) file:mrpt/random/RandomGenerators.h line:490
	...
	// mrpt::random::Randomize() file:mrpt/random/RandomGenerators.h line:494
