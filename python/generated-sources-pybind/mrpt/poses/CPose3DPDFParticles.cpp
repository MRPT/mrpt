...
void bind_mrpt_poses_CPose3DPDFParticles(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::poses::CPose3DPDFParticles file:mrpt/poses/CPose3DPDFParticles.h line:33
		...
		cl.def("resetDeterministic", (void (mrpt::poses::CPose3DPDFParticles::*)(const struct mrpt::math::TPose3D &, unsigned long)) &mrpt::poses::CPose3DPDFParticles::resetDeterministic, "Reset the PDF to a single point: All m_particles will be set exactly to\n the supplied pose.\n \n\n The location to set all the m_particles.\n \n\n If this is set to 0 the number of m_particles\n remains unchanged.\n  \n\n resetUniform \n\nC++: mrpt::poses::CPose3DPDFParticles::resetDeterministic(const struct mrpt::math::TPose3D &, unsigned long) --> void", pybind11::arg("location"), pybind11::arg("particlesCount"));
		...
		cl.def("size", (unsigned long (mrpt::poses::CPose3DPDFParticles::*)() const) &mrpt::poses::CPose3DPDFParticles::size, "Get the m_particles count (equivalent to \"particlesCount\") \n\nC++: mrpt::poses::CPose3DPDFParticles::size() const --> unsigned long");
	...
	{ // mrpt::poses::CPosePDFParticles file:mrpt/poses/CPosePDFParticles.h line:34
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<30> (*)()) &mrpt::poses::CPosePDFParticles::getClassName, "C++: mrpt::poses::CPosePDFParticles::getClassName() --> class mrpt::typemeta::string_literal<30>");
		...
		cl.def("resetDeterministic", (void (mrpt::poses::CPosePDFParticles::*)(const struct mrpt::math::TPose2D &, unsigned long)) &mrpt::poses::CPosePDFParticles::resetDeterministic, "Reset the PDF to a single point: All m_particles will be set exactly to\n the supplied pose.\n \n\n The location to set all the m_particles.\n \n\n If this is set to 0 the number of m_particles\n remains unchanged.\n  \n\n resetUniform, CMonteCarloLocalization2D::resetUniformFreeSpace,\n resetAroundSetOfPoses\n\nC++: mrpt::poses::CPosePDFParticles::resetDeterministic(const struct mrpt::math::TPose2D &, unsigned long) --> void", pybind11::arg("location"), pybind11::arg("particlesCount"));
		...
		cl.def("getParticlePose", (struct mrpt::math::TPose2D (mrpt::poses::CPosePDFParticles::*)(unsigned long) const) &mrpt::poses::CPosePDFParticles::getParticlePose, "Returns the pose of the i'th particle.\n\nC++: mrpt::poses::CPosePDFParticles::getParticlePose(unsigned long) const --> struct mrpt::math::TPose2D", pybind11::arg("i"));
		...
		cl.def("size", (unsigned long (mrpt::poses::CPosePDFParticles::*)() const) &mrpt::poses::CPosePDFParticles::size, "Get the m_particles count (equivalent to \"particlesCount\")\n\nC++: mrpt::poses::CPosePDFParticles::size() const --> unsigned long");
