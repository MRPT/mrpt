...
void bind_mrpt_poses_CPointPDFSOG(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::poses::CPointPDFSOG file:mrpt/poses/CPointPDFSOG.h line:35
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<25> (*)()) &mrpt::poses::CPointPDFSOG::getClassName, "C++: mrpt::poses::CPointPDFSOG::getClassName() --> class mrpt::typemeta::string_literal<25>");
		...
		cl.def("__getitem__", (struct mrpt::poses::CPointPDFSOG::TGaussianMode & (mrpt::poses::CPointPDFSOG::*)(unsigned long)) &mrpt::poses::CPointPDFSOG::operator[], "Access to individual beacons \n\nC++: mrpt::poses::CPointPDFSOG::operator[](unsigned long) --> struct mrpt::poses::CPointPDFSOG::TGaussianMode &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("get", (struct mrpt::poses::CPointPDFSOG::TGaussianMode & (mrpt::poses::CPointPDFSOG::*)(unsigned long)) &mrpt::poses::CPointPDFSOG::get, "Access to individual beacons \n\nC++: mrpt::poses::CPointPDFSOG::get(unsigned long) --> struct mrpt::poses::CPointPDFSOG::TGaussianMode &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		...
		cl.def("resize", (void (mrpt::poses::CPointPDFSOG::*)(const unsigned long)) &mrpt::poses::CPointPDFSOG::resize, "Resize the number of SOG modes \n\nC++: mrpt::poses::CPointPDFSOG::resize(const unsigned long) --> void", pybind11::arg("N"));
		cl.def("size", (unsigned long (mrpt::poses::CPointPDFSOG::*)() const) &mrpt::poses::CPointPDFSOG::size, "Return the number of Gaussian modes. \n\nC++: mrpt::poses::CPointPDFSOG::size() const --> unsigned long");
