...
void bind_mrpt_poses_CPoses2DSequence(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::poses::CPoses2DSequence file:mrpt/poses/CPoses2DSequence.h line:25
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<29> (*)()) &mrpt::poses::CPoses2DSequence::getClassName, "C++: mrpt::poses::CPoses2DSequence::getClassName() --> class mrpt::typemeta::string_literal<29>");
		...
		cl.def("posesCount", (unsigned long (mrpt::poses::CPoses2DSequence::*)()) &mrpt::poses::CPoses2DSequence::posesCount, "Returns the poses count in the sequence:\n\nC++: mrpt::poses::CPoses2DSequence::posesCount() --> unsigned long");
		...
		cl.def("computeTraveledDistanceAfter", (double (mrpt::poses::CPoses2DSequence::*)(unsigned long)) &mrpt::poses::CPoses2DSequence::computeTraveledDistanceAfter, "Returns the traveled distance after moving \"n\" poses, so for \"n=0\" it\n returns 0, for \"n=1\" the first traveled distance, and for\n \"n=posesCount()\", the total\n  distance after ALL movements.\n \n\n std::exception On invalid index value\n \n\n computeTraveledDistanceAfterAll\n\nC++: mrpt::poses::CPoses2DSequence::computeTraveledDistanceAfter(unsigned long) --> double", pybind11::arg("n"));
	...
	{ // mrpt::poses::CPoses3DSequence file:mrpt/poses/CPoses3DSequence.h line:23
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<29> (*)()) &mrpt::poses::CPoses3DSequence::getClassName, "C++: mrpt::poses::CPoses3DSequence::getClassName() --> class mrpt::typemeta::string_literal<29>");
		...
		cl.def("posesCount", (unsigned long (mrpt::poses::CPoses3DSequence::*)()) &mrpt::poses::CPoses3DSequence::posesCount, "Returns the poses count in the sequence:\n\nC++: mrpt::poses::CPoses3DSequence::posesCount() --> unsigned long");
		...
		cl.def("computeTraveledDistanceAfter", (double (mrpt::poses::CPoses3DSequence::*)(unsigned long)) &mrpt::poses::CPoses3DSequence::computeTraveledDistanceAfter, "Returns the traveled distance after moving \"n\" poses, so for \"n=0\" it\n returns 0, for \"n=1\" the first traveled distance, and for\n \"n=posesCount()\", the total\n  distance after ALL movements.\n \n\n std::exception On invalid index value\n \n\n computeTraveledDistanceAfterAll\n\nC++: mrpt::poses::CPoses3DSequence::computeTraveledDistanceAfter(unsigned long) --> double", pybind11::arg("n"));
	...
	{ // mrpt::poses::CRobot2DPoseEstimator file:mrpt/poses/CRobot2DPoseEstimator.h line:30
		...
		cl.def("processUpdateNewPoseLocalization", (void (mrpt::poses::CRobot2DPoseEstimator::*)(const struct mrpt::math::TPose2D &, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >)) &mrpt::poses::CRobot2DPoseEstimator::processUpdateNewPoseLocalization, "Updates the filter with new global-coordinates localization data from a\n localization or SLAM source.\n \n\n The timestamp of the sensor readings used to evaluate\n localization / SLAM.\n\nC++: mrpt::poses::CRobot2DPoseEstimator::processUpdateNewPoseLocalization(const struct mrpt::math::TPose2D &, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >) --> void", pybind11::arg("newPose"), pybind11::arg("tim"));
		cl.def("processUpdateNewOdometry", [](mrpt::poses::CRobot2DPoseEstimator &o, const struct mrpt::math::TPose2D & a0, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > const & a1) -> void { return o.processUpdateNewOdometry(a0, a1); }, "", pybind11::arg("newGlobalOdometry"), pybind11::arg("cur_tim"));
		cl.def("processUpdateNewOdometry", [](mrpt::poses::CRobot2DPoseEstimator &o, const struct mrpt::math::TPose2D & a0, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > const & a1, bool const & a2) -> void { return o.processUpdateNewOdometry(a0, a1, a2); }, "", pybind11::arg("newGlobalOdometry"), pybind11::arg("cur_tim"), pybind11::arg("hasVelocities"));
		cl.def("processUpdateNewOdometry", (void (mrpt::poses::CRobot2DPoseEstimator::*)(const struct mrpt::math::TPose2D &, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >, bool, const struct mrpt::math::TTwist2D &)) &mrpt::poses::CRobot2DPoseEstimator::processUpdateNewOdometry, "Updates the filter with new odometry readings. \n\nC++: mrpt::poses::CRobot2DPoseEstimator::processUpdateNewOdometry(const struct mrpt::math::TPose2D &, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >, bool, const struct mrpt::math::TTwist2D &) --> void", pybind11::arg("newGlobalOdometry"), pybind11::arg("cur_tim"), pybind11::arg("hasVelocities"), pybind11::arg("newRobotVelLocal"));
		...
		cl.def("getCurrentEstimate", (bool (mrpt::poses::CRobot2DPoseEstimator::*)(struct mrpt::math::TPose2D &, struct mrpt::math::TTwist2D &, struct mrpt::math::TTwist2D &, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >) const) &mrpt::poses::CRobot2DPoseEstimator::getCurrentEstimate, "Get the estimate for a given timestamp (defaults to `now()`), obtained\n as:\n\n   last_loc (+) [ last_odo (-) odo_ref ] (+) extrapolation_from_vw\n\n \n true is the estimate can be trusted. False if the real observed\n data is too old or there is no valid data yet.\n \n\n getLatestRobotPose\n\nC++: mrpt::poses::CRobot2DPoseEstimator::getCurrentEstimate(struct mrpt::math::TPose2D &, struct mrpt::math::TTwist2D &, struct mrpt::math::TTwist2D &, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >) const --> bool", pybind11::arg("pose"), pybind11::arg("velLocal"), pybind11::arg("velGlobal"), pybind11::arg("tim_query"));
