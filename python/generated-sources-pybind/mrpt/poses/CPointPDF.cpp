...
void bind_mrpt_poses_CPointPDF(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::poses::CPointPDFParticles file:mrpt/poses/CPointPDFParticles.h line:24
		...
		cl.def( pybind11::init<unsigned long>(), pybind11::arg("numParticles") );
		...
		cl.def("setSize", (void (mrpt::poses::CPointPDFParticles::*)(unsigned long, const struct mrpt::math::TPoint3D_<float> &)) &mrpt::poses::CPointPDFParticles::setSize, "Erase all the previous particles and change the number of particles,\n with a given initial value  \n\nC++: mrpt::poses::CPointPDFParticles::setSize(unsigned long, const struct mrpt::math::TPoint3D_<float> &) --> void", pybind11::arg("numberParticles"), pybind11::arg("defaultValue"));
		cl.def("size", (unsigned long (mrpt::poses::CPointPDFParticles::*)() const) &mrpt::poses::CPointPDFParticles::size, "Returns the number of particles \n\nC++: mrpt::poses::CPointPDFParticles::size() const --> unsigned long");
