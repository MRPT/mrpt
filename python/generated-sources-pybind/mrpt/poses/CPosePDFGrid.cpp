...
void bind_mrpt_poses_CPosePDFGrid(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::poses::CPosePDFSOG file:mrpt/poses/CPosePDFSOG.h line:35
		...
		cl.def("size", (unsigned long (mrpt::poses::CPosePDFSOG::*)() const) &mrpt::poses::CPosePDFSOG::size, "Return the number of Gaussian modes. \n\nC++: mrpt::poses::CPosePDFSOG::size() const --> unsigned long");
		...
		cl.def("__getitem__", (struct mrpt::poses::CPosePDFSOG::TGaussianMode & (mrpt::poses::CPosePDFSOG::*)(unsigned long)) &mrpt::poses::CPosePDFSOG::operator[], "Access to individual beacons \n\nC++: mrpt::poses::CPosePDFSOG::operator[](unsigned long) --> struct mrpt::poses::CPosePDFSOG::TGaussianMode &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("get", (struct mrpt::poses::CPosePDFSOG::TGaussianMode & (mrpt::poses::CPosePDFSOG::*)(unsigned long)) &mrpt::poses::CPosePDFSOG::get, "Access to individual beacons \n\nC++: mrpt::poses::CPosePDFSOG::get(unsigned long) --> struct mrpt::poses::CPosePDFSOG::TGaussianMode &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		...
		cl.def("resize", (void (mrpt::poses::CPosePDFSOG::*)(const unsigned long)) &mrpt::poses::CPosePDFSOG::resize, "Resize the number of SOG modes \n\nC++: mrpt::poses::CPosePDFSOG::resize(const unsigned long) --> void", pybind11::arg("N"));
