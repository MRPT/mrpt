...
void bind_mrpt_poses_CPose3D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::poses::CPose3D file:mrpt/poses/CPose3D.h line:79
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<20> (*)()) &mrpt::poses::CPose3D::getClassName, "C++: mrpt::poses::CPose3D::getClassName() --> class mrpt::typemeta::string_literal<20>");
		...
		cl.def_static("FromTranslation", (class mrpt::poses::CPose3D (*)(const struct mrpt::math::TPoint3D_<double> &)) &mrpt::poses::CPose3D::FromTranslation, "	 \n\nC++: mrpt::poses::CPose3D::FromTranslation(const struct mrpt::math::TPoint3D_<double> &) --> class mrpt::poses::CPose3D", pybind11::arg("t"));
