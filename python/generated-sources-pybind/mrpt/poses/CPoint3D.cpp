...
void bind_mrpt_poses_CPoint3D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::poses::CPose3DQuat file:mrpt/poses/CPose3DQuat.h line:46
		...
		{ // mrpt::poses::CPose3DQuat::iterator file:mrpt/poses/CPose3DQuat.h line:371
			...
			cl.def("__iadd__", (struct mrpt::poses::CPose3DQuat::iterator & (mrpt::poses::CPose3DQuat::iterator::*)(int64_t)) &mrpt::poses::CPose3DQuat::iterator::operator+=, "C++: mrpt::poses::CPose3DQuat::iterator::operator+=(int64_t) --> struct mrpt::poses::CPose3DQuat::iterator &", pybind11::return_value_policy::automatic, pybind11::arg("off"));
			cl.def("__add__", (struct mrpt::poses::CPose3DQuat::iterator (mrpt::poses::CPose3DQuat::iterator::*)(int64_t) const) &mrpt::poses::CPose3DQuat::iterator::operator+, "C++: mrpt::poses::CPose3DQuat::iterator::operator+(int64_t) const --> struct mrpt::poses::CPose3DQuat::iterator", pybind11::arg("off"));
			cl.def("__isub__", (struct mrpt::poses::CPose3DQuat::iterator & (mrpt::poses::CPose3DQuat::iterator::*)(int64_t)) &mrpt::poses::CPose3DQuat::iterator::operator-=, "C++: mrpt::poses::CPose3DQuat::iterator::operator-=(int64_t) --> struct mrpt::poses::CPose3DQuat::iterator &", pybind11::return_value_policy::automatic, pybind11::arg("off"));
			cl.def("__sub__", (struct mrpt::poses::CPose3DQuat::iterator (mrpt::poses::CPose3DQuat::iterator::*)(int64_t) const) &mrpt::poses::CPose3DQuat::iterator::operator-, "C++: mrpt::poses::CPose3DQuat::iterator::operator-(int64_t) const --> struct mrpt::poses::CPose3DQuat::iterator", pybind11::arg("off"));
		...
		{ // mrpt::poses::CPose3DQuat::const_iterator file:mrpt/poses/CPose3DQuat.h line:482
			...
			cl.def("__iadd__", (struct mrpt::poses::CPose3DQuat::const_iterator & (mrpt::poses::CPose3DQuat::const_iterator::*)(int64_t)) &mrpt::poses::CPose3DQuat::const_iterator::operator+=, "C++: mrpt::poses::CPose3DQuat::const_iterator::operator+=(int64_t) --> struct mrpt::poses::CPose3DQuat::const_iterator &", pybind11::return_value_policy::automatic, pybind11::arg("off"));
			cl.def("__add__", (struct mrpt::poses::CPose3DQuat::const_iterator (mrpt::poses::CPose3DQuat::const_iterator::*)(int64_t) const) &mrpt::poses::CPose3DQuat::const_iterator::operator+, "C++: mrpt::poses::CPose3DQuat::const_iterator::operator+(int64_t) const --> struct mrpt::poses::CPose3DQuat::const_iterator", pybind11::arg("off"));
			cl.def("__isub__", (struct mrpt::poses::CPose3DQuat::const_iterator & (mrpt::poses::CPose3DQuat::const_iterator::*)(int64_t)) &mrpt::poses::CPose3DQuat::const_iterator::operator-=, "C++: mrpt::poses::CPose3DQuat::const_iterator::operator-=(int64_t) --> struct mrpt::poses::CPose3DQuat::const_iterator &", pybind11::return_value_policy::automatic, pybind11::arg("off"));
			cl.def("__sub__", (struct mrpt::poses::CPose3DQuat::const_iterator (mrpt::poses::CPose3DQuat::const_iterator::*)(int64_t) const) &mrpt::poses::CPose3DQuat::const_iterator::operator-, "C++: mrpt::poses::CPose3DQuat::const_iterator::operator-(int64_t) const --> struct mrpt::poses::CPose3DQuat::const_iterator", pybind11::arg("off"));
