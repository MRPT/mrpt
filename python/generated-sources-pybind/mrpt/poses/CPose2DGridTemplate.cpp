...
void bind_mrpt_poses_CPose2DGridTemplate(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::poses::CPose2DGridTemplate file:mrpt/poses/CPose2DGridTemplate.h line:22
		...
		cl.def("x2idx", (unsigned long (mrpt::poses::CPose2DGridTemplate<double>::*)(double) const) &mrpt::poses::CPose2DGridTemplate<double>::x2idx, "C++: mrpt::poses::CPose2DGridTemplate<double>::x2idx(double) const --> unsigned long", pybind11::arg("x"));
		cl.def("y2idx", (unsigned long (mrpt::poses::CPose2DGridTemplate<double>::*)(double) const) &mrpt::poses::CPose2DGridTemplate<double>::y2idx, "C++: mrpt::poses::CPose2DGridTemplate<double>::y2idx(double) const --> unsigned long", pybind11::arg("y"));
		cl.def("phi2idx", (unsigned long (mrpt::poses::CPose2DGridTemplate<double>::*)(double) const) &mrpt::poses::CPose2DGridTemplate<double>::phi2idx, "C++: mrpt::poses::CPose2DGridTemplate<double>::phi2idx(double) const --> unsigned long", pybind11::arg("phi"));
		cl.def("idx2x", (double (mrpt::poses::CPose2DGridTemplate<double>::*)(unsigned long) const) &mrpt::poses::CPose2DGridTemplate<double>::idx2x, "C++: mrpt::poses::CPose2DGridTemplate<double>::idx2x(unsigned long) const --> double", pybind11::arg("x"));
		cl.def("idx2y", (double (mrpt::poses::CPose2DGridTemplate<double>::*)(unsigned long) const) &mrpt::poses::CPose2DGridTemplate<double>::idx2y, "C++: mrpt::poses::CPose2DGridTemplate<double>::idx2y(unsigned long) const --> double", pybind11::arg("y"));
		cl.def("idx2phi", (double (mrpt::poses::CPose2DGridTemplate<double>::*)(unsigned long) const) &mrpt::poses::CPose2DGridTemplate<double>::idx2phi, "C++: mrpt::poses::CPose2DGridTemplate<double>::idx2phi(unsigned long) const --> double", pybind11::arg("phi"));
		...
		cl.def("getByIndex", (double * (mrpt::poses::CPose2DGridTemplate<double>::*)(unsigned long, unsigned long, unsigned long)) &mrpt::poses::CPose2DGridTemplate<double>::getByIndex, "C++: mrpt::poses::CPose2DGridTemplate<double>::getByIndex(unsigned long, unsigned long, unsigned long) --> double *", pybind11::return_value_policy::automatic, pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("phi"));
		...
		cl.def("getSizeX", (unsigned long (mrpt::poses::CPose2DGridTemplate<double>::*)() const) &mrpt::poses::CPose2DGridTemplate<double>::getSizeX, "C++: mrpt::poses::CPose2DGridTemplate<double>::getSizeX() const --> unsigned long");
		cl.def("getSizeY", (unsigned long (mrpt::poses::CPose2DGridTemplate<double>::*)() const) &mrpt::poses::CPose2DGridTemplate<double>::getSizeY, "C++: mrpt::poses::CPose2DGridTemplate<double>::getSizeY() const --> unsigned long");
		cl.def("getSizePhi", (unsigned long (mrpt::poses::CPose2DGridTemplate<double>::*)() const) &mrpt::poses::CPose2DGridTemplate<double>::getSizePhi, "C++: mrpt::poses::CPose2DGridTemplate<double>::getSizePhi() const --> unsigned long");
	...
	{ // mrpt::poses::CPose3DGridTemplate file:mrpt/poses/CPose3DGridTemplate.h line:23
		...
		cl.def("idx2x", (double (mrpt::poses::CPose3DGridTemplate<double>::*)(unsigned int) const) &mrpt::poses::CPose3DGridTemplate<double>::idx2x, "C++: mrpt::poses::CPose3DGridTemplate<double>::idx2x(unsigned int) const --> double", pybind11::arg("cx"));
		cl.def("idx2y", (double (mrpt::poses::CPose3DGridTemplate<double>::*)(unsigned int) const) &mrpt::poses::CPose3DGridTemplate<double>::idx2y, "C++: mrpt::poses::CPose3DGridTemplate<double>::idx2y(unsigned int) const --> double", pybind11::arg("cy"));
		cl.def("idx2z", (double (mrpt::poses::CPose3DGridTemplate<double>::*)(unsigned int) const) &mrpt::poses::CPose3DGridTemplate<double>::idx2z, "C++: mrpt::poses::CPose3DGridTemplate<double>::idx2z(unsigned int) const --> double", pybind11::arg("cz"));
		cl.def("idx2yaw", (double (mrpt::poses::CPose3DGridTemplate<double>::*)(unsigned int) const) &mrpt::poses::CPose3DGridTemplate<double>::idx2yaw, "C++: mrpt::poses::CPose3DGridTemplate<double>::idx2yaw(unsigned int) const --> double", pybind11::arg("cY"));
		cl.def("idx2pitch", (double (mrpt::poses::CPose3DGridTemplate<double>::*)(unsigned int) const) &mrpt::poses::CPose3DGridTemplate<double>::idx2pitch, "C++: mrpt::poses::CPose3DGridTemplate<double>::idx2pitch(unsigned int) const --> double", pybind11::arg("cP"));
		cl.def("idx2roll", (double (mrpt::poses::CPose3DGridTemplate<double>::*)(unsigned int) const) &mrpt::poses::CPose3DGridTemplate<double>::idx2roll, "C++: mrpt::poses::CPose3DGridTemplate<double>::idx2roll(unsigned int) const --> double", pybind11::arg("cR"));
		...
		cl.def("getSizeX", (unsigned int (mrpt::poses::CPose3DGridTemplate<double>::*)() const) &mrpt::poses::CPose3DGridTemplate<double>::getSizeX, "C++: mrpt::poses::CPose3DGridTemplate<double>::getSizeX() const --> unsigned int");
		cl.def("getSizeY", (unsigned int (mrpt::poses::CPose3DGridTemplate<double>::*)() const) &mrpt::poses::CPose3DGridTemplate<double>::getSizeY, "C++: mrpt::poses::CPose3DGridTemplate<double>::getSizeY() const --> unsigned int");
		cl.def("getSizeZ", (unsigned int (mrpt::poses::CPose3DGridTemplate<double>::*)() const) &mrpt::poses::CPose3DGridTemplate<double>::getSizeZ, "C++: mrpt::poses::CPose3DGridTemplate<double>::getSizeZ() const --> unsigned int");
		cl.def("getSizeYaw", (unsigned int (mrpt::poses::CPose3DGridTemplate<double>::*)() const) &mrpt::poses::CPose3DGridTemplate<double>::getSizeYaw, "C++: mrpt::poses::CPose3DGridTemplate<double>::getSizeYaw() const --> unsigned int");
		cl.def("getSizePitch", (unsigned int (mrpt::poses::CPose3DGridTemplate<double>::*)() const) &mrpt::poses::CPose3DGridTemplate<double>::getSizePitch, "C++: mrpt::poses::CPose3DGridTemplate<double>::getSizePitch() const --> unsigned int");
		cl.def("getSizeRoll", (unsigned int (mrpt::poses::CPose3DGridTemplate<double>::*)() const) &mrpt::poses::CPose3DGridTemplate<double>::getSizeRoll, "C++: mrpt::poses::CPose3DGridTemplate<double>::getSizeRoll() const --> unsigned int");
		cl.def("getTotalVoxelCount", (unsigned int (mrpt::poses::CPose3DGridTemplate<double>::*)() const) &mrpt::poses::CPose3DGridTemplate<double>::getTotalVoxelCount, "C++: mrpt::poses::CPose3DGridTemplate<double>::getTotalVoxelCount() const --> unsigned int");
