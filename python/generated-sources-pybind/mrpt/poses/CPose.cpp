...
struct PyCallBack_mrpt_poses_CPose_mrpt_poses_CPose2D_3_t : public mrpt::poses::CPose<mrpt::poses::CPose2D,3> {
	using mrpt::poses::CPose<mrpt::poses::CPose2D,3>::CPose;

	void setToNaN() override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::poses::CPose<mrpt::poses::CPose2D,3> *>(this), "setToNaN");
		if (overload) {
...
// mrpt::poses::CPose file:mrpt/poses/CPose.h line:24
struct PyCallBack_mrpt_poses_CPose_mrpt_poses_CPose3D_6_t : public mrpt::poses::CPose<mrpt::poses::CPose3D,6> {
	using mrpt::poses::CPose<mrpt::poses::CPose3D,6>::CPose;

	void setToNaN() override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::poses::CPose<mrpt::poses::CPose3D,6> *>(this), "setToNaN");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>();
			if (pybind11::detail::cast_is_temporary_value_reference<void>::value) {
				static pybind11::detail::override_caster_t<void> caster;
...
// mrpt::poses::CPose file:mrpt/poses/CPose.h line:24
struct PyCallBack_mrpt_poses_CPose_mrpt_poses_CPose3DQuat_7_t : public mrpt::poses::CPose<mrpt::poses::CPose3DQuat,7> {
	using mrpt::poses::CPose<mrpt::poses::CPose3DQuat,7>::CPose;

	void setToNaN() override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::poses::CPose<mrpt::poses::CPose3DQuat,7> *>(this), "setToNaN");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>();
			if (pybind11::detail::cast_is_temporary_value_reference<void>::value) {
				static pybind11::detail::override_caster_t<void> caster;
...
{
	{ // mrpt::poses::CPose file:mrpt/poses/CPose.h line:24
		pybind11::class_<mrpt::poses::CPose<mrpt::poses::CPose2D,3>, std::shared_ptr<mrpt::poses::CPose<mrpt::poses::CPose2D,3>>, PyCallBack_mrpt_poses_CPose_mrpt_poses_CPose2D_3_t, mrpt::poses::CPoseOrPoint<mrpt::poses::CPose2D,3>> cl(M("mrpt::poses"), "CPose_mrpt_poses_CPose2D_3_t", "");
		cl.def(pybind11::init<PyCallBack_mrpt_poses_CPose_mrpt_poses_CPose2D_3_t const &>());
		cl.def( pybind11::init( [](){ return new PyCallBack_mrpt_poses_CPose_mrpt_poses_CPose2D_3_t(); } ) );
		cl.def("assign", (class mrpt::poses::CPose<class mrpt::poses::CPose2D, 3> & (mrpt::poses::CPose<mrpt::poses::CPose2D,3>::*)(const class mrpt::poses::CPose<class mrpt::poses::CPose2D, 3> &)) &mrpt::poses::CPose<mrpt::poses::CPose2D, 3>::operator=, "C++: mrpt::poses::CPose<mrpt::poses::CPose2D, 3>::operator=(const class mrpt::poses::CPose<class mrpt::poses::CPose2D, 3> &) --> class mrpt::poses::CPose<class mrpt::poses::CPose2D, 3> &", pybind11::return_value_policy::automatic, pybind11::arg(""));
	...
	{ // mrpt::poses::CPose file:mrpt/poses/CPose.h line:24
		pybind11::class_<mrpt::poses::CPose<mrpt::poses::CPose3D,6>, std::shared_ptr<mrpt::poses::CPose<mrpt::poses::CPose3D,6>>, PyCallBack_mrpt_poses_CPose_mrpt_poses_CPose3D_6_t, mrpt::poses::CPoseOrPoint<mrpt::poses::CPose3D,6>> cl(M("mrpt::poses"), "CPose_mrpt_poses_CPose3D_6_t", "");
		cl.def(pybind11::init<PyCallBack_mrpt_poses_CPose_mrpt_poses_CPose3D_6_t const &>());
		cl.def( pybind11::init( [](){ return new PyCallBack_mrpt_poses_CPose_mrpt_poses_CPose3D_6_t(); } ) );
		cl.def("assign", (class mrpt::poses::CPose<class mrpt::poses::CPose3D, 6> & (mrpt::poses::CPose<mrpt::poses::CPose3D,6>::*)(const class mrpt::poses::CPose<class mrpt::poses::CPose3D, 6> &)) &mrpt::poses::CPose<mrpt::poses::CPose3D, 6>::operator=, "C++: mrpt::poses::CPose<mrpt::poses::CPose3D, 6>::operator=(const class mrpt::poses::CPose<class mrpt::poses::CPose3D, 6> &) --> class mrpt::poses::CPose<class mrpt::poses::CPose3D, 6> &", pybind11::return_value_policy::automatic, pybind11::arg(""));
	...
	{ // mrpt::poses::CPose file:mrpt/poses/CPose.h line:24
		pybind11::class_<mrpt::poses::CPose<mrpt::poses::CPose3DQuat,7>, std::shared_ptr<mrpt::poses::CPose<mrpt::poses::CPose3DQuat,7>>, PyCallBack_mrpt_poses_CPose_mrpt_poses_CPose3DQuat_7_t, mrpt::poses::CPoseOrPoint<mrpt::poses::CPose3DQuat,7>> cl(M("mrpt::poses"), "CPose_mrpt_poses_CPose3DQuat_7_t", "");
		cl.def(pybind11::init<PyCallBack_mrpt_poses_CPose_mrpt_poses_CPose3DQuat_7_t const &>());
		cl.def( pybind11::init( [](){ return new PyCallBack_mrpt_poses_CPose_mrpt_poses_CPose3DQuat_7_t(); } ) );
		cl.def("assign", (class mrpt::poses::CPose<class mrpt::poses::CPose3DQuat, 7> & (mrpt::poses::CPose<mrpt::poses::CPose3DQuat,7>::*)(const class mrpt::poses::CPose<class mrpt::poses::CPose3DQuat, 7> &)) &mrpt::poses::CPose<mrpt::poses::CPose3DQuat, 7>::operator=, "C++: mrpt::poses::CPose<mrpt::poses::CPose3DQuat, 7>::operator=(const class mrpt::poses::CPose<class mrpt::poses::CPose3DQuat, 7> &) --> class mrpt::poses::CPose<class mrpt::poses::CPose3DQuat, 7> &", pybind11::return_value_policy::automatic, pybind11::arg(""));
