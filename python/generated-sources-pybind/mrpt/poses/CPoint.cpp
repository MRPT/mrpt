...
struct PyCallBack_mrpt_poses_CPoint_mrpt_poses_CPoint3D_3_t : public mrpt::poses::CPoint<mrpt::poses::CPoint3D,3> {
	using mrpt::poses::CPoint<mrpt::poses::CPoint3D,3>::CPoint;

	std::string asString() const override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::poses::CPoint<mrpt::poses::CPoint3D,3> *>(this), "asString");
		if (overload) {
	...
	void setToNaN() override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::poses::CPoint<mrpt::poses::CPoint3D,3> *>(this), "setToNaN");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>();
...
// mrpt::poses::CPoint file:mrpt/poses/CPoint.h line:25
struct PyCallBack_mrpt_poses_CPoint_mrpt_poses_CPoint2D_2_t : public mrpt::poses::CPoint<mrpt::poses::CPoint2D,2> {
	using mrpt::poses::CPoint<mrpt::poses::CPoint2D,2>::CPoint;

	std::string asString() const override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::poses::CPoint<mrpt::poses::CPoint2D,2> *>(this), "asString");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>();
			if (pybind11::detail::cast_is_temporary_value_reference<std::string>::value) {
				static pybind11::detail::override_caster_t<std::string> caster;
	...
	void setToNaN() override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::poses::CPoint<mrpt::poses::CPoint2D,2> *>(this), "setToNaN");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>();
			if (pybind11::detail::cast_is_temporary_value_reference<void>::value) {
				static pybind11::detail::override_caster_t<void> caster;
...
{
	{ // mrpt::poses::CPoint file:mrpt/poses/CPoint.h line:25
		pybind11::class_<mrpt::poses::CPoint<mrpt::poses::CPoint3D,3>, std::shared_ptr<mrpt::poses::CPoint<mrpt::poses::CPoint3D,3>>, PyCallBack_mrpt_poses_CPoint_mrpt_poses_CPoint3D_3_t, mrpt::poses::CPoseOrPoint<mrpt::poses::CPoint3D,3>, mrpt::Stringifyable> cl(M("mrpt::poses"), "CPoint_mrpt_poses_CPoint3D_3_t", "");
		cl.def(pybind11::init<PyCallBack_mrpt_poses_CPoint_mrpt_poses_CPoint3D_3_t const &>());
		cl.def( pybind11::init( [](){ return new PyCallBack_mrpt_poses_CPoint_mrpt_poses_CPoint3D_3_t(); } ) );
		cl.def("__imul__", (void (mrpt::poses::CPoint<mrpt::poses::CPoint3D,3>::*)(const double)) &mrpt::poses::CPoint<mrpt::poses::CPoint3D, 3>::operator*=, "C++: mrpt::poses::CPoint<mrpt::poses::CPoint3D, 3>::operator*=(const double) --> void", pybind11::arg("s"));
		cl.def("asString", (std::string (mrpt::poses::CPoint<mrpt::poses::CPoint3D,3>::*)() const) &mrpt::poses::CPoint<mrpt::poses::CPoint3D, 3>::asString, "C++: mrpt::poses::CPoint<mrpt::poses::CPoint3D, 3>::asString() const --> std::string");
		cl.def("fromString", (void (mrpt::poses::CPoint<mrpt::poses::CPoint3D,3>::*)(const std::string &)) &mrpt::poses::CPoint<mrpt::poses::CPoint3D, 3>::fromString, "C++: mrpt::poses::CPoint<mrpt::poses::CPoint3D, 3>::fromString(const std::string &) --> void", pybind11::arg("s"));
		cl.def("__getitem__", (double & (mrpt::poses::CPoint<mrpt::poses::CPoint3D,3>::*)(unsigned int)) &mrpt::poses::CPoint<mrpt::poses::CPoint3D, 3>::operator[], "C++: mrpt::poses::CPoint<mrpt::poses::CPoint3D, 3>::operator[](unsigned int) --> double &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("assign", (class mrpt::poses::CPoint<class mrpt::poses::CPoint3D, 3> & (mrpt::poses::CPoint<mrpt::poses::CPoint3D,3>::*)(const class mrpt::poses::CPoint<class mrpt::poses::CPoint3D, 3> &)) &mrpt::poses::CPoint<mrpt::poses::CPoint3D, 3>::operator=, "C++: mrpt::poses::CPoint<mrpt::poses::CPoint3D, 3>::operator=(const class mrpt::poses::CPoint<class mrpt::poses::CPoint3D, 3> &) --> class mrpt::poses::CPoint<class mrpt::poses::CPoint3D, 3> &", pybind11::return_value_policy::automatic, pybind11::arg(""));
	...
	{ // mrpt::poses::CPoint file:mrpt/poses/CPoint.h line:25
		pybind11::class_<mrpt::poses::CPoint<mrpt::poses::CPoint2D,2>, std::shared_ptr<mrpt::poses::CPoint<mrpt::poses::CPoint2D,2>>, PyCallBack_mrpt_poses_CPoint_mrpt_poses_CPoint2D_2_t, mrpt::poses::CPoseOrPoint<mrpt::poses::CPoint2D,2>, mrpt::Stringifyable> cl(M("mrpt::poses"), "CPoint_mrpt_poses_CPoint2D_2_t", "");
		cl.def(pybind11::init<PyCallBack_mrpt_poses_CPoint_mrpt_poses_CPoint2D_2_t const &>());
		cl.def( pybind11::init( [](){ return new PyCallBack_mrpt_poses_CPoint_mrpt_poses_CPoint2D_2_t(); } ) );
		cl.def("__imul__", (void (mrpt::poses::CPoint<mrpt::poses::CPoint2D,2>::*)(const double)) &mrpt::poses::CPoint<mrpt::poses::CPoint2D, 2>::operator*=, "C++: mrpt::poses::CPoint<mrpt::poses::CPoint2D, 2>::operator*=(const double) --> void", pybind11::arg("s"));
		cl.def("asString", (std::string (mrpt::poses::CPoint<mrpt::poses::CPoint2D,2>::*)() const) &mrpt::poses::CPoint<mrpt::poses::CPoint2D, 2>::asString, "C++: mrpt::poses::CPoint<mrpt::poses::CPoint2D, 2>::asString() const --> std::string");
		cl.def("fromString", (void (mrpt::poses::CPoint<mrpt::poses::CPoint2D,2>::*)(const std::string &)) &mrpt::poses::CPoint<mrpt::poses::CPoint2D, 2>::fromString, "C++: mrpt::poses::CPoint<mrpt::poses::CPoint2D, 2>::fromString(const std::string &) --> void", pybind11::arg("s"));
		cl.def("__getitem__", (double & (mrpt::poses::CPoint<mrpt::poses::CPoint2D,2>::*)(unsigned int)) &mrpt::poses::CPoint<mrpt::poses::CPoint2D, 2>::operator[], "C++: mrpt::poses::CPoint<mrpt::poses::CPoint2D, 2>::operator[](unsigned int) --> double &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("assign", (class mrpt::poses::CPoint<class mrpt::poses::CPoint2D, 2> & (mrpt::poses::CPoint<mrpt::poses::CPoint2D,2>::*)(const class mrpt::poses::CPoint<class mrpt::poses::CPoint2D, 2> &)) &mrpt::poses::CPoint<mrpt::poses::CPoint2D, 2>::operator=, "C++: mrpt::poses::CPoint<mrpt::poses::CPoint2D, 2>::operator=(const class mrpt::poses::CPoint<class mrpt::poses::CPoint2D, 2> &) --> class mrpt::poses::CPoint<class mrpt::poses::CPoint2D, 2> &", pybind11::return_value_policy::automatic, pybind11::arg(""));
