...
;
	...
	{ // mrpt::poses::CPoseOrPoint file:mrpt/poses/CPoseOrPoint.h line:123
		pybind11::class_<mrpt::poses::CPoseOrPoint<mrpt::poses::CPose2D,3UL>, std::shared_ptr<mrpt::poses::CPoseOrPoint<mrpt::poses::CPose2D,3UL>>, PyCallBack_mrpt_poses_CPoseOrPoint_mrpt_poses_CPose2D_3UL_t, mrpt::poses::detail::pose_point_impl<mrpt::poses::CPose2D,0>> cl(M("mrpt::poses"), "CPoseOrPoint_mrpt_poses_CPose2D_3UL_t", "");
	...
	{ // mrpt::poses::CPoseOrPoint file:mrpt/poses/CPoseOrPoint.h line:123
		pybind11::class_<mrpt::poses::CPoseOrPoint<mrpt::poses::CPose3D,6UL>, std::shared_ptr<mrpt::poses::CPoseOrPoint<mrpt::poses::CPose3D,6UL>>, PyCallBack_mrpt_poses_CPoseOrPoint_mrpt_poses_CPose3D_6UL_t, mrpt::poses::detail::pose_point_impl<mrpt::poses::CPose3D,1>> cl(M("mrpt::poses"), "CPoseOrPoint_mrpt_poses_CPose3D_6UL_t", "");
	...
	{ // mrpt::poses::CPoseOrPoint file:mrpt/poses/CPoseOrPoint.h line:123
		pybind11::class_<mrpt::poses::CPoseOrPoint<mrpt::poses::CPoint3D,3UL>, std::shared_ptr<mrpt::poses::CPoseOrPoint<mrpt::poses::CPoint3D,3UL>>, PyCallBack_mrpt_poses_CPoseOrPoint_mrpt_poses_CPoint3D_3UL_t, mrpt::poses::detail::pose_point_impl<mrpt::poses::CPoint3D,1>> cl(M("mrpt::poses"), "CPoseOrPoint_mrpt_poses_CPoint3D_3UL_t", "");
