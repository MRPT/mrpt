...
void bind_mrpt_containers_CDynamicGrid_2(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::containers::CDynamicGrid file:mrpt/containers/CDynamicGrid.h line:39
		...
		cl.def("getSizeX", (unsigned long (mrpt::containers::CDynamicGrid<unsigned short>::*)() const) &mrpt::containers::CDynamicGrid<unsigned short>::getSizeX, "C++: mrpt::containers::CDynamicGrid<unsigned short>::getSizeX() const --> unsigned long");
		cl.def("getSizeY", (unsigned long (mrpt::containers::CDynamicGrid<unsigned short>::*)() const) &mrpt::containers::CDynamicGrid<unsigned short>::getSizeY, "C++: mrpt::containers::CDynamicGrid<unsigned short>::getSizeY() const --> unsigned long");
	...
	{ // mrpt::containers::CDynamicGrid file:mrpt/containers/CDynamicGrid.h line:39
		...
		cl.def("getSizeX", (unsigned long (mrpt::containers::CDynamicGrid<signed char>::*)() const) &mrpt::containers::CDynamicGrid<signed char>::getSizeX, "C++: mrpt::containers::CDynamicGrid<signed char>::getSizeX() const --> unsigned long");
		cl.def("getSizeY", (unsigned long (mrpt::containers::CDynamicGrid<signed char>::*)() const) &mrpt::containers::CDynamicGrid<signed char>::getSizeY, "C++: mrpt::containers::CDynamicGrid<signed char>::getSizeY() const --> unsigned long");
