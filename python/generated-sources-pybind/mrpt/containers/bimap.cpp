...
void bind_mrpt_containers_bimap(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::containers::bimap file:mrpt/containers/bimap.h line:42
		...
		cl.def("size", (unsigned long (mrpt::containers::bimap<long,unsigned int>::*)() const) &mrpt::containers::bimap<long, unsigned int>::size, "C++: mrpt::containers::bimap<long, unsigned int>::size() const --> unsigned long");
		...
		cl.def("getDirectMap", (const class std::map<long, unsigned int, struct std::less<long>, class std::allocator<struct std::pair<const long, unsigned int> > > & (mrpt::containers::bimap<long,unsigned int>::*)() const) &mrpt::containers::bimap<long, unsigned int>::getDirectMap, "C++: mrpt::containers::bimap<long, unsigned int>::getDirectMap() const --> const class std::map<long, unsigned int, struct std::less<long>, class std::allocator<struct std::pair<const long, unsigned int> > > &", pybind11::return_value_policy::automatic);
		cl.def("getInverseMap", (const class std::map<unsigned int, long, struct std::less<unsigned int>, class std::allocator<struct std::pair<const unsigned int, long> > > & (mrpt::containers::bimap<long,unsigned int>::*)() const) &mrpt::containers::bimap<long, unsigned int>::getInverseMap, "C++: mrpt::containers::bimap<long, unsigned int>::getInverseMap() const --> const class std::map<unsigned int, long, struct std::less<unsigned int>, class std::allocator<struct std::pair<const unsigned int, long> > > &", pybind11::return_value_policy::automatic);
