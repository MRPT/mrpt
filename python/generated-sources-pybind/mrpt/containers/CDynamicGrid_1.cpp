...
void bind_mrpt_containers_CDynamicGrid_1(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::containers::CDynamicGrid file:mrpt/containers/CDynamicGrid.h line:39
		...
		cl.def("getSizeX", (unsigned long (mrpt::containers::CDynamicGrid<mrpt::maps::THeightGridmapCell>::*)() const) &mrpt::containers::CDynamicGrid<mrpt::maps::THeightGridmapCell>::getSizeX, "C++: mrpt::containers::CDynamicGrid<mrpt::maps::THeightGridmapCell>::getSizeX() const --> unsigned long");
		cl.def("getSizeY", (unsigned long (mrpt::containers::CDynamicGrid<mrpt::maps::THeightGridmapCell>::*)() const) &mrpt::containers::CDynamicGrid<mrpt::maps::THeightGridmapCell>::getSizeY, "C++: mrpt::containers::CDynamicGrid<mrpt::maps::THeightGridmapCell>::getSizeY() const --> unsigned long");
	...
	{ // mrpt::containers::CDynamicGrid file:mrpt/containers/CDynamicGrid.h line:39
		...
		cl.def("getSizeX", (unsigned long (mrpt::containers::CDynamicGrid<unsigned char>::*)() const) &mrpt::containers::CDynamicGrid<unsigned char>::getSizeX, "C++: mrpt::containers::CDynamicGrid<unsigned char>::getSizeX() const --> unsigned long");
		cl.def("getSizeY", (unsigned long (mrpt::containers::CDynamicGrid<unsigned char>::*)() const) &mrpt::containers::CDynamicGrid<unsigned char>::getSizeY, "C++: mrpt::containers::CDynamicGrid<unsigned char>::getSizeY() const --> unsigned long");
