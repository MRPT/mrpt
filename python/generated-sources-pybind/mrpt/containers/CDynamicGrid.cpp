...
void bind_mrpt_containers_CDynamicGrid(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::containers::CDynamicGrid file:mrpt/containers/CDynamicGrid.h line:39
		...
		cl.def("getSizeX", (unsigned long (mrpt::containers::CDynamicGrid<mrpt::maps::TRandomFieldCell>::*)() const) &mrpt::containers::CDynamicGrid<mrpt::maps::TRandomFieldCell>::getSizeX, "C++: mrpt::containers::CDynamicGrid<mrpt::maps::TRandomFieldCell>::getSizeX() const --> unsigned long");
		cl.def("getSizeY", (unsigned long (mrpt::containers::CDynamicGrid<mrpt::maps::TRandomFieldCell>::*)() const) &mrpt::containers::CDynamicGrid<mrpt::maps::TRandomFieldCell>::getSizeY, "C++: mrpt::containers::CDynamicGrid<mrpt::maps::TRandomFieldCell>::getSizeY() const --> unsigned long");
	...
	{ // mrpt::containers::CDynamicGrid file:mrpt/containers/CDynamicGrid.h line:39
		...
		cl.def("getSizeX", (unsigned long (mrpt::containers::CDynamicGrid<double>::*)() const) &mrpt::containers::CDynamicGrid<double>::getSizeX, "C++: mrpt::containers::CDynamicGrid<double>::getSizeX() const --> unsigned long");
		cl.def("getSizeY", (unsigned long (mrpt::containers::CDynamicGrid<double>::*)() const) &mrpt::containers::CDynamicGrid<double>::getSizeY, "C++: mrpt::containers::CDynamicGrid<double>::getSizeY() const --> unsigned long");
