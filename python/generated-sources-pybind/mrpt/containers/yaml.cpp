...
void bind_mrpt_containers_yaml(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::containers::yaml file:mrpt/containers/yaml.h line:85
		...
		cl.def("assign", (class mrpt::containers::yaml & (mrpt::containers::yaml::*)(std::size_t)) &mrpt::containers::yaml::operator=<std::enable_if<false, void>>, "C++: mrpt::containers::yaml::operator=(std::size_t) --> class mrpt::containers::yaml &", pybind11::return_value_policy::automatic, pybind11::arg("v"));
