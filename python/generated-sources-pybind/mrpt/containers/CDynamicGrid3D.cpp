...
void bind_mrpt_containers_CDynamicGrid3D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::containers::CDynamicGrid3D file:mrpt/containers/CDynamicGrid3D.h line:27
		...
		cl.def("cellAbsIndexFromCXCYCZ", (size_t (mrpt::containers::CDynamicGrid3D<signed char,double>::*)(const int, const int, const int) const) &mrpt::containers::CDynamicGrid3D<signed char, double>::cellAbsIndexFromCXCYCZ, "C++: mrpt::containers::CDynamicGrid3D<signed char, double>::cellAbsIndexFromCXCYCZ(const int, const int, const int) const --> size_t", pybind11::arg("cx"), pybind11::arg("cy"), pybind11::arg("cz"));
		...
		cl.def("cellByIndex", (signed char * (mrpt::containers::CDynamicGrid3D<signed char,double>::*)(size_t)) &mrpt::containers::CDynamicGrid3D<signed char, double>::cellByIndex, "C++: mrpt::containers::CDynamicGrid3D<signed char, double>::cellByIndex(size_t) --> signed char *", pybind11::return_value_policy::automatic, pybind11::arg("cidx"));
		cl.def("getSizeX", (size_t (mrpt::containers::CDynamicGrid3D<signed char,double>::*)() const) &mrpt::containers::CDynamicGrid3D<signed char, double>::getSizeX, "C++: mrpt::containers::CDynamicGrid3D<signed char, double>::getSizeX() const --> size_t");
		cl.def("getSizeY", (size_t (mrpt::containers::CDynamicGrid3D<signed char,double>::*)() const) &mrpt::containers::CDynamicGrid3D<signed char, double>::getSizeY, "C++: mrpt::containers::CDynamicGrid3D<signed char, double>::getSizeY() const --> size_t");
		cl.def("getSizeZ", (size_t (mrpt::containers::CDynamicGrid3D<signed char,double>::*)() const) &mrpt::containers::CDynamicGrid3D<signed char, double>::getSizeZ, "C++: mrpt::containers::CDynamicGrid3D<signed char, double>::getSizeZ() const --> size_t");
		cl.def("getVoxelCount", (size_t (mrpt::containers::CDynamicGrid3D<signed char,double>::*)() const) &mrpt::containers::CDynamicGrid3D<signed char, double>::getVoxelCount, "C++: mrpt::containers::CDynamicGrid3D<signed char, double>::getVoxelCount() const --> size_t");
	...
	{ // mrpt::containers::CDynamicGrid3D file:mrpt/containers/CDynamicGrid3D.h line:27
		...
		cl.def("cellAbsIndexFromCXCYCZ", (size_t (mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel,double>::*)(const int, const int, const int) const) &mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel, double>::cellAbsIndexFromCXCYCZ, "C++: mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel, double>::cellAbsIndexFromCXCYCZ(const int, const int, const int) const --> size_t", pybind11::arg("cx"), pybind11::arg("cy"), pybind11::arg("cz"));
		...
		cl.def("cellByIndex", (struct mrpt::maps::TRandomFieldVoxel * (mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel,double>::*)(size_t)) &mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel, double>::cellByIndex, "C++: mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel, double>::cellByIndex(size_t) --> struct mrpt::maps::TRandomFieldVoxel *", pybind11::return_value_policy::automatic, pybind11::arg("cidx"));
		cl.def("getSizeX", (size_t (mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel,double>::*)() const) &mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel, double>::getSizeX, "C++: mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel, double>::getSizeX() const --> size_t");
		cl.def("getSizeY", (size_t (mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel,double>::*)() const) &mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel, double>::getSizeY, "C++: mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel, double>::getSizeY() const --> size_t");
		cl.def("getSizeZ", (size_t (mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel,double>::*)() const) &mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel, double>::getSizeZ, "C++: mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel, double>::getSizeZ() const --> size_t");
		cl.def("getVoxelCount", (size_t (mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel,double>::*)() const) &mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel, double>::getVoxelCount, "C++: mrpt::containers::CDynamicGrid3D<mrpt::maps::TRandomFieldVoxel, double>::getVoxelCount() const --> size_t");
