...
void bind_mrpt_img_CCanvas(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::img::CCanvas file:mrpt/img/CCanvas.h line:42
		...
		cl.def("setPixel", (void (mrpt::img::CCanvas::*)(int, int, unsigned long)) &mrpt::img::CCanvas::setPixel, "Changes the value of the pixel (x,y).\n  Pixel coordinates starts at the left-top corner of the image, and start\n in (0,0).\n  The meaning of the parameter \"color\" depends on the implementation: it\n will usually\n   be a 24bit RGB value (0x00RRGGBB), but it can also be just a 8bit gray\n level.\n\n  You can also use a TColor() type as input and it will be automatically\n converted to size_t.\n\n  This method must support (x,y) values OUT of the actual image size\n without neither\n   raising exceptions, nor leading to memory access errors.\n\n	 \n\nC++: mrpt::img::CCanvas::setPixel(int, int, unsigned long) --> void", pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("color"));
		cl.def("getWidth", (unsigned long (mrpt::img::CCanvas::*)() const) &mrpt::img::CCanvas::getWidth, "Returns the width of the image in pixels\n\nC++: mrpt::img::CCanvas::getWidth() const --> unsigned long");
		cl.def("getHeight", (unsigned long (mrpt::img::CCanvas::*)() const) &mrpt::img::CCanvas::getHeight, "Returns the height of the image in pixels\n\nC++: mrpt::img::CCanvas::getHeight() const --> unsigned long");
