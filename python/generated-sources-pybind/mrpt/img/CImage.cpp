...
;
	...
	{ // mrpt::img::CImage file:mrpt/img/CImage.h line:149
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<17> (*)()) &mrpt::img::CImage::getClassName, "C++: mrpt::img::CImage::getClassName() --> class mrpt::typemeta::string_literal<17>");
		...
		cl.def("resize", (void (mrpt::img::CImage::*)(unsigned long, unsigned long, enum mrpt::img::TImageChannels, enum mrpt::img::PixelDepth)) &mrpt::img::CImage::resize, "Changes the size of the image, erasing previous contents (does NOT scale\n its current content, for that, see scaleImage).\n  - nChannels: Can be 3 for RGB images or 1 for grayscale images.\n \n\n scaleImage\n\nC++: mrpt::img::CImage::resize(unsigned long, unsigned long, enum mrpt::img::TImageChannels, enum mrpt::img::PixelDepth) --> void", pybind11::arg("width"), pybind11::arg("height"), pybind11::arg("nChannels"), pybind11::arg("depth"));
		...
		cl.def("getWidth", (unsigned long (mrpt::img::CImage::*)() const) &mrpt::img::CImage::getWidth, "Returns the width of the image in pixels \n getSize \n\nC++: mrpt::img::CImage::getWidth() const --> unsigned long");
		cl.def("getHeight", (unsigned long (mrpt::img::CImage::*)() const) &mrpt::img::CImage::getHeight, "Returns the height of the image in pixels \n getSize \n\nC++: mrpt::img::CImage::getHeight() const --> unsigned long");
		...
		cl.def("getRowStride", (unsigned long (mrpt::img::CImage::*)() const) &mrpt::img::CImage::getRowStride, "Returns the row stride of the image: this is the number of *bytes*\n between two consecutive rows. You can access the pointer to the first row\n with ptrLine(0)\n \n\n getSize, as, ptr, ptrLine \n\nC++: mrpt::img::CImage::getRowStride() const --> unsigned long");
