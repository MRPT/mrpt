...
// mrpt::maps::CGasConcentrationGridMap2D::TInsertionOptions file:mrpt/maps/CGasConcentrationGridMap2D.h line:47
...
void bind_mrpt_maps_CGasConcentrationGridMap2D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::maps::CGasConcentrationGridMap2D file:mrpt/maps/CGasConcentrationGridMap2D.h line:32
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<38> (*)()) &mrpt::maps::CGasConcentrationGridMap2D::getClassName, "C++: mrpt::maps::CGasConcentrationGridMap2D::getClassName() --> class mrpt::typemeta::string_literal<38>");
		...
		{ // mrpt::maps::CGasConcentrationGridMap2D::TGaussianCell file:mrpt/maps/CGasConcentrationGridMap2D.h line:112
			auto & enclosing_class = cl;
		...
		{ // mrpt::maps::CGasConcentrationGridMap2D::TGaussianWindTable file:mrpt/maps/CGasConcentrationGridMap2D.h line:120
			auto & enclosing_class = cl;
