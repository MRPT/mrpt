...
void bind_mrpt_maps_CHeightGridMap2D_Base(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::maps::CHeightGridMap2D_Base file:mrpt/maps/CHeightGridMap2D_Base.h line:23
		...
		cl.def("dem_get_size_x", (unsigned long (mrpt::maps::CHeightGridMap2D_Base::*)() const) &mrpt::maps::CHeightGridMap2D_Base::dem_get_size_x, "C++: mrpt::maps::CHeightGridMap2D_Base::dem_get_size_x() const --> unsigned long");
		cl.def("dem_get_size_y", (unsigned long (mrpt::maps::CHeightGridMap2D_Base::*)() const) &mrpt::maps::CHeightGridMap2D_Base::dem_get_size_y, "C++: mrpt::maps::CHeightGridMap2D_Base::dem_get_size_y() const --> unsigned long");
	...
	{ // mrpt::maps::CHeightGridMap2D file:mrpt/maps/CHeightGridMap2D.h line:62
		...
		cl.def("countObservedCells", (unsigned long (mrpt::maps::CHeightGridMap2D::*)() const) &mrpt::maps::CHeightGridMap2D::countObservedCells, "Return the number of cells with at least one height data inserted. \n\nC++: mrpt::maps::CHeightGridMap2D::countObservedCells() const --> unsigned long");
		...
		cl.def("dem_get_size_x", (unsigned long (mrpt::maps::CHeightGridMap2D::*)() const) &mrpt::maps::CHeightGridMap2D::dem_get_size_x, "C++: mrpt::maps::CHeightGridMap2D::dem_get_size_x() const --> unsigned long");
		cl.def("dem_get_size_y", (unsigned long (mrpt::maps::CHeightGridMap2D::*)() const) &mrpt::maps::CHeightGridMap2D::dem_get_size_y, "C++: mrpt::maps::CHeightGridMap2D::dem_get_size_y() const --> unsigned long");
