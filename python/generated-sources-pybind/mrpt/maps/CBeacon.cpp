...
void bind_mrpt_maps_CBeacon(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::maps::CBeacon file:mrpt/maps/CBeacon.h line:34
		...
		cl.def("getAsMatlabDrawCommands", (void (mrpt::maps::CBeacon::*)(class std::vector<std::string, class std::allocator<std::string > > &) const) &mrpt::maps::CBeacon::getAsMatlabDrawCommands, "Gets a set of MATLAB commands which draw the current state of the\n beacon: \n\nC++: mrpt::maps::CBeacon::getAsMatlabDrawCommands(class std::vector<std::string, class std::allocator<std::string > > &) const --> void", pybind11::arg("out_Str"));
	...
	{ // mrpt::maps::CBeaconMap file:mrpt/maps/CBeaconMap.h line:43
		...
		cl.def("resize", (void (mrpt::maps::CBeaconMap::*)(const unsigned long)) &mrpt::maps::CBeaconMap::resize, "Resize the number of SOG modes \n\nC++: mrpt::maps::CBeaconMap::resize(const unsigned long) --> void", pybind11::arg("N"));
		...
		cl.def("__getitem__", (class mrpt::maps::CBeacon & (mrpt::maps::CBeaconMap::*)(unsigned long)) &mrpt::maps::CBeaconMap::operator[], "Access to individual beacons \n\nC++: mrpt::maps::CBeaconMap::operator[](unsigned long) --> class mrpt::maps::CBeacon &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("get", (class mrpt::maps::CBeacon & (mrpt::maps::CBeaconMap::*)(unsigned long)) &mrpt::maps::CBeaconMap::get, "Access to individual beacons \n\nC++: mrpt::maps::CBeaconMap::get(unsigned long) --> class mrpt::maps::CBeacon &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		...
		cl.def("size", (unsigned long (mrpt::maps::CBeaconMap::*)() const) &mrpt::maps::CBeaconMap::size, "Returns the stored landmarks count.\n\nC++: mrpt::maps::CBeaconMap::size() const --> unsigned long");
		...
		cl.def("getBeaconByID", (class mrpt::maps::CBeacon * (mrpt::maps::CBeaconMap::*)(long)) &mrpt::maps::CBeaconMap::getBeaconByID, "Returns a pointer to the beacon with the given ID, or nullptr if it does\n not exist. \n\nC++: mrpt::maps::CBeaconMap::getBeaconByID(long) --> class mrpt::maps::CBeacon *", pybind11::return_value_policy::automatic, pybind11::arg("id"));
