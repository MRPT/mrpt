...
struct PyCallBack_mrpt_maps_CPointCloudFilterByDistance : public mrpt::maps::CPointCloudFilterByDistance {
	...
	void filter(class mrpt::maps::CPointsMap * a0, const struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > a1, const class mrpt::poses::CPose3D & a2, struct mrpt::maps::CPointCloudFilterBase::TExtraFilterParams * a3) override {
...
// mrpt::maps::CPointsMapXYZI::TMapDefinition file: line:67
...
void bind_mrpt_maps_CPointCloudFilterByDistance(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::maps::CPointCloudFilterByDistance file:mrpt/maps/CPointCloudFilterByDistance.h line:27
		...
		cl.def("filter", [](mrpt::maps::CPointCloudFilterByDistance &o, class mrpt::maps::CPointsMap * a0, const struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > & a1, const class mrpt::poses::CPose3D & a2) -> void { return o.filter(a0, a1, a2); }, "", pybind11::arg("inout_pointcloud"), pybind11::arg("pc_timestamp"), pybind11::arg("pc_reference_pose"));
		cl.def("filter", (void (mrpt::maps::CPointCloudFilterByDistance::*)(class mrpt::maps::CPointsMap *, const struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >, const class mrpt::poses::CPose3D &, struct mrpt::maps::CPointCloudFilterBase::TExtraFilterParams *)) &mrpt::maps::CPointCloudFilterByDistance::filter, "C++: mrpt::maps::CPointCloudFilterByDistance::filter(class mrpt::maps::CPointsMap *, const struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >, const class mrpt::poses::CPose3D &, struct mrpt::maps::CPointCloudFilterBase::TExtraFilterParams *) --> void", pybind11::arg("inout_pointcloud"), pybind11::arg("pc_timestamp"), pybind11::arg("pc_reference_pose"), pybind11::arg("params"));
	...
	{ // mrpt::maps::CPointsMapXYZI file:mrpt/maps/CPointsMapXYZI.h line:26
		...
		cl.def("reserve", (void (mrpt::maps::CPointsMapXYZI::*)(unsigned long)) &mrpt::maps::CPointsMapXYZI::reserve, "from CPointsMap\n	@{ \n\nC++: mrpt::maps::CPointsMapXYZI::reserve(unsigned long) --> void", pybind11::arg("newLength"));
		cl.def("resize", (void (mrpt::maps::CPointsMapXYZI::*)(unsigned long)) &mrpt::maps::CPointsMapXYZI::resize, "C++: mrpt::maps::CPointsMapXYZI::resize(unsigned long) --> void", pybind11::arg("newLength"));
		cl.def("setSize", (void (mrpt::maps::CPointsMapXYZI::*)(unsigned long)) &mrpt::maps::CPointsMapXYZI::setSize, "C++: mrpt::maps::CPointsMapXYZI::setSize(unsigned long) --> void", pybind11::arg("newLength"));
		...
		cl.def("setPointRGB", (void (mrpt::maps::CPointsMapXYZI::*)(unsigned long, float, float, float, float, float, float)) &mrpt::maps::CPointsMapXYZI::setPointRGB, "Changes a given point from map. First index is 0.\n \n\n Throws std::exception on index out of bound.\n\nC++: mrpt::maps::CPointsMapXYZI::setPointRGB(unsigned long, float, float, float, float, float, float) --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"), pybind11::arg("R_intensity"), pybind11::arg("G_ignored"), pybind11::arg("B_ignored"));
		...
		cl.def("setPointIntensity", (void (mrpt::maps::CPointsMapXYZI::*)(unsigned long, float)) &mrpt::maps::CPointsMapXYZI::setPointIntensity, "Changes the intensity of a given point from the map. First index is 0.\n \n\n Throws std::exception on index out of bound.\n\nC++: mrpt::maps::CPointsMapXYZI::setPointIntensity(unsigned long, float) --> void", pybind11::arg("index"), pybind11::arg("intensity"));
		cl.def("setPointColor_fast", (void (mrpt::maps::CPointsMapXYZI::*)(unsigned long, float, float, float)) &mrpt::maps::CPointsMapXYZI::setPointColor_fast, "Like  but without checking for out-of-index erors \n\nC++: mrpt::maps::CPointsMapXYZI::setPointColor_fast(unsigned long, float, float, float) --> void", pybind11::arg("index"), pybind11::arg("R"), pybind11::arg("G"), pybind11::arg("B"));
		cl.def("getPointRGB", (void (mrpt::maps::CPointsMapXYZI::*)(unsigned long, float &, float &, float &, float &, float &, float &) const) &mrpt::maps::CPointsMapXYZI::getPointRGB, "Retrieves a point and its color (colors range is [0,1])\n\nC++: mrpt::maps::CPointsMapXYZI::getPointRGB(unsigned long, float &, float &, float &, float &, float &, float &) const --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"), pybind11::arg("R_intensity"), pybind11::arg("G_intensity"), pybind11::arg("B_intensity"));
		cl.def("getPointIntensity", (float (mrpt::maps::CPointsMapXYZI::*)(unsigned long) const) &mrpt::maps::CPointsMapXYZI::getPointIntensity, "Retrieves a point intensity (range [0,1]) \n\nC++: mrpt::maps::CPointsMapXYZI::getPointIntensity(unsigned long) const --> float", pybind11::arg("index"));
		cl.def("getPointIntensity_fast", (float (mrpt::maps::CPointsMapXYZI::*)(unsigned long) const) &mrpt::maps::CPointsMapXYZI::getPointIntensity_fast, "Like  but without checking for out-of-index erors \n\nC++: mrpt::maps::CPointsMapXYZI::getPointIntensity_fast(unsigned long) const --> float", pybind11::arg("index"));
		...
		{ // mrpt::maps::CPointsMapXYZI::TMapDefinitionBase file: line:62
			auto & enclosing_class = cl;
