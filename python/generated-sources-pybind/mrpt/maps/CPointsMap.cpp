...
void bind_mrpt_maps_CPointsMap(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::maps::CPointsMap file:mrpt/maps/CPointsMap.h line:70
		...
		cl.def("reserve", (void (mrpt::maps::CPointsMap::*)(unsigned long)) &mrpt::maps::CPointsMap::reserve, "Reserves memory for a given number of points: the size of the map does\n not change, it only reserves the memory.\n  This is useful for situations where it is approximately known the final\n size of the map. This method is more\n  efficient than constantly increasing the size of the buffers. Refer to\n the STL C++ library's \"reserve\" methods.\n\nC++: mrpt::maps::CPointsMap::reserve(unsigned long) --> void", pybind11::arg("newLength"));
		cl.def("resize", (void (mrpt::maps::CPointsMap::*)(unsigned long)) &mrpt::maps::CPointsMap::resize, "Resizes all point buffers so they can hold the given number of points:\n newly created points are set to default values,\n  and old contents are not changed.\n \n\n reserve, setPoint, setPointFast, setSize\n\nC++: mrpt::maps::CPointsMap::resize(unsigned long) --> void", pybind11::arg("newLength"));
		cl.def("setSize", (void (mrpt::maps::CPointsMap::*)(unsigned long)) &mrpt::maps::CPointsMap::setSize, "Resizes all point buffers so they can hold the given number of points,\n *erasing* all previous contents\n  and leaving all points to default values.\n \n\n reserve, setPoint, setPointFast, setSize\n\nC++: mrpt::maps::CPointsMap::setSize(unsigned long) --> void", pybind11::arg("newLength"));
		cl.def("setPointFast", (void (mrpt::maps::CPointsMap::*)(unsigned long, float, float, float)) &mrpt::maps::CPointsMap::setPointFast, "Changes the coordinates of the given point (0-based index), *without*\n checking for out-of-bounds and *without* calling mark_as_modified().\n Also, color, intensity, or other data is left unchanged. \n\n setPoint \n\nC++: mrpt::maps::CPointsMap::setPointFast(unsigned long, float, float, float) --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"));
		...
		cl.def("size", (unsigned long (mrpt::maps::CPointsMap::*)() const) &mrpt::maps::CPointsMap::size, "Returns the number of stored points in the map.\n\nC++: mrpt::maps::CPointsMap::size() const --> unsigned long");
		cl.def("getPoint", (void (mrpt::maps::CPointsMap::*)(unsigned long, float &, float &, float &) const) &mrpt::maps::CPointsMap::getPoint, "Access to a given point from map, as a 2D point. First index is 0.\n \n\n Throws std::exception on index out of bound.\n \n\n setPoint, getPointFast\n\nC++: mrpt::maps::CPointsMap::getPoint(unsigned long, float &, float &, float &) const --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"));
		cl.def("getPoint", (void (mrpt::maps::CPointsMap::*)(unsigned long, float &, float &) const) &mrpt::maps::CPointsMap::getPoint, "C++: mrpt::maps::CPointsMap::getPoint(unsigned long, float &, float &) const --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"));
		cl.def("getPoint", (void (mrpt::maps::CPointsMap::*)(unsigned long, double &, double &, double &) const) &mrpt::maps::CPointsMap::getPoint, "C++: mrpt::maps::CPointsMap::getPoint(unsigned long, double &, double &, double &) const --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"));
		cl.def("getPoint", (void (mrpt::maps::CPointsMap::*)(unsigned long, double &, double &) const) &mrpt::maps::CPointsMap::getPoint, "C++: mrpt::maps::CPointsMap::getPoint(unsigned long, double &, double &) const --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"));
		cl.def("getPoint", (void (mrpt::maps::CPointsMap::*)(unsigned long, struct mrpt::math::TPoint2D_<double> &) const) &mrpt::maps::CPointsMap::getPoint, "C++: mrpt::maps::CPointsMap::getPoint(unsigned long, struct mrpt::math::TPoint2D_<double> &) const --> void", pybind11::arg("index"), pybind11::arg("p"));
		cl.def("getPoint", (void (mrpt::maps::CPointsMap::*)(unsigned long, struct mrpt::math::TPoint3D_<double> &) const) &mrpt::maps::CPointsMap::getPoint, "C++: mrpt::maps::CPointsMap::getPoint(unsigned long, struct mrpt::math::TPoint3D_<double> &) const --> void", pybind11::arg("index"), pybind11::arg("p"));
		cl.def("getPointRGB", (void (mrpt::maps::CPointsMap::*)(unsigned long, float &, float &, float &, float &, float &, float &) const) &mrpt::maps::CPointsMap::getPointRGB, "Access to a given point from map, and its colors, if the map defines\n them (othersise, R=G=B=1.0). First index is 0.\n \n\n The return value is the weight of the point (the times it has\n been fused)\n \n\n Throws std::exception on index out of bound.\n\nC++: mrpt::maps::CPointsMap::getPointRGB(unsigned long, float &, float &, float &, float &, float &, float &) const --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"), pybind11::arg("R"), pybind11::arg("G"), pybind11::arg("B"));
		cl.def("getPointFast", (void (mrpt::maps::CPointsMap::*)(unsigned long, float &, float &, float &) const) &mrpt::maps::CPointsMap::getPointFast, "Just like  but without checking out-of-bound index and\n without returning the point weight, just XYZ.\n\nC++: mrpt::maps::CPointsMap::getPointFast(unsigned long, float &, float &, float &) const --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"));
		...
		cl.def("setPoint", (void (mrpt::maps::CPointsMap::*)(unsigned long, float, float, float)) &mrpt::maps::CPointsMap::setPoint, "Changes a given point from map, with Z defaulting to 0 if not provided.\n \n\n Throws std::exception on index out of bound.\n\nC++: mrpt::maps::CPointsMap::setPoint(unsigned long, float, float, float) --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"));
		cl.def("setPoint", (void (mrpt::maps::CPointsMap::*)(unsigned long, const struct mrpt::math::TPoint2D_<double> &)) &mrpt::maps::CPointsMap::setPoint, "C++: mrpt::maps::CPointsMap::setPoint(unsigned long, const struct mrpt::math::TPoint2D_<double> &) --> void", pybind11::arg("index"), pybind11::arg("p"));
		cl.def("setPoint", (void (mrpt::maps::CPointsMap::*)(unsigned long, const struct mrpt::math::TPoint3D_<double> &)) &mrpt::maps::CPointsMap::setPoint, "C++: mrpt::maps::CPointsMap::setPoint(unsigned long, const struct mrpt::math::TPoint3D_<double> &) --> void", pybind11::arg("index"), pybind11::arg("p"));
		cl.def("setPoint", (void (mrpt::maps::CPointsMap::*)(unsigned long, float, float)) &mrpt::maps::CPointsMap::setPoint, "C++: mrpt::maps::CPointsMap::setPoint(unsigned long, float, float) --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"));
		cl.def("setPointRGB", (void (mrpt::maps::CPointsMap::*)(unsigned long, float, float, float, float, float, float)) &mrpt::maps::CPointsMap::setPointRGB, "overload (RGB data is ignored in classes without color information)\n\nC++: mrpt::maps::CPointsMap::setPointRGB(unsigned long, float, float, float, float, float, float) --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"), pybind11::arg("R"), pybind11::arg("G"), pybind11::arg("B"));
		cl.def("setPointWeight", (void (mrpt::maps::CPointsMap::*)(unsigned long, unsigned long)) &mrpt::maps::CPointsMap::setPointWeight, "Sets the point weight, which is ignored in all classes but those which\n actually store that field (Note: No checks are done for out-of-bounds\n index). \n\n getPointWeight\n\nC++: mrpt::maps::CPointsMap::setPointWeight(unsigned long, unsigned long) --> void", pybind11::arg("index"), pybind11::arg("w"));
		cl.def("getPointWeight", (unsigned int (mrpt::maps::CPointsMap::*)(unsigned long) const) &mrpt::maps::CPointsMap::getPointWeight, "Gets the point weight, which is ignored in all classes (defaults to 1)\n but in those which actually store that field (Note: No checks are done\n for out-of-bounds index).  \n\n setPointWeight\n\nC++: mrpt::maps::CPointsMap::getPointWeight(unsigned long) const --> unsigned int", pybind11::arg("index"));
		...
		cl.def("kdtree_get_point_count", (unsigned long (mrpt::maps::CPointsMap::*)() const) &mrpt::maps::CPointsMap::kdtree_get_point_count, "Must return the number of data points\n\nC++: mrpt::maps::CPointsMap::kdtree_get_point_count() const --> unsigned long");
		cl.def("kdtree_get_pt", (float (mrpt::maps::CPointsMap::*)(const unsigned long, int) const) &mrpt::maps::CPointsMap::kdtree_get_pt, "Returns the dim'th component of the idx'th point in the class:\n\nC++: mrpt::maps::CPointsMap::kdtree_get_pt(const unsigned long, int) const --> float", pybind11::arg("idx"), pybind11::arg("dim"));
		cl.def("kdtree_distance", (float (mrpt::maps::CPointsMap::*)(const float *, const unsigned long, unsigned long) const) &mrpt::maps::CPointsMap::kdtree_distance, "Returns the distance between the vector \"p1[0:size-1]\" and the data\n point with index \"idx_p2\" stored in the class:\n\nC++: mrpt::maps::CPointsMap::kdtree_distance(const float *, const unsigned long, unsigned long) const --> float", pybind11::arg("p1"), pybind11::arg("idx_p2"), pybind11::arg("size"));
