...
void bind_mrpt_maps_CMultiMetricMap(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::maps::CMultiMetricMap file:mrpt/maps/CMultiMetricMap.h line:119
		...
		cl.def("mapByIndex", (class std::shared_ptr<class mrpt::maps::CMetricMap> (mrpt::maps::CMultiMetricMap::*)(unsigned long) const) &mrpt::maps::CMultiMetricMap::mapByIndex, "Gets the i-th map \n std::runtime_error On out-of-bounds \n\nC++: mrpt::maps::CMultiMetricMap::mapByIndex(unsigned long) const --> class std::shared_ptr<class mrpt::maps::CMetricMap>", pybind11::arg("idx"));
	...
	{ // mrpt::maps::CSimpleMap file:mrpt/maps/CSimpleMap.h line:43
		...
		cl.def("size", (unsigned long (mrpt::maps::CSimpleMap::*)() const) &mrpt::maps::CSimpleMap::size, "Returns the count of (pose,sensoryFrame) pairs \n\nC++: mrpt::maps::CSimpleMap::size() const --> unsigned long");
		...
		cl.def("get", (void (mrpt::maps::CSimpleMap::*)(unsigned long, class std::shared_ptr<const class mrpt::poses::CPose3DPDF> &, class std::shared_ptr<const class mrpt::obs::CSensoryFrame> &) const) &mrpt::maps::CSimpleMap::get, "Access to the 0-based index i'th pair.\n \n\n std::exception On index out of bounds.\n\nC++: mrpt::maps::CSimpleMap::get(unsigned long, class std::shared_ptr<const class mrpt::poses::CPose3DPDF> &, class std::shared_ptr<const class mrpt::obs::CSensoryFrame> &) const --> void", pybind11::arg("index"), pybind11::arg("out_posePDF"), pybind11::arg("out_SF"));
		cl.def("getAsPair", (struct mrpt::maps::CSimpleMap::Pair & (mrpt::maps::CSimpleMap::*)(unsigned long)) &mrpt::maps::CSimpleMap::getAsPair, "C++: mrpt::maps::CSimpleMap::getAsPair(unsigned long) --> struct mrpt::maps::CSimpleMap::Pair &", pybind11::return_value_policy::automatic, pybind11::arg("index"));
		cl.def("get", (void (mrpt::maps::CSimpleMap::*)(unsigned long, class std::shared_ptr<class mrpt::poses::CPose3DPDF> &, class std::shared_ptr<class mrpt::obs::CSensoryFrame> &)) &mrpt::maps::CSimpleMap::get, "C++: mrpt::maps::CSimpleMap::get(unsigned long, class std::shared_ptr<class mrpt::poses::CPose3DPDF> &, class std::shared_ptr<class mrpt::obs::CSensoryFrame> &) --> void", pybind11::arg("index"), pybind11::arg("out_posePDF"), pybind11::arg("out_SF"));
		cl.def("get", (class std::tuple<class std::shared_ptr<class mrpt::poses::CPose3DPDF>, class std::shared_ptr<class mrpt::obs::CSensoryFrame> > (mrpt::maps::CSimpleMap::*)(unsigned long)) &mrpt::maps::CSimpleMap::get, "C++: mrpt::maps::CSimpleMap::get(unsigned long) --> class std::tuple<class std::shared_ptr<class mrpt::poses::CPose3DPDF>, class std::shared_ptr<class mrpt::obs::CSensoryFrame> >", pybind11::arg("index"));
		cl.def("set", (void (mrpt::maps::CSimpleMap::*)(unsigned long, const class std::shared_ptr<class mrpt::poses::CPose3DPDF> &, const class std::shared_ptr<class mrpt::obs::CSensoryFrame> &)) &mrpt::maps::CSimpleMap::set, "Changes the 0-based index i'th pair.\n  If one of either `in_posePDF` or `in_SF` are empty `shared_ptr`s, the\n corresponding field in the map is not modified.\n\n \n std::exception On index out of bounds.\n \n\n insert, get, remove\n\nC++: mrpt::maps::CSimpleMap::set(unsigned long, const class std::shared_ptr<class mrpt::poses::CPose3DPDF> &, const class std::shared_ptr<class mrpt::obs::CSensoryFrame> &) --> void", pybind11::arg("index"), pybind11::arg("in_posePDF"), pybind11::arg("in_SF"));
		cl.def("set", (void (mrpt::maps::CSimpleMap::*)(unsigned long, const struct mrpt::maps::CSimpleMap::Pair &)) &mrpt::maps::CSimpleMap::set, "C++: mrpt::maps::CSimpleMap::set(unsigned long, const struct mrpt::maps::CSimpleMap::Pair &) --> void", pybind11::arg("index"), pybind11::arg("poseSF"));
		cl.def("set", (void (mrpt::maps::CSimpleMap::*)(unsigned long, const class std::shared_ptr<class mrpt::poses::CPosePDF> &, const class std::shared_ptr<class mrpt::obs::CSensoryFrame> &)) &mrpt::maps::CSimpleMap::set, "C++: mrpt::maps::CSimpleMap::set(unsigned long, const class std::shared_ptr<class mrpt::poses::CPosePDF> &, const class std::shared_ptr<class mrpt::obs::CSensoryFrame> &) --> void", pybind11::arg("index"), pybind11::arg("in_posePDF"), pybind11::arg("in_SF"));
		cl.def("remove", (void (mrpt::maps::CSimpleMap::*)(unsigned long)) &mrpt::maps::CSimpleMap::remove, "Deletes the 0-based index i'th pair.\n \n\n std::exception On index out of bounds.\n \n\n insert, get, set\n\nC++: mrpt::maps::CSimpleMap::remove(unsigned long) --> void", pybind11::arg("index"));
