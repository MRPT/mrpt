...
void bind_mrpt_maps_CLogOddsGridMapLUT(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::maps::CLogOddsGridMapLUT file:mrpt/maps/CLogOddsGridMapLUT.h line:29
		pybind11::class_<mrpt::maps::CLogOddsGridMapLUT<signed char>, std::shared_ptr<mrpt::maps::CLogOddsGridMapLUT<signed char>>, mrpt::maps::detail::logoddscell_traits<signed char>> cl(M("mrpt::maps"), "CLogOddsGridMapLUT_signed_char_t", "");
		...
		cl.def("l2p_255", (unsigned char (mrpt::maps::CLogOddsGridMapLUT<signed char>::*)(const signed char)) &mrpt::maps::CLogOddsGridMapLUT<signed char>::l2p_255, "C++: mrpt::maps::CLogOddsGridMapLUT<signed char>::l2p_255(const signed char) --> unsigned char", pybind11::arg("l"));
	...
	{ // mrpt::maps::CLogOddsGridMap2D file:mrpt/maps/CLogOddsGridMap2D.h line:26
		pybind11::class_<mrpt::maps::CLogOddsGridMap2D<signed char>, std::shared_ptr<mrpt::maps::CLogOddsGridMap2D<signed char>>, mrpt::maps::detail::logoddscell_traits<signed char>> cl(M("mrpt::maps"), "CLogOddsGridMap2D_signed_char_t", "");
