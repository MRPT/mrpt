...
void bind_mrpt_maps_COccupancyGridMap2D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::maps::COccupancyGridMap2D file:mrpt/maps/COccupancyGridMap2D.h line:53
		...
		cl.def("idx2x", (float (mrpt::maps::COccupancyGridMap2D::*)(const unsigned long) const) &mrpt::maps::COccupancyGridMap2D::idx2x, "Transform a cell index into a coordinate value \n\nC++: mrpt::maps::COccupancyGridMap2D::idx2x(const unsigned long) const --> float", pybind11::arg("cx"));
		cl.def("idx2y", (float (mrpt::maps::COccupancyGridMap2D::*)(const unsigned long) const) &mrpt::maps::COccupancyGridMap2D::idx2y, "C++: mrpt::maps::COccupancyGridMap2D::idx2y(const unsigned long) const --> float", pybind11::arg("cy"));
		...
		cl.def_static("l2p_255", (unsigned char (*)(const signed char)) &mrpt::maps::COccupancyGridMap2D::l2p_255, "Scales an integer representation of the log-odd into a linear scale\n [0,255], using p=exp(l)/(1+exp(l)) \n\nC++: mrpt::maps::COccupancyGridMap2D::l2p_255(const signed char) --> unsigned char", pybind11::arg("l"));
		...
		cl.def("setBasisCell", (void (mrpt::maps::COccupancyGridMap2D::*)(int, int, unsigned char)) &mrpt::maps::COccupancyGridMap2D::setBasisCell, "Change a cell in the \"basis\" maps.Used for Voronoi calculation \n\nC++: mrpt::maps::COccupancyGridMap2D::setBasisCell(int, int, unsigned char) --> void", pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("value"));
		...
		cl.def("getVoroniClearance", (unsigned short (mrpt::maps::COccupancyGridMap2D::*)(int, int) const) &mrpt::maps::COccupancyGridMap2D::getVoroniClearance, "Reads a the clearance of a cell (in centimeters), after building the\n Voronoi diagram with  \n\nC++: mrpt::maps::COccupancyGridMap2D::getVoroniClearance(int, int) const --> unsigned short", pybind11::arg("cx"), pybind11::arg("cy"));
		...
		cl.def_static("saveAsEMFTwoMapsWithCorrespondences", (bool (*)(const std::string &, const class mrpt::maps::COccupancyGridMap2D *, const class mrpt::maps::COccupancyGridMap2D *, const class mrpt::tfest::TMatchingPairListTempl<float> &)) &mrpt::maps::COccupancyGridMap2D::saveAsEMFTwoMapsWithCorrespondences, "Saves a composite image with two gridmaps and numbers for the\n correspondences between them.\n \n\n saveAsBitmapTwoMapsWithCorrespondences\n \n\n False on any error.\n\nC++: mrpt::maps::COccupancyGridMap2D::saveAsEMFTwoMapsWithCorrespondences(const std::string &, const class mrpt::maps::COccupancyGridMap2D *, const class mrpt::maps::COccupancyGridMap2D *, const class mrpt::tfest::TMatchingPairListTempl<float> &) --> bool", pybind11::arg("fileName"), pybind11::arg("m1"), pybind11::arg("m2"), pybind11::arg("corrs"));
