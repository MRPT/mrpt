...
struct PyCallBack_mrpt_maps_CWeightedPointsMap : public mrpt::maps::CWeightedPointsMap {
	...
	void impl_copyFrom(const class mrpt::maps::CPointsMap & a0) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::maps::CWeightedPointsMap *>(this), "impl_copyFrom");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
			if (pybind11::detail::cast_is_temporary_value_reference<void>::value) {
				static pybind11::detail::override_caster_t<void> caster;
		...
		return CWeightedPointsMap::impl_copyFrom(a0);
	}
...
void bind_mrpt_maps_CReflectivityGridMap2D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::maps::CWeightedPointsMap file:mrpt/maps/CWeightedPointsMap.h line:29
		...
		cl.def("reserve", (void (mrpt::maps::CWeightedPointsMap::*)(unsigned long)) &mrpt::maps::CWeightedPointsMap::reserve, "	   from CPointsMap\n		@{ \n\nC++: mrpt::maps::CWeightedPointsMap::reserve(unsigned long) --> void", pybind11::arg("newLength"));
		cl.def("resize", (void (mrpt::maps::CWeightedPointsMap::*)(unsigned long)) &mrpt::maps::CWeightedPointsMap::resize, "C++: mrpt::maps::CWeightedPointsMap::resize(unsigned long) --> void", pybind11::arg("newLength"));
		cl.def("setSize", (void (mrpt::maps::CWeightedPointsMap::*)(unsigned long)) &mrpt::maps::CWeightedPointsMap::setSize, "C++: mrpt::maps::CWeightedPointsMap::setSize(unsigned long) --> void", pybind11::arg("newLength"));
		...
		cl.def("setPointWeight", (void (mrpt::maps::CWeightedPointsMap::*)(unsigned long, unsigned long)) &mrpt::maps::CWeightedPointsMap::setPointWeight, "Sets the point weight, which is ignored in all classes but those which\n actually store that field (Note: No checks are done for out-of-bounds\n index). \n\n getPointWeight\n\nC++: mrpt::maps::CWeightedPointsMap::setPointWeight(unsigned long, unsigned long) --> void", pybind11::arg("index"), pybind11::arg("w"));
		cl.def("getPointWeight", (unsigned int (mrpt::maps::CWeightedPointsMap::*)(unsigned long) const) &mrpt::maps::CWeightedPointsMap::getPointWeight, "Gets the point weight, which is ignored in all classes (defaults to 1)\n but in those which actually store that field (Note: No checks are done\n for out-of-bounds index).  \n\n setPointWeight\n\nC++: mrpt::maps::CWeightedPointsMap::getPointWeight(unsigned long) const --> unsigned int", pybind11::arg("index"));
