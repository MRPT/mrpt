...
// mrpt::maps::CRandomFieldGridMap2D::ConnectivityDescriptor file:mrpt/maps/CRandomFieldGridMap2D.h line:350
...
void bind_mrpt_maps_CRandomFieldGridMap2D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::maps::CRandomFieldGridMap2D file:mrpt/maps/CRandomFieldGridMap2D.h line:154
		...
		{ // mrpt::maps::CRandomFieldGridMap2D::ConnectivityDescriptor file:mrpt/maps/CRandomFieldGridMap2D.h line:350
			...
			cl.def("getEdgeInformation", (bool (mrpt::maps::CRandomFieldGridMap2D::ConnectivityDescriptor::*)(const class mrpt::maps::CRandomFieldGridMap2D *, unsigned long, unsigned long, unsigned long, unsigned long, double &)) &mrpt::maps::CRandomFieldGridMap2D::ConnectivityDescriptor::getEdgeInformation, "Implement the check of whether node i=(icx,icy) is connected with\n node j=(jcx,jcy).\n This visitor method will be called only for immediate neighbors.\n \n\n true if connected (and the \"information\" value should be\n also updated in out_edge_information), false otherwise.\n\nC++: mrpt::maps::CRandomFieldGridMap2D::ConnectivityDescriptor::getEdgeInformation(const class mrpt::maps::CRandomFieldGridMap2D *, unsigned long, unsigned long, unsigned long, unsigned long, double &) --> bool", pybind11::arg("parent"), pybind11::arg("icx"), pybind11::arg("icy"), pybind11::arg("jcx"), pybind11::arg("jcy"), pybind11::arg("out_edge_information"));
