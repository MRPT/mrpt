...
void bind_mrpt_maps_CLandmarksMap(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::maps::CLandmarksMap file:mrpt/maps/CLandmarksMap.h line:74
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<25> (*)()) &mrpt::maps::CLandmarksMap::getClassName, "C++: mrpt::maps::CLandmarksMap::getClassName() --> class mrpt::typemeta::string_literal<25>");
		...
		cl.def("size", (unsigned long (mrpt::maps::CLandmarksMap::*)() const) &mrpt::maps::CLandmarksMap::size, "Returns the stored landmarks count.\n\nC++: mrpt::maps::CLandmarksMap::size() const --> unsigned long");
		...
		{ // mrpt::maps::CLandmarksMap::TCustomSequenceLandmarks file:mrpt/maps/CLandmarksMap.h line:135
			...
			cl.def("size", (unsigned long (mrpt::maps::CLandmarksMap::TCustomSequenceLandmarks::*)() const) &mrpt::maps::CLandmarksMap::TCustomSequenceLandmarks::size, "C++: mrpt::maps::CLandmarksMap::TCustomSequenceLandmarks::size() const --> unsigned long");
			...
			cl.def("getByID", (const class mrpt::maps::CLandmark * (mrpt::maps::CLandmarksMap::TCustomSequenceLandmarks::*)(long) const) &mrpt::maps::CLandmarksMap::TCustomSequenceLandmarks::getByID, "Returns the landmark with a given landmrk ID, or nullptr if not\n found\n\nC++: mrpt::maps::CLandmarksMap::TCustomSequenceLandmarks::getByID(long) const --> const class mrpt::maps::CLandmark *", pybind11::return_value_policy::automatic, pybind11::arg("ID"));
