...
// mrpt::maps::COctoMap::TMapDefinition file: line:67
...
// mrpt::maps::CSimplePointsMap::TMapDefinition file: line:67
...
void bind_mrpt_maps_COctoMap(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::maps::COctoMap file:mrpt/maps/COctoMap.h line:39
		...
		cl.def("size", (unsigned long (mrpt::maps::COctoMap::*)() const) &mrpt::maps::COctoMap::size, "The number of nodes in the tree\n\nC++: mrpt::maps::COctoMap::size() const --> unsigned long");
		cl.def("memoryUsage", (unsigned long (mrpt::maps::COctoMap::*)() const) &mrpt::maps::COctoMap::memoryUsage, "Memory usage of the complete octree in bytes (may vary between\n architectures)\n\nC++: mrpt::maps::COctoMap::memoryUsage() const --> unsigned long");
		cl.def("memoryUsageNode", (unsigned long (mrpt::maps::COctoMap::*)() const) &mrpt::maps::COctoMap::memoryUsageNode, "Memory usage of the a single octree node\n\nC++: mrpt::maps::COctoMap::memoryUsageNode() const --> unsigned long");
		cl.def("memoryFullGrid", (unsigned long (mrpt::maps::COctoMap::*)() const) &mrpt::maps::COctoMap::memoryFullGrid, "Memory usage of a full grid of the same size as the OcTree in\n bytes (for comparison)\n\nC++: mrpt::maps::COctoMap::memoryFullGrid() const --> unsigned long");
		...
		cl.def("calcNumNodes", (unsigned long (mrpt::maps::COctoMap::*)() const) &mrpt::maps::COctoMap::calcNumNodes, "Traverses the tree to calculate the total number of nodes\n\nC++: mrpt::maps::COctoMap::calcNumNodes() const --> unsigned long");
		cl.def("getNumLeafNodes", (unsigned long (mrpt::maps::COctoMap::*)() const) &mrpt::maps::COctoMap::getNumLeafNodes, "Traverses the tree to calculate the total number of leaf nodes\n\nC++: mrpt::maps::COctoMap::getNumLeafNodes() const --> unsigned long");
		...
		{ // mrpt::maps::COctoMap::TMapDefinitionBase file: line:62
	...
	{ // mrpt::maps::CPointCloudFilterBase file:mrpt/maps/CPointCloudFilterBase.h line:34
		...
		cl.def("filter", [](mrpt::maps::CPointCloudFilterBase &o, class mrpt::maps::CPointsMap * a0, const struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > & a1, const class mrpt::poses::CPose3D & a2) -> void { return o.filter(a0, a1, a2); }, "", pybind11::arg("inout_pointcloud"), pybind11::arg("pc_timestamp"), pybind11::arg("pc_reference_pose"));
		cl.def("filter", (void (mrpt::maps::CPointCloudFilterBase::*)(class mrpt::maps::CPointsMap *, const struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >, const class mrpt::poses::CPose3D &, struct mrpt::maps::CPointCloudFilterBase::TExtraFilterParams *)) &mrpt::maps::CPointCloudFilterBase::filter, "Apply the filtering algorithm to the pointcloud. \n\nC++: mrpt::maps::CPointCloudFilterBase::filter(class mrpt::maps::CPointsMap *, const struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >, const class mrpt::poses::CPose3D &, struct mrpt::maps::CPointCloudFilterBase::TExtraFilterParams *) --> void", pybind11::arg("inout_pointcloud"), pybind11::arg("pc_timestamp"), pybind11::arg("pc_reference_pose"), pybind11::arg("params"));
	...
	{ // mrpt::maps::CSimplePointsMap file:mrpt/maps/CSimplePointsMap.h line:30
		...
		cl.def("reserve", (void (mrpt::maps::CSimplePointsMap::*)(unsigned long)) &mrpt::maps::CSimplePointsMap::reserve, "	   from CPointsMap\n		@{ \n\nC++: mrpt::maps::CSimplePointsMap::reserve(unsigned long) --> void", pybind11::arg("newLength"));
		cl.def("resize", (void (mrpt::maps::CSimplePointsMap::*)(unsigned long)) &mrpt::maps::CSimplePointsMap::resize, "C++: mrpt::maps::CSimplePointsMap::resize(unsigned long) --> void", pybind11::arg("newLength"));
		cl.def("setSize", (void (mrpt::maps::CSimplePointsMap::*)(unsigned long)) &mrpt::maps::CSimplePointsMap::setSize, "C++: mrpt::maps::CSimplePointsMap::setSize(unsigned long) --> void", pybind11::arg("newLength"));
		...
		{ // mrpt::maps::CSimplePointsMap::TMapDefinitionBase file: line:62
			auto & enclosing_class = cl;
