...
void bind_mrpt_maps_CHeightGridMap2D_MRF(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::maps::CHeightGridMap2D_MRF file:mrpt/maps/CHeightGridMap2D_MRF.h line:33
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<32> (*)()) &mrpt::maps::CHeightGridMap2D_MRF::getClassName, "C++: mrpt::maps::CHeightGridMap2D_MRF::getClassName() --> class mrpt::typemeta::string_literal<32>");
		...
		cl.def("dem_get_size_x", (unsigned long (mrpt::maps::CHeightGridMap2D_MRF::*)() const) &mrpt::maps::CHeightGridMap2D_MRF::dem_get_size_x, "C++: mrpt::maps::CHeightGridMap2D_MRF::dem_get_size_x() const --> unsigned long");
		cl.def("dem_get_size_y", (unsigned long (mrpt::maps::CHeightGridMap2D_MRF::*)() const) &mrpt::maps::CHeightGridMap2D_MRF::dem_get_size_y, "C++: mrpt::maps::CHeightGridMap2D_MRF::dem_get_size_y() const --> unsigned long");
		cl.def("dem_get_z_by_cell", (bool (mrpt::maps::CHeightGridMap2D_MRF::*)(const unsigned long, const unsigned long, double &) const) &mrpt::maps::CHeightGridMap2D_MRF::dem_get_z_by_cell, "C++: mrpt::maps::CHeightGridMap2D_MRF::dem_get_z_by_cell(const unsigned long, const unsigned long, double &) const --> bool", pybind11::arg("cx"), pybind11::arg("cy"), pybind11::arg("z_out"));
