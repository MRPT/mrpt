...
void bind_mrpt_maps_metric_map_types(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::maps::TSetOfMetricMapInitializers file:mrpt/maps/TMetricMapInitializer.h line:90
		...
		cl.def("size", (unsigned long (mrpt::maps::TSetOfMetricMapInitializers::*)() const) &mrpt::maps::TSetOfMetricMapInitializers::size, "C++: mrpt::maps::TSetOfMetricMapInitializers::size() const --> unsigned long");
