...
void bind_mrpt_maps_CMultiMetricMapPDF(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::maps::CMultiMetricMapPDF file:mrpt/maps/CMultiMetricMapPDF.h line:54
		...
		cl.def("getEstimatedPosePDFAtTime", (void (mrpt::maps::CMultiMetricMapPDF::*)(unsigned long, class mrpt::poses::CPose3DPDFParticles &) const) &mrpt::maps::CMultiMetricMapPDF::getEstimatedPosePDFAtTime, "Returns the estimate of the robot pose as a particles PDF for the\n instant of time \"timeStep\", from 0 to N-1.\n \n\n getEstimatedPosePDF\n\nC++: mrpt::maps::CMultiMetricMapPDF::getEstimatedPosePDFAtTime(unsigned long, class mrpt::poses::CPose3DPDFParticles &) const --> void", pybind11::arg("timeStep"), pybind11::arg("out_estimation"));
		...
		cl.def("getNumberOfObservationsInSimplemap", (unsigned long (mrpt::maps::CMultiMetricMapPDF::*)() const) &mrpt::maps::CMultiMetricMapPDF::getNumberOfObservationsInSimplemap, "Get the number of CSensoryFrame inserted into the internal member SFs \n\nC++: mrpt::maps::CMultiMetricMapPDF::getNumberOfObservationsInSimplemap() const --> unsigned long");
		...
		cl.def("getLastPose", (struct mrpt::math::TPose3D (mrpt::maps::CMultiMetricMapPDF::*)(const unsigned long, bool &) const) &mrpt::maps::CMultiMetricMapPDF::getLastPose, "		@{ \n\nC++: mrpt::maps::CMultiMetricMapPDF::getLastPose(const unsigned long, bool &) const --> struct mrpt::math::TPose3D", pybind11::arg("i"), pybind11::arg("pose_is_valid"));
		...
		cl.def("PF_SLAM_computeObservationLikelihoodForParticle", (double (mrpt::maps::CMultiMetricMapPDF::*)(const struct mrpt::bayes::CParticleFilter::TParticleFilterOptions &, const unsigned long, const class mrpt::obs::CSensoryFrame &, const class mrpt::poses::CPose3D &) const) &mrpt::maps::CMultiMetricMapPDF::PF_SLAM_computeObservationLikelihoodForParticle, "Evaluate the observation likelihood for one particle at a given location\n\nC++: mrpt::maps::CMultiMetricMapPDF::PF_SLAM_computeObservationLikelihoodForParticle(const struct mrpt::bayes::CParticleFilter::TParticleFilterOptions &, const unsigned long, const class mrpt::obs::CSensoryFrame &, const class mrpt::poses::CPose3D &) const --> double", pybind11::arg("PF_options"), pybind11::arg("particleIndexForMap"), pybind11::arg("observation"), pybind11::arg("x"));
