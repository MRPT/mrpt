...
void bind_mrpt_maps_CColouredOctoMap(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::maps::CColouredOctoMap file:mrpt/maps/CColouredOctoMap.h line:36
		...
		cl.def("size", (unsigned long (mrpt::maps::CColouredOctoMap::*)() const) &mrpt::maps::CColouredOctoMap::size, "The number of nodes in the tree\n\nC++: mrpt::maps::CColouredOctoMap::size() const --> unsigned long");
		cl.def("memoryUsage", (unsigned long (mrpt::maps::CColouredOctoMap::*)() const) &mrpt::maps::CColouredOctoMap::memoryUsage, "Memory usage of the complete octree in bytes (may vary between\n architectures)\n\nC++: mrpt::maps::CColouredOctoMap::memoryUsage() const --> unsigned long");
		cl.def("memoryUsageNode", (unsigned long (mrpt::maps::CColouredOctoMap::*)() const) &mrpt::maps::CColouredOctoMap::memoryUsageNode, "Memory usage of the a single octree node\n\nC++: mrpt::maps::CColouredOctoMap::memoryUsageNode() const --> unsigned long");
		cl.def("memoryFullGrid", (unsigned long (mrpt::maps::CColouredOctoMap::*)() const) &mrpt::maps::CColouredOctoMap::memoryFullGrid, "Memory usage of a full grid of the same size as the OcTree in\n bytes (for comparison)\n\nC++: mrpt::maps::CColouredOctoMap::memoryFullGrid() const --> unsigned long");
		...
		cl.def("calcNumNodes", (unsigned long (mrpt::maps::CColouredOctoMap::*)() const) &mrpt::maps::CColouredOctoMap::calcNumNodes, "Traverses the tree to calculate the total number of nodes\n\nC++: mrpt::maps::CColouredOctoMap::calcNumNodes() const --> unsigned long");
		cl.def("getNumLeafNodes", (unsigned long (mrpt::maps::CColouredOctoMap::*)() const) &mrpt::maps::CColouredOctoMap::getNumLeafNodes, "Traverses the tree to calculate the total number of leaf nodes\n\nC++: mrpt::maps::CColouredOctoMap::getNumLeafNodes() const --> unsigned long");
	...
	{ // mrpt::maps::CColouredPointsMap file:mrpt/maps/CColouredPointsMap.h line:29
		...
		cl.def("reserve", (void (mrpt::maps::CColouredPointsMap::*)(unsigned long)) &mrpt::maps::CColouredPointsMap::reserve, "	   from CPointsMap\n		@{ \n\nC++: mrpt::maps::CColouredPointsMap::reserve(unsigned long) --> void", pybind11::arg("newLength"));
		cl.def("resize", (void (mrpt::maps::CColouredPointsMap::*)(unsigned long)) &mrpt::maps::CColouredPointsMap::resize, "C++: mrpt::maps::CColouredPointsMap::resize(unsigned long) --> void", pybind11::arg("newLength"));
		cl.def("setSize", (void (mrpt::maps::CColouredPointsMap::*)(unsigned long)) &mrpt::maps::CColouredPointsMap::setSize, "C++: mrpt::maps::CColouredPointsMap::setSize(unsigned long) --> void", pybind11::arg("newLength"));
		...
		cl.def("setPointRGB", (void (mrpt::maps::CColouredPointsMap::*)(unsigned long, float, float, float, float, float, float)) &mrpt::maps::CColouredPointsMap::setPointRGB, "Changes a given point from map. First index is 0.\n \n\n Throws std::exception on index out of bound.\n\nC++: mrpt::maps::CColouredPointsMap::setPointRGB(unsigned long, float, float, float, float, float, float) --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"), pybind11::arg("R"), pybind11::arg("G"), pybind11::arg("B"));
		...
		cl.def("setPointColor", (void (mrpt::maps::CColouredPointsMap::*)(unsigned long, float, float, float)) &mrpt::maps::CColouredPointsMap::setPointColor, "Changes just the color of a given point from the map. First index is 0.\n \n\n Throws std::exception on index out of bound.\n\nC++: mrpt::maps::CColouredPointsMap::setPointColor(unsigned long, float, float, float) --> void", pybind11::arg("index"), pybind11::arg("R"), pybind11::arg("G"), pybind11::arg("B"));
		cl.def("setPointColor_fast", (void (mrpt::maps::CColouredPointsMap::*)(unsigned long, float, float, float)) &mrpt::maps::CColouredPointsMap::setPointColor_fast, "Like  but without checking for out-of-index erors \n\nC++: mrpt::maps::CColouredPointsMap::setPointColor_fast(unsigned long, float, float, float) --> void", pybind11::arg("index"), pybind11::arg("R"), pybind11::arg("G"), pybind11::arg("B"));
		cl.def("getPointRGB", (void (mrpt::maps::CColouredPointsMap::*)(unsigned long, float &, float &, float &, float &, float &, float &) const) &mrpt::maps::CColouredPointsMap::getPointRGB, "Retrieves a point and its color (colors range is [0,1])\n\nC++: mrpt::maps::CColouredPointsMap::getPointRGB(unsigned long, float &, float &, float &, float &, float &, float &) const --> void", pybind11::arg("index"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"), pybind11::arg("R"), pybind11::arg("G"), pybind11::arg("B"));
		cl.def("getPointColor", (void (mrpt::maps::CColouredPointsMap::*)(unsigned long, float &, float &, float &) const) &mrpt::maps::CColouredPointsMap::getPointColor, "Retrieves a point color (colors range is [0,1]) \n\nC++: mrpt::maps::CColouredPointsMap::getPointColor(unsigned long, float &, float &, float &) const --> void", pybind11::arg("index"), pybind11::arg("R"), pybind11::arg("G"), pybind11::arg("B"));
		cl.def("getPointColor_fast", (void (mrpt::maps::CColouredPointsMap::*)(unsigned long, float &, float &, float &) const) &mrpt::maps::CColouredPointsMap::getPointColor_fast, "Like  but without checking for out-of-index erors \n\nC++: mrpt::maps::CColouredPointsMap::getPointColor_fast(unsigned long, float &, float &, float &) const --> void", pybind11::arg("index"), pybind11::arg("R"), pybind11::arg("G"), pybind11::arg("B"));
