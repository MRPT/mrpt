...
void bind_mrpt_maps_CLogOddsGridMap3D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::maps::CLogOddsGridMap3D file:mrpt/maps/CLogOddsGridMap3D.h line:27
		pybind11::class_<mrpt::maps::CLogOddsGridMap3D<signed char>, std::shared_ptr<mrpt::maps::CLogOddsGridMap3D<signed char>>, mrpt::maps::detail::logoddscell_traits<signed char>> cl(M("mrpt::maps"), "CLogOddsGridMap3D_signed_char_t", "");
	...
	{ // mrpt::maps::OccGridCellTraits file:mrpt/maps/OccupancyGridCellType.h line:26
