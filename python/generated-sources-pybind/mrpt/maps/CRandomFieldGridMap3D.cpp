...
void bind_mrpt_maps_CRandomFieldGridMap3D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::maps::CRandomFieldGridMap3D file:mrpt/maps/CRandomFieldGridMap3D.h line:71
		...
		{ // mrpt::maps::CRandomFieldGridMap3D::ConnectivityDescriptor file:mrpt/maps/CRandomFieldGridMap3D.h line:162
			...
			cl.def("getEdgeInformation", (bool (mrpt::maps::CRandomFieldGridMap3D::ConnectivityDescriptor::*)(const class mrpt::maps::CRandomFieldGridMap3D *, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, double &)) &mrpt::maps::CRandomFieldGridMap3D::ConnectivityDescriptor::getEdgeInformation, "Implement the check of whether node i=(icx,icy,icz) is connected\n with node j=(jcx,jcy,jcy).\n This visitor method will be called only for immediate neighbors.\n \n\n true if connected (and the \"information\" value should be also\n updated in out_edge_information), false otherwise.\n\nC++: mrpt::maps::CRandomFieldGridMap3D::ConnectivityDescriptor::getEdgeInformation(const class mrpt::maps::CRandomFieldGridMap3D *, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, unsigned long, double &) --> bool", pybind11::arg("parent"), pybind11::arg("icx"), pybind11::arg("icy"), pybind11::arg("icz"), pybind11::arg("jcx"), pybind11::arg("jcy"), pybind11::arg("jcz"), pybind11::arg("out_edge_information"));
