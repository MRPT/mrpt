...
void bind_mrpt_config_CConfigFileBase(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::config::CConfigFileBase file:mrpt/config/CConfigFileBase.h line:45
		...
		cl.def("read_uint64_t", [](mrpt::config::CConfigFileBase const &o, const std::string & a0, const std::string & a1, unsigned long const & a2) -> unsigned long { return o.read_uint64_t(a0, a1, a2); }, "", pybind11::arg("section"), pybind11::arg("name"), pybind11::arg("defaultValue"));
		cl.def("read_uint64_t", (unsigned long (mrpt::config::CConfigFileBase::*)(const std::string &, const std::string &, unsigned long, bool) const) &mrpt::config::CConfigFileBase::read_uint64_t, "C++: mrpt::config::CConfigFileBase::read_uint64_t(const std::string &, const std::string &, unsigned long, bool) const --> unsigned long", pybind11::arg("section"), pybind11::arg("name"), pybind11::arg("defaultValue"), pybind11::arg("failIfNotFound"));
