...
void bind_mrpt_tfest_TMatchingPair(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::tfest::TMatchingPairListTempl file:mrpt/tfest/TMatchingPair.h line:128
		...
		cl.def("indexOtherMapHasCorrespondence", (bool (mrpt::tfest::TMatchingPairListTempl<float>::*)(unsigned long) const) &mrpt::tfest::TMatchingPairListTempl<float>::indexOtherMapHasCorrespondence, "C++: mrpt::tfest::TMatchingPairListTempl<float>::indexOtherMapHasCorrespondence(unsigned long) const --> bool", pybind11::arg("idx"));
		...
		cl.def("filterUniqueRobustPairs", (void (mrpt::tfest::TMatchingPairListTempl<float>::*)(const unsigned long, class mrpt::tfest::TMatchingPairListTempl<float> &) const) &mrpt::tfest::TMatchingPairListTempl<float>::filterUniqueRobustPairs, "C++: mrpt::tfest::TMatchingPairListTempl<float>::filterUniqueRobustPairs(const unsigned long, class mrpt::tfest::TMatchingPairListTempl<float> &) const --> void", pybind11::arg("num_elements_this_map"), pybind11::arg("out_filtered_list"));
