...
void bind_mrpt_nav_holonomic_CHolonomicVFF(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::nav::TPlannerResultTempl file:mrpt/nav/planners/PlannerRRT_common.h line:39
		pybind11::class_<mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>, std::shared_ptr<mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>>> cl(M("mrpt::nav"), "TPlannerResultTempl_mrpt_nav_TMoveTree_mrpt_nav_TNodeSE2_TP_mrpt_nav_TMoveEdgeSE2_TP_mrpt_containers_map_traits_map_as_vector_t", "");
		cl.def( pybind11::init( [](){ return new mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>(); } ) );
		cl.def( pybind11::init( [](mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>> const &o){ return new mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>(o); } ) );
		cl.def_readwrite("success", &mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>::success);
		cl.def_readwrite("computation_time", &mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>::computation_time);
		cl.def_readwrite("goal_distance", &mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>::goal_distance);
		cl.def_readwrite("path_cost", &mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>::path_cost);
		cl.def_readwrite("best_goal_node_id", &mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>::best_goal_node_id);
		cl.def_readwrite("acceptable_goal_node_ids", &mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>::acceptable_goal_node_ids);
		cl.def_readwrite("move_tree", &mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>::move_tree);
		cl.def("assign", (struct mrpt::nav::TPlannerResultTempl<class mrpt::nav::TMoveTree<struct mrpt::nav::TNodeSE2_TP, struct mrpt::nav::TMoveEdgeSE2_TP, struct mrpt::containers::map_traits_map_as_vector> > & (mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>::*)(const struct mrpt::nav::TPlannerResultTempl<class mrpt::nav::TMoveTree<struct mrpt::nav::TNodeSE2_TP, struct mrpt::nav::TMoveEdgeSE2_TP, struct mrpt::containers::map_traits_map_as_vector> > &)) &mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>::operator=, "C++: mrpt::nav::TPlannerResultTempl<mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>>::operator=(const struct mrpt::nav::TPlannerResultTempl<class mrpt::nav::TMoveTree<struct mrpt::nav::TNodeSE2_TP, struct mrpt::nav::TMoveEdgeSE2_TP, struct mrpt::containers::map_traits_map_as_vector> > &) --> struct mrpt::nav::TPlannerResultTempl<class mrpt::nav::TMoveTree<struct mrpt::nav::TNodeSE2_TP, struct mrpt::nav::TMoveEdgeSE2_TP, struct mrpt::containers::map_traits_map_as_vector> > &", pybind11::return_value_policy::automatic, pybind11::arg(""));
	}
