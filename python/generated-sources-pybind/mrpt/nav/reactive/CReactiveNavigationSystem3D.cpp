...
void bind_mrpt_nav_reactive_CReactiveNavigationSystem3D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::nav::TRobotShape file:mrpt/nav/reactive/CReactiveNavigationSystem3D.h line:21
		...
		cl.def("size", (unsigned long (mrpt::nav::TRobotShape::*)() const) &mrpt::nav::TRobotShape::size, "C++: mrpt::nav::TRobotShape::size() const --> unsigned long");
		cl.def("resize", (void (mrpt::nav::TRobotShape::*)(unsigned long)) &mrpt::nav::TRobotShape::resize, "C++: mrpt::nav::TRobotShape::resize(unsigned long) --> void", pybind11::arg("num_levels"));
		cl.def("getRadius", (double (mrpt::nav::TRobotShape::*)(unsigned long) const) &mrpt::nav::TRobotShape::getRadius, "C++: mrpt::nav::TRobotShape::getRadius(unsigned long) const --> double", pybind11::arg("level"));
		cl.def("getHeight", (double (mrpt::nav::TRobotShape::*)(unsigned long) const) &mrpt::nav::TRobotShape::getHeight, "C++: mrpt::nav::TRobotShape::getHeight(unsigned long) const --> double", pybind11::arg("level"));
		cl.def("polygon", (class mrpt::math::CPolygon & (mrpt::nav::TRobotShape::*)(unsigned long)) &mrpt::nav::TRobotShape::polygon, "C++: mrpt::nav::TRobotShape::polygon(unsigned long) --> class mrpt::math::CPolygon &", pybind11::return_value_policy::automatic, pybind11::arg("level"));
		cl.def("setRadius", (void (mrpt::nav::TRobotShape::*)(unsigned long, double)) &mrpt::nav::TRobotShape::setRadius, "C++: mrpt::nav::TRobotShape::setRadius(unsigned long, double) --> void", pybind11::arg("level"), pybind11::arg("r"));
		cl.def("setHeight", (void (mrpt::nav::TRobotShape::*)(unsigned long, double)) &mrpt::nav::TRobotShape::setHeight, "C++: mrpt::nav::TRobotShape::setHeight(unsigned long, double) --> void", pybind11::arg("level"), pybind11::arg("h"));
	...
	{ // mrpt::nav::CReactiveNavigationSystem3D file:mrpt/nav/reactive/CReactiveNavigationSystem3D.h line:83
		...
		cl.def("getPTG_count", (unsigned long (mrpt::nav::CReactiveNavigationSystem3D::*)() const) &mrpt::nav::CReactiveNavigationSystem3D::getPTG_count, "C++: mrpt::nav::CReactiveNavigationSystem3D::getPTG_count() const --> unsigned long");
		cl.def("getPTG", (class mrpt::nav::CParameterizedTrajectoryGenerator * (mrpt::nav::CReactiveNavigationSystem3D::*)(unsigned long)) &mrpt::nav::CReactiveNavigationSystem3D::getPTG, "C++: mrpt::nav::CReactiveNavigationSystem3D::getPTG(unsigned long) --> class mrpt::nav::CParameterizedTrajectoryGenerator *", pybind11::return_value_policy::automatic, pybind11::arg("i"));
