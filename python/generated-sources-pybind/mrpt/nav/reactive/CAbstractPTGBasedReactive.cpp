...
void bind_mrpt_nav_reactive_CAbstractPTGBasedReactive(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::nav::CAbstractPTGBasedReactive file:mrpt/nav/reactive/CAbstractPTGBasedReactive.h line:93
		...
		cl.def("getPTG_count", (unsigned long (mrpt::nav::CAbstractPTGBasedReactive::*)() const) &mrpt::nav::CAbstractPTGBasedReactive::getPTG_count, "Returns the number of different PTGs that have been setup \n\nC++: mrpt::nav::CAbstractPTGBasedReactive::getPTG_count() const --> unsigned long");
		cl.def("getPTG", (class mrpt::nav::CParameterizedTrajectoryGenerator * (mrpt::nav::CAbstractPTGBasedReactive::*)(unsigned long)) &mrpt::nav::CAbstractPTGBasedReactive::getPTG, "Gets the i'th PTG \n\nC++: mrpt::nav::CAbstractPTGBasedReactive::getPTG(unsigned long) --> class mrpt::nav::CParameterizedTrajectoryGenerator *", pybind11::return_value_policy::automatic, pybind11::arg("i"));
