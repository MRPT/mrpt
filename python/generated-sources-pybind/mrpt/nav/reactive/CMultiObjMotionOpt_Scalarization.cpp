...
void bind_mrpt_nav_reactive_CMultiObjMotionOpt_Scalarization(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::nav::CMultiObjMotionOpt_Scalarization file:mrpt/nav/reactive/CMultiObjMotionOpt_Scalarization.h line:25
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<43> (*)()) &mrpt::nav::CMultiObjMotionOpt_Scalarization::getClassName, "C++: mrpt::nav::CMultiObjMotionOpt_Scalarization::getClassName() --> class mrpt::typemeta::string_literal<43>");
	...
	{ // mrpt::nav::CReactiveNavigationSystem file:mrpt/nav/reactive/CReactiveNavigationSystem.h line:59
		...
		cl.def("getPTG_count", (unsigned long (mrpt::nav::CReactiveNavigationSystem::*)() const) &mrpt::nav::CReactiveNavigationSystem::getPTG_count, "C++: mrpt::nav::CReactiveNavigationSystem::getPTG_count() const --> unsigned long");
		cl.def("getPTG", (class mrpt::nav::CParameterizedTrajectoryGenerator * (mrpt::nav::CReactiveNavigationSystem::*)(unsigned long)) &mrpt::nav::CReactiveNavigationSystem::getPTG, "C++: mrpt::nav::CReactiveNavigationSystem::getPTG(unsigned long) --> class mrpt::nav::CParameterizedTrajectoryGenerator *", pybind11::return_value_policy::automatic, pybind11::arg("i"));
