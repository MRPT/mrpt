...
void bind_mrpt_nav_planners_TMoveTree(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::nav::TMoveTree file:mrpt/nav/planners/TMoveTree.h line:51
		...
		cl.def("getNextFreeNodeID", (unsigned long (mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP,mrpt::nav::TMoveEdgeSE2_TP,mrpt::containers::map_traits_map_as_vector>::*)() const) &mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>::getNextFreeNodeID, "C++: mrpt::nav::TMoveTree<mrpt::nav::TNodeSE2_TP, mrpt::nav::TMoveEdgeSE2_TP, mrpt::containers::map_traits_map_as_vector>::getNextFreeNodeID() const --> unsigned long");
