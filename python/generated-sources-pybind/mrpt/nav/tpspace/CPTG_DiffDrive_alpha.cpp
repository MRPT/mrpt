...
void bind_mrpt_nav_tpspace_CPTG_DiffDrive_alpha(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::nav::CPTG_Holo_Blend file:mrpt/nav/tpspace/CPTG_Holo_Blend.h line:25
		...
		cl.def("directionToMotionCommand", (class std::shared_ptr<class mrpt::kinematics::CVehicleVelCmd> (mrpt::nav::CPTG_Holo_Blend::*)(unsigned short) const) &mrpt::nav::CPTG_Holo_Blend::directionToMotionCommand, "Converts a discretized \"alpha\" value into a feasible motion command or\n action. See derived classes for the meaning of these actions \n\nC++: mrpt::nav::CPTG_Holo_Blend::directionToMotionCommand(unsigned short) const --> class std::shared_ptr<class mrpt::kinematics::CVehicleVelCmd>", pybind11::arg("k"));
		...
		cl.def("getPathStepCount", (unsigned long (mrpt::nav::CPTG_Holo_Blend::*)(unsigned short) const) &mrpt::nav::CPTG_Holo_Blend::getPathStepCount, "C++: mrpt::nav::CPTG_Holo_Blend::getPathStepCount(unsigned short) const --> unsigned long", pybind11::arg("k"));
		cl.def("getPathPose", (struct mrpt::math::TPose2D (mrpt::nav::CPTG_Holo_Blend::*)(unsigned short, unsigned int) const) &mrpt::nav::CPTG_Holo_Blend::getPathPose, "C++: mrpt::nav::CPTG_Holo_Blend::getPathPose(unsigned short, unsigned int) const --> struct mrpt::math::TPose2D", pybind11::arg("k"), pybind11::arg("step"));
		cl.def("getPathDist", (double (mrpt::nav::CPTG_Holo_Blend::*)(unsigned short, unsigned int) const) &mrpt::nav::CPTG_Holo_Blend::getPathDist, "C++: mrpt::nav::CPTG_Holo_Blend::getPathDist(unsigned short, unsigned int) const --> double", pybind11::arg("k"), pybind11::arg("step"));
		cl.def("getPathStepForDist", (bool (mrpt::nav::CPTG_Holo_Blend::*)(unsigned short, double, unsigned int &) const) &mrpt::nav::CPTG_Holo_Blend::getPathStepForDist, "C++: mrpt::nav::CPTG_Holo_Blend::getPathStepForDist(unsigned short, double, unsigned int &) const --> bool", pybind11::arg("k"), pybind11::arg("dist"), pybind11::arg("out_step"));
		...
		cl.def("updateTPObstacleSingle", (void (mrpt::nav::CPTG_Holo_Blend::*)(double, double, unsigned short, double &) const) &mrpt::nav::CPTG_Holo_Blend::updateTPObstacleSingle, "C++: mrpt::nav::CPTG_Holo_Blend::updateTPObstacleSingle(double, double, unsigned short, double &) const --> void", pybind11::arg("ox"), pybind11::arg("oy"), pybind11::arg("k"), pybind11::arg("tp_obstacle_k"));
