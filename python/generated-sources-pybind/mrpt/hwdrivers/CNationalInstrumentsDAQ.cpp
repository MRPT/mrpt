...
void bind_mrpt_hwdrivers_CNationalInstrumentsDAQ(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::hwdrivers::CNationalInstrumentsDAQ file:mrpt/hwdrivers/CNationalInstrumentsDAQ.h line:209
		...
		cl.def("writeAnalogOutputTask", (void (mrpt::hwdrivers::CNationalInstrumentsDAQ::*)(unsigned long, unsigned long, const double *, double, bool)) &mrpt::hwdrivers::CNationalInstrumentsDAQ::writeAnalogOutputTask, "Set voltage outputs to all the outputs in an AOUT task\n For the meaning of parameters, refere to NI DAQmx docs for\n DAQmxBaseWriteAnalogF64()\n \n\n The number of samples in  must match the number of\n channels in the task when it was initiated.\n\nC++: mrpt::hwdrivers::CNationalInstrumentsDAQ::writeAnalogOutputTask(unsigned long, unsigned long, const double *, double, bool) --> void", pybind11::arg("task_index"), pybind11::arg("nSamplesPerChannel"), pybind11::arg("volt_values"), pybind11::arg("timeout"), pybind11::arg("groupedByChannel"));
		cl.def("writeDigitalOutputTask", (void (mrpt::hwdrivers::CNationalInstrumentsDAQ::*)(unsigned long, bool, double)) &mrpt::hwdrivers::CNationalInstrumentsDAQ::writeDigitalOutputTask, "Changes the boolean state of one digital output line.\n For the meaning of parameters, refere to NI DAQmx docs for\n DAQmxBaseWriteAnalogF64()\n \n\n The number of samples in  must match the number of\n channels in the task when it was initiated.\n\nC++: mrpt::hwdrivers::CNationalInstrumentsDAQ::writeDigitalOutputTask(unsigned long, bool, double) --> void", pybind11::arg("task_index"), pybind11::arg("line_value"), pybind11::arg("timeout"));
