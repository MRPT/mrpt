...
void bind_mrpt_hwdrivers_CKinect(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::hwdrivers::CKinect file:mrpt/hwdrivers/CKinect.h line:265
		...
		cl.def("setPreviewDecimation", (void (mrpt::hwdrivers::CKinect::*)(unsigned long)) &mrpt::hwdrivers::CKinect::setPreviewDecimation, "If preview is enabled, show only one image out of N (default: 1=show\n all) \n\nC++: mrpt::hwdrivers::CKinect::setPreviewDecimation(unsigned long) --> void", pybind11::arg("decimation_factor"));
		cl.def("getPreviewDecimation", (unsigned long (mrpt::hwdrivers::CKinect::*)() const) &mrpt::hwdrivers::CKinect::getPreviewDecimation, "C++: mrpt::hwdrivers::CKinect::getPreviewDecimation() const --> unsigned long");
		...
		cl.def("rows", (unsigned long (mrpt::hwdrivers::CKinect::*)() const) &mrpt::hwdrivers::CKinect::rows, "Get the row count in the camera images, loaded automatically upon camera\n open(). \n\nC++: mrpt::hwdrivers::CKinect::rows() const --> unsigned long");
		cl.def("cols", (unsigned long (mrpt::hwdrivers::CKinect::*)() const) &mrpt::hwdrivers::CKinect::cols, "Get the col count in the camera images, loaded automatically upon camera\n open(). \n\nC++: mrpt::hwdrivers::CKinect::cols() const --> unsigned long");
