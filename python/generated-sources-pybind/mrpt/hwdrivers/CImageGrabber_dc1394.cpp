...
void bind_mrpt_hwdrivers_CImageGrabber_dc1394(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::hwdrivers::CImageGrabber_dc1394 file:mrpt/hwdrivers/CImageGrabber_dc1394.h line:125
		...
		cl.def( pybind11::init( [](unsigned long const & a0){ return new mrpt::hwdrivers::CImageGrabber_dc1394(a0); } ), "doc" , pybind11::arg("cameraGUID"));
		cl.def( pybind11::init( [](unsigned long const & a0, unsigned short const & a1){ return new mrpt::hwdrivers::CImageGrabber_dc1394(a0, a1); } ), "doc" , pybind11::arg("cameraGUID"), pybind11::arg("cameraUnit"));
		cl.def( pybind11::init( [](unsigned long const & a0, unsigned short const & a1, const struct mrpt::hwdrivers::TCaptureOptions_dc1394 & a2){ return new mrpt::hwdrivers::CImageGrabber_dc1394(a0, a1, a2); } ), "doc" , pybind11::arg("cameraGUID"), pybind11::arg("cameraUnit"), pybind11::arg("options"));
		cl.def( pybind11::init<unsigned long, unsigned short, const struct mrpt::hwdrivers::TCaptureOptions_dc1394 &, bool>(), pybind11::arg("cameraGUID"), pybind11::arg("cameraUnit"), pybind11::arg("options"), pybind11::arg("verbose") );
