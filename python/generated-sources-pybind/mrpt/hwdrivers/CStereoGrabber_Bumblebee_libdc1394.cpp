...
void bind_mrpt_hwdrivers_CStereoGrabber_Bumblebee_libdc1394(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::hwdrivers::CStereoGrabber_Bumblebee_libdc1394 file:mrpt/hwdrivers/CStereoGrabber_Bumblebee_libdc1394.h line:34
		...
		cl.def( pybind11::init<unsigned long, unsigned short, double>(), pybind11::arg("cameraGUID"), pybind11::arg("cameraUnit"), pybind11::arg("frameRate") );
	...
	{ // mrpt::hwdrivers::CStereoGrabber_SVS file:mrpt/hwdrivers/CStereoGrabber_SVS.h line:65
	...
	{ // mrpt::hwdrivers::CSwissRanger3DCamera file:mrpt/hwdrivers/CSwissRanger3DCamera.h line:108
		...
		cl.def("rows", (unsigned long (mrpt::hwdrivers::CSwissRanger3DCamera::*)() const) &mrpt::hwdrivers::CSwissRanger3DCamera::rows, "Get the row count in the camera images, loaded automatically upon camera\n open(). \n\nC++: mrpt::hwdrivers::CSwissRanger3DCamera::rows() const --> unsigned long");
		cl.def("cols", (unsigned long (mrpt::hwdrivers::CSwissRanger3DCamera::*)() const) &mrpt::hwdrivers::CSwissRanger3DCamera::cols, "Get the col count in the camera images, loaded automatically upon camera\n open(). \n\nC++: mrpt::hwdrivers::CSwissRanger3DCamera::cols() const --> unsigned long");
