...
void bind_mrpt_hwdrivers_CGPSInterface(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::hwdrivers::CGPSInterface file:mrpt/hwdrivers/CGPSInterface.h line:142
		...
		cl.def("sendCustomCommand", (bool (mrpt::hwdrivers::CGPSInterface::*)(const void *, const unsigned long)) &mrpt::hwdrivers::CGPSInterface::sendCustomCommand, "Send a custom data block to the GNSS device right now. Can be used to\n	  change its behavior online as needed.\n	  \n\n false on communication error \n\nC++: mrpt::hwdrivers::CGPSInterface::sendCustomCommand(const void *, const unsigned long) --> bool", pybind11::arg("data"), pybind11::arg("datalen"));
