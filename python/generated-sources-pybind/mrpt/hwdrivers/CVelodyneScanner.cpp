...
void bind_mrpt_hwdrivers_CVelodyneScanner(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::hwdrivers::CVelodyneScanner file:mrpt/hwdrivers/CVelodyneScanner.h line:165
		...
		cl.def("receivePackets", (bool (mrpt::hwdrivers::CVelodyneScanner::*)(struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &, struct mrpt::obs::CObservationVelodyneScan::TVelodyneRawPacket &, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &, struct mrpt::obs::CObservationVelodyneScan::TVelodynePositionPacket &)) &mrpt::hwdrivers::CVelodyneScanner::receivePackets, "Users normally would prefer calling  instead.\n This method polls the UDP data port and returns one Velodyne DATA packet\n (1206 bytes) and/or one POSITION packet. Refer to Velodyne users manual.\n Approximate timestamps (based on this computer clock) are returned for\n each kind of packets, or INVALID_TIMESTAMP if timeout ocurred waiting for\n a packet.\n \n\n true on all ok. false only for pcap reading EOF\n\nC++: mrpt::hwdrivers::CVelodyneScanner::receivePackets(struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &, struct mrpt::obs::CObservationVelodyneScan::TVelodyneRawPacket &, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &, struct mrpt::obs::CObservationVelodyneScan::TVelodynePositionPacket &) --> bool", pybind11::arg("data_pkt_timestamp"), pybind11::arg("out_data_pkt"), pybind11::arg("pos_pkt_timestamp"), pybind11::arg("out_pos_pkt"));
