...
void bind_mrpt_hwdrivers_CMyntEyeCamera(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::hwdrivers::CMyntEyeCamera file:mrpt/hwdrivers/CMyntEyeCamera.h line:38
	...
	{ // mrpt::hwdrivers::COpenNI2Generic file:mrpt/hwdrivers/COpenNI2Generic.h line:23
		...
		cl.def("getNextFrameRGB", [](mrpt::hwdrivers::COpenNI2Generic &o, class mrpt::img::CImage & a0, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > & a1, bool & a2, bool & a3) -> void { return o.getNextFrameRGB(a0, a1, a2, a3); }, "", pybind11::arg("rgb_img"), pybind11::arg("timestamp"), pybind11::arg("there_is_obs"), pybind11::arg("hardware_error"));
		cl.def("getNextFrameRGB", (void (mrpt::hwdrivers::COpenNI2Generic::*)(class mrpt::img::CImage &, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &, bool &, bool &, unsigned int)) &mrpt::hwdrivers::COpenNI2Generic::getNextFrameRGB, "The main data retrieving function, to be called after calling\n loadConfig() and initialize().\n  \n\n The output retrieved RGB image (only if\n there_is_obs=true).\n  \n\n The timestamp of the capture (only if\n there_is_obs=true).\n  \n\n If set to false, there was no new observation.\n  \n\n True on hardware/comms error.\n  \n\n The index of the sensor accessed.  \n\nC++: mrpt::hwdrivers::COpenNI2Generic::getNextFrameRGB(class mrpt::img::CImage &, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &, bool &, bool &, unsigned int) --> void", pybind11::arg("rgb_img"), pybind11::arg("timestamp"), pybind11::arg("there_is_obs"), pybind11::arg("hardware_error"), pybind11::arg("sensor_id"));
		cl.def("getNextFrameD", [](mrpt::hwdrivers::COpenNI2Generic &o, class mrpt::math::CMatrixDynamic<unsigned short> & a0, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > & a1, bool & a2, bool & a3) -> void { return o.getNextFrameD(a0, a1, a2, a3); }, "", pybind11::arg("depth_img_mm"), pybind11::arg("timestamp"), pybind11::arg("there_is_obs"), pybind11::arg("hardware_error"));
		cl.def("getNextFrameD", (void (mrpt::hwdrivers::COpenNI2Generic::*)(class mrpt::math::CMatrixDynamic<unsigned short> &, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &, bool &, bool &, unsigned int)) &mrpt::hwdrivers::COpenNI2Generic::getNextFrameD, "The main data retrieving function, to be called after calling\n loadConfig() and initialize().\n  \n\n The output retrieved depth image (only if\n there_is_obs=true).\n  \n\n The timestamp of the capture (only if\n there_is_obs=true).\n  \n\n If set to false, there was no new observation.\n  \n\n True on hardware/comms error.\n  \n\n The index of the sensor accessed. \n\nC++: mrpt::hwdrivers::COpenNI2Generic::getNextFrameD(class mrpt::math::CMatrixDynamic<unsigned short> &, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &, bool &, bool &, unsigned int) --> void", pybind11::arg("depth_img_mm"), pybind11::arg("timestamp"), pybind11::arg("there_is_obs"), pybind11::arg("hardware_error"), pybind11::arg("sensor_id"));
	...
	{ // mrpt::hwdrivers::COpenNI2Sensor file:mrpt/hwdrivers/COpenNI2Sensor.h line:216
		...
		cl.def("rows", (unsigned long (mrpt::hwdrivers::COpenNI2Sensor::*)() const) &mrpt::hwdrivers::COpenNI2Sensor::rows, "Get the row count in the camera images, loaded automatically upon camera\n open(). \n\nC++: mrpt::hwdrivers::COpenNI2Sensor::rows() const --> unsigned long");
		cl.def("cols", (unsigned long (mrpt::hwdrivers::COpenNI2Sensor::*)() const) &mrpt::hwdrivers::COpenNI2Sensor::cols, "Get the col count in the camera images, loaded automatically upon camera\n open(). \n\nC++: mrpt::hwdrivers::COpenNI2Sensor::cols() const --> unsigned long");
