...
void bind_mrpt_kinematics_CVehicleVelCmd(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::kinematics::CVehicleVelCmd file:mrpt/kinematics/CVehicleVelCmd.h line:22
		...
		cl.def("getVelCmdLength", (unsigned long (mrpt::kinematics::CVehicleVelCmd::*)() const) &mrpt::kinematics::CVehicleVelCmd::getVelCmdLength, "Get number of components in each velocity command \n\nC++: mrpt::kinematics::CVehicleVelCmd::getVelCmdLength() const --> unsigned long");
		...
		{ // mrpt::kinematics::CVehicleVelCmd::TVelCmdParams file:mrpt/kinematics/CVehicleVelCmd.h line:51
