...
struct PyCallBack_mrpt_kinematics_CVehicleVelCmd_DiffDriven : public mrpt::kinematics::CVehicleVelCmd_DiffDriven {
	...
	unsigned long getVelCmdLength() const override {
		pybind11::gil_scoped_acquire gil;
...
void bind_mrpt_kinematics_CVehicleVelCmd_DiffDriven(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::kinematics::CVehicleVelCmd_DiffDriven file:mrpt/kinematics/CVehicleVelCmd_DiffDriven.h line:19
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<43> (*)()) &mrpt::kinematics::CVehicleVelCmd_DiffDriven::getClassName, "C++: mrpt::kinematics::CVehicleVelCmd_DiffDriven::getClassName() --> class mrpt::typemeta::string_literal<43>");
		...
		cl.def("getVelCmdLength", (unsigned long (mrpt::kinematics::CVehicleVelCmd_DiffDriven::*)() const) &mrpt::kinematics::CVehicleVelCmd_DiffDriven::getVelCmdLength, "C++: mrpt::kinematics::CVehicleVelCmd_DiffDriven::getVelCmdLength() const --> unsigned long");
	...
	{ // mrpt::kinematics::CVehicleVelCmd_Holo file:mrpt/kinematics/CVehicleVelCmd_Holo.h line:19
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<37> (*)()) &mrpt::kinematics::CVehicleVelCmd_Holo::getClassName, "C++: mrpt::kinematics::CVehicleVelCmd_Holo::getClassName() --> class mrpt::typemeta::string_literal<37>");
		...
		cl.def("getVelCmdLength", (unsigned long (mrpt::kinematics::CVehicleVelCmd_Holo::*)() const) &mrpt::kinematics::CVehicleVelCmd_Holo::getVelCmdLength, "C++: mrpt::kinematics::CVehicleVelCmd_Holo::getVelCmdLength() const --> unsigned long");
