...
void bind_mrpt_kinematics_CKinematicChain(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::kinematics::CKinematicChain file:mrpt/kinematics/CKinematicChain.h line:74
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<33> (*)()) &mrpt::kinematics::CKinematicChain::getClassName, "C++: mrpt::kinematics::CKinematicChain::getClassName() --> class mrpt::typemeta::string_literal<33>");
		...
		cl.def("size", (unsigned long (mrpt::kinematics::CKinematicChain::*)() const) &mrpt::kinematics::CKinematicChain::size, "Return the number of links \n\nC++: mrpt::kinematics::CKinematicChain::size() const --> unsigned long");
		...
		cl.def("removeLink", (void (mrpt::kinematics::CKinematicChain::*)(const unsigned long)) &mrpt::kinematics::CKinematicChain::removeLink, "Removes one link from the kinematic chain (0<=idx<N) \n\nC++: mrpt::kinematics::CKinematicChain::removeLink(const unsigned long) --> void", pybind11::arg("idx"));
		cl.def("getLink", (const struct mrpt::kinematics::TKinematicLink & (mrpt::kinematics::CKinematicChain::*)(const unsigned long) const) &mrpt::kinematics::CKinematicChain::getLink, "Get a ref to a given link (read-only) \n\nC++: mrpt::kinematics::CKinematicChain::getLink(const unsigned long) const --> const struct mrpt::kinematics::TKinematicLink &", pybind11::return_value_policy::automatic, pybind11::arg("idx"));
		cl.def("getLinkRef", (struct mrpt::kinematics::TKinematicLink & (mrpt::kinematics::CKinematicChain::*)(const unsigned long)) &mrpt::kinematics::CKinematicChain::getLinkRef, "Get a ref to a given link (read-write) \n\nC++: mrpt::kinematics::CKinematicChain::getLinkRef(const unsigned long) --> struct mrpt::kinematics::TKinematicLink &", pybind11::return_value_policy::automatic, pybind11::arg("idx"));
