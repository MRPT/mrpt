...
void bind_mrpt_io_CTextFileLinesParser(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::io::CTextFileLinesParser file:mrpt/io/CTextFileLinesParser.h line:25
		...
		cl.def("getCurrentLineNumber", (unsigned long (mrpt::io::CTextFileLinesParser::*)() const) &mrpt::io::CTextFileLinesParser::getCurrentLineNumber, "Return the line number of the last line returned with  \n\nC++: mrpt::io::CTextFileLinesParser::getCurrentLineNumber() const --> unsigned long");
