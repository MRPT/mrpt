...
void bind_mrpt_serialization_CSerializable(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// mrpt::serialization::ObjectToOctetVector(const class mrpt::serialization::CSerializable *, class std::vector<unsigned char> &) file:mrpt/serialization/CSerializable.h line:105
	...
	// mrpt::serialization::OctetVectorToObject(const class std::vector<unsigned char> &, class std::shared_ptr<class mrpt::serialization::CSerializable> &) file:mrpt/serialization/CSerializable.h line:116
