...
void bind_mrpt_serialization_CSerializable(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// mrpt::serialization::ObjectToOctetVector(const class mrpt::serialization::CSerializable *, class std::vector<unsigned char, class std::allocator<unsigned char> > &) file:mrpt/serialization/CSerializable.h line:105
	M("mrpt::serialization").def("ObjectToOctetVector", (void (*)(const class mrpt::serialization::CSerializable *, class std::vector<unsigned char, class std::allocator<unsigned char> > &)) &mrpt::serialization::ObjectToOctetVector, "Converts (serializes) an MRPT object into an array of bytes.\n \n\n The object to be serialized.\n \n\n The vector which at return will contain the data. Size will\n be set automatically.\n \n\n OctetVectorToObject, ObjectToString\n\nC++: mrpt::serialization::ObjectToOctetVector(const class mrpt::serialization::CSerializable *, class std::vector<unsigned char, class std::allocator<unsigned char> > &) --> void", pybind11::arg("o"), pybind11::arg("out_vector"));

	// mrpt::serialization::OctetVectorToObject(const class std::vector<unsigned char, class std::allocator<unsigned char> > &, class std::shared_ptr<class mrpt::serialization::CSerializable> &) file:mrpt/serialization/CSerializable.h line:116
	M("mrpt::serialization").def("OctetVectorToObject", (void (*)(const class std::vector<unsigned char, class std::allocator<unsigned char> > &, class std::shared_ptr<class mrpt::serialization::CSerializable> &)) &mrpt::serialization::OctetVectorToObject, "Converts back (de-serializes) a sequence of binary data into a MRPT object,\n without prior information about the object's class.\n \n\n The serialized input data representing the object.\n \n\n The newly created object will be stored in this smart pointer.\n \n\n None On any internal exception, this function returns a nullptr\n pointer.\n \n\n ObjectToOctetVector, StringToObject\n\nC++: mrpt::serialization::OctetVectorToObject(const class std::vector<unsigned char, class std::allocator<unsigned char> > &, class std::shared_ptr<class mrpt::serialization::CSerializable> &) --> void", pybind11::arg("in_data"), pybind11::arg("obj"));
