...
void bind_mrpt_serialization_CArchive(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::serialization::CArchive file:mrpt/serialization/CArchive.h line:56
		...
		cl.def("ReadBuffer", (unsigned long (mrpt::serialization::CArchive::*)(void *, unsigned long)) &mrpt::serialization::CArchive::ReadBuffer, "@{ \n\n Reads a block of bytes from the stream into Buffer\n	\n\n std::exception On any error, or if ZERO bytes are read.\n  \n\n The amound of bytes actually read.\n \n\n This method is endianness-dependent.\n \n\n ReadBufferImmediate ; Important, see: ReadBufferFixEndianness,\n\nC++: mrpt::serialization::CArchive::ReadBuffer(void *, unsigned long) --> unsigned long", pybind11::arg("Buffer"), pybind11::arg("Count"));
		cl.def("WriteBuffer", (void (mrpt::serialization::CArchive::*)(const void *, unsigned long)) &mrpt::serialization::CArchive::WriteBuffer, "Writes a block of bytes to the stream from Buffer.\n	\n\n std::exception On any error\n  \n\n Important, see: WriteBufferFixEndianness\n \n\n This method is endianness-dependent.\n\nC++: mrpt::serialization::CArchive::WriteBuffer(const void *, unsigned long) --> void", pybind11::arg("Buffer"), pybind11::arg("Count"));
