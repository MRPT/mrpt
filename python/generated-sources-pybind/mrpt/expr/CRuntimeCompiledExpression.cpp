...
{
	{ // mrpt::expr::CRuntimeCompiledExpression file:mrpt/expr/CRuntimeCompiledExpression.h line:64
		...
		cl.def("compile", [](mrpt::expr::CRuntimeCompiledExpression &o, const std::string & a0, const class std::map<std::string, double, struct std::less<std::string >, class std::allocator<struct std::pair<const std::string, double> > > & a1) -> void { return o.compile(a0, a1); }, "", pybind11::arg("expression"), pybind11::arg("variables"));
		cl.def("compile", (void (mrpt::expr::CRuntimeCompiledExpression::*)(const std::string &, const class std::map<std::string, double, struct std::less<std::string >, class std::allocator<struct std::pair<const std::string, double> > > &, const std::string &)) &mrpt::expr::CRuntimeCompiledExpression::compile, "Initializes the object by compiling an expression.\n \n\n std::runtime_error On any syntax error or undefined symbol\n while compiling the expression. The `e.what()` message describes what is\n exactly the problem.\n \n\n register_symbol_table()\n\nC++: mrpt::expr::CRuntimeCompiledExpression::compile(const std::string &, const class std::map<std::string, double, struct std::less<std::string >, class std::allocator<struct std::pair<const std::string, double> > > &, const std::string &) --> void", pybind11::arg("expression"), pybind11::arg("variables"), pybind11::arg("expr_name_for_error_reporting"));
