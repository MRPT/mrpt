...
void bind_mrpt_typemeta_static_string_2(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::typemeta::string_literal file:mrpt/typemeta/static_string.h line:25
		...
		cl.def("size", (unsigned long (mrpt::typemeta::string_literal<43>::*)() const) &mrpt::typemeta::string_literal<43>::size, "C++: mrpt::typemeta::string_literal<43>::size() const --> unsigned long");
	...
	{ // mrpt::typemeta::string_literal file:mrpt/typemeta/static_string.h line:25
		...
		cl.def("size", (unsigned long (mrpt::typemeta::string_literal<37>::*)() const) &mrpt::typemeta::string_literal<37>::size, "C++: mrpt::typemeta::string_literal<37>::size() const --> unsigned long");
	...
	{ // mrpt::typemeta::string_literal file:mrpt/typemeta/static_string.h line:25
		...
		cl.def("size", (unsigned long (mrpt::typemeta::string_literal<38>::*)() const) &mrpt::typemeta::string_literal<38>::size, "C++: mrpt::typemeta::string_literal<38>::size() const --> unsigned long");
	...
	{ // mrpt::typemeta::string_literal file:mrpt/typemeta/static_string.h line:25
		...
		cl.def("size", (unsigned long (mrpt::typemeta::string_literal<23>::*)() const) &mrpt::typemeta::string_literal<23>::size, "C++: mrpt::typemeta::string_literal<23>::size() const --> unsigned long");
	...
	{ // mrpt::typemeta::string_literal file:mrpt/typemeta/static_string.h line:25
		...
		cl.def("size", (unsigned long (mrpt::typemeta::string_literal<42>::*)() const) &mrpt::typemeta::string_literal<42>::size, "C++: mrpt::typemeta::string_literal<42>::size() const --> unsigned long");
