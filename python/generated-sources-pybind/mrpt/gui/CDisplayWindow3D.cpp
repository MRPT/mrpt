...
void bind_mrpt_gui_CDisplayWindow3D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::gui::CDisplayWindow3D file:mrpt/gui/CDisplayWindow3D.h line:111
		...
		cl.def("addTextMessage", [](mrpt::gui::CDisplayWindow3D &o, const double & a0, const double & a1, const std::string & a2, const unsigned long & a3) -> void { return o.addTextMessage(a0, a1, a2, a3); }, "", pybind11::arg("x_frac"), pybind11::arg("y_frac"), pybind11::arg("text"), pybind11::arg("unique_index"));
		cl.def("addTextMessage", (void (mrpt::gui::CDisplayWindow3D::*)(const double, const double, const std::string &, const unsigned long, const struct mrpt::opengl::TFontParams &)) &mrpt::gui::CDisplayWindow3D::addTextMessage, "A shortcut for calling mrpt::opengl::Viewport::addTextMessage()\n in the \"main\" viewport of the 3D scene.\n \n\n clearTextMessages, mrpt::opengl::Viewport::addTextMessage()\n\nC++: mrpt::gui::CDisplayWindow3D::addTextMessage(const double, const double, const std::string &, const unsigned long, const struct mrpt::opengl::TFontParams &) --> void", pybind11::arg("x_frac"), pybind11::arg("y_frac"), pybind11::arg("text"), pybind11::arg("unique_index"), pybind11::arg("fontParams"));
