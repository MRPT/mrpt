...
void bind_mrpt_gui_MRPT2NanoguiGLCanvas(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::gui::CDisplayWindowGUI file:mrpt/gui/CDisplayWindowGUI.h line:88
		...
		cl.def("addDropFilesCallback", (void (mrpt::gui::CDisplayWindowGUI::*)(const class std::function<bool (const class std::vector<std::string, class std::allocator<std::string > > &)> &)) &mrpt::gui::CDisplayWindowGUI::addDropFilesCallback, "Handles drag-and drop events of files into the window.\n This method can be safely called multiple times to register multiple\n callbacks.\n\n \n (New in MRPT 2.3.2)\n\nC++: mrpt::gui::CDisplayWindowGUI::addDropFilesCallback(const class std::function<bool (const class std::vector<std::string, class std::allocator<std::string > > &)> &) --> void", pybind11::arg("callback"));
		...
		cl.def("setDropFilesCallback", (void (mrpt::gui::CDisplayWindowGUI::*)(const class std::function<bool (const class std::vector<std::string, class std::allocator<std::string > > &)> &)) &mrpt::gui::CDisplayWindowGUI::setDropFilesCallback, "This call replaces *all* existing drop file callbacks. See\n addDropFilesCallback().\n \n\n In MRPT 2.3.2, replaced by addDropFilesCallback()\n\nC++: mrpt::gui::CDisplayWindowGUI::setDropFilesCallback(const class std::function<bool (const class std::vector<std::string, class std::allocator<std::string > > &)> &) --> void", pybind11::arg("callback"));
		cl.def("dropFilesCallback", (class std::function<bool (const class std::vector<std::string, class std::allocator<std::string > > &)> (mrpt::gui::CDisplayWindowGUI::*)() const) &mrpt::gui::CDisplayWindowGUI::dropFilesCallback, "In MRPT 2.3.2, replaced by dropFilesCallbacks() \n\nC++: mrpt::gui::CDisplayWindowGUI::dropFilesCallback() const --> class std::function<bool (const class std::vector<std::string, class std::allocator<std::string > > &)>");
		...
		cl.def("getSubwindow", (const class nanogui::Window * (mrpt::gui::CDisplayWindowGUI::*)(unsigned long) const) &mrpt::gui::CDisplayWindowGUI::getSubwindow, "Direct (read-only) access to managed subwindows by 0-based index\n (creation order).\n\n \n createManagedSubWindow()\n \n\n [New in MRPT 2.3.1]\n\nC++: mrpt::gui::CDisplayWindowGUI::getSubwindow(unsigned long) const --> const class nanogui::Window *", pybind11::return_value_policy::automatic, pybind11::arg("index"));
		cl.def("getSubwindowCount", (unsigned long (mrpt::gui::CDisplayWindowGUI::*)() const) &mrpt::gui::CDisplayWindowGUI::getSubwindowCount, "Get the number of managed subwindows. \n createManagedSubWindow()\n \n\n [New in MRPT 2.3.1]\n\nC++: mrpt::gui::CDisplayWindowGUI::getSubwindowCount() const --> unsigned long");
		cl.def("subwindowMinimize", (void (mrpt::gui::CDisplayWindowGUI::*)(unsigned long)) &mrpt::gui::CDisplayWindowGUI::subwindowMinimize, "Minimize a subwindow. \n [New in MRPT 2.3.1] \n\nC++: mrpt::gui::CDisplayWindowGUI::subwindowMinimize(unsigned long) --> void", pybind11::arg("index"));
		cl.def("subwindowRestore", (void (mrpt::gui::CDisplayWindowGUI::*)(unsigned long)) &mrpt::gui::CDisplayWindowGUI::subwindowRestore, "Restore a minimized subwindow. \n [New in MRPT 2.3.1] \n\nC++: mrpt::gui::CDisplayWindowGUI::subwindowRestore(unsigned long) --> void", pybind11::arg("index"));
		cl.def("subwindowSetFocused", (void (mrpt::gui::CDisplayWindowGUI::*)(unsigned long)) &mrpt::gui::CDisplayWindowGUI::subwindowSetFocused, "Forces focus on a subwindow. \n [New in MRPT 2.3.1] \n\nC++: mrpt::gui::CDisplayWindowGUI::subwindowSetFocused(unsigned long) --> void", pybind11::arg("index"));
