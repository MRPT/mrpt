...
// mrpt::slam::PF_implementation file:mrpt/slam/PF_implementations_data.h line:37
struct PyCallBack_mrpt_slam_PF_implementation_mrpt_maps_CRBPFParticleData_mrpt_maps_CMultiMetricMapPDF_mrpt_bayes_particle_storage_mode_POINTER_t : public mrpt::slam::PF_implementation<mrpt::maps::CRBPFParticleData,mrpt::maps::CMultiMetricMapPDF,mrpt::bayes::particle_storage_mode::POINTER> {
	...
	struct mrpt::math::TPose3D getLastPose(const unsigned long a0, bool & a1) const override {
		pybind11::gil_scoped_acquire gil;
	...
	double PF_SLAM_computeObservationLikelihoodForParticle(const struct mrpt::bayes::CParticleFilter::TParticleFilterOptions & a0, const unsigned long a1, const class mrpt::obs::CSensoryFrame & a2, const class mrpt::poses::CPose3D & a3) const override {
		pybind11::gil_scoped_acquire gil;
...
void bind_mrpt_slam_TKLDParams(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::slam::PF_implementation file:mrpt/slam/PF_implementations_data.h line:37
		...
		cl.def("getLastPose", (struct mrpt::math::TPose3D (mrpt::slam::PF_implementation<mrpt::maps::CRBPFParticleData,mrpt::maps::CMultiMetricMapPDF,mrpt::bayes::particle_storage_mode::POINTER>::*)(const unsigned long, bool &) const) &mrpt::slam::PF_implementation<mrpt::maps::CRBPFParticleData, mrpt::maps::CMultiMetricMapPDF, mrpt::bayes::particle_storage_mode::POINTER>::getLastPose, "C++: mrpt::slam::PF_implementation<mrpt::maps::CRBPFParticleData, mrpt::maps::CMultiMetricMapPDF, mrpt::bayes::particle_storage_mode::POINTER>::getLastPose(const unsigned long, bool &) const --> struct mrpt::math::TPose3D", pybind11::arg("i"), pybind11::arg("is_valid_pose"));
		...
		cl.def("PF_SLAM_computeObservationLikelihoodForParticle", (double (mrpt::slam::PF_implementation<mrpt::maps::CRBPFParticleData,mrpt::maps::CMultiMetricMapPDF,mrpt::bayes::particle_storage_mode::POINTER>::*)(const struct mrpt::bayes::CParticleFilter::TParticleFilterOptions &, const unsigned long, const class mrpt::obs::CSensoryFrame &, const class mrpt::poses::CPose3D &) const) &mrpt::slam::PF_implementation<mrpt::maps::CRBPFParticleData, mrpt::maps::CMultiMetricMapPDF, mrpt::bayes::particle_storage_mode::POINTER>::PF_SLAM_computeObservationLikelihoodForParticle, "C++: mrpt::slam::PF_implementation<mrpt::maps::CRBPFParticleData, mrpt::maps::CMultiMetricMapPDF, mrpt::bayes::particle_storage_mode::POINTER>::PF_SLAM_computeObservationLikelihoodForParticle(const struct mrpt::bayes::CParticleFilter::TParticleFilterOptions &, const unsigned long, const class mrpt::obs::CSensoryFrame &, const class mrpt::poses::CPose3D &) const --> double", pybind11::arg("PF_options"), pybind11::arg("particleIndexForMap"), pybind11::arg("observation"), pybind11::arg("x"));
	...
	{ // mrpt::slam::PF_implementation file:mrpt/slam/PF_implementations_data.h line:37
		...
		cl.def("PF_SLAM_computeObservationLikelihoodForParticle", (double (mrpt::slam::PF_implementation<mrpt::math::TPose2D,mrpt::slam::CMonteCarloLocalization2D,mrpt::bayes::particle_storage_mode::VALUE>::*)(const struct mrpt::bayes::CParticleFilter::TParticleFilterOptions &, const unsigned long, const class mrpt::obs::CSensoryFrame &, const class mrpt::poses::CPose3D &) const) &mrpt::slam::PF_implementation<mrpt::math::TPose2D, mrpt::slam::CMonteCarloLocalization2D, mrpt::bayes::particle_storage_mode::VALUE>::PF_SLAM_computeObservationLikelihoodForParticle, "C++: mrpt::slam::PF_implementation<mrpt::math::TPose2D, mrpt::slam::CMonteCarloLocalization2D, mrpt::bayes::particle_storage_mode::VALUE>::PF_SLAM_computeObservationLikelihoodForParticle(const struct mrpt::bayes::CParticleFilter::TParticleFilterOptions &, const unsigned long, const class mrpt::obs::CSensoryFrame &, const class mrpt::poses::CPose3D &) const --> double", pybind11::arg("PF_options"), pybind11::arg("particleIndexForMap"), pybind11::arg("observation"), pybind11::arg("x"));
