...
;
	...
	{ // mrpt::slam::CIncrementalMapPartitioner file:mrpt/slam/CIncrementalMapPartitioner.h line:56
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<38> (*)()) &mrpt::slam::CIncrementalMapPartitioner::getClassName, "C++: mrpt::slam::CIncrementalMapPartitioner::getClassName() --> class mrpt::typemeta::string_literal<38>");
		...
		cl.def("addMapFrame", (unsigned int (mrpt::slam::CIncrementalMapPartitioner::*)(const class mrpt::obs::CSensoryFrame &, const class mrpt::poses::CPose3DPDF &)) &mrpt::slam::CIncrementalMapPartitioner::addMapFrame, "Insert a new keyframe to the graph.\n\n Call this method each time a new observation is added to the map/graph.\n Afterwards, call updatePartitions() to get the updated partitions.\n\n \n The sensed data\n \n\n An estimation of the robot global pose.\n\n \n The index of the new pose in the graph, which can be used to\n refer to this pose in the future.\n\n \n updatePartitions\n\nC++: mrpt::slam::CIncrementalMapPartitioner::addMapFrame(const class mrpt::obs::CSensoryFrame &, const class mrpt::poses::CPose3DPDF &) --> unsigned int", pybind11::arg("frame"), pybind11::arg("robotPose3D"));
		cl.def("getNodesCount", (unsigned long (mrpt::slam::CIncrementalMapPartitioner::*)()) &mrpt::slam::CIncrementalMapPartitioner::getNodesCount, "Get the total node count currently in the internal map/graph. \n\nC++: mrpt::slam::CIncrementalMapPartitioner::getNodesCount() --> unsigned long");
		...
		cl.def("getAs3DScene", (void (mrpt::slam::CIncrementalMapPartitioner::*)(class std::shared_ptr<class mrpt::opengl::CSetOfObjects> &, const class std::map<unsigned int, long, struct std::less<unsigned int>, class std::allocator<struct std::pair<const unsigned int, long> > > *) const) &mrpt::slam::CIncrementalMapPartitioner::getAs3DScene, "@{ \n\nReturn a 3D representation of the graph: poses & links between them.\n The previous contents of \"objs\" will be discarded\n\nC++: mrpt::slam::CIncrementalMapPartitioner::getAs3DScene(class std::shared_ptr<class mrpt::opengl::CSetOfObjects> &, const class std::map<unsigned int, long, struct std::less<unsigned int>, class std::allocator<struct std::pair<const unsigned int, long> > > *) const --> void", pybind11::arg("objs"), pybind11::arg("renameIndexes"));
