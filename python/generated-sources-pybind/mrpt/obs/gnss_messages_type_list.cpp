...
;
	...
	{ // mrpt::obs::gnss::UTC_time file: line:194
		...
		cl.def("getAsTimestamp", (struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > (mrpt::obs::gnss::UTC_time::*)(const struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &) const) &mrpt::obs::gnss::UTC_time::getAsTimestamp, "Build an MRPT timestamp with the hour/minute/sec of this structure and\n the date from the given timestamp. \n\nC++: mrpt::obs::gnss::UTC_time::getAsTimestamp(const struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &) const --> struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >", pybind11::arg("date"));
