...
void bind_mrpt_obs_CSensoryFrame(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::obs::CSensoryFrame file:mrpt/obs/CSensoryFrame.h line:51
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<24> (*)()) &mrpt::obs::CSensoryFrame::getClassName, "C++: mrpt::obs::CSensoryFrame::getClassName() --> class mrpt::typemeta::string_literal<24>");
		...
		cl.def("size", (unsigned long (mrpt::obs::CSensoryFrame::*)() const) &mrpt::obs::CSensoryFrame::size, "Returns the number of observations in the list. \n\nC++: mrpt::obs::CSensoryFrame::size() const --> unsigned long");
		...
		cl.def("eraseByIndex", (void (mrpt::obs::CSensoryFrame::*)(unsigned long)) &mrpt::obs::CSensoryFrame::eraseByIndex, "Removes the i'th observation in the list (0=first). \n\nC++: mrpt::obs::CSensoryFrame::eraseByIndex(unsigned long) --> void", pybind11::arg("idx"));
		...
		cl.def("getObservationByIndex", (class std::shared_ptr<class mrpt::obs::CObservation> & (mrpt::obs::CSensoryFrame::*)(unsigned long)) &mrpt::obs::CSensoryFrame::getObservationByIndex, "C++: mrpt::obs::CSensoryFrame::getObservationByIndex(unsigned long) --> class std::shared_ptr<class mrpt::obs::CObservation> &", pybind11::return_value_policy::automatic, pybind11::arg("idx"));
		...
		cl.def("getObservationBySensorLabel", (class std::shared_ptr<class mrpt::obs::CObservation> (mrpt::obs::CSensoryFrame::*)(const std::string &, unsigned long) const) &mrpt::obs::CSensoryFrame::getObservationBySensorLabel, "Returns the i'th observation in the list with the given \"sensorLabel\"\n (0=first).\n \n\n The observation, or nullptr if not found.\n \n\n begin, size\n\nC++: mrpt::obs::CSensoryFrame::getObservationBySensorLabel(const std::string &, unsigned long) const --> class std::shared_ptr<class mrpt::obs::CObservation>", pybind11::arg("label"), pybind11::arg("idx"));
