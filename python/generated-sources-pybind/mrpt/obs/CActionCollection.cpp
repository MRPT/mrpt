...
void bind_mrpt_obs_CActionCollection(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::obs::CActionCollection file:mrpt/obs/CActionCollection.h line:26
		...
		cl.def("get", (class std::shared_ptr<class mrpt::obs::CAction> (mrpt::obs::CActionCollection::*)(unsigned long)) &mrpt::obs::CActionCollection::get, "Access the i'th action.DO NOT MODIFY the returned object, make a copy of\n ir with \"CSerializable::duplicate\" if desired.\n  First element is 0.\n \n\n std::exception On index out of bounds.\n\nC++: mrpt::obs::CActionCollection::get(unsigned long) --> class std::shared_ptr<class mrpt::obs::CAction>", pybind11::arg("index"));
		...
		cl.def("size", (unsigned long (mrpt::obs::CActionCollection::*)() const) &mrpt::obs::CActionCollection::size, "Returns the actions count in the collection.\n\nC++: mrpt::obs::CActionCollection::size() const --> unsigned long");
		...
		cl.def("eraseByIndex", (void (mrpt::obs::CActionCollection::*)(unsigned long)) &mrpt::obs::CActionCollection::eraseByIndex, "Remove an action from the list by its index.\n \n\n std::exception On index out of bounds.\n\nC++: mrpt::obs::CActionCollection::eraseByIndex(unsigned long) --> void", pybind11::arg("index"));
