...
struct PyCallBack_mrpt_obs_CObservationGasSensors : public mrpt::obs::CObservationGasSensors {
	...
	void load() const override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::obs::CObservationGasSensors *>(this), "load");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>();
			if (pybind11::detail::cast_is_temporary_value_reference<void>::value) {
				static pybind11::detail::override_caster_t<void> caster;
...
void bind_mrpt_obs_CObservationGasSensors(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::obs::CObservationGasSensors file:mrpt/obs/CObservationGasSensors.h line:24
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<33> (*)()) &mrpt::obs::CObservationGasSensors::getClassName, "C++: mrpt::obs::CObservationGasSensors::getClassName() --> class mrpt::typemeta::string_literal<33>");
