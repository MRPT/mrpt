...
void bind_mrpt_obs_CObservation(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::obs::CObservation file:mrpt/obs/CObservation.h line:46
		...
		cl.def("getTimeStamp", (struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > (mrpt::obs::CObservation::*)() const) &mrpt::obs::CObservation::getTimeStamp, "Returns CObservation::timestamp for all kind of observations \n\n getOriginalReceivedTimeStamp() \n\nC++: mrpt::obs::CObservation::getTimeStamp() const --> struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >");
		cl.def("getOriginalReceivedTimeStamp", (struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > (mrpt::obs::CObservation::*)() const) &mrpt::obs::CObservation::getOriginalReceivedTimeStamp, "By default, returns CObservation::timestamp but in sensors capable of\n satellite (or otherwise) accurate UTC timing of readings, this contains\n the computer-based timestamp of reception, which may be slightly\n different than  \n\n getTimeStamp()  \n\nC++: mrpt::obs::CObservation::getOriginalReceivedTimeStamp() const --> struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >");
