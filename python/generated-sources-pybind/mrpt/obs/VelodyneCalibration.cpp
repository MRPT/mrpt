...
struct PyCallBack_mrpt_obs_CObservationVelodyneScan : public mrpt::obs::CObservationVelodyneScan {
	...
	void load() const override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::obs::CObservationVelodyneScan *>(this), "load");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>();
			if (pybind11::detail::cast_is_temporary_value_reference<void>::value) {
				static pybind11::detail::override_caster_t<void> caster;
...
void bind_mrpt_obs_VelodyneCalibration(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::obs::CObservationVelodyneScan file:mrpt/obs/CObservationVelodyneScan.h line:82
		...
		cl.def("getOriginalReceivedTimeStamp", (struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > (mrpt::obs::CObservationVelodyneScan::*)() const) &mrpt::obs::CObservationVelodyneScan::getOriginalReceivedTimeStamp, "C++: mrpt::obs::CObservationVelodyneScan::getOriginalReceivedTimeStamp() const --> struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > >");
		...
		{ // mrpt::obs::CObservationVelodyneScan::laser_return_t file:mrpt/obs/CObservationVelodyneScan.h line:123
			...
			cl.def("distance", (unsigned short (mrpt::obs::CObservationVelodyneScan::laser_return_t::*)() const) &mrpt::obs::CObservationVelodyneScan::laser_return_t::distance, "C++: mrpt::obs::CObservationVelodyneScan::laser_return_t::distance() const --> unsigned short");
			cl.def("intensity", (unsigned char (mrpt::obs::CObservationVelodyneScan::laser_return_t::*)() const) &mrpt::obs::CObservationVelodyneScan::laser_return_t::intensity, "C++: mrpt::obs::CObservationVelodyneScan::laser_return_t::intensity() const --> unsigned char");
		}
		...
		{ // mrpt::obs::CObservationVelodyneScan::raw_block_t file:mrpt/obs/CObservationVelodyneScan.h line:139
			...
			cl.def("header", (unsigned short (mrpt::obs::CObservationVelodyneScan::raw_block_t::*)() const) &mrpt::obs::CObservationVelodyneScan::raw_block_t::header, "C++: mrpt::obs::CObservationVelodyneScan::raw_block_t::header() const --> unsigned short");
			cl.def("rotation", (unsigned short (mrpt::obs::CObservationVelodyneScan::raw_block_t::*)() const) &mrpt::obs::CObservationVelodyneScan::raw_block_t::rotation, "C++: mrpt::obs::CObservationVelodyneScan::raw_block_t::rotation() const --> unsigned short");
		}
		...
		{ // mrpt::obs::CObservationVelodyneScan::TVelodyneRawPacket file:mrpt/obs/CObservationVelodyneScan.h line:159
			...
			cl.def("gps_timestamp", (unsigned int (mrpt::obs::CObservationVelodyneScan::TVelodyneRawPacket::*)() const) &mrpt::obs::CObservationVelodyneScan::TVelodyneRawPacket::gps_timestamp, "C++: mrpt::obs::CObservationVelodyneScan::TVelodyneRawPacket::gps_timestamp() const --> unsigned int");
		}
		...
		{ // mrpt::obs::CObservationVelodyneScan::TVelodynePositionPacket file:mrpt/obs/CObservationVelodyneScan.h line:181
			...
			cl.def("gps_timestamp", (unsigned int (mrpt::obs::CObservationVelodyneScan::TVelodynePositionPacket::*)() const) &mrpt::obs::CObservationVelodyneScan::TVelodynePositionPacket::gps_timestamp, "C++: mrpt::obs::CObservationVelodyneScan::TVelodynePositionPacket::gps_timestamp() const --> unsigned int");
			cl.def("unused2", (unsigned int (mrpt::obs::CObservationVelodyneScan::TVelodynePositionPacket::*)() const) &mrpt::obs::CObservationVelodyneScan::TVelodynePositionPacket::unused2, "C++: mrpt::obs::CObservationVelodyneScan::TVelodynePositionPacket::unused2() const --> unsigned int");
		}
		...
		{ // mrpt::obs::CObservationVelodyneScan::TPointCloud file:mrpt/obs/CObservationVelodyneScan.h line:232
			...
			cl.def("size", (unsigned long (mrpt::obs::CObservationVelodyneScan::TPointCloud::*)() const) &mrpt::obs::CObservationVelodyneScan::TPointCloud::size, "C++: mrpt::obs::CObservationVelodyneScan::TPointCloud::size() const --> unsigned long");
			cl.def("reserve", (void (mrpt::obs::CObservationVelodyneScan::TPointCloud::*)(unsigned long)) &mrpt::obs::CObservationVelodyneScan::TPointCloud::reserve, "C++: mrpt::obs::CObservationVelodyneScan::TPointCloud::reserve(unsigned long) --> void", pybind11::arg("n"));
		...
		{ // mrpt::obs::CObservationVelodyneScan::PointCloudStorageWrapper file:mrpt/obs/CObservationVelodyneScan.h line:321
			...
			cl.def("reserve", (void (mrpt::obs::CObservationVelodyneScan::PointCloudStorageWrapper::*)(unsigned long)) &mrpt::obs::CObservationVelodyneScan::PointCloudStorageWrapper::reserve, "C++: mrpt::obs::CObservationVelodyneScan::PointCloudStorageWrapper::reserve(unsigned long) --> void", pybind11::arg("n"));
			cl.def("resizeLaserCount", (void (mrpt::obs::CObservationVelodyneScan::PointCloudStorageWrapper::*)(unsigned long)) &mrpt::obs::CObservationVelodyneScan::PointCloudStorageWrapper::resizeLaserCount, "C++: mrpt::obs::CObservationVelodyneScan::PointCloudStorageWrapper::resizeLaserCount(unsigned long) --> void", pybind11::arg("n"));
			cl.def("add_point", (void (mrpt::obs::CObservationVelodyneScan::PointCloudStorageWrapper::*)(float, float, float, unsigned char, const struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &, const float, unsigned short)) &mrpt::obs::CObservationVelodyneScan::PointCloudStorageWrapper::add_point, "Process the insertion of a new (x,y,z) point to the cloud, in\n sensor-centric coordinates, with the exact timestamp of that LIDAR\n ray \n\nC++: mrpt::obs::CObservationVelodyneScan::PointCloudStorageWrapper::add_point(float, float, float, unsigned char, const struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &, const float, unsigned short) --> void", pybind11::arg("pt_x"), pybind11::arg("pt_y"), pybind11::arg("pt_z"), pybind11::arg("pt_intensity"), pybind11::arg("tim"), pybind11::arg("azimuth"), pybind11::arg("laser_id"));
