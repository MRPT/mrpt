...
void bind_mrpt_obs_CObservationGPS(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::obs::CObservationGPS file:mrpt/obs/CObservationGPS.h line:68
		...
		cl.def_static("GPS_time_to_UTC", (bool (*)(uint16_t, double, const int, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &)) &mrpt::obs::CObservationGPS::GPS_time_to_UTC, "@{ \n\nC++: mrpt::obs::CObservationGPS::GPS_time_to_UTC(uint16_t, double, const int, struct std::chrono::time_point<class mrpt::Clock, struct std::chrono::duration<long, struct std::ratio<1, 10000000> > > &) --> bool", pybind11::arg("gps_week"), pybind11::arg("gps_sec"), pybind11::arg("leap_seconds_count"), pybind11::arg("utc_out"));
