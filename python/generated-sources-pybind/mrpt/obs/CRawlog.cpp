...
void bind_mrpt_obs_CRawlog(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::obs::CRawlog file:mrpt/obs/CRawlog.h line:60
		...
		cl.def_static("getClassName", (auto (*)()) &mrpt::obs::CRawlog::getClassName, "C++: mrpt::obs::CRawlog::getClassName() --> auto");
		...
		cl.def("findObservationsByClassInRange", [](mrpt::obs::CRawlog const &o, mrpt::Clock::time_point const & a0, mrpt::Clock::time_point const & a1, const struct mrpt::rtti::TRuntimeClassId * a2, int & a3) -> void { return o.findObservationsByClassInRange(a0, a1, a2, a3); }, "", pybind11::arg("time_start"), pybind11::arg("time_end"), pybind11::arg("class_type"), pybind11::arg("out_found"));
		cl.def("findObservationsByClassInRange", (void (mrpt::obs::CRawlog::*)(mrpt::Clock::time_point, mrpt::Clock::time_point, const struct mrpt::rtti::TRuntimeClassId *, int &, size_t) const) &mrpt::obs::CRawlog::findObservationsByClassInRange, "Returns the sub-set of observations of a given class whose time-stamp t\n fulfills  time_start <= t < time_end.\n  This method requires the timestamps of the sensors to be in strict\n ascending order (which should be the normal situation).\n   Otherwise, the output is undeterminate.\n \n\n findClosestObservationsByClass\n\nC++: mrpt::obs::CRawlog::findObservationsByClassInRange(mrpt::Clock::time_point, mrpt::Clock::time_point, const struct mrpt::rtti::TRuntimeClassId *, int &, size_t) const --> void", pybind11::arg("time_start"), pybind11::arg("time_end"), pybind11::arg("class_type"), pybind11::arg("out_found"), pybind11::arg("guess_start_position"));
		...
		{ // mrpt::obs::CRawlog::iterator file:mrpt/obs/CRawlog.h line:230
			...
			cl.def( pybind11::init<const int &>(), pybind11::arg("it") );
