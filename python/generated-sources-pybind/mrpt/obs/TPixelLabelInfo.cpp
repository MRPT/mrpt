...
// mrpt::obs::CObservation3DRangeScan file:mrpt/obs/CObservation3DRangeScan.h line:148
struct PyCallBack_mrpt_obs_CObservation3DRangeScan : public mrpt::obs::CObservation3DRangeScan {
	...
	void load() const override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::obs::CObservation3DRangeScan *>(this), "load");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>();
			if (pybind11::detail::cast_is_temporary_value_reference<void>::value) {
				static pybind11::detail::override_caster_t<void> caster;
		...
		return CObservation3DRangeScan::load();
	}
...
void bind_mrpt_obs_TPixelLabelInfo(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::obs::TPixelLabelInfoBase file:mrpt/obs/TPixelLabelInfo.h line:25
		...
		cl.def("setLabel", (void (mrpt::obs::TPixelLabelInfoBase::*)(const int, const int, unsigned char)) &mrpt::obs::TPixelLabelInfoBase::setLabel, "Mark the pixel(row,col) as classified in the category \n which may be in the range 0 to MAX_NUM_LABELS-1\n Note that 0 is a valid label index, it does not mean \"no label\" \n\n\n unsetLabel, unsetAll \n\nC++: mrpt::obs::TPixelLabelInfoBase::setLabel(const int, const int, unsigned char) --> void", pybind11::arg("row"), pybind11::arg("col"), pybind11::arg("label_idx"));
		...
		cl.def("unsetLabel", (void (mrpt::obs::TPixelLabelInfoBase::*)(const int, const int, unsigned char)) &mrpt::obs::TPixelLabelInfoBase::unsetLabel, "For the pixel(row,col), removes its classification into the category\n  which may be in the range 0 to 7\n Note that 0 is a valid label index, it does not mean \"no label\" \n\n\n setLabel, unsetAll \n\nC++: mrpt::obs::TPixelLabelInfoBase::unsetLabel(const int, const int, unsigned char) --> void", pybind11::arg("row"), pybind11::arg("col"), pybind11::arg("label_idx"));
		cl.def("unsetAll", (void (mrpt::obs::TPixelLabelInfoBase::*)(const int, const int, unsigned char)) &mrpt::obs::TPixelLabelInfoBase::unsetAll, "Removes all categories for pixel(row,col)  \n setLabel, unsetLabel\n\nC++: mrpt::obs::TPixelLabelInfoBase::unsetAll(const int, const int, unsigned char) --> void", pybind11::arg("row"), pybind11::arg("col"), pybind11::arg("label_idx"));
		cl.def("checkLabel", (bool (mrpt::obs::TPixelLabelInfoBase::*)(const int, const int, unsigned char) const) &mrpt::obs::TPixelLabelInfoBase::checkLabel, "Checks whether pixel(row,col) has been clasified into category \n which may be in the range 0 to 7\n \n\n unsetLabel, unsetAll \n\nC++: mrpt::obs::TPixelLabelInfoBase::checkLabel(const int, const int, unsigned char) const --> bool", pybind11::arg("row"), pybind11::arg("col"), pybind11::arg("label_idx"));
	...
	{ // mrpt::obs::TRangeImageFilter file:mrpt/obs/TRangeImageFilter.h line:48
		...
		cl.def("do_range_filter", (bool (mrpt::obs::TRangeImageFilter::*)(unsigned long, unsigned long, const float) const) &mrpt::obs::TRangeImageFilter::do_range_filter, "Returns true if the point (r,c) with depth D passes all filters. \n\nC++: mrpt::obs::TRangeImageFilter::do_range_filter(unsigned long, unsigned long, const float) const --> bool", pybind11::arg("r"), pybind11::arg("c"), pybind11::arg("D"));
	}
	{ // mrpt::obs::CObservation3DRangeScan file:mrpt/obs/CObservation3DRangeScan.h line:148
		...
		cl.def("resizePoints3DVectors", (void (mrpt::obs::CObservation3DRangeScan::*)(const unsigned long)) &mrpt::obs::CObservation3DRangeScan::resizePoints3DVectors, "Use this method instead of resizing all three  \n &  to allow the usage of the internal memory\n pool. \n\nC++: mrpt::obs::CObservation3DRangeScan::resizePoints3DVectors(const unsigned long) --> void", pybind11::arg("nPoints"));
		cl.def("getScanSize", (unsigned long (mrpt::obs::CObservation3DRangeScan::*)() const) &mrpt::obs::CObservation3DRangeScan::getScanSize, "Get the size of the scan pointcloud. \n Method is added for\n compatibility with its CObservation2DRangeScan counterpart \n\nC++: mrpt::obs::CObservation3DRangeScan::getScanSize() const --> unsigned long");
		...
		{ // mrpt::obs::CObservation3DRangeScan::unproject_LUT_t file:mrpt/obs/CObservation3DRangeScan.h line:569
