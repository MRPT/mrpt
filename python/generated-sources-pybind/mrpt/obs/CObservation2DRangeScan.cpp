...
struct PyCallBack_mrpt_obs_CObservation2DRangeScan : public mrpt::obs::CObservation2DRangeScan {
	...
	void load() const override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::obs::CObservation2DRangeScan *>(this), "load");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>();
			if (pybind11::detail::cast_is_temporary_value_reference<void>::value) {
				static pybind11::detail::override_caster_t<void> caster;
...
void bind_mrpt_obs_CObservation2DRangeScan(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::obs::CObservation2DRangeScan file:mrpt/obs/CObservation2DRangeScan.h line:55
		...
		cl.def("resizeScan", (void (mrpt::obs::CObservation2DRangeScan::*)(const unsigned long)) &mrpt::obs::CObservation2DRangeScan::resizeScan, "		@{ \n\n Resizes all data vectors to allocate a given number of scan rays \n\nC++: mrpt::obs::CObservation2DRangeScan::resizeScan(const unsigned long) --> void", pybind11::arg("len"));
		cl.def("resizeScanAndAssign", [](mrpt::obs::CObservation2DRangeScan &o, const unsigned long & a0, const float & a1, const bool & a2) -> void { return o.resizeScanAndAssign(a0, a1, a2); }, "", pybind11::arg("len"), pybind11::arg("rangeVal"), pybind11::arg("rangeValidity"));
		cl.def("resizeScanAndAssign", (void (mrpt::obs::CObservation2DRangeScan::*)(const unsigned long, const float, const bool, const int)) &mrpt::obs::CObservation2DRangeScan::resizeScanAndAssign, "Resizes all data vectors to allocate a given number of scan rays and\n assign default values. \n\nC++: mrpt::obs::CObservation2DRangeScan::resizeScanAndAssign(const unsigned long, const float, const bool, const int) --> void", pybind11::arg("len"), pybind11::arg("rangeVal"), pybind11::arg("rangeValidity"), pybind11::arg("rangeIntensity"));
		cl.def("getScanSize", (unsigned long (mrpt::obs::CObservation2DRangeScan::*)() const) &mrpt::obs::CObservation2DRangeScan::getScanSize, "Get number of scan rays \n\nC++: mrpt::obs::CObservation2DRangeScan::getScanSize() const --> unsigned long");
		cl.def("getScanRange", (float & (mrpt::obs::CObservation2DRangeScan::*)(const unsigned long)) &mrpt::obs::CObservation2DRangeScan::getScanRange, "C++: mrpt::obs::CObservation2DRangeScan::getScanRange(const unsigned long) --> float &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("setScanRange", (void (mrpt::obs::CObservation2DRangeScan::*)(const unsigned long, const float)) &mrpt::obs::CObservation2DRangeScan::setScanRange, "C++: mrpt::obs::CObservation2DRangeScan::setScanRange(const unsigned long, const float) --> void", pybind11::arg("i"), pybind11::arg("val"));
		cl.def("getScanIntensity", (int & (mrpt::obs::CObservation2DRangeScan::*)(const unsigned long)) &mrpt::obs::CObservation2DRangeScan::getScanIntensity, "C++: mrpt::obs::CObservation2DRangeScan::getScanIntensity(const unsigned long) --> int &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("setScanIntensity", (void (mrpt::obs::CObservation2DRangeScan::*)(const unsigned long, const int)) &mrpt::obs::CObservation2DRangeScan::setScanIntensity, "C++: mrpt::obs::CObservation2DRangeScan::setScanIntensity(const unsigned long, const int) --> void", pybind11::arg("i"), pybind11::arg("val"));
		cl.def("getScanRangeValidity", (bool (mrpt::obs::CObservation2DRangeScan::*)(const unsigned long) const) &mrpt::obs::CObservation2DRangeScan::getScanRangeValidity, "It's false (=0) on no reflected rays, referenced to elements in \n	 \n\nC++: mrpt::obs::CObservation2DRangeScan::getScanRangeValidity(const unsigned long) const --> bool", pybind11::arg("i"));
		cl.def("setScanRangeValidity", (void (mrpt::obs::CObservation2DRangeScan::*)(const unsigned long, const bool)) &mrpt::obs::CObservation2DRangeScan::setScanRangeValidity, "C++: mrpt::obs::CObservation2DRangeScan::setScanRangeValidity(const unsigned long, const bool) --> void", pybind11::arg("i"), pybind11::arg("val"));
		cl.def("getScanAngle", (float (mrpt::obs::CObservation2DRangeScan::*)(const unsigned long) const) &mrpt::obs::CObservation2DRangeScan::getScanAngle, "Returns the computed direction (relative heading in radians, with\n 0=forward) of the given ray index, following the following formula:\n \n\n\n\n\n\n\n\n\n\n\n \n Index of the ray, from `0` to `size()-1`.\n\n \n (New in MRPT 2.3.1)\n\nC++: mrpt::obs::CObservation2DRangeScan::getScanAngle(const unsigned long) const --> float", pybind11::arg("idx"));
		...
		cl.def("loadFromVectors", (void (mrpt::obs::CObservation2DRangeScan::*)(unsigned long, const float *, const char *)) &mrpt::obs::CObservation2DRangeScan::loadFromVectors, "@} \n\nC++: mrpt::obs::CObservation2DRangeScan::loadFromVectors(unsigned long, const float *, const char *) --> void", pybind11::arg("nRays"), pybind11::arg("scanRanges"), pybind11::arg("scanValidity"));
