...
void bind_mrpt_obs_CObservationStereoImagesFeatures(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::obs::CRawlog file:mrpt/obs/CRawlog.h line:60
		...
		cl.def("size", (unsigned long (mrpt::obs::CRawlog::*)() const) &mrpt::obs::CRawlog::size, "Returns the number of actions / observations object in the sequence. \n\nC++: mrpt::obs::CRawlog::size() const --> unsigned long");
		cl.def("getType", (enum mrpt::obs::CRawlog::TEntryType (mrpt::obs::CRawlog::*)(unsigned long) const) &mrpt::obs::CRawlog::getType, "Returns the type of a given element.\n \n\n isAction, isObservation\n\nC++: mrpt::obs::CRawlog::getType(unsigned long) const --> enum mrpt::obs::CRawlog::TEntryType", pybind11::arg("index"));
		cl.def("remove", (void (mrpt::obs::CRawlog::*)(unsigned long)) &mrpt::obs::CRawlog::remove, "Delete the action or observation stored in the given index.\n \n\n std::exception If index is out of bounds\n\nC++: mrpt::obs::CRawlog::remove(unsigned long) --> void", pybind11::arg("index"));
		cl.def("remove", (void (mrpt::obs::CRawlog::*)(unsigned long, unsigned long)) &mrpt::obs::CRawlog::remove, "Delete the elements stored in the given range of indices (including both\n the first and last one).\n \n\n std::exception If any index is out of bounds\n\nC++: mrpt::obs::CRawlog::remove(unsigned long, unsigned long) --> void", pybind11::arg("first_index"), pybind11::arg("last_index"));
		cl.def("getAsAction", (class std::shared_ptr<class mrpt::obs::CActionCollection> (mrpt::obs::CRawlog::*)(unsigned long) const) &mrpt::obs::CRawlog::getAsAction, "Returns the i'th element in the sequence, as being actions, where\n index=0 is the first object.\n  If it is not a CActionCollection, it throws an exception. Do neighter\n modify nor delete the returned pointer.\n \n\n size, isAction, getAsObservations, getAsObservation\n \n\n std::exception If index is out of bounds\n\nC++: mrpt::obs::CRawlog::getAsAction(unsigned long) const --> class std::shared_ptr<class mrpt::obs::CActionCollection>", pybind11::arg("index"));
		cl.def("getAsObservations", (class std::shared_ptr<class mrpt::obs::CSensoryFrame> (mrpt::obs::CRawlog::*)(unsigned long) const) &mrpt::obs::CRawlog::getAsObservations, "Returns the i'th element in the sequence, as being an action, where\n index=0 is the first object.\n  If it is not an CSensoryFrame, it throws an exception.\n \n\n size, isAction, getAsAction, getAsObservation\n \n\n std::exception If index is out of bounds\n\nC++: mrpt::obs::CRawlog::getAsObservations(unsigned long) const --> class std::shared_ptr<class mrpt::obs::CSensoryFrame>", pybind11::arg("index"));
		cl.def("getAsGeneric", (class std::shared_ptr<class mrpt::serialization::CSerializable> (mrpt::obs::CRawlog::*)(unsigned long) const) &mrpt::obs::CRawlog::getAsGeneric, "Returns the i'th element in the sequence, being its class whatever.\n \n\n size, isAction, getAsAction, getAsObservations\n \n\n std::exception If index is out of bounds\n\nC++: mrpt::obs::CRawlog::getAsGeneric(unsigned long) const --> class std::shared_ptr<class mrpt::serialization::CSerializable>", pybind11::arg("index"));
		cl.def("getAsObservation", (class std::shared_ptr<class mrpt::obs::CObservation> (mrpt::obs::CRawlog::*)(unsigned long) const) &mrpt::obs::CRawlog::getAsObservation, "Returns the i'th element in the sequence, as being an observation, where\n index=0 is the first object.\n  If it is not an CObservation, it throws an exception. Do neighter\n modify nor delete the returned pointer.\n  This is the proper method to obtain the objects stored in a \"only\n observations\"-rawlog file (named \"format #2\" above.\n \n\n size, isAction, getAsAction\n \n\n std::exception If index is out of bounds\n\nC++: mrpt::obs::CRawlog::getAsObservation(unsigned long) const --> class std::shared_ptr<class mrpt::obs::CObservation>", pybind11::arg("index"));
		cl.def("begin", (class mrpt::obs::CRawlog::iterator (mrpt::obs::CRawlog::*)()) &mrpt::obs::CRawlog::begin, "C++: mrpt::obs::CRawlog::begin() --> class mrpt::obs::CRawlog::iterator");
		cl.def("end", (class mrpt::obs::CRawlog::iterator (mrpt::obs::CRawlog::*)()) &mrpt::obs::CRawlog::end, "C++: mrpt::obs::CRawlog::end() --> class mrpt::obs::CRawlog::iterator");
		cl.def("erase", (class mrpt::obs::CRawlog::iterator (mrpt::obs::CRawlog::*)(const class mrpt::obs::CRawlog::iterator &)) &mrpt::obs::CRawlog::erase, "C++: mrpt::obs::CRawlog::erase(const class mrpt::obs::CRawlog::iterator &) --> class mrpt::obs::CRawlog::iterator", pybind11::arg("it"));
		...
		{ // mrpt::obs::CRawlog::iterator file:mrpt/obs/CRawlog.h line:230
			...
			cl.def( pybind11::init( [](mrpt::obs::CRawlog::iterator const &o){ return new mrpt::obs::CRawlog::iterator(o); } ) );
			cl.def("assign", (class mrpt::obs::CRawlog::iterator & (mrpt::obs::CRawlog::iterator::*)(const class mrpt::obs::CRawlog::iterator &)) &mrpt::obs::CRawlog::iterator::operator=, "C++: mrpt::obs::CRawlog::iterator::operator=(const class mrpt::obs::CRawlog::iterator &) --> class mrpt::obs::CRawlog::iterator &", pybind11::return_value_policy::automatic, pybind11::arg("o"));
			cl.def("__eq__", (bool (mrpt::obs::CRawlog::iterator::*)(const class mrpt::obs::CRawlog::iterator &)) &mrpt::obs::CRawlog::iterator::operator==, "C++: mrpt::obs::CRawlog::iterator::operator==(const class mrpt::obs::CRawlog::iterator &) --> bool", pybind11::arg("o"));
			cl.def("__ne__", (bool (mrpt::obs::CRawlog::iterator::*)(const class mrpt::obs::CRawlog::iterator &)) &mrpt::obs::CRawlog::iterator::operator!=, "C++: mrpt::obs::CRawlog::iterator::operator!=(const class mrpt::obs::CRawlog::iterator &) --> bool", pybind11::arg("o"));
			...
			cl.def("post_increment", (class mrpt::obs::CRawlog::iterator (mrpt::obs::CRawlog::iterator::*)(int)) &mrpt::obs::CRawlog::iterator::operator++, "C++: mrpt::obs::CRawlog::iterator::operator++(int) --> class mrpt::obs::CRawlog::iterator", pybind11::arg(""));
			cl.def("pre_increment", (class mrpt::obs::CRawlog::iterator & (mrpt::obs::CRawlog::iterator::*)()) &mrpt::obs::CRawlog::iterator::operator++, "C++: mrpt::obs::CRawlog::iterator::operator++() --> class mrpt::obs::CRawlog::iterator &", pybind11::return_value_policy::automatic);
			cl.def("post_decrement", (class mrpt::obs::CRawlog::iterator (mrpt::obs::CRawlog::iterator::*)(int)) &mrpt::obs::CRawlog::iterator::operator--, "C++: mrpt::obs::CRawlog::iterator::operator--(int) --> class mrpt::obs::CRawlog::iterator", pybind11::arg(""));
			cl.def("pre_decrement", (class mrpt::obs::CRawlog::iterator & (mrpt::obs::CRawlog::iterator::*)()) &mrpt::obs::CRawlog::iterator::operator--, "C++: mrpt::obs::CRawlog::iterator::operator--() --> class mrpt::obs::CRawlog::iterator &", pybind11::return_value_policy::automatic);
		...
		{ // mrpt::obs::CRawlog::const_iterator file:mrpt/obs/CRawlog.h line:286
			auto & enclosing_class = cl;
			...
			cl.def( pybind11::init( [](mrpt::obs::CRawlog::const_iterator const &o){ return new mrpt::obs::CRawlog::const_iterator(o); } ) );
			cl.def("__eq__", (bool (mrpt::obs::CRawlog::const_iterator::*)(const class mrpt::obs::CRawlog::const_iterator &)) &mrpt::obs::CRawlog::const_iterator::operator==, "C++: mrpt::obs::CRawlog::const_iterator::operator==(const class mrpt::obs::CRawlog::const_iterator &) --> bool", pybind11::arg("o"));
			cl.def("__ne__", (bool (mrpt::obs::CRawlog::const_iterator::*)(const class mrpt::obs::CRawlog::const_iterator &)) &mrpt::obs::CRawlog::const_iterator::operator!=, "C++: mrpt::obs::CRawlog::const_iterator::operator!=(const class mrpt::obs::CRawlog::const_iterator &) --> bool", pybind11::arg("o"));
			...
			cl.def("post_increment", (class mrpt::obs::CRawlog::const_iterator (mrpt::obs::CRawlog::const_iterator::*)(int)) &mrpt::obs::CRawlog::const_iterator::operator++, "C++: mrpt::obs::CRawlog::const_iterator::operator++(int) --> class mrpt::obs::CRawlog::const_iterator", pybind11::arg(""));
			cl.def("pre_increment", (class mrpt::obs::CRawlog::const_iterator & (mrpt::obs::CRawlog::const_iterator::*)()) &mrpt::obs::CRawlog::const_iterator::operator++, "C++: mrpt::obs::CRawlog::const_iterator::operator++() --> class mrpt::obs::CRawlog::const_iterator &", pybind11::return_value_policy::automatic);
			cl.def("post_decrement", (class mrpt::obs::CRawlog::const_iterator (mrpt::obs::CRawlog::const_iterator::*)(int)) &mrpt::obs::CRawlog::const_iterator::operator--, "C++: mrpt::obs::CRawlog::const_iterator::operator--(int) --> class mrpt::obs::CRawlog::const_iterator", pybind11::arg(""));
			cl.def("pre_decrement", (class mrpt::obs::CRawlog::const_iterator & (mrpt::obs::CRawlog::const_iterator::*)()) &mrpt::obs::CRawlog::const_iterator::operator--, "C++: mrpt::obs::CRawlog::const_iterator::operator--() --> class mrpt::obs::CRawlog::const_iterator &", pybind11::return_value_policy::automatic);
			...
			cl.def("assign", (class mrpt::obs::CRawlog::const_iterator & (mrpt::obs::CRawlog::const_iterator::*)(const class mrpt::obs::CRawlog::const_iterator &)) &mrpt::obs::CRawlog::const_iterator::operator=, "C++: mrpt::obs::CRawlog::const_iterator::operator=(const class mrpt::obs::CRawlog::const_iterator &) --> class mrpt::obs::CRawlog::const_iterator &", pybind11::return_value_policy::automatic, pybind11::arg(""));
		}
