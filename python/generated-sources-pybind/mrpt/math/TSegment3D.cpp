...
void bind_mrpt_math_TSegment3D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::TSegment3D file:mrpt/math/TSegment3D.h line:21
		...
		cl.def("__getitem__", (struct mrpt::math::TPoint3D_<double> & (mrpt::math::TSegment3D::*)(unsigned long)) &mrpt::math::TSegment3D::operator[], "Access to points using operator[0-1] \n\nC++: mrpt::math::TSegment3D::operator[](unsigned long) --> struct mrpt::math::TPoint3D_<double> &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
