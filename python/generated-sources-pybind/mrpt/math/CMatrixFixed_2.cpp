...
void bind_mrpt_math_CMatrixFixed_2(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 2, 1> (mrpt::math::CMatrixFixed<double,2UL,1UL>::*)() const) &mrpt::math::CMatrixFixed<double, 2, 1>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 2, 1>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 2, 1>");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 6, 1> (mrpt::math::CMatrixFixed<double,6UL,1UL>::*)() const) &mrpt::math::CMatrixFixed<double, 6, 1>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 6, 1>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 6, 1>");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 7, 1> (mrpt::math::CMatrixFixed<double,7UL,1UL>::*)() const) &mrpt::math::CMatrixFixed<double, 7, 1>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 7, 1>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 7, 1>");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 4, 1> (mrpt::math::CMatrixFixed<double,4UL,1UL>::*)() const) &mrpt::math::CMatrixFixed<double, 4, 1>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 4, 1>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 4, 1>");
