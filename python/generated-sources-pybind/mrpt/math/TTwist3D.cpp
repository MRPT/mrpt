...
void bind_mrpt_math_TTwist3D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::TTwist3D file:mrpt/math/TTwist3D.h line:19
		...
		cl.def("__getitem__", (double & (mrpt::math::TTwist3D::*)(unsigned long)) &mrpt::math::TTwist3D::operator[], "Coordinate access using operator[]. Order: vx,vy,vz, wx, wy, wz \n\nC++: mrpt::math::TTwist3D::operator[](unsigned long) --> double &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
