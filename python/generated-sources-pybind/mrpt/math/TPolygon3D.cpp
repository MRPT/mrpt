...
void bind_mrpt_math_TPolygon3D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::TPolygon3D file:mrpt/math/TPolygon3D.h line:23
		...
		cl.def_static("createRegularPolygon", (void (*)(unsigned long, double, class mrpt::math::TPolygon3D &)) &mrpt::math::TPolygon3D::createRegularPolygon, "C++: mrpt::math::TPolygon3D::createRegularPolygon(unsigned long, double, class mrpt::math::TPolygon3D &) --> void", pybind11::arg("numEdges"), pybind11::arg("radius"), pybind11::arg("poly"));
		cl.def_static("createRegularPolygon", (void (*)(unsigned long, double, class mrpt::math::TPolygon3D &, const struct mrpt::math::TPose3D &)) &mrpt::math::TPolygon3D::createRegularPolygon, "Static method to create a regular polygon, given its size and radius.\n The center will be located on the given pose.\n \n\n std::logic_error if number of edges is less than three, or radius\n is near zero.\n\nC++: mrpt::math::TPolygon3D::createRegularPolygon(unsigned long, double, class mrpt::math::TPolygon3D &, const struct mrpt::math::TPose3D &) --> void", pybind11::arg("numEdges"), pybind11::arg("radius"), pybind11::arg("poly"), pybind11::arg("pose"));
