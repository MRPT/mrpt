...
void bind_mrpt_math_CMatrixFixed_3(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 4, 3> (mrpt::math::CMatrixFixed<double,4UL,3UL>::*)() const) &mrpt::math::CMatrixFixed<double, 4, 3>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 4, 3>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 4, 3>");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 3, 3> (mrpt::math::CMatrixFixed<float,3UL,3UL>::*)() const) &mrpt::math::CMatrixFixed<float, 3, 3>::cast_double, "C++: mrpt::math::CMatrixFixed<float, 3, 3>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 3, 3>");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 4, 4> (mrpt::math::CMatrixFixed<float,4UL,4UL>::*)() const) &mrpt::math::CMatrixFixed<float, 4, 4>::cast_double, "C++: mrpt::math::CMatrixFixed<float, 4, 4>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 4, 4>");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 3, 1> (mrpt::math::CMatrixFixed<float,3UL,1UL>::*)() const) &mrpt::math::CMatrixFixed<float, 3, 1>::cast_double, "C++: mrpt::math::CMatrixFixed<float, 3, 1>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 3, 1>");
