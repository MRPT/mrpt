...
void bind_mrpt_math_CPolygon(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::CPolygon file:mrpt/math/CPolygon.h line:19
		...
		cl.def("GetVertex_x", (double (mrpt::math::CPolygon::*)(unsigned long) const) &mrpt::math::CPolygon::GetVertex_x, "Methods for accessing the vertices \n verticesCount \n\nC++: mrpt::math::CPolygon::GetVertex_x(unsigned long) const --> double", pybind11::arg("i"));
		cl.def("GetVertex_y", (double (mrpt::math::CPolygon::*)(unsigned long) const) &mrpt::math::CPolygon::GetVertex_y, "C++: mrpt::math::CPolygon::GetVertex_y(unsigned long) const --> double", pybind11::arg("i"));
		cl.def("verticesCount", (unsigned long (mrpt::math::CPolygon::*)() const) &mrpt::math::CPolygon::verticesCount, "Returns the vertices count in the polygon: \n\nC++: mrpt::math::CPolygon::verticesCount() const --> unsigned long");
		cl.def("setAllVertices", (void (mrpt::math::CPolygon::*)(unsigned long, const double *, const double *)) &mrpt::math::CPolygon::setAllVertices, "Set all vertices at once. Please use the std::vector version whenever\n possible unless efficiency is really an issue \n\nC++: mrpt::math::CPolygon::setAllVertices(unsigned long, const double *, const double *) --> void", pybind11::arg("nVertices"), pybind11::arg("xs"), pybind11::arg("ys"));
		cl.def("setAllVertices", (void (mrpt::math::CPolygon::*)(unsigned long, const float *, const float *)) &mrpt::math::CPolygon::setAllVertices, "Set all vertices at once. Please use the std::vector version whenever\n possible unless efficiency is really an issue \n\nC++: mrpt::math::CPolygon::setAllVertices(unsigned long, const float *, const float *) --> void", pybind11::arg("nVertices"), pybind11::arg("xs"), pybind11::arg("ys"));
