...
void bind_mrpt_math_TPose2D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::TPose2D file:mrpt/math/TPose2D.h line:25
		...
		cl.def("__getitem__", (double & (mrpt::math::TPose2D::*)(unsigned long)) &mrpt::math::TPose2D::operator[], "Coordinate access using operator[]. Order: x,y,phi \n\nC++: mrpt::math::TPose2D::operator[](unsigned long) --> double &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		...
		cl.def("__add__", (struct mrpt::math::TPose2D (mrpt::math::TPose2D::*)(const struct mrpt::math::TPose2D &) const) &mrpt::math::TPose2D::operator+, "Operator \"oplus\" pose composition: \"ret=this  b\"  \n CPose2D \n\nC++: mrpt::math::TPose2D::operator+(const struct mrpt::math::TPose2D &) const --> struct mrpt::math::TPose2D", pybind11::arg("b"));
		cl.def("__sub__", (struct mrpt::math::TPose2D (mrpt::math::TPose2D::*)(const struct mrpt::math::TPose2D &) const) &mrpt::math::TPose2D::operator-, "Operator \"ominus\" pose composition: \"ret=this  b\"  \n CPose2D \n\nC++: mrpt::math::TPose2D::operator-(const struct mrpt::math::TPose2D &) const --> struct mrpt::math::TPose2D", pybind11::arg("b"));
