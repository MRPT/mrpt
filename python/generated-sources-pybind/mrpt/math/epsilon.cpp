...
void bind_mrpt_math_epsilon(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// mrpt::math::getAngle(const struct mrpt::math::TLine3D &, const struct mrpt::math::TLine3D &) file:mrpt/math/geometry.h line:202
	...
	// mrpt::math::getAngle(const struct mrpt::math::TLine2D &, const struct mrpt::math::TLine2D &) file:mrpt/math/geometry.h line:207
	...
	// mrpt::math::createFromPoseX(const struct mrpt::math::TPose3D &, struct mrpt::math::TLine3D &) file:mrpt/math/geometry.h line:219
	...
	// mrpt::math::createFromPoseY(const struct mrpt::math::TPose3D &, struct mrpt::math::TLine3D &) file:mrpt/math/geometry.h line:225
	...
	// mrpt::math::createFromPoseZ(const struct mrpt::math::TPose3D &, struct mrpt::math::TLine3D &) file:mrpt/math/geometry.h line:231
