...
void bind_mrpt_math_TSegment2D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::TSegment2D file:mrpt/math/TSegment2D.h line:21
		...
		cl.def("__getitem__", (struct mrpt::math::TPoint2D_<double> & (mrpt::math::TSegment2D::*)(unsigned long)) &mrpt::math::TSegment2D::operator[], "Access to points using operator[0-1] \n\nC++: mrpt::math::TSegment2D::operator[](unsigned long) --> struct mrpt::math::TPoint2D_<double> &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
