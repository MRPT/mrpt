...
void bind_mrpt_math_CMatrixFixed(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("setSize", [](mrpt::math::CMatrixFixed<float,3,3> &o, unsigned long const & a0, unsigned long const & a1) -> void { return o.setSize(a0, a1); }, "", pybind11::arg("row"), pybind11::arg("col"));
		cl.def("setSize", (void (mrpt::math::CMatrixFixed<float,3,3>::*)(unsigned long, unsigned long, bool)) &mrpt::math::CMatrixFixed<float, 3, 3>::setSize, "C++: mrpt::math::CMatrixFixed<float, 3, 3>::setSize(unsigned long, unsigned long, bool) --> void", pybind11::arg("row"), pybind11::arg("col"), pybind11::arg("zeroNewElements"));
		...
		cl.def("conservativeResize", (void (mrpt::math::CMatrixFixed<float,3,3>::*)(unsigned long, unsigned long)) &mrpt::math::CMatrixFixed<float, 3, 3>::conservativeResize, "C++: mrpt::math::CMatrixFixed<float, 3, 3>::conservativeResize(unsigned long, unsigned long) --> void", pybind11::arg("row"), pybind11::arg("col"));
		cl.def("resize", (void (mrpt::math::CMatrixFixed<float,3,3>::*)(unsigned long)) &mrpt::math::CMatrixFixed<float, 3, 3>::resize, "C++: mrpt::math::CMatrixFixed<float, 3, 3>::resize(unsigned long) --> void", pybind11::arg("n"));
		cl.def("resize", [](mrpt::math::CMatrixFixed<float,3,3> &o, const struct mrpt::math::matrix_size_t & a0) -> void { return o.resize(a0); }, "", pybind11::arg("siz"));
		cl.def("resize", (void (mrpt::math::CMatrixFixed<float,3,3>::*)(const struct mrpt::math::matrix_size_t &, bool)) &mrpt::math::CMatrixFixed<float, 3, 3>::resize, "C++: mrpt::math::CMatrixFixed<float, 3, 3>::resize(const struct mrpt::math::matrix_size_t &, bool) --> void", pybind11::arg("siz"), pybind11::arg("zeroNewElements"));
		cl.def("resize", (void (mrpt::math::CMatrixFixed<float,3,3>::*)(unsigned long, unsigned long)) &mrpt::math::CMatrixFixed<float, 3, 3>::resize, "C++: mrpt::math::CMatrixFixed<float, 3, 3>::resize(unsigned long, unsigned long) --> void", pybind11::arg("row"), pybind11::arg("col"));
		...
		cl.def("size", (struct mrpt::math::matrix_size_t (mrpt::math::CMatrixFixed<float,3,3>::*)() const) &mrpt::math::CMatrixFixed<float, 3, 3>::size, "C++: mrpt::math::CMatrixFixed<float, 3, 3>::size() const --> struct mrpt::math::matrix_size_t");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("setSize", [](mrpt::math::CMatrixFixed<float,4,4> &o, unsigned long const & a0, unsigned long const & a1) -> void { return o.setSize(a0, a1); }, "", pybind11::arg("row"), pybind11::arg("col"));
		cl.def("setSize", (void (mrpt::math::CMatrixFixed<float,4,4>::*)(unsigned long, unsigned long, bool)) &mrpt::math::CMatrixFixed<float, 4, 4>::setSize, "C++: mrpt::math::CMatrixFixed<float, 4, 4>::setSize(unsigned long, unsigned long, bool) --> void", pybind11::arg("row"), pybind11::arg("col"), pybind11::arg("zeroNewElements"));
		...
		cl.def("conservativeResize", (void (mrpt::math::CMatrixFixed<float,4,4>::*)(unsigned long, unsigned long)) &mrpt::math::CMatrixFixed<float, 4, 4>::conservativeResize, "C++: mrpt::math::CMatrixFixed<float, 4, 4>::conservativeResize(unsigned long, unsigned long) --> void", pybind11::arg("row"), pybind11::arg("col"));
		cl.def("resize", (void (mrpt::math::CMatrixFixed<float,4,4>::*)(unsigned long)) &mrpt::math::CMatrixFixed<float, 4, 4>::resize, "C++: mrpt::math::CMatrixFixed<float, 4, 4>::resize(unsigned long) --> void", pybind11::arg("n"));
		cl.def("resize", [](mrpt::math::CMatrixFixed<float,4,4> &o, const struct mrpt::math::matrix_size_t & a0) -> void { return o.resize(a0); }, "", pybind11::arg("siz"));
		cl.def("resize", (void (mrpt::math::CMatrixFixed<float,4,4>::*)(const struct mrpt::math::matrix_size_t &, bool)) &mrpt::math::CMatrixFixed<float, 4, 4>::resize, "C++: mrpt::math::CMatrixFixed<float, 4, 4>::resize(const struct mrpt::math::matrix_size_t &, bool) --> void", pybind11::arg("siz"), pybind11::arg("zeroNewElements"));
		cl.def("resize", (void (mrpt::math::CMatrixFixed<float,4,4>::*)(unsigned long, unsigned long)) &mrpt::math::CMatrixFixed<float, 4, 4>::resize, "C++: mrpt::math::CMatrixFixed<float, 4, 4>::resize(unsigned long, unsigned long) --> void", pybind11::arg("row"), pybind11::arg("col"));
		...
		cl.def("size", (struct mrpt::math::matrix_size_t (mrpt::math::CMatrixFixed<float,4,4>::*)() const) &mrpt::math::CMatrixFixed<float, 4, 4>::size, "C++: mrpt::math::CMatrixFixed<float, 4, 4>::size() const --> struct mrpt::math::matrix_size_t");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("setSize", [](mrpt::math::CMatrixFixed<float,3,1> &o, unsigned long const & a0, unsigned long const & a1) -> void { return o.setSize(a0, a1); }, "", pybind11::arg("row"), pybind11::arg("col"));
		cl.def("setSize", (void (mrpt::math::CMatrixFixed<float,3,1>::*)(unsigned long, unsigned long, bool)) &mrpt::math::CMatrixFixed<float, 3, 1>::setSize, "C++: mrpt::math::CMatrixFixed<float, 3, 1>::setSize(unsigned long, unsigned long, bool) --> void", pybind11::arg("row"), pybind11::arg("col"), pybind11::arg("zeroNewElements"));
		...
		cl.def("conservativeResize", (void (mrpt::math::CMatrixFixed<float,3,1>::*)(unsigned long, unsigned long)) &mrpt::math::CMatrixFixed<float, 3, 1>::conservativeResize, "C++: mrpt::math::CMatrixFixed<float, 3, 1>::conservativeResize(unsigned long, unsigned long) --> void", pybind11::arg("row"), pybind11::arg("col"));
		cl.def("resize", (void (mrpt::math::CMatrixFixed<float,3,1>::*)(unsigned long)) &mrpt::math::CMatrixFixed<float, 3, 1>::resize, "C++: mrpt::math::CMatrixFixed<float, 3, 1>::resize(unsigned long) --> void", pybind11::arg("n"));
		cl.def("resize", [](mrpt::math::CMatrixFixed<float,3,1> &o, const struct mrpt::math::matrix_size_t & a0) -> void { return o.resize(a0); }, "", pybind11::arg("siz"));
		cl.def("resize", (void (mrpt::math::CMatrixFixed<float,3,1>::*)(const struct mrpt::math::matrix_size_t &, bool)) &mrpt::math::CMatrixFixed<float, 3, 1>::resize, "C++: mrpt::math::CMatrixFixed<float, 3, 1>::resize(const struct mrpt::math::matrix_size_t &, bool) --> void", pybind11::arg("siz"), pybind11::arg("zeroNewElements"));
		cl.def("resize", (void (mrpt::math::CMatrixFixed<float,3,1>::*)(unsigned long, unsigned long)) &mrpt::math::CMatrixFixed<float, 3, 1>::resize, "C++: mrpt::math::CMatrixFixed<float, 3, 1>::resize(unsigned long, unsigned long) --> void", pybind11::arg("row"), pybind11::arg("col"));
		...
		cl.def("size", (struct mrpt::math::matrix_size_t (mrpt::math::CMatrixFixed<float,3,1>::*)() const) &mrpt::math::CMatrixFixed<float, 3, 1>::size, "C++: mrpt::math::CMatrixFixed<float, 3, 1>::size() const --> struct mrpt::math::matrix_size_t");
