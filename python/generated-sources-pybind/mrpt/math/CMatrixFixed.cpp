...
void bind_mrpt_math_CMatrixFixed(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 2, 2> (mrpt::math::CMatrixFixed<double,2UL,2UL>::*)() const) &mrpt::math::CMatrixFixed<double, 2, 2>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 2, 2>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 2, 2>");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 3, 3> (mrpt::math::CMatrixFixed<double,3UL,3UL>::*)() const) &mrpt::math::CMatrixFixed<double, 3, 3>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 3, 3>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 3, 3>");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 4, 4> (mrpt::math::CMatrixFixed<double,4UL,4UL>::*)() const) &mrpt::math::CMatrixFixed<double, 4, 4>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 4, 4>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 4, 4>");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 6, 6> (mrpt::math::CMatrixFixed<double,6UL,6UL>::*)() const) &mrpt::math::CMatrixFixed<double, 6, 6>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 6, 6>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 6, 6>");
