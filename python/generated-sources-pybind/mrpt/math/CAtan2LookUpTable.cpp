...
void bind_mrpt_math_CAtan2LookUpTable(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::CAtan2LookUpTable file:mrpt/math/CAtan2LookUpTable.h line:24
		...
		cl.def("getSizeX", (unsigned long (mrpt::math::CAtan2LookUpTable::*)() const) &mrpt::math::CAtan2LookUpTable::getSizeX, "C++: mrpt::math::CAtan2LookUpTable::getSizeX() const --> unsigned long");
		cl.def("getSizeY", (unsigned long (mrpt::math::CAtan2LookUpTable::*)() const) &mrpt::math::CAtan2LookUpTable::getSizeY, "C++: mrpt::math::CAtan2LookUpTable::getSizeY() const --> unsigned long");
	}
	...
	{ // mrpt::math::CHistogram file:mrpt/math/CHistogram.h line:34
		...
		cl.def( pybind11::init<const double, const double, const unsigned long>(), pybind11::arg("min"), pybind11::arg("max"), pybind11::arg("nBins") );
		...
		cl.def("getBinCount", (unsigned long (mrpt::math::CHistogram::*)(const unsigned long) const) &mrpt::math::CHistogram::getBinCount, "Retuns the elements count into the selected bin index, where first one\n is 0.\n \n\n std::exception On invalid index\n\nC++: mrpt::math::CHistogram::getBinCount(const unsigned long) const --> unsigned long", pybind11::arg("index"));
		cl.def("getBinRatio", (double (mrpt::math::CHistogram::*)(const unsigned long) const) &mrpt::math::CHistogram::getBinRatio, "Retuns the ratio in [0,1] range for the selected bin index, where first\n one is 0.\n  It returns 0 if no elements have been added.\n \n\n std::exception On invalid index.\n\nC++: mrpt::math::CHistogram::getBinRatio(const unsigned long) const --> double", pybind11::arg("index"));
