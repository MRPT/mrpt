...
void bind_mrpt_math_CAtan2LookUpTable(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::math::CHistogram file:mrpt/math/CHistogram.h line:34
		...
		cl.def("getBinCount", (size_t (mrpt::math::CHistogram::*)(const unsigned long) const) &mrpt::math::CHistogram::getBinCount, "Retuns the elements count into the selected bin index, where first one\n is 0.\n \n\n std::exception On invalid index\n\nC++: mrpt::math::CHistogram::getBinCount(const unsigned long) const --> size_t", pybind11::arg("index"));
