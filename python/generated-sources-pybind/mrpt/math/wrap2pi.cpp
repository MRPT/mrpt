...
void bind_mrpt_math_wrap2pi(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::math::TPose3D file:mrpt/math/TPose3D.h line:26
		...
		cl.def("__getitem__", (double & (mrpt::math::TPose3D::*)(unsigned long)) &mrpt::math::TPose3D::operator[], "Coordinate access using operator[]. Order: x,y,z,yaw,pitch,roll \n\nC++: mrpt::math::TPose3D::operator[](unsigned long) --> double &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		...
		cl.def("__add__", (struct mrpt::math::TPose3D (mrpt::math::TPose3D::*)(const struct mrpt::math::TPose3D &) const) &mrpt::math::TPose3D::operator+, "Operator \"oplus\" pose composition: \"ret=this  b\"  \n CPose3D\n \n\n [Added in MRPT 2.1.5] \n\nC++: mrpt::math::TPose3D::operator+(const struct mrpt::math::TPose3D &) const --> struct mrpt::math::TPose3D", pybind11::arg("b"));
