...
void bind_mrpt_math_CMatrixFixed_1(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 7, 7> (mrpt::math::CMatrixFixed<double,7UL,7UL>::*)() const) &mrpt::math::CMatrixFixed<double, 7, 7>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 7, 7>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 7, 7>");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 3, 1> (mrpt::math::CMatrixFixed<double,3UL,1UL>::*)() const) &mrpt::math::CMatrixFixed<double, 3, 1>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 3, 1>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 3, 1>");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 3, 4> (mrpt::math::CMatrixFixed<double,3UL,4UL>::*)() const) &mrpt::math::CMatrixFixed<double, 3, 4>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 3, 4>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 3, 4>");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 3, 6> (mrpt::math::CMatrixFixed<double,3UL,6UL>::*)() const) &mrpt::math::CMatrixFixed<double, 3, 6>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 3, 6>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 3, 6>");
