...
void bind_mrpt_math_CSplineInterpolator1D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::CSplineInterpolator1D file:mrpt/math/CSplineInterpolator1D.h line:25
		...
		cl.def_static("getClassName", (auto (*)()) &mrpt::math::CSplineInterpolator1D::getClassName, "C++: mrpt::math::CSplineInterpolator1D::getClassName() --> auto");
