...
;
	...
	M("mrpt::math").def("factorial64", (unsigned long (*)(unsigned int)) &mrpt::math::factorial64, "Computes the factorial of an integer number and returns it as a 64-bit\n integer number.\n\nC++: mrpt::math::factorial64(unsigned int) --> unsigned long", pybind11::arg("n"));
	...
	// mrpt::math::MATLAB_plotCovariance2D(const class mrpt::math::CMatrixDynamic<float> &, const class mrpt::math::CVectorDynamic<float> &, float, const std::string &, unsigned long) file:mrpt/math/utils.h line:185
	...
	M("mrpt::math").def("MATLAB_plotCovariance2D", (std::string (*)(const class mrpt::math::CMatrixDynamic<float> &, const class mrpt::math::CVectorDynamic<float> &, float, const std::string &, unsigned long)) &mrpt::math::MATLAB_plotCovariance2D, "Generates a string with the MATLAB commands required to plot an confidence\n interval (ellipse) for a 2D Gaussian ('float' version)..\n  \n\n The 2x2 covariance matrix\n  \n\n  The 2-length vector with the mean\n  \n\n How many \"quantiles\" to get into the area of the ellipse:\n 2: 95%, 3:99.97%,...\n  \n\n A matlab style string, for colors, line styles,...\n  \n\n The number of points in the ellipse to generate\n \n\n\n \n\nC++: mrpt::math::MATLAB_plotCovariance2D(const class mrpt::math::CMatrixDynamic<float> &, const class mrpt::math::CVectorDynamic<float> &, float, const std::string &, unsigned long) --> std::string", pybind11::arg("cov22"), pybind11::arg("mean"), pybind11::arg("stdCount"), pybind11::arg("style"), pybind11::arg("nEllipsePoints"));

	// mrpt::math::MATLAB_plotCovariance2D(const class mrpt::math::CMatrixDynamic<double> &, const class mrpt::math::CVectorDynamic<double> &, float, const std::string &, unsigned long) file:mrpt/math/utils.h line:199
	...
	M("mrpt::math").def("MATLAB_plotCovariance2D", (std::string (*)(const class mrpt::math::CMatrixDynamic<double> &, const class mrpt::math::CVectorDynamic<double> &, float, const std::string &, unsigned long)) &mrpt::math::MATLAB_plotCovariance2D, "Generates a string with the MATLAB commands required to plot an confidence\n interval (ellipse) for a 2D Gaussian ('double' version).\n  \n\n The 2x2 covariance matrix\n  \n\n  The 2-length vector with the mean\n  \n\n How many \"quantiles\" to get into the area of the ellipse:\n 2: 95%, 3:99.97%,...\n  \n\n A matlab style string, for colors, line styles,...\n  \n\n The number of points in the ellipse to generate\n \n\n\n \n\nC++: mrpt::math::MATLAB_plotCovariance2D(const class mrpt::math::CMatrixDynamic<double> &, const class mrpt::math::CVectorDynamic<double> &, float, const std::string &, unsigned long) --> std::string", pybind11::arg("cov22"), pybind11::arg("mean"), pybind11::arg("stdCount"), pybind11::arg("style"), pybind11::arg("nEllipsePoints"));
