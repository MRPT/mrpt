...
;
	...
	// mrpt::math::MATLAB_plotCovariance2D(const class mrpt::math::CMatrixDynamic<float> &, const class mrpt::math::CVectorDynamic<float> &, float, const std::string &, size_t) file:mrpt/math/utils.h line:185
	...
	// mrpt::math::MATLAB_plotCovariance2D(const class mrpt::math::CMatrixDynamic<double> &, const class mrpt::math::CVectorDynamic<double> &, float, const std::string &, size_t) file:mrpt/math/utils.h line:199
