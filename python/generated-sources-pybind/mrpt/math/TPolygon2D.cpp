...
void bind_mrpt_math_TPolygon2D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::TPolygon2D file:mrpt/math/TPolygon2D.h line:25
		...
		cl.def("getPlotData", (class std::tuple<class std::vector<double, class std::allocator<double> >, class std::vector<double, class std::allocator<double> > > (mrpt::math::TPolygon2D::*)() const) &mrpt::math::TPolygon2D::getPlotData, "C++: mrpt::math::TPolygon2D::getPlotData() const --> class std::tuple<class std::vector<double, class std::allocator<double> >, class std::vector<double, class std::allocator<double> > >");
		...
		cl.def_static("createRegularPolygon", (void (*)(unsigned long, double, class mrpt::math::TPolygon2D &)) &mrpt::math::TPolygon2D::createRegularPolygon, "Static method to create a regular polygon, given its size and radius.\n \n\n std::logic_error if radius is near zero or the number of edges is\n less than three.\n\nC++: mrpt::math::TPolygon2D::createRegularPolygon(unsigned long, double, class mrpt::math::TPolygon2D &) --> void", pybind11::arg("numEdges"), pybind11::arg("radius"), pybind11::arg("poly"));
		cl.def_static("createRegularPolygon", (void (*)(unsigned long, double, class mrpt::math::TPolygon2D &, const struct mrpt::math::TPose2D &)) &mrpt::math::TPolygon2D::createRegularPolygon, "Static method to create a regular polygon from its size and radius. The\n center will correspond to the given pose.\n \n\n std::logic_error if radius is near zero or the number of edges is\n less than three.\n\nC++: mrpt::math::TPolygon2D::createRegularPolygon(unsigned long, double, class mrpt::math::TPolygon2D &, const struct mrpt::math::TPose2D &) --> void", pybind11::arg("numEdges"), pybind11::arg("radius"), pybind11::arg("poly"), pybind11::arg("pose"));
