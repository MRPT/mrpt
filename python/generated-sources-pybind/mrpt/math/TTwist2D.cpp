...
void bind_mrpt_math_TTwist2D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::TTwist2D file:mrpt/math/TTwist2D.h line:21
		...
		cl.def("__getitem__", (double & (mrpt::math::TTwist2D::*)(unsigned long)) &mrpt::math::TTwist2D::operator[], "Coordinate access using operator[]. Order: vx,vy,vphi \n\nC++: mrpt::math::TTwist2D::operator[](unsigned long) --> double &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
