...
void bind_mrpt_math_CMatrixF(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::CMatrixF file:mrpt/math/CMatrixF.h line:22
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<20> (*)()) &mrpt::math::CMatrixF::getClassName, "C++: mrpt::math::CMatrixF::getClassName() --> class mrpt::typemeta::string_literal<20>");
