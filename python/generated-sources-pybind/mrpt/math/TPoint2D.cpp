...
void bind_mrpt_math_TPoint2D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::TPoint2D_ file:mrpt/math/TPoint2D.h line:35
		...
		cl.def("__getitem__", (double & (mrpt::math::TPoint2D_<double>::*)(unsigned long)) &mrpt::math::TPoint2D_<double>::operator[], "C++: mrpt::math::TPoint2D_<double>::operator[](unsigned long) --> double &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
	...
	{ // mrpt::math::TPoint2D_ file:mrpt/math/TPoint2D.h line:35
		...
		cl.def("__getitem__", (float & (mrpt::math::TPoint2D_<float>::*)(unsigned long)) &mrpt::math::TPoint2D_<float>::operator[], "C++: mrpt::math::TPoint2D_<float>::operator[](unsigned long) --> float &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
	...
	{ // mrpt::math::TPoint3D_ file:mrpt/math/TPoint3D.h line:42
		...
		cl.def("__getitem__", (double & (mrpt::math::TPoint3D_<double>::*)(unsigned long)) &mrpt::math::TPoint3D_<double>::operator[], "C++: mrpt::math::TPoint3D_<double>::operator[](unsigned long) --> double &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
