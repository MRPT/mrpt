...
void bind_mrpt_math_CMatrixFixed_4(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 12, 1> (mrpt::math::CMatrixFixed<double,12UL,1UL>::*)() const) &mrpt::math::CMatrixFixed<double, 12, 1>::cast_double, "C++: mrpt::math::CMatrixFixed<double, 12, 1>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 12, 1>");
	...
	{ // mrpt::math::CMatrixFixed file:mrpt/math/CMatrixFixed.h line:34
		...
		cl.def("cast_double", (class mrpt::math::CMatrixFixed<double, 4, 1> (mrpt::math::CMatrixFixed<float,4UL,1UL>::*)() const) &mrpt::math::CMatrixFixed<float, 4, 1>::cast_double, "C++: mrpt::math::CMatrixFixed<float, 4, 1>::cast_double() const --> class mrpt::math::CMatrixFixed<double, 4, 1>");
