...
;
	...
	{ // mrpt::bayes::CKalmanFilterCapable file:mrpt/bayes/CKalmanFilterCapable.h line:225
		...
		cl.def("OnNewLandmarkAddedToMap", (void (mrpt::bayes::CKalmanFilterCapable<7,3,3,7,double>::*)(size_t, size_t)) &mrpt::bayes::CKalmanFilterCapable<7, 3, 3, 7, double>::OnNewLandmarkAddedToMap, "C++: mrpt::bayes::CKalmanFilterCapable<7, 3, 3, 7, double>::OnNewLandmarkAddedToMap(size_t, size_t) --> void", pybind11::arg("in_obsIdx"), pybind11::arg("in_idxNewFeat"));
	...
	{ // mrpt::bayes::CKalmanFilterCapable file:mrpt/bayes/CKalmanFilterCapable.h line:225
		...
		cl.def("OnNewLandmarkAddedToMap", (void (mrpt::bayes::CKalmanFilterCapable<3,2,2,3,double>::*)(size_t, size_t)) &mrpt::bayes::CKalmanFilterCapable<3, 2, 2, 3, double>::OnNewLandmarkAddedToMap, "C++: mrpt::bayes::CKalmanFilterCapable<3, 2, 2, 3, double>::OnNewLandmarkAddedToMap(size_t, size_t) --> void", pybind11::arg("in_obsIdx"), pybind11::arg("in_idxNewFeat"));
