...
void bind_mrpt_comms_CClientTCPSocket(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::comms::CClientTCPSocket file:mrpt/comms/CClientTCPSocket.h line:35
		...
		cl.def("Seek", (unsigned long (mrpt::comms::CClientTCPSocket::*)(long, enum mrpt::io::CStream::TSeekOrigin)) &mrpt::comms::CClientTCPSocket::Seek, "This virtual method has no effect in this implementation over a TCP\n socket, and its use raises an exception \n\nC++: mrpt::comms::CClientTCPSocket::Seek(long, enum mrpt::io::CStream::TSeekOrigin) --> unsigned long", pybind11::arg("off"), pybind11::arg("org"));
		cl.def("getTotalBytesCount", (unsigned long (mrpt::comms::CClientTCPSocket::*)() const) &mrpt::comms::CClientTCPSocket::getTotalBytesCount, "This virtual method has no effect in this implementation over a TCP\n socket, and its use raises an exception \n\nC++: mrpt::comms::CClientTCPSocket::getTotalBytesCount() const --> unsigned long");
		cl.def("getPosition", (unsigned long (mrpt::comms::CClientTCPSocket::*)() const) &mrpt::comms::CClientTCPSocket::getPosition, "This virtual method has no effect in this implementation over a TCP\n socket, and its use raises an exception \n\nC++: mrpt::comms::CClientTCPSocket::getPosition() const --> unsigned long");
		...
		cl.def("readAsync", (unsigned long (mrpt::comms::CClientTCPSocket::*)(void *, const unsigned long, const int, const int)) &mrpt::comms::CClientTCPSocket::readAsync, "A method for reading from the socket with an optional timeout.\n \n\n The destination of data.\n \n\n The number of bytes to read.\n \n\n The maximum timeout (in milliseconds) to wait for\n the starting of data from the other side.\n \n\n The maximum timeout (in milliseconds) to wait\n for a chunk of data after a previous one.\n  Set timeout's to -1 to block until the desired number of bytes are\n read, or an error happens.\n  \n\n The number of actually read bytes.\n\nC++: mrpt::comms::CClientTCPSocket::readAsync(void *, const unsigned long, const int, const int) --> unsigned long", pybind11::arg("Buffer"), pybind11::arg("Count"), pybind11::arg("timeoutStart_ms"), pybind11::arg("timeoutBetween_ms"));
		...
		cl.def("writeAsync", (unsigned long (mrpt::comms::CClientTCPSocket::*)(const void *, const unsigned long, const int)) &mrpt::comms::CClientTCPSocket::writeAsync, "A method for writing to the socket with optional timeouts.\n  The method supports writing block by block as the socket allows us to\n write more data.\n \n\n The data.\n \n\n The number of bytes to write.\n \n\n The maximum timeout (in milliseconds) to wait for the\n socket to be available for writing (for each block).\n  Set timeout's to -1 to block until the desired number of bytes are\n written, or an error happens.\n  \n\n The number of actually written bytes.\n\nC++: mrpt::comms::CClientTCPSocket::writeAsync(const void *, const unsigned long, const int) --> unsigned long", pybind11::arg("Buffer"), pybind11::arg("Count"), pybind11::arg("timeout_ms"));
		cl.def("getReadPendingBytes", (unsigned long (mrpt::comms::CClientTCPSocket::*)()) &mrpt::comms::CClientTCPSocket::getReadPendingBytes, "Return the number of bytes already in the receive queue (they can be\n read without waiting) \n\nC++: mrpt::comms::CClientTCPSocket::getReadPendingBytes() --> unsigned long");
	...
	{ // mrpt::comms::CSerialPort file:mrpt/comms/CSerialPort.h line:41
		...
		cl.def("Read", (unsigned long (mrpt::comms::CSerialPort::*)(void *, unsigned long)) &mrpt::comms::CSerialPort::Read, "Implements the virtual method responsible for reading from the stream -\n Unlike CStream::ReadBuffer, this method will not raise an exception on\n zero bytes read, as long as there is not any fatal error in the\n communications.\n \n\n std::exception On communication errors\n\nC++: mrpt::comms::CSerialPort::Read(void *, unsigned long) --> unsigned long", pybind11::arg("Buffer"), pybind11::arg("Count"));
		...
		cl.def("Write", (unsigned long (mrpt::comms::CSerialPort::*)(const void *, unsigned long)) &mrpt::comms::CSerialPort::Write, "C++: mrpt::comms::CSerialPort::Write(const void *, unsigned long) --> unsigned long", pybind11::arg("Buffer"), pybind11::arg("Count"));
		cl.def("Seek", [](mrpt::comms::CSerialPort &o, long const & a0) -> unsigned long { return o.Seek(a0); }, "", pybind11::arg("off"));
		cl.def("Seek", (unsigned long (mrpt::comms::CSerialPort::*)(long, enum mrpt::io::CStream::TSeekOrigin)) &mrpt::comms::CSerialPort::Seek, "not applicable in a serial port \n\nC++: mrpt::comms::CSerialPort::Seek(long, enum mrpt::io::CStream::TSeekOrigin) --> unsigned long", pybind11::arg("off"), pybind11::arg("o"));
		cl.def("getTotalBytesCount", (unsigned long (mrpt::comms::CSerialPort::*)() const) &mrpt::comms::CSerialPort::getTotalBytesCount, "not applicable in a serial port \n\nC++: mrpt::comms::CSerialPort::getTotalBytesCount() const --> unsigned long");
		cl.def("getPosition", (unsigned long (mrpt::comms::CSerialPort::*)() const) &mrpt::comms::CSerialPort::getPosition, "not applicable in a serial port \n\nC++: mrpt::comms::CSerialPort::getPosition() const --> unsigned long");
