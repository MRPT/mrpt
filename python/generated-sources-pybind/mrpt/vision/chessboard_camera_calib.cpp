...
void bind_mrpt_vision_chessboard_camera_calib(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	M("mrpt::vision").def("matchFeatures", [](const class mrpt::vision::CFeatureList & a0, const class mrpt::vision::CFeatureList & a1, class mrpt::vision::CMatchedFeatureList & a2) -> unsigned long { return mrpt::vision::matchFeatures(a0, a1, a2); }, "", pybind11::arg("list1"), pybind11::arg("list2"), pybind11::arg("matches"));
	M("mrpt::vision").def("matchFeatures", [](const class mrpt::vision::CFeatureList & a0, const class mrpt::vision::CFeatureList & a1, class mrpt::vision::CMatchedFeatureList & a2, const struct mrpt::vision::TMatchingOptions & a3) -> unsigned long { return mrpt::vision::matchFeatures(a0, a1, a2, a3); }, "", pybind11::arg("list1"), pybind11::arg("list2"), pybind11::arg("matches"), pybind11::arg("options"));
	M("mrpt::vision").def("matchFeatures", (unsigned long (*)(const class mrpt::vision::CFeatureList &, const class mrpt::vision::CFeatureList &, class mrpt::vision::CMatchedFeatureList &, const struct mrpt::vision::TMatchingOptions &, const struct mrpt::vision::TStereoSystemParams &)) &mrpt::vision::matchFeatures, "Find the matches between two lists of features which must be of the same\n type.\n \n\n    [IN]    One list.\n \n\n    [IN]    Other list.\n \n\n  [OUT]   A vector of pairs of correspondences.\n \n\n  [IN]    A struct containing matching options\n \n\n Returns the number of matched pairs of features.\n\nC++: mrpt::vision::matchFeatures(const class mrpt::vision::CFeatureList &, const class mrpt::vision::CFeatureList &, class mrpt::vision::CMatchedFeatureList &, const struct mrpt::vision::TMatchingOptions &, const struct mrpt::vision::TStereoSystemParams &) --> unsigned long", pybind11::arg("list1"), pybind11::arg("list2"), pybind11::arg("matches"), pybind11::arg("options"), pybind11::arg("params"));
