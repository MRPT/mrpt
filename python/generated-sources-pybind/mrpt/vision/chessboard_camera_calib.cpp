...
void bind_mrpt_vision_chessboard_camera_calib(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// mrpt::vision::pixelTo3D(const struct mrpt::img::TPixelCoordf &, const class mrpt::math::CMatrixFixed<double, 3, 3> &) file:mrpt/vision/utils.h line:76
	...
	// mrpt::vision::buildIntrinsicParamsMatrix(const double, const double, const double, const double) file:mrpt/vision/utils.h line:95
