...
void bind_mrpt_vision_CFeature(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::vision::CFeatureList file:mrpt/vision/CFeature.h line:276
		...
		cl.def("kdtree_distance", (float (mrpt::vision::CFeatureList::*)(const float *, const unsigned long, size_t) const) &mrpt::vision::CFeatureList::kdtree_distance, "Returns the distance between the vector \"p1[0:size-1]\" and the data\n point with index \"idx_p2\" stored in the class:\n\nC++: mrpt::vision::CFeatureList::kdtree_distance(const float *, const unsigned long, size_t) const --> float", pybind11::arg("p1"), pybind11::arg("idx_p2"), pybind11::arg("size"));
