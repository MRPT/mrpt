...
void bind_mrpt_vision_CFeature(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::vision::CFeatureList file:mrpt/vision/CFeature.h line:276
		...
		cl.def("size", (unsigned long (mrpt::vision::CFeatureList::*)() const) &mrpt::vision::CFeatureList::size, "C++: mrpt::vision::CFeatureList::size() const --> unsigned long");
		cl.def("clear", (void (mrpt::vision::CFeatureList::*)()) &mrpt::vision::CFeatureList::clear, "C++: mrpt::vision::CFeatureList::clear() --> void");
		cl.def("resize", (void (mrpt::vision::CFeatureList::*)(unsigned long)) &mrpt::vision::CFeatureList::resize, "C++: mrpt::vision::CFeatureList::resize(unsigned long) --> void", pybind11::arg("N"));
		...
		cl.def("kdtree_get_point_count", (unsigned long (mrpt::vision::CFeatureList::*)() const) &mrpt::vision::CFeatureList::kdtree_get_point_count, "Must return the number of data points\n\nC++: mrpt::vision::CFeatureList::kdtree_get_point_count() const --> unsigned long");
		cl.def("kdtree_get_pt", (float (mrpt::vision::CFeatureList::*)(const unsigned long, int) const) &mrpt::vision::CFeatureList::kdtree_get_pt, "Returns the dim'th component of the idx'th point in the class:\n\nC++: mrpt::vision::CFeatureList::kdtree_get_pt(const unsigned long, int) const --> float", pybind11::arg("idx"), pybind11::arg("dim"));
		cl.def("kdtree_distance", (float (mrpt::vision::CFeatureList::*)(const float *, const unsigned long, unsigned long) const) &mrpt::vision::CFeatureList::kdtree_distance, "Returns the distance between the vector \"p1[0:size-1]\" and the data\n point with index \"idx_p2\" stored in the class:\n\nC++: mrpt::vision::CFeatureList::kdtree_distance(const float *, const unsigned long, unsigned long) const --> float", pybind11::arg("p1"), pybind11::arg("idx_p2"), pybind11::arg("size"));
		cl.def("getFeatureX", (float (mrpt::vision::CFeatureList::*)(unsigned long) const) &mrpt::vision::CFeatureList::getFeatureX, "		@{ \n\nC++: mrpt::vision::CFeatureList::getFeatureX(unsigned long) const --> float", pybind11::arg("i"));
		cl.def("getFeatureY", (float (mrpt::vision::CFeatureList::*)(unsigned long) const) &mrpt::vision::CFeatureList::getFeatureY, "C++: mrpt::vision::CFeatureList::getFeatureY(unsigned long) const --> float", pybind11::arg("i"));
		cl.def("getFeatureID", (unsigned long (mrpt::vision::CFeatureList::*)(unsigned long) const) &mrpt::vision::CFeatureList::getFeatureID, "C++: mrpt::vision::CFeatureList::getFeatureID(unsigned long) const --> unsigned long", pybind11::arg("i"));
		cl.def("getFeatureResponse", (float (mrpt::vision::CFeatureList::*)(unsigned long) const) &mrpt::vision::CFeatureList::getFeatureResponse, "C++: mrpt::vision::CFeatureList::getFeatureResponse(unsigned long) const --> float", pybind11::arg("i"));
		cl.def("isPointFeature", (bool (mrpt::vision::CFeatureList::*)(unsigned long) const) &mrpt::vision::CFeatureList::isPointFeature, "C++: mrpt::vision::CFeatureList::isPointFeature(unsigned long) const --> bool", pybind11::arg("i"));
		cl.def("getScale", (float (mrpt::vision::CFeatureList::*)(unsigned long) const) &mrpt::vision::CFeatureList::getScale, "C++: mrpt::vision::CFeatureList::getScale(unsigned long) const --> float", pybind11::arg("i"));
		cl.def("getTrackStatus", (enum mrpt::vision::TFeatureTrackStatus (mrpt::vision::CFeatureList::*)(unsigned long)) &mrpt::vision::CFeatureList::getTrackStatus, "C++: mrpt::vision::CFeatureList::getTrackStatus(unsigned long) --> enum mrpt::vision::TFeatureTrackStatus", pybind11::arg("i"));
		cl.def("setFeatureX", (void (mrpt::vision::CFeatureList::*)(unsigned long, float)) &mrpt::vision::CFeatureList::setFeatureX, "C++: mrpt::vision::CFeatureList::setFeatureX(unsigned long, float) --> void", pybind11::arg("i"), pybind11::arg("x"));
		cl.def("setFeatureXf", (void (mrpt::vision::CFeatureList::*)(unsigned long, float)) &mrpt::vision::CFeatureList::setFeatureXf, "C++: mrpt::vision::CFeatureList::setFeatureXf(unsigned long, float) --> void", pybind11::arg("i"), pybind11::arg("x"));
		cl.def("setFeatureY", (void (mrpt::vision::CFeatureList::*)(unsigned long, float)) &mrpt::vision::CFeatureList::setFeatureY, "C++: mrpt::vision::CFeatureList::setFeatureY(unsigned long, float) --> void", pybind11::arg("i"), pybind11::arg("y"));
		cl.def("setFeatureYf", (void (mrpt::vision::CFeatureList::*)(unsigned long, float)) &mrpt::vision::CFeatureList::setFeatureYf, "C++: mrpt::vision::CFeatureList::setFeatureYf(unsigned long, float) --> void", pybind11::arg("i"), pybind11::arg("y"));
		cl.def("setFeatureID", (void (mrpt::vision::CFeatureList::*)(unsigned long, unsigned long)) &mrpt::vision::CFeatureList::setFeatureID, "C++: mrpt::vision::CFeatureList::setFeatureID(unsigned long, unsigned long) --> void", pybind11::arg("i"), pybind11::arg("id"));
		cl.def("setFeatureResponse", (void (mrpt::vision::CFeatureList::*)(unsigned long, float)) &mrpt::vision::CFeatureList::setFeatureResponse, "C++: mrpt::vision::CFeatureList::setFeatureResponse(unsigned long, float) --> void", pybind11::arg("i"), pybind11::arg("r"));
		cl.def("setScale", (void (mrpt::vision::CFeatureList::*)(unsigned long, unsigned char)) &mrpt::vision::CFeatureList::setScale, "C++: mrpt::vision::CFeatureList::setScale(unsigned long, unsigned char) --> void", pybind11::arg("i"), pybind11::arg("s"));
		cl.def("setTrackStatus", (void (mrpt::vision::CFeatureList::*)(unsigned long, enum mrpt::vision::TFeatureTrackStatus)) &mrpt::vision::CFeatureList::setTrackStatus, "C++: mrpt::vision::CFeatureList::setTrackStatus(unsigned long, enum mrpt::vision::TFeatureTrackStatus) --> void", pybind11::arg("i"), pybind11::arg("s"));
	...
	{ // mrpt::vision::CMatchedFeatureList file:mrpt/vision/CFeature.h line:494
