...
;
	...
	{ // mrpt::vision::CFeature file:mrpt/vision/CFeature.h line:54
		...
		cl.def("descriptorORBDistanceTo", (uint8_t (mrpt::vision::CFeature::*)(const class mrpt::vision::CFeature &) const) &mrpt::vision::CFeature::descriptorORBDistanceTo, "Computes the Hamming distance \"this\" and the \"other\" descriptor ORB\n descriptor \n\nC++: mrpt::vision::CFeature::descriptorORBDistanceTo(const class mrpt::vision::CFeature &) const --> uint8_t", pybind11::arg("oFeature"));
