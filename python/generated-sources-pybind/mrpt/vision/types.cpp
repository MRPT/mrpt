...
;
	...
	{ // mrpt::vision::TSequenceFeatureObservations file:mrpt/vision/types.h line:171
		...
		cl.def("removeFewObservedFeatures", [](mrpt::vision::TSequenceFeatureObservations &o) -> unsigned long { return o.removeFewObservedFeatures(); }, "");
		cl.def("removeFewObservedFeatures", (unsigned long (mrpt::vision::TSequenceFeatureObservations::*)(unsigned long)) &mrpt::vision::TSequenceFeatureObservations::removeFewObservedFeatures, "Remove all those features that don't have a minimum number of\n observations from different camera frame IDs.\n \n\n the number of erased entries.\n \n\n After calling this you may want to call  \n\nC++: mrpt::vision::TSequenceFeatureObservations::removeFewObservedFeatures(unsigned long) --> unsigned long", pybind11::arg("minNumObservations"));
		cl.def("decimateCameraFrames", (void (mrpt::vision::TSequenceFeatureObservations::*)(const unsigned long)) &mrpt::vision::TSequenceFeatureObservations::decimateCameraFrames, "Remove all but one out of  camera frame IDs from the\n list (eg: from N camera pose IDs at return there will be just\n N/decimate_ratio)\n The algorithm first builds a sorted list of frame IDs, then keep the\n lowest ID, remove the next \"decimate_ratio-1\", and so on.\n \n\n After calling this you may want to call  \n\nC++: mrpt::vision::TSequenceFeatureObservations::decimateCameraFrames(const unsigned long) --> void", pybind11::arg("decimate_ratio"));
		cl.def("compressIDs", [](mrpt::vision::TSequenceFeatureObservations &o) -> void { return o.compressIDs(); }, "");
		cl.def("compressIDs", [](mrpt::vision::TSequenceFeatureObservations &o, class std::map<unsigned long, unsigned long, struct std::less<unsigned long>, class std::allocator<struct std::pair<const unsigned long, unsigned long> > > * a0) -> void { return o.compressIDs(a0); }, "", pybind11::arg("old2new_camIDs"));
		cl.def("compressIDs", (void (mrpt::vision::TSequenceFeatureObservations::*)(class std::map<unsigned long, unsigned long, struct std::less<unsigned long>, class std::allocator<struct std::pair<const unsigned long, unsigned long> > > *, class std::map<unsigned long, unsigned long, struct std::less<unsigned long>, class std::allocator<struct std::pair<const unsigned long, unsigned long> > > *)) &mrpt::vision::TSequenceFeatureObservations::compressIDs, "Rearrange frame and feature IDs such as they start at 0 and there are no\n gaps.\n \n\n If provided, the mapping from old to new IDs is\n stored here.\n \n\n If provided, the mapping from old to new IDs is\n stored here. \n\nC++: mrpt::vision::TSequenceFeatureObservations::compressIDs(class std::map<unsigned long, unsigned long, struct std::less<unsigned long>, class std::allocator<struct std::pair<const unsigned long, unsigned long> > > *, class std::map<unsigned long, unsigned long, struct std::less<unsigned long>, class std::allocator<struct std::pair<const unsigned long, unsigned long> > > *) --> void", pybind11::arg("old2new_camIDs"), pybind11::arg("old2new_lmIDs"));
	...
	{ // mrpt::vision::TImageROI file:mrpt/vision/types.h line:326
		...
		cl.def( pybind11::init<unsigned long, unsigned long, unsigned long, unsigned long>(), pybind11::arg("x1"), pybind11::arg("x2"), pybind11::arg("y1"), pybind11::arg("y2") );
