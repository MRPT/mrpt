...
void bind_mrpt_graphs_ScalarFactorGraph(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::graphs::ScalarFactorGraph file:mrpt/graphs/ScalarFactorGraph.h line:41
		...
		cl.def("initialize", (void (mrpt::graphs::ScalarFactorGraph::*)(const unsigned long)) &mrpt::graphs::ScalarFactorGraph::initialize, "Initialize the GMRF internal state and copy the prior factors. \n\nC++: mrpt::graphs::ScalarFactorGraph::initialize(const unsigned long) --> void", pybind11::arg("nodeCount"));
