...
void bind_mrpt_topography_conversions(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// mrpt::topography::path_from_rtk_gps(class mrpt::poses::CPose3DInterpolator &, const class mrpt::obs::CRawlog &, size_t, size_t, bool, bool, int, struct mrpt::topography::TPathFromRTKInfo *) file:mrpt/topography/path_from_rtk_gps.h line:58
