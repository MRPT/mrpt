...
{
	// mrpt::topography::UTMToGeodetic(const struct mrpt::math::TPoint3D_<double> &, int, char, struct mrpt::topography::TGeodeticCoords &, const struct mrpt::topography::TEllipsoid &) file:mrpt/topography/conversions.h line:181
	...
	// mrpt::topography::GeodeticToUTM(double, double, double &, double &, int &, char &, const struct mrpt::topography::TEllipsoid &) file:mrpt/topography/conversions.h line:208
	...
	// mrpt::topography::geodeticToUTM(const struct mrpt::topography::TGeodeticCoords &, struct mrpt::math::TPoint3D_<double> &, int &, char &, const struct mrpt::topography::TEllipsoid &) file:mrpt/topography/conversions.h line:213
	...
	// mrpt::topography::GeodeticToUTM(const struct mrpt::topography::TGeodeticCoords &, struct mrpt::math::TPoint3D_<double> &, int &, char &, const struct mrpt::topography::TEllipsoid &) file:mrpt/topography/conversions.h line:234
	M("mrpt::topography").def("GeodeticToUTM", [](const struct mrpt::topography::TGeodeticCoords & a0, struct mrpt::math::TPoint3D_<double> & a1, int & a2, char & a3) -> void { return mrpt::topography::GeodeticToUTM(a0, a1, a2, a3); }, "", pybind11::arg("GeodeticCoords"), pybind11::arg("UTMCoords"), pybind11::arg("UTMZone"), pybind11::arg("UTMLatitudeBand"));
	...
	// mrpt::topography::ENU_axes_from_WGS84(double, double, double, struct mrpt::math::TPose3D &, bool) file:mrpt/topography/conversions.h line:260
	...
	// mrpt::topography::ENU_axes_from_WGS84(const struct mrpt::topography::TGeodeticCoords &, struct mrpt::math::TPose3D &, bool) file:mrpt/topography/conversions.h line:266
	...
	// mrpt::topography::path_from_rtk_gps(class mrpt::poses::CPose3DInterpolator &, const class mrpt::obs::CRawlog &, unsigned long, unsigned long, bool, bool, int, struct mrpt::topography::TPathFromRTKInfo *) file:mrpt/topography/path_from_rtk_gps.h line:58
	M("mrpt::topography").def("path_from_rtk_gps", [](class mrpt::poses::CPose3DInterpolator & a0, const class mrpt::obs::CRawlog & a1, unsigned long const & a2, unsigned long const & a3) -> void { return mrpt::topography::path_from_rtk_gps(a0, a1, a2, a3); }, "", pybind11::arg("robot_path"), pybind11::arg("rawlog"), pybind11::arg("rawlog_first"), pybind11::arg("rawlog_last"));
	M("mrpt::topography").def("path_from_rtk_gps", [](class mrpt::poses::CPose3DInterpolator & a0, const class mrpt::obs::CRawlog & a1, unsigned long const & a2, unsigned long const & a3, bool const & a4) -> void { return mrpt::topography::path_from_rtk_gps(a0, a1, a2, a3, a4); }, "", pybind11::arg("robot_path"), pybind11::arg("rawlog"), pybind11::arg("rawlog_first"), pybind11::arg("rawlog_last"), pybind11::arg("isGUI"));
	M("mrpt::topography").def("path_from_rtk_gps", [](class mrpt::poses::CPose3DInterpolator & a0, const class mrpt::obs::CRawlog & a1, unsigned long const & a2, unsigned long const & a3, bool const & a4, bool const & a5) -> void { return mrpt::topography::path_from_rtk_gps(a0, a1, a2, a3, a4, a5); }, "", pybind11::arg("robot_path"), pybind11::arg("rawlog"), pybind11::arg("rawlog_first"), pybind11::arg("rawlog_last"), pybind11::arg("isGUI"), pybind11::arg("disableGPSInterp"));
	M("mrpt::topography").def("path_from_rtk_gps", [](class mrpt::poses::CPose3DInterpolator & a0, const class mrpt::obs::CRawlog & a1, unsigned long const & a2, unsigned long const & a3, bool const & a4, bool const & a5, int const & a6) -> void { return mrpt::topography::path_from_rtk_gps(a0, a1, a2, a3, a4, a5, a6); }, "", pybind11::arg("robot_path"), pybind11::arg("rawlog"), pybind11::arg("rawlog_first"), pybind11::arg("rawlog_last"), pybind11::arg("isGUI"), pybind11::arg("disableGPSInterp"), pybind11::arg("path_smooth_filter_size"));
	M("mrpt::topography").def("path_from_rtk_gps", (void (*)(class mrpt::poses::CPose3DInterpolator &, const class mrpt::obs::CRawlog &, unsigned long, unsigned long, bool, bool, int, struct mrpt::topography::TPathFromRTKInfo *)) &mrpt::topography::path_from_rtk_gps, "Reconstruct the path of a vehicle equipped with 3 RTK GPSs.\n  \n\n [OUT] The reconstructed vehicle path\n  \n\n [IN] The dataset. It must contain mrpt::obs::CObservationGPS\n observations with GGA datums.\n  \n\n [IN] The index of the first entry to process (first=0)\n  \n\n [IN] The index of the last entry to process\n  \n\n [IN] If set to true, some progress dialogs will be shown\n during the computation (requires MRPT built with support for wxWidgets).\n  \n\n [IN] Whether to interpolate missing GPS readings\n between very close datums.\n  \n\n [IN] Size of the window in the pitch & roll\n noise filtering.\n  \n\n [OUT] Optional output: additional information from the\n optimization\n\n  For more details on the method, refer to the paper: (...)\n \n\n mrpt::topography\n\nC++: mrpt::topography::path_from_rtk_gps(class mrpt::poses::CPose3DInterpolator &, const class mrpt::obs::CRawlog &, unsigned long, unsigned long, bool, bool, int, struct mrpt::topography::TPathFromRTKInfo *) --> void", pybind11::arg("robot_path"), pybind11::arg("rawlog"), pybind11::arg("rawlog_first"), pybind11::arg("rawlog_last"), pybind11::arg("isGUI"), pybind11::arg("disableGPSInterp"), pybind11::arg("path_smooth_filter_size"), pybind11::arg("outInfo"));
