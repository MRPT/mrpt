...
void bind_mrpt_opengl_CDisk(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::CDisk file:mrpt/opengl/CDisk.h line:24
		...
		cl.def( pybind11::init<float, float, unsigned int>(), pybind11::arg("rOut"), pybind11::arg("rIn"), pybind11::arg("slices") );
		...
		cl.def("setSlicesCount", (void (mrpt::opengl::CDisk::*)(unsigned int)) &mrpt::opengl::CDisk::setSlicesCount, "Default=50 \n\nC++: mrpt::opengl::CDisk::setSlicesCount(unsigned int) --> void", pybind11::arg("N"));
	...
	{ // mrpt::opengl::CGeneralizedEllipsoidTemplate file:mrpt/opengl/CGeneralizedEllipsoidTemplate.h line:38
		...
		cl.def("getNumberOfSegments", (unsigned int (mrpt::opengl::CGeneralizedEllipsoidTemplate<2>::*)() const) &mrpt::opengl::CGeneralizedEllipsoidTemplate<2>::getNumberOfSegments, "C++: mrpt::opengl::CGeneralizedEllipsoidTemplate<2>::getNumberOfSegments() const --> unsigned int");
	...
	{ // mrpt::opengl::CGeneralizedEllipsoidTemplate file:mrpt/opengl/CGeneralizedEllipsoidTemplate.h line:38
		...
		cl.def("getNumberOfSegments", (unsigned int (mrpt::opengl::CGeneralizedEllipsoidTemplate<3>::*)() const) &mrpt::opengl::CGeneralizedEllipsoidTemplate<3>::getNumberOfSegments, "C++: mrpt::opengl::CGeneralizedEllipsoidTemplate<3>::getNumberOfSegments() const --> unsigned int");
