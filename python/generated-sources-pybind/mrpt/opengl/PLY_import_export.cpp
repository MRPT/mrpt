...
void bind_mrpt_opengl_PLY_import_export(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::PLY_Importer file:mrpt/opengl/PLY_import_export.h line:25
		...
		cl.def("loadFromPlyFile", [](mrpt::opengl::PLY_Importer &o, const std::string & a0, class std::vector<std::string, class std::allocator<std::string > > * a1) -> bool { return o.loadFromPlyFile(a0, a1); }, "", pybind11::arg("filename"), pybind11::arg("file_comments"));
		cl.def("loadFromPlyFile", (bool (mrpt::opengl::PLY_Importer::*)(const std::string &, class std::vector<std::string, class std::allocator<std::string > > *, class std::vector<std::string, class std::allocator<std::string > > *)) &mrpt::opengl::PLY_Importer::loadFromPlyFile, "Loads from a PLY file.\n \n\n The filename to open. It can be either in binary or\n text format.\n \n\n If provided (!=nullptr) the list of comment\n strings stored in the file will be returned.\n \n\n If provided (!=nullptr) the list of \"object\n info\" strings stored in the file will be returned.\n \n\n false on any error in the file format or reading it. To obtain\n more details on the error you can call getLoadPLYErrorString()\n\nC++: mrpt::opengl::PLY_Importer::loadFromPlyFile(const std::string &, class std::vector<std::string, class std::allocator<std::string > > *, class std::vector<std::string, class std::allocator<std::string > > *) --> bool", pybind11::arg("filename"), pybind11::arg("file_comments"), pybind11::arg("file_obj_info"));
	...
	{ // mrpt::opengl::PLY_Exporter file:mrpt/opengl/PLY_import_export.h line:84
		...
		cl.def("saveToPlyFile", [](mrpt::opengl::PLY_Exporter const &o, const std::string & a0, bool const & a1, const class std::vector<std::string, class std::allocator<std::string > > & a2) -> bool { return o.saveToPlyFile(a0, a1, a2); }, "", pybind11::arg("filename"), pybind11::arg("save_in_binary"), pybind11::arg("file_comments"));
		cl.def("saveToPlyFile", (bool (mrpt::opengl::PLY_Exporter::*)(const std::string &, bool, const class std::vector<std::string, class std::allocator<std::string > > &, const class std::vector<std::string, class std::allocator<std::string > > &) const) &mrpt::opengl::PLY_Exporter::saveToPlyFile, "Saves to a PLY file.\n \n\n The filename to be saved.\n \n\n If provided (!=nullptr) the list of comment\n strings stored in the file will be returned.\n \n\n If provided (!=nullptr) the list of \"object\n info\" strings stored in the file will be returned.\n \n\n false on any error writing the file. To obtain more details on\n the error you can call getSavePLYErrorString()\n\nC++: mrpt::opengl::PLY_Exporter::saveToPlyFile(const std::string &, bool, const class std::vector<std::string, class std::allocator<std::string > > &, const class std::vector<std::string, class std::allocator<std::string > > &) const --> bool", pybind11::arg("filename"), pybind11::arg("save_in_binary"), pybind11::arg("file_comments"), pybind11::arg("file_obj_info"));
