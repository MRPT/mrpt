...
void bind_mrpt_opengl_CArrow(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::CArrow file:mrpt/opengl/CArrow.h line:22
		...
		cl.def("setSlicesCount", (void (mrpt::opengl::CArrow::*)(unsigned int)) &mrpt::opengl::CArrow::setSlicesCount, "Number of radial divisions  \n\nC++: mrpt::opengl::CArrow::setSlicesCount(unsigned int) --> void", pybind11::arg("slices"));
		cl.def("getSlicesCount", (unsigned int (mrpt::opengl::CArrow::*)() const) &mrpt::opengl::CArrow::getSlicesCount, "Number of radial divisions  \n\nC++: mrpt::opengl::CArrow::getSlicesCount() const --> unsigned int");
	...
	{ // mrpt::opengl::CSetOfTexturedTriangles file:mrpt/opengl/CSetOfTexturedTriangles.h line:21
		...
		cl.def("getTrianglesCount", (unsigned long (mrpt::opengl::CSetOfTexturedTriangles::*)() const) &mrpt::opengl::CSetOfTexturedTriangles::getTrianglesCount, "C++: mrpt::opengl::CSetOfTexturedTriangles::getTrianglesCount() const --> unsigned long");
		cl.def("getTriangle", (struct mrpt::opengl::TTriangle (mrpt::opengl::CSetOfTexturedTriangles::*)(unsigned long) const) &mrpt::opengl::CSetOfTexturedTriangles::getTriangle, "C++: mrpt::opengl::CSetOfTexturedTriangles::getTriangle(unsigned long) const --> struct mrpt::opengl::TTriangle", pybind11::arg("idx"));
		cl.def("getTriangle", (void (mrpt::opengl::CSetOfTexturedTriangles::*)(unsigned long, struct mrpt::opengl::TTriangle &) const) &mrpt::opengl::CSetOfTexturedTriangles::getTriangle, "C++: mrpt::opengl::CSetOfTexturedTriangles::getTriangle(unsigned long, struct mrpt::opengl::TTriangle &) const --> void", pybind11::arg("idx"), pybind11::arg("t"));
