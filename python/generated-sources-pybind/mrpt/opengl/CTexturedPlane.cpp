...
void bind_mrpt_opengl_CTexturedPlane(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::opengl::Viewport file:mrpt/opengl/Viewport.h line:64
		...
		cl.def("size", (unsigned long (mrpt::opengl::Viewport::*)() const) &mrpt::opengl::Viewport::size, "Number of objects contained. \n\nC++: mrpt::opengl::Viewport::size() const --> unsigned long");
