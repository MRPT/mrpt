...
void bind_mrpt_opengl_CPolyhedron(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::CPolyhedron file:mrpt/opengl/CPolyhedron.h line:38
		...
		cl.def_static("CreateTrapezohedron", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double, double)) &mrpt::opengl::CPolyhedron::CreateTrapezohedron, "Creates a trapezohedron, consisting of 2*N kites, where N is the number\n of edges in the base. The base radius controls the polyhedron height,\n whilst the distance between bases affects the height.\n When the number of edges equals 3, the polyhedron is actually a\n parallelepiped, and it can even be a cube.\n\nC++: mrpt::opengl::CPolyhedron::CreateTrapezohedron(unsigned int, double, double) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("baseRadius"), pybind11::arg("basesDistance"));
		cl.def_static("CreateRegularAntiprism", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double, double)) &mrpt::opengl::CPolyhedron::CreateRegularAntiprism, "Creates an antiprism whose base is a regular polygon. The upper base is\n rotated \n\n with respect to the lower one, where N is the\n number of vertices in the base, and thus the lateral triangles are\n isosceles.\n \n\n CreateCustomAntiprism,CreateArchimedeanRegularAntiprism\n\nC++: mrpt::opengl::CPolyhedron::CreateRegularAntiprism(unsigned int, double, double) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("baseRadius"), pybind11::arg("height"));
		cl.def_static("CreateRegularPrism", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double, double)) &mrpt::opengl::CPolyhedron::CreateRegularPrism, "Creates a regular prism whose base is a regular polygon and whose edges\n are either parallel or perpendicular to the XY plane.\n \n\n CreateCubicPrism,CreateCustomPrism,CreateArchimedeanRegularAntiprism\n\nC++: mrpt::opengl::CPolyhedron::CreateRegularPrism(unsigned int, double, double) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("baseRadius"), pybind11::arg("height"));
		cl.def_static("CreateRegularPyramid", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double, double)) &mrpt::opengl::CPolyhedron::CreateRegularPyramid, "Creates a regular pyramid whose base is a regular polygon.\n \n\n CreatePyramid\n\nC++: mrpt::opengl::CPolyhedron::CreateRegularPyramid(unsigned int, double, double) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("baseRadius"), pybind11::arg("height"));
		cl.def_static("CreateRegularDoublePyramid", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double, double, double)) &mrpt::opengl::CPolyhedron::CreateRegularDoublePyramid, "Creates a regular double pyramid whose base is a regular polygon.\n \n\n CreateDoublePyramid\n\nC++: mrpt::opengl::CPolyhedron::CreateRegularDoublePyramid(unsigned int, double, double, double) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("baseRadius"), pybind11::arg("height1"), pybind11::arg("height2"));
		cl.def_static("CreateArchimedeanRegularPrism", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double)) &mrpt::opengl::CPolyhedron::CreateArchimedeanRegularPrism, "Creates a regular prism whose lateral area is comprised of squares, and\n so each face of its is a regular polygon. Due to vertex transitivity, the\n resulting object is always archimedean.\n \n\n CreateRegularPrism,CreateCustomPrism\n\nC++: mrpt::opengl::CPolyhedron::CreateArchimedeanRegularPrism(unsigned int, double) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("baseRadius"));
		cl.def_static("CreateArchimedeanRegularAntiprism", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double)) &mrpt::opengl::CPolyhedron::CreateArchimedeanRegularAntiprism, "Creates a regular antiprism whose lateral polygons are equilateral\n triangles, and so each face of its is a regular polygon. Due to vertex\n transitivity, the resulting object is always archimedean.\n \n\n CreateRegularAntiprism,CreateCustomAntiprism\n\nC++: mrpt::opengl::CPolyhedron::CreateArchimedeanRegularAntiprism(unsigned int, double) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("baseRadius"));
		cl.def_static("CreateRegularTruncatedPyramid", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double, double, double)) &mrpt::opengl::CPolyhedron::CreateRegularTruncatedPyramid, "Creates a regular truncated pyramid whose base is a regular polygon.\n \n\n CreateTruncatedPyramid\n\nC++: mrpt::opengl::CPolyhedron::CreateRegularTruncatedPyramid(unsigned int, double, double, double) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("baseRadius"), pybind11::arg("height"), pybind11::arg("ratio"));
		cl.def_static("CreateRegularFrustum", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double, double, double)) &mrpt::opengl::CPolyhedron::CreateRegularFrustum, "This is a synonym for CreateRegularTruncatedPyramid.\n \n\n CreateRegularTruncatedPyramid\n\nC++: mrpt::opengl::CPolyhedron::CreateRegularFrustum(unsigned int, double, double, double) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("baseRadius"), pybind11::arg("height"), pybind11::arg("ratio"));
		cl.def_static("CreateRegularBifrustum", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double, double, double, double, double)) &mrpt::opengl::CPolyhedron::CreateRegularBifrustum, "Creates a bifrustum (double truncated pyramid) whose base is a regular\n polygon lying in the XY plane.\n \n\n CreateBifrustum\n\nC++: mrpt::opengl::CPolyhedron::CreateRegularBifrustum(unsigned int, double, double, double, double, double) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("baseRadius"), pybind11::arg("height1"), pybind11::arg("ratio1"), pybind11::arg("height2"), pybind11::arg("ratio2"));
		cl.def_static("CreateCupola", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double)) &mrpt::opengl::CPolyhedron::CreateCupola, "Creates a cupola.\n \n\n std::logic_error if the number of edges is odd or less than four.\n\nC++: mrpt::opengl::CPolyhedron::CreateCupola(unsigned int, double) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("edgeLength"));
		cl.def_static("CreateCatalanTrapezohedron", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double)) &mrpt::opengl::CPolyhedron::CreateCatalanTrapezohedron, "Creates a trapezohedron whose dual is exactly an archimedean antiprism.\n Creates a cube if numBaseEdges is equal to 3.\n \n\n Actually resulting height is significantly higher than that passed\n to the algorithm.\n \n\n CreateTrapezohedron,CreateArchimedeanRegularAntiprism,getDual\n\nC++: mrpt::opengl::CPolyhedron::CreateCatalanTrapezohedron(unsigned int, double) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("height"));
		cl.def_static("CreateCatalanDoublePyramid", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double)) &mrpt::opengl::CPolyhedron::CreateCatalanDoublePyramid, "Creates a double pyramid whose dual is exactly an archimedean prism.\n Creates an octahedron if numBaseEdges is equal to 4.\n \n\n Actually resulting height is significantly higher than that passed\n to the algorithm.\n \n\n CreateDoublePyramid,CreateArchimedeanRegularPrism,getDual\n\nC++: mrpt::opengl::CPolyhedron::CreateCatalanDoublePyramid(unsigned int, double) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("height"));
		cl.def_static("CreateJohnsonSolidWithConstantBase", [](unsigned int const & a0, double const & a1, const std::string & a2) -> std::shared_ptr<class mrpt::opengl::CPolyhedron> { return mrpt::opengl::CPolyhedron::CreateJohnsonSolidWithConstantBase(a0, a1, a2); }, "", pybind11::arg("numBaseEdges"), pybind11::arg("baseRadius"), pybind11::arg("components"));
		cl.def_static("CreateJohnsonSolidWithConstantBase", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (*)(unsigned int, double, const std::string &, unsigned long)) &mrpt::opengl::CPolyhedron::CreateJohnsonSolidWithConstantBase, "Creates a series of concatenated solids (most of which are prismatoids)\n	  whose base is a regular polygon with a given number of edges. Every face\n	  of the resulting body will be a regular polygon, so it is a Johnson solid;\n	  in special cases, it may be archimedean or even platonic.\n The shape of the body is defined by the string argument, which can\n	  include one or more of the following:\n	  <center>\n	  StringBodyRestrictions\n	  P+Upward pointing pyramidMust be the last\n	  object, vertex number cannot surpass 5\n	  P-Downward pointing pyramidMust be the first\n	  object, vertex number cannot surpass 5\n	  C+Upward pointing cupolaMust be the last object,\n	  vertex number must be an even number in the range 4-10.\n	  C-Downward pointing cupolaMust be the first\n	  object, vertex number must be an even number in the range 4-10.\n	  GC+Upward pointing cupola, rotatedMust be the\n	  last object, vertex number must be an even number in the range\n	  4-10.\n	  GC-Downward pointing cupola, rotatedMust be the\n	  first object, vertex number must be an even number in the range\n	  4-10.\n	  PRArchimedean prismCannot abut other\n	  prism\n	  AArchimedean antiprismNone\n	  R+Upward pointing rotundaMust be the last\n	  object, vertex number must be exactly 10\n	  R-Downward pointing rotundaMust be the first\n	  object, vertex number must be exactly 10\n	  GR+Upward pointing rotunda, rotatedMust be the\n	  last object, vertex number must be exactly 10\n	  GR-Downward pointing rotundaMust be the first\n	  object, vertex number must be exactly 10\n	  </center>\n Some examples of bodies are:\n	  <center>\n	  StringVerticesResulting\n	  body\n	  P+3Tetrahedron\n	  PR4Hexahedron\n	  P-P+4Octahedron\n	  A3Octahedron\n	  C+PRC-\n8Rhombicuboctahedron\n	  P-AP+5Icosahedron\n	  R-R+10Icosidodecahedron\n	  </center>\n\nC++: mrpt::opengl::CPolyhedron::CreateJohnsonSolidWithConstantBase(unsigned int, double, const std::string &, unsigned long) --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numBaseEdges"), pybind11::arg("baseRadius"), pybind11::arg("components"), pybind11::arg("shifts"));
		...
		cl.def("getNumberOfVertices", (unsigned int (mrpt::opengl::CPolyhedron::*)() const) &mrpt::opengl::CPolyhedron::getNumberOfVertices, "Gets the amount of vertices.\n\nC++: mrpt::opengl::CPolyhedron::getNumberOfVertices() const --> unsigned int");
		cl.def("getNumberOfEdges", (unsigned int (mrpt::opengl::CPolyhedron::*)() const) &mrpt::opengl::CPolyhedron::getNumberOfEdges, "Gets the amount of edges.\n\nC++: mrpt::opengl::CPolyhedron::getNumberOfEdges() const --> unsigned int");
		cl.def("getNumberOfFaces", (unsigned int (mrpt::opengl::CPolyhedron::*)() const) &mrpt::opengl::CPolyhedron::getNumberOfFaces, "Gets the amount of faces.\n\nC++: mrpt::opengl::CPolyhedron::getNumberOfFaces() const --> unsigned int");
		...
		cl.def("augment", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (mrpt::opengl::CPolyhedron::*)(double, unsigned long) const) &mrpt::opengl::CPolyhedron::augment, "Augments a polyhedron to a given height. This method only affects to\n faces with certain number of vertices.\n \n\n augment(double) const\n\nC++: mrpt::opengl::CPolyhedron::augment(double, unsigned long) const --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("height"), pybind11::arg("numVertices"));
		...
		cl.def("augment", [](mrpt::opengl::CPolyhedron const &o, unsigned long const & a0) -> std::shared_ptr<class mrpt::opengl::CPolyhedron> { return o.augment(a0); }, "", pybind11::arg("numVertices"));
		cl.def("augment", (class std::shared_ptr<class mrpt::opengl::CPolyhedron> (mrpt::opengl::CPolyhedron::*)(unsigned long, bool) const) &mrpt::opengl::CPolyhedron::augment, "Augments a polyhedron, so that the resulting triangles are equilateral;\n affects only faces with certain number of faces. If the second argument\n is true, triangles are \"cut\" from the polyhedron.\n \n\n std::logic_error a non-regular face has been found.\n \n\n augment(double) const\n\nC++: mrpt::opengl::CPolyhedron::augment(unsigned long, bool) const --> class std::shared_ptr<class mrpt::opengl::CPolyhedron>", pybind11::arg("numVertices"), pybind11::arg("direction"));
		...
		{ // mrpt::opengl::CPolyhedron::TPolyhedronEdge file:mrpt/opengl/CPolyhedron.h line:66
