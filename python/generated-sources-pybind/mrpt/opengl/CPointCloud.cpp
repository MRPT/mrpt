...
void bind_mrpt_opengl_CPointCloud(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::PointCloudAdapter file:mrpt/opengl/CPointCloud.h line:344
		...
		cl.def("size", (unsigned long (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::*)() const) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::size, "Get number of points \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::size() const --> unsigned long");
		cl.def("resize", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::*)(const unsigned long)) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::resize, "Set number of points (to uninitialized values) \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::resize(const unsigned long) --> void", pybind11::arg("N"));
		cl.def("setDimensions", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::*)(unsigned long, unsigned long)) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::setDimensions, "Does nothing as of now \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::setDimensions(unsigned long, unsigned long) --> void", pybind11::arg("height"), pybind11::arg("width"));
		cl.def("setPointXYZ", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::*)(const unsigned long, const float, const float, const float)) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::setPointXYZ, "Set XYZ coordinates of i'th point \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::setPointXYZ(const unsigned long, const float, const float, const float) --> void", pybind11::arg("idx"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"));
		cl.def("setInvalidPoint", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::*)(const unsigned long)) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::setInvalidPoint, "Set XYZ coordinates of i'th point \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloud>::setInvalidPoint(const unsigned long) --> void", pybind11::arg("idx"));
	}
	{ // mrpt::opengl::CText3D file:mrpt/opengl/CText3D.h line:34
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<21> (*)()) &mrpt::opengl::CText3D::getClassName, "C++: mrpt::opengl::CText3D::getClassName() --> class mrpt::typemeta::string_literal<21>");
