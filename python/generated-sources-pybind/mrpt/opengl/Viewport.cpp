...
void bind_mrpt_opengl_Viewport(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::opengl::Scene file:mrpt/opengl/Scene.h line:60
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<19> (*)()) &mrpt::opengl::Scene::getClassName, "C++: mrpt::opengl::Scene::getClassName() --> class mrpt::typemeta::string_literal<19>");
		...
		cl.def("viewportsCount", (unsigned long (mrpt::opengl::Scene::*)() const) &mrpt::opengl::Scene::viewportsCount, "C++: mrpt::opengl::Scene::viewportsCount() const --> unsigned long");
