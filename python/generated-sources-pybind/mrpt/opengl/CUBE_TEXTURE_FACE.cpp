...
;
	...
	{ // mrpt::opengl::CVectorField2D file:mrpt/opengl/CVectorField2D.h line:29
		...
		cl.def("resize", (void (mrpt::opengl::CVectorField2D::*)(unsigned long, unsigned long)) &mrpt::opengl::CVectorField2D::resize, "Resizes the set.\n\nC++: mrpt::opengl::CVectorField2D::resize(unsigned long, unsigned long) --> void", pybind11::arg("rows"), pybind11::arg("cols"));
		cl.def("cols", (unsigned long (mrpt::opengl::CVectorField2D::*)() const) &mrpt::opengl::CVectorField2D::cols, "Returns the total count of rows used to represent the vector field. \n\nC++: mrpt::opengl::CVectorField2D::cols() const --> unsigned long");
		cl.def("rows", (unsigned long (mrpt::opengl::CVectorField2D::*)() const) &mrpt::opengl::CVectorField2D::rows, "Returns the total count of columns used to represent the vector field.\n\nC++: mrpt::opengl::CVectorField2D::rows() const --> unsigned long");
