...
void bind_mrpt_opengl_CSetOfObjects(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::CSetOfObjects file:mrpt/opengl/CSetOfObjects.h line:26
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<27> (*)()) &mrpt::opengl::CSetOfObjects::getClassName, "C++: mrpt::opengl::CSetOfObjects::getClassName() --> class mrpt::typemeta::string_literal<27>");
		...
		cl.def("size", (unsigned long (mrpt::opengl::CSetOfObjects::*)()) &mrpt::opengl::CSetOfObjects::size, "Returns number of objects.  \n\nC++: mrpt::opengl::CSetOfObjects::size() --> unsigned long");
		...
		cl.def("dumpListOfObjects", (void (mrpt::opengl::CSetOfObjects::*)(class std::vector<std::string, class std::allocator<std::string > > &) const) &mrpt::opengl::CSetOfObjects::dumpListOfObjects, "Retrieves a list of all objects in text form\n \n\n Prefer asYAML() (since MRPT 2.1.3) \n\nC++: mrpt::opengl::CSetOfObjects::dumpListOfObjects(class std::vector<std::string, class std::allocator<std::string > > &) const --> void", pybind11::arg("lst"));
