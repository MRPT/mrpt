...
void bind_mrpt_opengl_TTriangle(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::TTriangle file:mrpt/opengl/TTriangle.h line:36
		...
		cl.def("x", (float & (mrpt::opengl::TTriangle::*)(unsigned long)) &mrpt::opengl::TTriangle::x, "C++: mrpt::opengl::TTriangle::x(unsigned long) --> float &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("y", (float & (mrpt::opengl::TTriangle::*)(unsigned long)) &mrpt::opengl::TTriangle::y, "C++: mrpt::opengl::TTriangle::y(unsigned long) --> float &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("z", (float & (mrpt::opengl::TTriangle::*)(unsigned long)) &mrpt::opengl::TTriangle::z, "C++: mrpt::opengl::TTriangle::z(unsigned long) --> float &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("r", (unsigned char & (mrpt::opengl::TTriangle::*)(unsigned long)) &mrpt::opengl::TTriangle::r, "C++: mrpt::opengl::TTriangle::r(unsigned long) --> unsigned char &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("g", (unsigned char & (mrpt::opengl::TTriangle::*)(unsigned long)) &mrpt::opengl::TTriangle::g, "C++: mrpt::opengl::TTriangle::g(unsigned long) --> unsigned char &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("b", (unsigned char & (mrpt::opengl::TTriangle::*)(unsigned long)) &mrpt::opengl::TTriangle::b, "C++: mrpt::opengl::TTriangle::b(unsigned long) --> unsigned char &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("a", (unsigned char & (mrpt::opengl::TTriangle::*)(unsigned long)) &mrpt::opengl::TTriangle::a, "C++: mrpt::opengl::TTriangle::a(unsigned long) --> unsigned char &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("u", (float & (mrpt::opengl::TTriangle::*)(unsigned long)) &mrpt::opengl::TTriangle::u, "C++: mrpt::opengl::TTriangle::u(unsigned long) --> float &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("v", (float & (mrpt::opengl::TTriangle::*)(unsigned long)) &mrpt::opengl::TTriangle::v, "C++: mrpt::opengl::TTriangle::v(unsigned long) --> float &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("vertex", (struct mrpt::math::TPoint3D_<float> & (mrpt::opengl::TTriangle::*)(unsigned long)) &mrpt::opengl::TTriangle::vertex, "C++: mrpt::opengl::TTriangle::vertex(unsigned long) --> struct mrpt::math::TPoint3D_<float> &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
	...
	{ // mrpt::opengl::CTextMessageCapable file:mrpt/opengl/CTextMessageCapable.h line:25
		...
		cl.def("updateTextMessage", (bool (mrpt::opengl::CTextMessageCapable::*)(const unsigned long, const std::string &)) &mrpt::opengl::CTextMessageCapable::updateTextMessage, "Just updates the text of a given text message, without touching the\n other parameters.\n \n\n false if given ID doesn't exist.\n\nC++: mrpt::opengl::CTextMessageCapable::updateTextMessage(const unsigned long, const std::string &) --> bool", pybind11::arg("unique_index"), pybind11::arg("text"));
