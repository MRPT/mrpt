...
;
	...
	{ // mrpt::opengl::COctoMapVoxels file:mrpt/opengl/COctoMapVoxels.h line:63
		...
		cl.def("getGridCubeCount", (unsigned long (mrpt::opengl::COctoMapVoxels::*)() const) &mrpt::opengl::COctoMapVoxels::getGridCubeCount, "Returns the total count of grid cubes. \n\nC++: mrpt::opengl::COctoMapVoxels::getGridCubeCount() const --> unsigned long");
		cl.def("getVoxelSetCount", (unsigned long (mrpt::opengl::COctoMapVoxels::*)() const) &mrpt::opengl::COctoMapVoxels::getVoxelSetCount, "Returns the number of voxel sets. \n\nC++: mrpt::opengl::COctoMapVoxels::getVoxelSetCount() const --> unsigned long");
		cl.def("getVoxelCount", (unsigned long (mrpt::opengl::COctoMapVoxels::*)(const unsigned long) const) &mrpt::opengl::COctoMapVoxels::getVoxelCount, "Returns the total count of voxels in one voxel set. \n\nC++: mrpt::opengl::COctoMapVoxels::getVoxelCount(const unsigned long) const --> unsigned long", pybind11::arg("set_index"));
		...
		cl.def("resizeGridCubes", (void (mrpt::opengl::COctoMapVoxels::*)(const unsigned long)) &mrpt::opengl::COctoMapVoxels::resizeGridCubes, "C++: mrpt::opengl::COctoMapVoxels::resizeGridCubes(const unsigned long) --> void", pybind11::arg("nCubes"));
		cl.def("resizeVoxelSets", (void (mrpt::opengl::COctoMapVoxels::*)(const unsigned long)) &mrpt::opengl::COctoMapVoxels::resizeVoxelSets, "C++: mrpt::opengl::COctoMapVoxels::resizeVoxelSets(const unsigned long) --> void", pybind11::arg("nVoxelSets"));
		cl.def("resizeVoxels", (void (mrpt::opengl::COctoMapVoxels::*)(const unsigned long, const unsigned long)) &mrpt::opengl::COctoMapVoxels::resizeVoxels, "C++: mrpt::opengl::COctoMapVoxels::resizeVoxels(const unsigned long, const unsigned long) --> void", pybind11::arg("set_index"), pybind11::arg("nVoxels"));
		cl.def("reserveGridCubes", (void (mrpt::opengl::COctoMapVoxels::*)(const unsigned long)) &mrpt::opengl::COctoMapVoxels::reserveGridCubes, "C++: mrpt::opengl::COctoMapVoxels::reserveGridCubes(const unsigned long) --> void", pybind11::arg("nCubes"));
		cl.def("reserveVoxels", (void (mrpt::opengl::COctoMapVoxels::*)(const unsigned long, const unsigned long)) &mrpt::opengl::COctoMapVoxels::reserveVoxels, "C++: mrpt::opengl::COctoMapVoxels::reserveVoxels(const unsigned long, const unsigned long) --> void", pybind11::arg("set_index"), pybind11::arg("nVoxels"));
		cl.def("getGridCubeRef", (struct mrpt::opengl::COctoMapVoxels::TGridCube & (mrpt::opengl::COctoMapVoxels::*)(const unsigned long)) &mrpt::opengl::COctoMapVoxels::getGridCubeRef, "C++: mrpt::opengl::COctoMapVoxels::getGridCubeRef(const unsigned long) --> struct mrpt::opengl::COctoMapVoxels::TGridCube &", pybind11::return_value_policy::automatic, pybind11::arg("idx"));
		cl.def("getGridCube", (const struct mrpt::opengl::COctoMapVoxels::TGridCube & (mrpt::opengl::COctoMapVoxels::*)(const unsigned long) const) &mrpt::opengl::COctoMapVoxels::getGridCube, "C++: mrpt::opengl::COctoMapVoxels::getGridCube(const unsigned long) const --> const struct mrpt::opengl::COctoMapVoxels::TGridCube &", pybind11::return_value_policy::automatic, pybind11::arg("idx"));
		cl.def("getVoxelRef", (struct mrpt::opengl::COctoMapVoxels::TVoxel & (mrpt::opengl::COctoMapVoxels::*)(const unsigned long, const unsigned long)) &mrpt::opengl::COctoMapVoxels::getVoxelRef, "C++: mrpt::opengl::COctoMapVoxels::getVoxelRef(const unsigned long, const unsigned long) --> struct mrpt::opengl::COctoMapVoxels::TVoxel &", pybind11::return_value_policy::automatic, pybind11::arg("set_index"), pybind11::arg("idx"));
		cl.def("getVoxel", (const struct mrpt::opengl::COctoMapVoxels::TVoxel & (mrpt::opengl::COctoMapVoxels::*)(const unsigned long, const unsigned long) const) &mrpt::opengl::COctoMapVoxels::getVoxel, "C++: mrpt::opengl::COctoMapVoxels::getVoxel(const unsigned long, const unsigned long) const --> const struct mrpt::opengl::COctoMapVoxels::TVoxel &", pybind11::return_value_policy::automatic, pybind11::arg("set_index"), pybind11::arg("idx"));
		...
		cl.def("push_back_Voxel", (void (mrpt::opengl::COctoMapVoxels::*)(const unsigned long, const struct mrpt::opengl::COctoMapVoxels::TVoxel &)) &mrpt::opengl::COctoMapVoxels::push_back_Voxel, "C++: mrpt::opengl::COctoMapVoxels::push_back_Voxel(const unsigned long, const struct mrpt::opengl::COctoMapVoxels::TVoxel &) --> void", pybind11::arg("set_index"), pybind11::arg("v"));
		...
		{ // mrpt::opengl::COctoMapVoxels::TVoxel file:mrpt/opengl/COctoMapVoxels.h line:93
		...
		{ // mrpt::opengl::COctoMapVoxels::TGridCube file:mrpt/opengl/COctoMapVoxels.h line:109
			auto & enclosing_class = cl;
		...
		{ // mrpt::opengl::COctoMapVoxels::TInfoPerVoxelSet file:mrpt/opengl/COctoMapVoxels.h line:123
			auto & enclosing_class = cl;
