...
;
	...
	{ // mrpt::opengl::COctoMapVoxels file:mrpt/opengl/COctoMapVoxels.h line:63
		...
		cl.def("getVoxelCount", (size_t (mrpt::opengl::COctoMapVoxels::*)(const unsigned long) const) &mrpt::opengl::COctoMapVoxels::getVoxelCount, "Returns the total count of voxels in one voxel set. \n\nC++: mrpt::opengl::COctoMapVoxels::getVoxelCount(const unsigned long) const --> size_t", pybind11::arg("set_index"));
