...
void bind_mrpt_opengl_Buffer(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::opengl::CSetOfLines file:mrpt/opengl/CSetOfLines.h line:25
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<25> (*)()) &mrpt::opengl::CSetOfLines::getClassName, "C++: mrpt::opengl::CSetOfLines::getClassName() --> class mrpt::typemeta::string_literal<25>");
		...
		cl.def("resize", (void (mrpt::opengl::CSetOfLines::*)(unsigned long)) &mrpt::opengl::CSetOfLines::resize, "Resizes the set.\n \n\n reserve\n\nC++: mrpt::opengl::CSetOfLines::resize(unsigned long) --> void", pybind11::arg("nLines"));
		cl.def("reserve", (void (mrpt::opengl::CSetOfLines::*)(unsigned long)) &mrpt::opengl::CSetOfLines::reserve, "Reserves an amount of lines to the set. This method should be used when\n some known amount of lines is going to be inserted, so that only a memory\n allocation is needed.\n \n\n resize\n\nC++: mrpt::opengl::CSetOfLines::reserve(unsigned long) --> void", pybind11::arg("r"));
		cl.def("getLineCount", (unsigned long (mrpt::opengl::CSetOfLines::*)() const) &mrpt::opengl::CSetOfLines::getLineCount, "Returns the total count of lines in this set. \n\nC++: mrpt::opengl::CSetOfLines::getLineCount() const --> unsigned long");
		cl.def("size", (unsigned long (mrpt::opengl::CSetOfLines::*)() const) &mrpt::opengl::CSetOfLines::size, "Returns the total count of lines in this set. \n\nC++: mrpt::opengl::CSetOfLines::size() const --> unsigned long");
		...
		cl.def("setLineByIndex", (void (mrpt::opengl::CSetOfLines::*)(unsigned long, const struct mrpt::math::TSegment3D &)) &mrpt::opengl::CSetOfLines::setLineByIndex, "Sets a specific line in the set, given its index.\n \n\n appendLine\n\nC++: mrpt::opengl::CSetOfLines::setLineByIndex(unsigned long, const struct mrpt::math::TSegment3D &) --> void", pybind11::arg("index"), pybind11::arg("segm"));
		cl.def("setLineByIndex", (void (mrpt::opengl::CSetOfLines::*)(unsigned long, double, double, double, double, double, double)) &mrpt::opengl::CSetOfLines::setLineByIndex, "Sets a specific line in the set, given its index.\n \n\n appendLine\n\nC++: mrpt::opengl::CSetOfLines::setLineByIndex(unsigned long, double, double, double, double, double, double) --> void", pybind11::arg("index"), pybind11::arg("x0"), pybind11::arg("y0"), pybind11::arg("z0"), pybind11::arg("x1"), pybind11::arg("y1"), pybind11::arg("z1"));
		cl.def("getLineByIndex", (void (mrpt::opengl::CSetOfLines::*)(unsigned long, double &, double &, double &, double &, double &, double &) const) &mrpt::opengl::CSetOfLines::getLineByIndex, "Gets a specific line in the set, given its index.\n \n\n getLineByIndex\n\nC++: mrpt::opengl::CSetOfLines::getLineByIndex(unsigned long, double &, double &, double &, double &, double &, double &) const --> void", pybind11::arg("index"), pybind11::arg("x0"), pybind11::arg("y0"), pybind11::arg("z0"), pybind11::arg("x1"), pybind11::arg("y1"), pybind11::arg("z1"));
