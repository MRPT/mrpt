...
struct PyCallBack_mrpt_opengl_CText3D : public mrpt::opengl::CText3D {
	...
	void enqueueForRenderRecursive(const struct mrpt::opengl::TRenderMatrices & a0, int & a1, bool a2, bool a3) const override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::opengl::CText3D *>(this), "enqueueForRenderRecursive");
		if (overload) {
...
void bind_mrpt_opengl_CText3D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::CText3D file:mrpt/opengl/CText3D.h line:34
		...
		cl.def_readwrite("m_fontName", &mrpt::opengl::CText3D::m_fontName);
		cl.def_static("getClassName", (auto (*)()) &mrpt::opengl::CText3D::getClassName, "C++: mrpt::opengl::CText3D::getClassName() --> auto");
