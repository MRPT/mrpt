...
void bind_mrpt_opengl_CPointCloudColoured(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::CPointCloudColoured file:mrpt/opengl/CPointCloudColoured.h line:34
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<33> (*)()) &mrpt::opengl::CPointCloudColoured::getClassName, "C++: mrpt::opengl::CPointCloudColoured::getClassName() --> class mrpt::typemeta::string_literal<33>");
		...
		cl.def("resize", (void (mrpt::opengl::CPointCloudColoured::*)(unsigned long)) &mrpt::opengl::CPointCloudColoured::resize, "Set the number of points, with undefined contents \n\nC++: mrpt::opengl::CPointCloudColoured::resize(unsigned long) --> void", pybind11::arg("N"));
		cl.def("reserve", (void (mrpt::opengl::CPointCloudColoured::*)(unsigned long)) &mrpt::opengl::CPointCloudColoured::reserve, "Like STL std::vector's reserve \n\nC++: mrpt::opengl::CPointCloudColoured::reserve(unsigned long) --> void", pybind11::arg("N"));
		cl.def("getPoint3Df", (const struct mrpt::math::TPoint3D_<float> & (mrpt::opengl::CPointCloudColoured::*)(unsigned long) const) &mrpt::opengl::CPointCloudColoured::getPoint3Df, "NOTE: This method is intentionally not protected by the shared_mutex,\n since it's called in the inner loops of the octree, which acquires the\n lock once.\n\nC++: mrpt::opengl::CPointCloudColoured::getPoint3Df(unsigned long) const --> const struct mrpt::math::TPoint3D_<float> &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("setPoint", (void (mrpt::opengl::CPointCloudColoured::*)(unsigned long, const struct mrpt::math::TPointXYZfRGBAu8 &)) &mrpt::opengl::CPointCloudColoured::setPoint, "Write an individual point (checks for \"i\" in the valid range only in\n Debug). \n\nC++: mrpt::opengl::CPointCloudColoured::setPoint(unsigned long, const struct mrpt::math::TPointXYZfRGBAu8 &) --> void", pybind11::arg("i"), pybind11::arg("p"));
		...
		cl.def("setPointColor_fast", (void (mrpt::opengl::CPointCloudColoured::*)(unsigned long, float, float, float, float)) &mrpt::opengl::CPointCloudColoured::setPointColor_fast, "Like  but without checking for out-of-index erors \n\nC++: mrpt::opengl::CPointCloudColoured::setPointColor_fast(unsigned long, float, float, float, float) --> void", pybind11::arg("index"), pybind11::arg("R"), pybind11::arg("G"), pybind11::arg("B"), pybind11::arg("A"));
		...
		cl.def("setPointColor_u8_fast", (void (mrpt::opengl::CPointCloudColoured::*)(unsigned long, unsigned char, unsigned char, unsigned char, unsigned char)) &mrpt::opengl::CPointCloudColoured::setPointColor_u8_fast, "C++: mrpt::opengl::CPointCloudColoured::setPointColor_u8_fast(unsigned long, unsigned char, unsigned char, unsigned char, unsigned char) --> void", pybind11::arg("index"), pybind11::arg("r"), pybind11::arg("g"), pybind11::arg("b"), pybind11::arg("a"));
		cl.def("getPointColor_fast", (void (mrpt::opengl::CPointCloudColoured::*)(unsigned long, float &, float &, float &) const) &mrpt::opengl::CPointCloudColoured::getPointColor_fast, "Like  but without checking for out-of-index erors \n\nC++: mrpt::opengl::CPointCloudColoured::getPointColor_fast(unsigned long, float &, float &, float &) const --> void", pybind11::arg("index"), pybind11::arg("R"), pybind11::arg("G"), pybind11::arg("B"));
		cl.def("getPointColor_fast", (void (mrpt::opengl::CPointCloudColoured::*)(unsigned long, unsigned char &, unsigned char &, unsigned char &) const) &mrpt::opengl::CPointCloudColoured::getPointColor_fast, "C++: mrpt::opengl::CPointCloudColoured::getPointColor_fast(unsigned long, unsigned char &, unsigned char &, unsigned char &) const --> void", pybind11::arg("index"), pybind11::arg("r"), pybind11::arg("g"), pybind11::arg("b"));
		cl.def("getPointColor", (struct mrpt::img::TColor (mrpt::opengl::CPointCloudColoured::*)(unsigned long) const) &mrpt::opengl::CPointCloudColoured::getPointColor, "C++: mrpt::opengl::CPointCloudColoured::getPointColor(unsigned long) const --> struct mrpt::img::TColor", pybind11::arg("index"));
		cl.def("size", (unsigned long (mrpt::opengl::CPointCloudColoured::*)() const) &mrpt::opengl::CPointCloudColoured::size, "Return the number of points \n\nC++: mrpt::opengl::CPointCloudColoured::size() const --> unsigned long");
		cl.def("size_unprotected", (unsigned long (mrpt::opengl::CPointCloudColoured::*)() const) &mrpt::opengl::CPointCloudColoured::size_unprotected, "Like size(), but without locking the data mutex (internal usage)\n\nC++: mrpt::opengl::CPointCloudColoured::size_unprotected() const --> unsigned long");
		...
		cl.def("getActuallyRendered", (unsigned long (mrpt::opengl::CPointCloudColoured::*)() const) &mrpt::opengl::CPointCloudColoured::getActuallyRendered, "Get the number of elements actually rendered in the last render event.\n\nC++: mrpt::opengl::CPointCloudColoured::getActuallyRendered() const --> unsigned long");
	...
	{ // mrpt::opengl::PointCloudAdapter file:mrpt/opengl/CPointCloudColoured.h line:276
		...
		cl.def("size", (unsigned long (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::*)() const) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::size, "Get number of points \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::size() const --> unsigned long");
		cl.def("resize", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::*)(const unsigned long)) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::resize, "Set number of points (to uninitialized values) \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::resize(const unsigned long) --> void", pybind11::arg("N"));
		cl.def("setDimensions", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::*)(unsigned long, unsigned long)) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setDimensions, "Does nothing as of now \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setDimensions(unsigned long, unsigned long) --> void", pybind11::arg("height"), pybind11::arg("width"));
		cl.def("setPointXYZ", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::*)(const unsigned long, const float, const float, const float)) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setPointXYZ, "Set XYZ coordinates of i'th point \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setPointXYZ(const unsigned long, const float, const float, const float) --> void", pybind11::arg("idx"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"));
		cl.def("setInvalidPoint", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::*)(const unsigned long)) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setInvalidPoint, "C++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setInvalidPoint(const unsigned long) --> void", pybind11::arg("idx"));
		cl.def("setPointXYZ_RGBAf", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::*)(const unsigned long, const float, const float, const float, const float, const float, const float, const float)) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setPointXYZ_RGBAf, "Set XYZ_RGBf coordinates of i'th point \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setPointXYZ_RGBAf(const unsigned long, const float, const float, const float, const float, const float, const float, const float) --> void", pybind11::arg("idx"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"), pybind11::arg("Rf"), pybind11::arg("Gf"), pybind11::arg("Bf"), pybind11::arg("Af"));
		cl.def("setPointXYZ_RGBu8", [](mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured> &o, const unsigned long & a0, const float & a1, const float & a2, const float & a3, const unsigned char & a4, const unsigned char & a5, const unsigned char & a6) -> void { return o.setPointXYZ_RGBu8(a0, a1, a2, a3, a4, a5, a6); }, "", pybind11::arg("idx"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"), pybind11::arg("r"), pybind11::arg("g"), pybind11::arg("b"));
		cl.def("setPointXYZ_RGBu8", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::*)(const unsigned long, const float, const float, const float, const unsigned char, const unsigned char, const unsigned char, const unsigned char)) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setPointXYZ_RGBu8, "Set XYZ_RGBu8 coordinates of i'th point \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setPointXYZ_RGBu8(const unsigned long, const float, const float, const float, const unsigned char, const unsigned char, const unsigned char, const unsigned char) --> void", pybind11::arg("idx"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"), pybind11::arg("r"), pybind11::arg("g"), pybind11::arg("b"), pybind11::arg("a"));
		cl.def("getPointRGBf", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::*)(const unsigned long, float &, float &, float &) const) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::getPointRGBf, "Get RGBf color of i'th point \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::getPointRGBf(const unsigned long, float &, float &, float &) const --> void", pybind11::arg("idx"), pybind11::arg("r"), pybind11::arg("g"), pybind11::arg("b"));
		cl.def("setPointRGBf", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::*)(const unsigned long, const float, const float, const float)) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setPointRGBf, "Set XYZ_RGBf coordinates of i'th point \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setPointRGBf(const unsigned long, const float, const float, const float) --> void", pybind11::arg("idx"), pybind11::arg("r"), pybind11::arg("g"), pybind11::arg("b"));
		cl.def("getPointRGBu8", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::*)(const unsigned long, unsigned char &, unsigned char &, unsigned char &) const) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::getPointRGBu8, "Get RGBu8 color of i'th point \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::getPointRGBu8(const unsigned long, unsigned char &, unsigned char &, unsigned char &) const --> void", pybind11::arg("idx"), pybind11::arg("r"), pybind11::arg("g"), pybind11::arg("b"));
		cl.def("setPointRGBu8", (void (mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::*)(const unsigned long, const unsigned char, const unsigned char, const unsigned char)) &mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setPointRGBu8, "Set RGBu8 coordinates of i'th point \n\nC++: mrpt::opengl::PointCloudAdapter<mrpt::opengl::CPointCloudColoured>::setPointRGBu8(const unsigned long, const unsigned char, const unsigned char, const unsigned char) --> void", pybind11::arg("idx"), pybind11::arg("r"), pybind11::arg("g"), pybind11::arg("b"));
	}
}
