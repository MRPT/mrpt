...
;
	...
	{ // mrpt::opengl::CRenderizable file:mrpt/opengl/CRenderizable.h line:71
		...
		cl.def("setColor_u8", [](mrpt::opengl::CRenderizable &o, unsigned char const & a0, unsigned char const & a1, unsigned char const & a2) -> mrpt::opengl::CRenderizable & { return o.setColor_u8(a0, a1, a2); }, "", pybind11::return_value_policy::automatic, pybind11::arg("R"), pybind11::arg("G"), pybind11::arg("B"));
		cl.def("setColor_u8", (class mrpt::opengl::CRenderizable & (mrpt::opengl::CRenderizable::*)(unsigned char, unsigned char, unsigned char, unsigned char)) &mrpt::opengl::CRenderizable::setColor_u8, "Set the color components of this object (R,G,B,Alpha, in the range\n 0-255)  \n\n a ref to this \n\nC++: mrpt::opengl::CRenderizable::setColor_u8(unsigned char, unsigned char, unsigned char, unsigned char) --> class mrpt::opengl::CRenderizable &", pybind11::return_value_policy::automatic, pybind11::arg("R"), pybind11::arg("G"), pybind11::arg("B"), pybind11::arg("A"));
