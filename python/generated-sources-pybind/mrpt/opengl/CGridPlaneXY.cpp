...
void bind_mrpt_opengl_CGridPlaneXY(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::CGridPlaneXY file:mrpt/opengl/CGridPlaneXY.h line:23
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<26> (*)()) &mrpt::opengl::CGridPlaneXY::getClassName, "C++: mrpt::opengl::CGridPlaneXY::getClassName() --> class mrpt::typemeta::string_literal<26>");
	...
	{ // mrpt::opengl::CPointCloud file:mrpt/opengl/CPointCloud.h line:34
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<25> (*)()) &mrpt::opengl::CPointCloud::getClassName, "C++: mrpt::opengl::CPointCloud::getClassName() --> class mrpt::typemeta::string_literal<25>");
		...
		cl.def("size", (unsigned long (mrpt::opengl::CPointCloud::*)() const) &mrpt::opengl::CPointCloud::size, "		@{ \n\nC++: mrpt::opengl::CPointCloud::size() const --> unsigned long");
		cl.def("size_unprotected", (unsigned long (mrpt::opengl::CPointCloud::*)() const) &mrpt::opengl::CPointCloud::size_unprotected, "Like size(), but without locking the data mutex (internal usage)\n\nC++: mrpt::opengl::CPointCloud::size_unprotected() const --> unsigned long");
		cl.def("resize", (void (mrpt::opengl::CPointCloud::*)(unsigned long)) &mrpt::opengl::CPointCloud::resize, "Set the number of points (with contents undefined) \n\nC++: mrpt::opengl::CPointCloud::resize(unsigned long) --> void", pybind11::arg("N"));
		cl.def("reserve", (void (mrpt::opengl::CPointCloud::*)(unsigned long)) &mrpt::opengl::CPointCloud::reserve, "Like STL std::vector's reserve \n\nC++: mrpt::opengl::CPointCloud::reserve(unsigned long) --> void", pybind11::arg("N"));
		...
		cl.def("__getitem__", (const struct mrpt::math::TPoint3D_<float> & (mrpt::opengl::CPointCloud::*)(unsigned long) const) &mrpt::opengl::CPointCloud::operator[], "Read access to each individual point (checks for \"i\" in the valid\n range only in Debug). \n\nC++: mrpt::opengl::CPointCloud::operator[](unsigned long) const --> const struct mrpt::math::TPoint3D_<float> &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("getPoint3Df", (const struct mrpt::math::TPoint3D_<float> & (mrpt::opengl::CPointCloud::*)(unsigned long) const) &mrpt::opengl::CPointCloud::getPoint3Df, "NOTE: This method is intentionally not protected by the shared_mutex,\n since it's called in the inner loops of the octree, which acquires the\n lock once.\n\nC++: mrpt::opengl::CPointCloud::getPoint3Df(unsigned long) const --> const struct mrpt::math::TPoint3D_<float> &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
		cl.def("setPoint", (void (mrpt::opengl::CPointCloud::*)(unsigned long, const float, const float, const float)) &mrpt::opengl::CPointCloud::setPoint, "Write an individual point (checks for \"i\" in the valid range only in\n Debug). \n\nC++: mrpt::opengl::CPointCloud::setPoint(unsigned long, const float, const float, const float) --> void", pybind11::arg("i"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"));
		cl.def("setPoint_fast", (void (mrpt::opengl::CPointCloud::*)(unsigned long, const float, const float, const float)) &mrpt::opengl::CPointCloud::setPoint_fast, "Write an individual point (without checking validity of the index).\n\nC++: mrpt::opengl::CPointCloud::setPoint_fast(unsigned long, const float, const float, const float) --> void", pybind11::arg("i"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("z"));
		cl.def("getActuallyRendered", (unsigned long (mrpt::opengl::CPointCloud::*)() const) &mrpt::opengl::CPointCloud::getActuallyRendered, "Get the number of elements actually rendered in the last render\n event.\n\nC++: mrpt::opengl::CPointCloud::getActuallyRendered() const --> unsigned long");
