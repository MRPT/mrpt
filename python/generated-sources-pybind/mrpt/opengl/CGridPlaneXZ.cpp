...
struct PyCallBack_mrpt_opengl_CGridPlaneXZ : public mrpt::opengl::CGridPlaneXZ {
	...
	void enqueueForRenderRecursive(const struct mrpt::opengl::TRenderMatrices & a0, int & a1, bool a2, bool a3) const override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::opengl::CGridPlaneXZ *>(this), "enqueueForRenderRecursive");
		if (overload) {
...
struct PyCallBack_mrpt_opengl_CMesh : public mrpt::opengl::CMesh {
	...
	void enqueueForRenderRecursive(const struct mrpt::opengl::TRenderMatrices & a0, int & a1, bool a2, bool a3) const override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const mrpt::opengl::CMesh *>(this), "enqueueForRenderRecursive");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1, a2, a3);
			if (pybind11::detail::cast_is_temporary_value_reference<void>::value) {
				static pybind11::detail::override_caster_t<void> caster;
...
void bind_mrpt_opengl_CGridPlaneXZ(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::CGridPlaneXZ file:mrpt/opengl/CGridPlaneXZ.h line:23
		...
		cl.def_static("getClassName", (auto (*)()) &mrpt::opengl::CGridPlaneXZ::getClassName, "C++: mrpt::opengl::CGridPlaneXZ::getClassName() --> auto");
	...
	{ // mrpt::opengl::CMesh file:mrpt/opengl/CMesh.h line:39
		...
		cl.def_static("getClassName", (auto (*)()) &mrpt::opengl::CMesh::getClassName, "C++: mrpt::opengl::CMesh::getClassName() --> auto");
		...
		cl.def("requiredShaders", (int (mrpt::opengl::CMesh::*)() const) &mrpt::opengl::CMesh::requiredShaders, "C++: mrpt::opengl::CMesh::requiredShaders() const --> int");
