...
void bind_mrpt_opengl_CSetOfTriangles(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::CSetOfTriangles file:mrpt/opengl/CSetOfTriangles.h line:22
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<29> (*)()) &mrpt::opengl::CSetOfTriangles::getClassName, "C++: mrpt::opengl::CSetOfTriangles::getClassName() --> class mrpt::typemeta::string_literal<29>");
		...
		cl.def("getTrianglesCount", (unsigned long (mrpt::opengl::CSetOfTriangles::*)() const) &mrpt::opengl::CSetOfTriangles::getTrianglesCount, "Get triangle count \n\nC++: mrpt::opengl::CSetOfTriangles::getTrianglesCount() const --> unsigned long");
		cl.def("getTriangle", (void (mrpt::opengl::CSetOfTriangles::*)(unsigned long, struct mrpt::opengl::TTriangle &) const) &mrpt::opengl::CSetOfTriangles::getTriangle, "Gets the i-th triangle \n\nC++: mrpt::opengl::CSetOfTriangles::getTriangle(unsigned long, struct mrpt::opengl::TTriangle &) const --> void", pybind11::arg("idx"), pybind11::arg("t"));
		...
		cl.def("reserve", (void (mrpt::opengl::CSetOfTriangles::*)(unsigned long)) &mrpt::opengl::CSetOfTriangles::reserve, "Reserves memory for certain number of triangles, avoiding multiple\n memory allocation calls.\n\nC++: mrpt::opengl::CSetOfTriangles::reserve(unsigned long) --> void", pybind11::arg("t"));
	...
	{ // mrpt::opengl::CAngularObservationMesh file:mrpt/opengl/CAngularObservationMesh.h line:41
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<37> (*)()) &mrpt::opengl::CAngularObservationMesh::getClassName, "C++: mrpt::opengl::CAngularObservationMesh::getClassName() --> class mrpt::typemeta::string_literal<37>");
		...
		{ // mrpt::opengl::CAngularObservationMesh::TDoubleRange file:mrpt/opengl/CAngularObservationMesh.h line:49
			...
			cl.def( pybind11::init<double, double, unsigned long>(), pybind11::arg("a"), pybind11::arg("b"), pybind11::arg("c") );

			cl.def( pybind11::init<double, unsigned long, bool>(), pybind11::arg("a"), pybind11::arg("b"), pybind11::arg("c") );
			...
			cl.def_static("CreateFromAmount", (struct mrpt::opengl::CAngularObservationMesh::TDoubleRange (*)(double, double, unsigned long)) &mrpt::opengl::CAngularObservationMesh::TDoubleRange::CreateFromAmount, "Creates a range of values from the initial value, the final value\n and a desired amount of samples.\n\nC++: mrpt::opengl::CAngularObservationMesh::TDoubleRange::CreateFromAmount(double, double, unsigned long) --> struct mrpt::opengl::CAngularObservationMesh::TDoubleRange", pybind11::arg("initial"), pybind11::arg("final"), pybind11::arg("amount"));
			...
			cl.def_static("CreateFromAperture", (struct mrpt::opengl::CAngularObservationMesh::TDoubleRange (*)(double, unsigned long, bool)) &mrpt::opengl::CAngularObservationMesh::TDoubleRange::CreateFromAperture, "Creates a zero-centered range of values from an aperture, an amount\n of samples and a direction.\n\nC++: mrpt::opengl::CAngularObservationMesh::TDoubleRange::CreateFromAperture(double, unsigned long, bool) --> struct mrpt::opengl::CAngularObservationMesh::TDoubleRange", pybind11::arg("aperture"), pybind11::arg("amount"), pybind11::arg("negToPos"));
			...
			cl.def("amount", (unsigned long (mrpt::opengl::CAngularObservationMesh::TDoubleRange::*)() const) &mrpt::opengl::CAngularObservationMesh::TDoubleRange::amount, "Returns the total amount of values in this range.\n \n\n std::logic_error on invalid range type.\n\nC++: mrpt::opengl::CAngularObservationMesh::TDoubleRange::amount() const --> unsigned long");
