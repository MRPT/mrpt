...
void bind_mrpt_opengl_CPlanarLaserScan(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::CPlanarLaserScan file:mrpt/opengl/CPlanarLaserScan.h line:55
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<30> (*)()) &mrpt::opengl::CPlanarLaserScan::getClassName, "C++: mrpt::opengl::CPlanarLaserScan::getClassName() --> class mrpt::typemeta::string_literal<30>");
