...
void bind_mrpt_opengl_CSimpleLine(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // mrpt::opengl::CCylinder file:mrpt/opengl/CCylinder.h line:23
		...
		cl.def("setSlicesCount", (void (mrpt::opengl::CCylinder::*)(unsigned int)) &mrpt::opengl::CCylinder::setSlicesCount, "Number of radial divisions  \n\nC++: mrpt::opengl::CCylinder::setSlicesCount(unsigned int) --> void", pybind11::arg("slices"));
		cl.def("getSlicesCount", (unsigned int (mrpt::opengl::CCylinder::*)() const) &mrpt::opengl::CCylinder::getSlicesCount, "Number of radial divisions  \n\nC++: mrpt::opengl::CCylinder::getSlicesCount() const --> unsigned int");
