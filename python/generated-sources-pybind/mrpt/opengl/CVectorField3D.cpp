...
void bind_mrpt_opengl_CVectorField3D(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::opengl::CVectorField3D file:mrpt/opengl/CVectorField3D.h line:32
		...
		cl.def_static("getClassName", (class mrpt::typemeta::string_literal<28> (*)()) &mrpt::opengl::CVectorField3D::getClassName, "C++: mrpt::opengl::CVectorField3D::getClassName() --> class mrpt::typemeta::string_literal<28>");
		...
		cl.def("resize", (void (mrpt::opengl::CVectorField3D::*)(unsigned long, unsigned long)) &mrpt::opengl::CVectorField3D::resize, "Resizes the set.\n\nC++: mrpt::opengl::CVectorField3D::resize(unsigned long, unsigned long) --> void", pybind11::arg("rows"), pybind11::arg("cols"));
		cl.def("cols", (unsigned long (mrpt::opengl::CVectorField3D::*)() const) &mrpt::opengl::CVectorField3D::cols, "Returns the total count of rows used to represent the vector field. \n\nC++: mrpt::opengl::CVectorField3D::cols() const --> unsigned long");
		cl.def("rows", (unsigned long (mrpt::opengl::CVectorField3D::*)() const) &mrpt::opengl::CVectorField3D::rows, "Returns the total count of columns used to represent the vector field.\n\nC++: mrpt::opengl::CVectorField3D::rows() const --> unsigned long");
