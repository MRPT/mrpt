...
void bind_mrpt_system_CTimeLogger(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mrpt::system::CTimeLogger file:mrpt/system/CTimeLogger.h line:51
		...
		cl.def("getStatsAsText", (std::string (mrpt::system::CTimeLogger::*)(const unsigned long) const) &mrpt::system::CTimeLogger::getStatsAsText, "Dump all stats to a multi-line text string. \n dumpAllStats,\n saveToCVSFile \n\nC++: mrpt::system::CTimeLogger::getStatsAsText(const unsigned long) const --> std::string", pybind11::arg("column_width"));
		cl.def("dumpAllStats", [](mrpt::system::CTimeLogger const &o) -> void { return o.dumpAllStats(); }, "");
		cl.def("dumpAllStats", (void (mrpt::system::CTimeLogger::*)(const unsigned long) const) &mrpt::system::CTimeLogger::dumpAllStats, "Dump all stats through the COutputLogger interface. \n getStatsAsText,\n saveToCVSFile \n\nC++: mrpt::system::CTimeLogger::dumpAllStats(const unsigned long) const --> void", pybind11::arg("column_width"));
