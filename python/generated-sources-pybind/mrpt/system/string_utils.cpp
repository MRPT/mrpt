...
{
	// mrpt::system::tokenize(const std::string &, const std::string &, class std::vector<std::string, class std::allocator<std::string > > &, bool) file:mrpt/system/string_utils.h line:50
	M("mrpt::system").def("tokenize", [](const std::string & a0, const std::string & a1, class std::vector<std::string, class std::allocator<std::string > > & a2) -> void { return mrpt::system::tokenize(a0, a1, a2); }, "", pybind11::arg("inString"), pybind11::arg("inDelimiters"), pybind11::arg("outTokens"));
	M("mrpt::system").def("tokenize", (void (*)(const std::string &, const std::string &, class std::vector<std::string, class std::allocator<std::string > > &, bool)) &mrpt::system::tokenize<std::vector<std::string, std::allocator<std::string > >>, "Tokenizes a string according to a set of delimiting characters.\n Example:\n \n\n\n\n\n  Will generate 3 tokens:\n		- \"Pepe\"\n		- \"Er\"\n		- \"Muo\"\n \n\n If `true`, consecutive \"delimiters\" will be\n considered one single delimiters. If `false`, a blank token will be returned\n between each pair of delimiters.\n \n\n Can be a std::vector or std::deque of std::string's.\n\nC++: mrpt::system::tokenize(const std::string &, const std::string &, class std::vector<std::string, class std::allocator<std::string > > &, bool) --> void", pybind11::arg("inString"), pybind11::arg("inDelimiters"), pybind11::arg("outTokens"), pybind11::arg("skipBlankTokens"));

	// mrpt::system::trim(const std::string &) file:mrpt/system/string_utils.h line:63
	...
	// mrpt::system::upperCase(const std::string &) file:mrpt/system/string_utils.h line:67
	...
	// mrpt::system::lowerCase(const std::string &) file:mrpt/system/string_utils.h line:71
	...
	// mrpt::system::unitsFormat(const double, int, bool) file:mrpt/system/string_utils.h line:99
	...
	// mrpt::system::rightPad(const std::string &, const unsigned long, bool) file:mrpt/system/string_utils.h line:103
	M("mrpt::system").def("rightPad", [](const std::string & a0, const unsigned long & a1) -> std::string { return mrpt::system::rightPad(a0, a1); }, "", pybind11::arg("str"), pybind11::arg("total_len"));
	M("mrpt::system").def("rightPad", (std::string (*)(const std::string &, const unsigned long, bool)) &mrpt::system::rightPad, "Enlarge the string with spaces up to the given length. \n\nC++: mrpt::system::rightPad(const std::string &, const unsigned long, bool) --> std::string", pybind11::arg("str"), pybind11::arg("total_len"), pybind11::arg("truncate_if_larger"));

	// mrpt::system::strCmp(const std::string &, const std::string &) file:mrpt/system/string_utils.h line:108
	...
	// mrpt::system::strCmpI(const std::string &, const std::string &) file:mrpt/system/string_utils.h line:111
	...
	// mrpt::system::strStarts(const std::string &, const std::string &) file:mrpt/system/string_utils.h line:115
	...
	// mrpt::system::strStartsI(const std::string &, const std::string &) file:mrpt/system/string_utils.h line:119
	...
	// mrpt::system::stringListAsString(const class std::vector<std::string, class std::allocator<std::string > > &, std::string &, const std::string &) file:mrpt/system/string_utils.h line:140
