...
{
	// mrpt::system::compute_CRC16(const int &, const unsigned short) file:mrpt/system/crc.h line:24
	M("mrpt::system").def("compute_CRC16", [](const int & a0) -> uint16_t { return mrpt::system::compute_CRC16(a0); }, "", pybind11::arg("data"));
	M("mrpt::system").def("compute_CRC16", (uint16_t (*)(const int &, const unsigned short)) &mrpt::system::compute_CRC16, "Computes the CRC16 checksum of a block of data.  \n\nC++: mrpt::system::compute_CRC16(const int &, const unsigned short) --> uint16_t", pybind11::arg("data"), pybind11::arg("gen_pol"));
	...
	// mrpt::system::compute_CRC32(const int &, const unsigned int) file:mrpt/system/crc.h line:30
	M("mrpt::system").def("compute_CRC32", [](const int & a0) -> uint32_t { return mrpt::system::compute_CRC32(a0); }, "", pybind11::arg("data"));
	M("mrpt::system").def("compute_CRC32", (uint32_t (*)(const int &, const unsigned int)) &mrpt::system::compute_CRC32, "Computes the CRC32 checksum of a block of data.  \n\nC++: mrpt::system::compute_CRC32(const int &, const unsigned int) --> uint32_t", pybind11::arg("data"), pybind11::arg("gen_pol"));
	...
	// mrpt::system::deleteFilesInDirectory(const std::string &, bool) file:mrpt/system/filesystem.h line:81
	...
	// mrpt::system::extractFileDirectory(const std::string &) file:mrpt/system/filesystem.h line:106
	...
	// mrpt::system::fileExists(const std::string &) file:mrpt/system/filesystem.h line:111
	...
	// mrpt::system::directoryExists(const std::string &) file:mrpt/system/filesystem.h line:117
	...
	// mrpt::system::fileNameStripInvalidChars(const std::string &, const char) file:mrpt/system/filesystem.h line:123
	...
	// mrpt::system::fileNameChangeExtension(const std::string &, const std::string &) file:mrpt/system/filesystem.h line:132
	...
	// mrpt::system::getFileSize(const std::string &) file:mrpt/system/filesystem.h line:137
	...
	// mrpt::system::getFileModificationTime(const std::string &) file:mrpt/system/filesystem.h line:141
	...
	// mrpt::system::filePathSeparatorsToNative(const std::string &) file:mrpt/system/filesystem.h line:144
	...
	// mrpt::system::copyFile(const std::string &, const std::string &, std::string *) file:mrpt/system/filesystem.h line:154
	...
	// mrpt::system::toAbsolutePath(const std::string &, bool) file:mrpt/system/filesystem.h line:172
	...
	// mrpt::system::pathJoin(const int &) file:mrpt/system/filesystem.h line:185
	M("mrpt::system").def("pathJoin", (std::string (*)(const int &)) &mrpt::system::pathJoin, "Portable version of std::filesystem::path::append(), with Python-like name.\n\n  \n\n\n\n\n  \n (New in MRPT 2.5.0)\n\nC++: mrpt::system::pathJoin(const int &) --> std::string", pybind11::arg("paths"));
	...
	// mrpt::system::md5(const int &) file:mrpt/system/md5.h line:26
	M("mrpt::system").def("md5", (std::string (*)(const int &)) &mrpt::system::md5, "Computes the md5 of a block of data. \n\nC++: mrpt::system::md5(const int &) --> std::string", pybind11::arg("str"));
