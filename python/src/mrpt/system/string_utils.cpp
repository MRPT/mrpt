...
void bind_mrpt_system_string_utils(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// mrpt::system::unitsFormat(const double, int, bool) file:mrpt/system/string_utils.h line:107
	...
	// mrpt::system::rightPad(const std::string &, size_t, bool) file:mrpt/system/string_utils.h line:111
	...
	// mrpt::system::strCmp(const std::string &, const std::string &) file:mrpt/system/string_utils.h line:115
	...
	// mrpt::system::strCmpI(const std::string &, const std::string &) file:mrpt/system/string_utils.h line:118
	...
	// mrpt::system::strStarts(const std::string &, const std::string &) file:mrpt/system/string_utils.h line:122
	...
	// mrpt::system::strStartsI(const std::string &, const std::string &) file:mrpt/system/string_utils.h line:126
	...
	// mrpt::system::stringListAsString(const class std::vector<std::string > &, std::string &, const std::string &) file:mrpt/system/string_utils.h line:147
	...
	// mrpt::system::nthOccurrence(const std::string &, const std::string &, size_t) file:mrpt/system/string_utils.h line:159
