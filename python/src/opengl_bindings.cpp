...
{
	return std::make_aligned_shared<CSetOfLines>();
}
// end of CSetOfLines

// CEllipsoid
CEllipsoid::Ptr CEllipsoid_Create() { return std::make_aligned_shared<CEllipsoid>(); }
...
{
	return std::make_aligned_shared<CGridPlaneXY>(xMin, xMax, yMin, yMax, z, frequency);
}
