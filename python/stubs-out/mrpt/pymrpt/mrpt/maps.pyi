...
class CBeacon(mrpt.pymrpt.mrpt.poses.CPointPDF):
    ...
    @overload
    def bayesianFusion(self, p1: mrpt.pymrpt.mrpt.poses.CPointPDF,
                       p2: mrpt.pymrpt.mrpt.poses.CPointPDF) -> None: ...

    @overload
    def bayesianFusion(self, p1: mrpt.pymrpt.mrpt.poses.CPointPDF,
                       p2: mrpt.pymrpt.mrpt.poses.CPointPDF, minMahalanobisDistToDrop: float) -> None: ...

    @overload
    def changeCoordinatesReference(
        self, newReferenceBase: mrpt.pymrpt.mrpt.poses.CPose3D) -> None: ...
    ...
    def drawSingleSample(
        self, outSample: mrpt.pymrpt.mrpt.poses.CPoint3D) -> None: ...
    ...
    def getCovarianceAndMean(self) -> Tuple[mrpt.pymrpt.mrpt.math.CMatrixFixed_double_3UL_3UL_t,
                                            mrpt.pymrpt.mrpt.poses.CPoint3D]: ...
    ...
    @overload
    def getVisualizationInto(
        self, o: mrpt.pymrpt.mrpt.opengl.CSetOfObjects) -> None: ...
...
class CBeaconMap(CMetricMap):
    class TInsertionOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        def loadFromConfigFile(
            self, source: mrpt.pymrpt.mrpt.config.CConfigFileBase, section: str) -> None: ...
    ...
    @overload
    def changeCoordinatesReference(
        self, newOrg: mrpt.pymrpt.mrpt.poses.CPose3D) -> None: ...
    ...
    @overload
    def changeCoordinatesReference(
        self, newOrg: mrpt.pymrpt.mrpt.poses.CPose3D, otherMap: CBeaconMap) -> None: ...

    def clone(self) -> mrpt.pymrpt.mrpt.rtti.CObject: ...

    def compute3DMatchingRatio(
        self, otherMap: CMetricMap, otherMapPose: mrpt.pymrpt.mrpt.poses.CPose3D, params: TMatchingRatioParams) -> float: ...
    def determineMatching2D(self, otherMap: CMetricMap, otherMapPose: mrpt.pymrpt.mrpt.poses.CPose2D,
                            correspondences: mrpt.pymrpt.mrpt.tfest.TMatchingPairListTempl_float_t, params: TMatchingParams, extraResults: TMatchingExtraResults) -> None: ...
    ...
    @overload
    def getVisualizationInto(
        self, outObj: mrpt.pymrpt.mrpt.opengl.CSetOfObjects) -> None: ...
    ...
    def simulateBeaconReadings(self, in_robotPose: mrpt.pymrpt.mrpt.poses.CPose3D,
                               in_sensorLocationOnRobot: mrpt.pymrpt.mrpt.poses.CPoint3D, out_Observations) -> None: ...
...
class CColouredOctoMap(COctoMapBase_octomap_ColorOcTree_octomap_ColorOcTreeNode_t):
    ...
    @overload
    def getAsOctoMapVoxels(
        self, gl_obj: mrpt.pymrpt.mrpt.opengl.COctoMapVoxels) -> None: ...
    ...
    def getPointColour(self, x: float, y: float, z: float,
    ...
    def insertRay(self, end_x: float, end_y: float, end_z: float,
                  sensor_x: float, sensor_y: float, sensor_z: float) -> None: ...
    ...
    @overload
    def setVoxelColourMethod(
        self, new_method: CColouredOctoMap.TColourUpdate) -> None: ...
    ...
    def updateVoxel(self, x: float, y: float, z: float,
                    occupied: bool) -> None: ...
    def updateVoxelColour(self, x: float, y: float, z: float,
...
class CColouredPointsMap(CPointsMap):
    class TColourOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, arg0: CColouredPointsMap.TColourOptions) -> None: ...
    ...
    class TMapDefinition(CColouredPointsMap.TMapDefinitionBase):
        ...
        @overload
        def __init__(
            self, arg0: CColouredPointsMap.TMapDefinition) -> None: ...
    ...
    def colourFromObservation(self, obs: mrpt.pymrpt.mrpt.obs.CObservationImage,
                              robotPose: mrpt.pymrpt.mrpt.poses.CPose3D) -> bool: ...

    def getPointColor(self, index: int, R: float,
                      G: float, B: float) -> None: ...

    def getPointColor_fast(self, index: int, R: float,
                           G: float, B: float) -> None: ...

    def getPointRGB(self, index: int, x: float, y: float,
                    z: float, R: float, G: float, B: float) -> None: ...
    ...
    def insertPointRGB(self, x: float, y: float, z: float,
    ...
    def setPointColor(self, index: int, R: float,
                      G: float, B: float) -> None: ...

    def setPointColor_fast(self, index: int, R: float,
                           G: float, B: float) -> None: ...
    def setPointRGB(self, index: int, x: float, y: float,
                    z: float, R: float, G: float, B: float) -> None: ...
...
class CGasConcentrationGridMap2D(CRandomFieldGridMap2D):
    ...
    class TGaussianWindTable:
        ...
        @overload
        def __init__(
            self, arg0: CGasConcentrationGridMap2D.TGaussianWindTable) -> None: ...
    ...
    class TInsertionOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions, CRandomFieldGridMap2D.TInsertionOptionsCommon):
        ...
        @overload
        def __init__(
            self, arg0: CGasConcentrationGridMap2D.TInsertionOptions) -> None: ...
    ...
    @overload
    def __init__(
        self, arg0: CRandomFieldGridMap2D.TMapRepresentation) -> None: ...

    @overload
    def __init__(self, arg0: CRandomFieldGridMap2D.TMapRepresentation,
                 arg1: float) -> None: ...

    @overload
    def __init__(self, arg0: CRandomFieldGridMap2D.TMapRepresentation,
                 arg1: float, arg2: float) -> None: ...

    @overload
    def __init__(self, arg0: CRandomFieldGridMap2D.TMapRepresentation,
                 arg1: float, arg2: float, arg3: float) -> None: ...

    @overload
    def __init__(self, arg0: CRandomFieldGridMap2D.TMapRepresentation,
                 arg1: float, arg2: float, arg3: float, arg4: float) -> None: ...

    @overload
    def __init__(self, mapType: CRandomFieldGridMap2D.TMapRepresentation, x_min: float,
                 x_max: float, y_min: float, y_max: float, resolution: float) -> None: ...
    ...
    def getAs3DObject(self, meanObj: mrpt.pymrpt.mrpt.opengl.CSetOfObjects,
                      varObj: mrpt.pymrpt.mrpt.opengl.CSetOfObjects) -> None: ...
    ...
    @overload
    def getWindAs3DObject(
        self, windObj: mrpt.pymrpt.mrpt.opengl.CSetOfObjects) -> None: ...
...
class CHeightGridMap2D(CMetricMap, mrpt.pymrpt.mrpt.containers.CDynamicGrid_mrpt_maps_THeightGridmapCell_t, CHeightGridMap2D_Base):
    class TInsertionOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, arg0: CHeightGridMap2D.TInsertionOptions) -> None: ...
    ...
    @overload
    def __init__(self, arg0, arg1: float, arg2: float,
                 arg3: float) -> None: ...

    @overload
    def __init__(self, arg0, arg1: float, arg2: float,
                 arg3: float, arg4: float) -> None: ...

    @overload
    def __init__(self, mapType, x_min: float, x_max: float,
                 y_min: float, y_max: float, resolution: float) -> None: ...
    ...
    @overload
    def insertIndividualPoint(self, x: float, y: float, z: float,
                              params: CHeightGridMap2D_Base.TPointInsertParams) -> bool: ...

    @overload
    def internal_clear(self) -> None: ...
    @overload
    def internal_clear() -> void: ...
    def internal_computeObservationLikelihood(
        self, obs: mrpt.pymrpt.mrpt.obs.CObservation, takenFrom: mrpt.pymrpt.mrpt.poses.CPose3D) -> float: ...
...
class CHeightGridMap2D_Base:
    class TPointInsertParams:
        ...
        @overload
        def __init__(
            self, arg0: CHeightGridMap2D_Base.TPointInsertParams) -> None: ...
    ...
    @overload
    def insertIndividualPoint(self, x: float, y: float,
                              z: float, params) -> bool: ...
    def intersectLine3D(self, r1: mrpt.pymrpt.mrpt.math.TLine3D,
                        obj: mrpt.pymrpt.mrpt.math.TObject3D) -> bool: ...
...
class CHeightGridMap2D_MRF(CRandomFieldGridMap2D, CHeightGridMap2D_Base):
    class TInsertionOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions, CRandomFieldGridMap2D.TInsertionOptionsCommon):
        ...
        @overload
        def __init__(
            self, arg0: CHeightGridMap2D_MRF.TInsertionOptions) -> None: ...
    ...
    @overload
    def __init__(self, arg0: CRandomFieldGridMap2D.TMapRepresentation, arg1: float,
                 arg2: float, arg3: float, arg4: float, arg5: float) -> None: ...

    @overload
    def __init__(self, mapType: CRandomFieldGridMap2D.TMapRepresentation, x_min: float, x_max: float,
                 y_min: float, y_max: float, resolution: float, run_first_map_estimation_now: bool) -> None: ...
    ...
    def getCommonInsertOptions(
        self) -> CRandomFieldGridMap2D.TInsertionOptionsCommon: ...
...
class CLandmark(mrpt.pymrpt.mrpt.serialization.CSerializable):
    ...
    @overload
    def getPose(self, p: mrpt.pymrpt.mrpt.poses.CPoint3D,
                COV: mrpt.pymrpt.mrpt.math.CMatrixDynamic_double_t) -> None: ...
...
class CLandmarksMap(CMetricMap):
    class TCustomSequenceLandmarks:
        ...
        @overload
        def __init__(
            self, arg0: CLandmarksMap.TCustomSequenceLandmarks) -> None: ...
    ...
    class TLikelihoodOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        class TGPSOrigin:
            ...
            @overload
            def __init__(
                self, arg0: CLandmarksMap.TLikelihoodOptions.TGPSOrigin) -> None: ...
    ...
    @overload
    def changeCoordinatesReference(
        self, newOrg: mrpt.pymrpt.mrpt.poses.CPose3D, otherMap: CLandmarksMap) -> None: ...
    ...
    def computeLikelihood_RSLC_2007(
        self, s: CLandmarksMap, sensorPose: mrpt.pymrpt.mrpt.poses.CPose2D) -> float: ...

    @overload
    def computeMatchingWith2D(self, otherMap: CMetricMap, otherMapPose: mrpt.pymrpt.mrpt.poses.CPose2D, maxDistForCorrespondence: float, maxAngularDistForCorrespondence: float,
                              angularDistPivotPoint: mrpt.pymrpt.mrpt.poses.CPose2D, correspondences: mrpt.pymrpt.mrpt.tfest.TMatchingPairListTempl_float_t, correspondencesRatio: float) -> None: ...

    @overload
    def computeMatchingWith2D(self, otherMap: CMetricMap, otherMapPose: mrpt.pymrpt.mrpt.poses.CPose2D, maxDistForCorrespondence: float, maxAngularDistForCorrespondence: float,
                              angularDistPivotPoint: mrpt.pymrpt.mrpt.poses.CPose2D, correspondences: mrpt.pymrpt.mrpt.tfest.TMatchingPairListTempl_float_t, correspondencesRatio: float, sumSqrDist: float) -> None: ...

    @overload
    def computeMatchingWith2D(self, otherMap: CMetricMap, otherMapPose: mrpt.pymrpt.mrpt.poses.CPose2D, maxDistForCorrespondence: float, maxAngularDistForCorrespondence: float, angularDistPivotPoint:
                              mrpt.pymrpt.mrpt.poses.CPose2D, correspondences: mrpt.pymrpt.mrpt.tfest.TMatchingPairListTempl_float_t, correspondencesRatio: float, sumSqrDist: float, onlyKeepTheClosest: bool) -> None: ...

    @overload
    def computeMatchingWith2D(self, otherMap: CMetricMap, otherMapPose: mrpt.pymrpt.mrpt.poses.CPose2D, maxDistForCorrespondence: float, maxAngularDistForCorrespondence: float, angularDistPivotPoint: mrpt.pymrpt.mrpt.poses.CPose2D,
                              correspondences: mrpt.pymrpt.mrpt.tfest.TMatchingPairListTempl_float_t, correspondencesRatio: float, sumSqrDist: float, onlyKeepTheClosest: bool, onlyUniqueRobust: bool) -> None: ...

    @overload
    def fuseWith(self, other: CLandmarksMap) -> None: ...

    @overload
    def fuseWith(self, other: CLandmarksMap,
                 justInsertAllOfThem: bool) -> None: ...
    ...
    @overload
    def loadSiftFeaturesFromImageObservation(
        self, obs: mrpt.pymrpt.mrpt.obs.CObservationImage) -> None: ...

    @overload
    def loadSiftFeaturesFromImageObservation(self, obs: mrpt.pymrpt.mrpt.obs.CObservationImage,
                                             feat_options: mrpt.pymrpt.mrpt.vision.CFeatureExtraction.TOptions) -> None: ...

    @overload
    def loadSiftFeaturesFromImageObservation(
        constclassmrpt, conststructmrpt) -> void: ...

    @overload
    def loadSiftFeaturesFromStereoImageObservation(
        self, obs: mrpt.pymrpt.mrpt.obs.CObservationStereoImages, fID: int) -> None: ...

    @overload
    def loadSiftFeaturesFromStereoImageObservation(self, obs: mrpt.pymrpt.mrpt.obs.CObservationStereoImages,
                                                   fID: int, feat_options: mrpt.pymrpt.mrpt.vision.CFeatureExtraction.TOptions) -> None: ...

    @overload
    def loadSiftFeaturesFromStereoImageObservation(
        constclassmrpt, long, conststructmrpt) -> void: ...
    ...
    def simulateBeaconReadings(self, in_robotPose: mrpt.pymrpt.mrpt.poses.CPose3D, in_sensorLocationOnRobot: mrpt.pymrpt.mrpt.poses.CPoint3D,
                               out_Observations: mrpt.pymrpt.mrpt.obs.CObservationBeaconRanges) -> None: ...
...
class CLogOddsGridMap2D_signed_char_t:
    ...
    @overload
    def updateCell_fast_occupied(
        self, x: int, y: int, logodd_obs: int, thres: int, mapArray: int, _size_x: int) -> None: ...

    @overload
    def updateCell_fast_occupied(
        self, theCell: int, logodd_obs: int, thres: int) -> None: ...
...
class CLogOddsGridMap3D_signed_char_t:
    ...
    @overload
    def updateCell_fast_free(
        self, theCell: int, logodd_obs: int, thres: int) -> None: ...

    @overload
    def updateCell_fast_free(self, x: int, y: int,
                             z: int, logodd_obs: int, thres: int) -> None: ...
    ...
    @overload
    def updateCell_fast_occupied(
        self, x: int, y: int, z: int, logodd_obs: int, thres: int) -> None: ...
...
class CMetricMap(mrpt.pymrpt.mrpt.serialization.CSerializable, mrpt.pymrpt.mrpt.system.CObservable, mrpt.pymrpt.mrpt.Stringifyable, mrpt.pymrpt.mrpt.opengl.Visualizable):
    ...
    @overload
    def canComputeObservationLikelihood(
        self, obs: mrpt.pymrpt.mrpt.obs.CObservation) -> bool: ...
    ...
    def computeObservationLikelihood(
        self, obs: mrpt.pymrpt.mrpt.obs.CObservation, takenFrom: mrpt.pymrpt.mrpt.poses.CPose3D) -> float: ...
    def computeObservationsLikelihood(
        self, sf, takenFrom: mrpt.pymrpt.mrpt.poses.CPose3D) -> float: ...
    ...
    @overload
    def insertObs(self, obs: mrpt.pymrpt.mrpt.obs.CObservation,
                  robotPose: mrpt.pymrpt.mrpt.poses.CPose3D) -> bool: ...
    ...
    @overload
    def insertObs(
        self, sf, robotPose: mrpt.pymrpt.mrpt.poses.CPose3D) -> bool: ...
    ...
    @overload
    def saveMetricMapRepresentationToFile(conststd) -> void: ...
    def squareDistanceToClosestCorrespondence(
...
class CMultiMetricMapPDF(mrpt.pymrpt.mrpt.serialization.CSerializable, mrpt.pymrpt.mrpt.bayes.CParticleFilterData_mrpt_maps_CRBPFParticleData_mrpt_bayes_particle_storage_mode_POINTER_t, mrpt.pymrpt.mrpt.bayes.CParticleFilterDataImpl_mrpt_maps_CMultiMetricMapPDF_std_deque_mrpt_bayes_CProbabilityParticle_mrpt_maps_CRBPFParticleData_mrpt_bayes_particle_storage_mode_POINTER_t, mrpt.pymrpt.mrpt.slam.PF_implementation_mrpt_maps_CRBPFParticleData_mrpt_maps_CMultiMetricMapPDF_mrpt_bayes_particle_storage_mode_POINTER_t):
    class TPredictionParams(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, arg0: CMultiMetricMapPDF.TPredictionParams) -> None: ...
    ...
    @overload
    def __init__(self, opts: mrpt.pymrpt.mrpt.bayes.CParticleFilter.TParticleFilterOptions,
                 mapsInitializers: TSetOfMetricMapInitializers, predictionOptions) -> None: ...
    ...
    def PF_SLAM_computeObservationLikelihoodForParticle(self, PF_options: mrpt.pymrpt.mrpt.bayes.CParticleFilter.TParticleFilterOptions,
                                                        particleIndexForMap: int, observation: mrpt.pymrpt.mrpt.obs.CSensoryFrame, x: mrpt.pymrpt.mrpt.poses.CPose3D) -> float: ...

    @overload
    def PF_SLAM_implementation_custom_update_particle_with_new_pose(
        self, particleData: CRBPFParticleData, newPose: mrpt.pymrpt.mrpt.math.TPose3D) -> None: ...

    @overload
    def PF_SLAM_implementation_custom_update_particle_with_new_pose(
        classmrpt, conststructmrpt) -> void: ...

    @overload
    def PF_SLAM_implementation_doWeHaveValidObservations(
        self, particles, sf: mrpt.pymrpt.mrpt.obs.CSensoryFrame) -> bool: ...

    @overload
    def PF_SLAM_implementation_doWeHaveValidObservations(
        constclassstd, mrpt, constclassmrpt) -> bool: ...
    ...
    @overload
    def clear(self, prevMap: CSimpleMap,
              currentPose: mrpt.pymrpt.mrpt.poses.CPose3D) -> None: ...
    ...
    @overload
    def getEstimatedPosePDF(
        self, out_estimation: mrpt.pymrpt.mrpt.poses.CPose3DPDFParticles) -> None: ...
    ...
    def getEstimatedPosePDFAtTime(
        self, timeStep: int, out_estimation: mrpt.pymrpt.mrpt.poses.CPose3DPDFParticles) -> None: ...

    @overload
    def getEstimatedPosePDFAtTime(size_t, classmrpt) -> void: ...
    def getLastPose(
        self, i: int, pose_is_valid: bool) -> mrpt.pymrpt.mrpt.math.TPose3D: ...
    ...
    @overload
    def getPath(
        self, i: int, out_path: List[mrpt.pymrpt.mrpt.math.TPose3D]) -> None: ...
    ...
    def insertObservation(
        self, sf: mrpt.pymrpt.mrpt.obs.CSensoryFrame) -> bool: ...
...
class COccupancyGridMap2D(CMetricMap, CLogOddsGridMap2D_signed_char_t, NearestNeighborsCapable):
    class TCriticalPointsList:
        ...
        @overload
        def __init__(
            self, arg0: COccupancyGridMap2D.TCriticalPointsList) -> None: ...
    ...
    class TInsertionOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, arg0: COccupancyGridMap2D.TInsertionOptions) -> None: ...
    ...
    class TLikelihoodOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, arg0: COccupancyGridMap2D.TLikelihoodOptions) -> None: ...
    ...
    class TLikelihoodOutput:
        ...
        @overload
        def __init__(
            self, arg0: COccupancyGridMap2D.TLikelihoodOutput) -> None: ...
    ...
    class TUpdateCellsInfoChangeOnly:
        ...
        @overload
        def __init__(
            self, arg0: COccupancyGridMap2D.TUpdateCellsInfoChangeOnly) -> None: ...
    ...
    def __init__(self, min_x: float, max_x: float, min_y: float,
                 max_y: float, resolution: float) -> None: ...
    ...
    @overload
    def buildVoronoiDiagram(self, threshold: float,
                            robot_size: float) -> None: ...

    @overload
    def buildVoronoiDiagram(self, threshold: float,
                            robot_size: float, x1: int) -> None: ...

    @overload
    def buildVoronoiDiagram(self, threshold: float,
                            robot_size: float, x1: int, x2: int) -> None: ...

    @overload
    def buildVoronoiDiagram(
        self, threshold: float, robot_size: float, x1: int, x2: int, y1: int) -> None: ...

    @overload
    def buildVoronoiDiagram(self, threshold: float, robot_size: float,
    ...
    @overload
    def computeLikelihoodField_II(
        self, pm: CPointsMap, relativePose: mrpt.pymrpt.mrpt.poses.CPose2D) -> float: ...

    @overload
    def computeLikelihoodField_Thrun(self, pm: CPointsMap) -> float: ...

    @overload
    def computeLikelihoodField_Thrun(
        self, pm: CPointsMap, relativePose: mrpt.pymrpt.mrpt.poses.CPose2D) -> float: ...
    def computePathCost(self, x1: float, y1: float,
    ...
    @overload
    def getAsImage(self, img: mrpt.pymrpt.mrpt.img.CImage,
                   verticalFlip: bool) -> None: ...

    @overload
    def getAsImage(self, img: mrpt.pymrpt.mrpt.img.CImage,
                   verticalFlip: bool, forceRGB: bool) -> None: ...

    @overload
    def getAsImage(self, img: mrpt.pymrpt.mrpt.img.CImage,
                   verticalFlip: bool, forceRGB: bool, tricolor: bool) -> None: ...

    @overload
    def getAsImageFiltered(self, img: mrpt.pymrpt.mrpt.img.CImage) -> None: ...

    @overload
    def getAsImageFiltered(
        self, img: mrpt.pymrpt.mrpt.img.CImage, verticalFlip: bool) -> None: ...

    @overload
    def getAsImageFiltered(self, img: mrpt.pymrpt.mrpt.img.CImage,
                           verticalFlip: bool, forceRGB: bool) -> None: ...
    ...
    def getBasisMap(
        self) -> mrpt.pymrpt.mrpt.containers.CDynamicGrid_unsigned_char_t: ...
    ...
    def getVoronoiDiagram(
        self) -> mrpt.pymrpt.mrpt.containers.CDynamicGrid_unsigned_short_t: ...
    ...
    @overload
    def laserScanSimulator(self, inout_Scan: mrpt.pymrpt.mrpt.obs.CObservation2DRangeScan,
                           robotPose: mrpt.pymrpt.mrpt.poses.CPose2D) -> None: ...

    @overload
    def laserScanSimulator(self, inout_Scan: mrpt.pymrpt.mrpt.obs.CObservation2DRangeScan,
                           robotPose: mrpt.pymrpt.mrpt.poses.CPose2D, threshold: float) -> None: ...

    @overload
    def laserScanSimulator(self, inout_Scan: mrpt.pymrpt.mrpt.obs.CObservation2DRangeScan,
                           robotPose: mrpt.pymrpt.mrpt.poses.CPose2D, threshold: float, N: int) -> None: ...

    @overload
    def laserScanSimulator(self, inout_Scan: mrpt.pymrpt.mrpt.obs.CObservation2DRangeScan,
                           robotPose: mrpt.pymrpt.mrpt.poses.CPose2D, threshold: float, N: int, noiseStd: float) -> None: ...

    @overload
    def laserScanSimulator(self, inout_Scan: mrpt.pymrpt.mrpt.obs.CObservation2DRangeScan,
                           robotPose: mrpt.pymrpt.mrpt.poses.CPose2D, threshold: float, N: int, noiseStd: float, decimation: int) -> None: ...

    @overload
    def laserScanSimulator(self, inout_Scan: mrpt.pymrpt.mrpt.obs.CObservation2DRangeScan, robotPose: mrpt.pymrpt.mrpt.poses.CPose2D,
                           threshold: float, N: int, noiseStd: float, decimation: int, angleNoiseStd: float) -> None: ...

    def laserScanSimulatorWithUncertainty(self, *args, **kwargs) -> Any: ...

    @overload
    def loadFromBitmap(self, img: mrpt.pymrpt.mrpt.img.CImage,
                       resolution: float) -> bool: ...

    @overload
    def loadFromBitmap(self, img: mrpt.pymrpt.mrpt.img.CImage,
                       resolution: float, origin) -> bool: ...
    ...
    @overload
    def loadFromBitmapFile(
        self, file: str, resolution: float, origin) -> bool: ...
    ...
    @overload
    def nn_single_search(
        self, query, result, out_dist_sqr: float, resultIndexOrID: int) -> bool: ...
    ...
    @overload
    def resizeGrid(self, new_x_min: float, new_x_max: float,
                   new_y_min: float, new_y_max: float) -> None: ...

    @overload
    def resizeGrid(self, new_x_min: float, new_x_max: float, new_y_min: float,
                   new_y_max: float, new_cells_default_value: float) -> None: ...

    @overload
    def resizeGrid(self, new_x_min: float, new_x_max: float, new_y_min: float,
                   new_y_max: float, new_cells_default_value: float, additionalMargin: bool) -> None: ...
    ...
    def saveAsBitmapTwoMapsWithCorrespondences(
    ...
    @overload
    def setSize(self, x_min: float, x_max: float, y_min: float,
                y_max: float, resolution: float) -> None: ...

    @overload
    def setSize(self, x_min: float, x_max: float, y_min: float,
                y_max: float, resolution: float, default_value: float) -> None: ...

    @overload
    def simulateScanRay(self, x: float, y: float, angle_direction: float,
                        out_range: float, out_valid: bool, max_range_meters: float) -> None: ...

    @overload
    def simulateScanRay(self, x: float, y: float, angle_direction: float, out_range: float,
                        out_valid: bool, max_range_meters: float, threshold_free: float) -> None: ...

    @overload
    def simulateScanRay(self, x: float, y: float, angle_direction: float, out_range: float,
                        out_valid: bool, max_range_meters: float, threshold_free: float, noiseStd: float) -> None: ...

    @overload
    def simulateScanRay(self, x: float, y: float, angle_direction: float, out_range: float, out_valid: bool,
                        max_range_meters: float, threshold_free: float, noiseStd: float, angleNoiseStd: float) -> None: ...
...
class COccupancyGridMap3D(CMetricMap, CLogOddsGridMap3D_signed_char_t, NearestNeighborsCapable):
    class TInsertionOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, arg0: COccupancyGridMap3D.TInsertionOptions) -> None: ...
        ...
        def saveToConfigFile(
            self, target: mrpt.pymrpt.mrpt.config.CConfigFileBase, section: str) -> None: ...
    ...
    class TLikelihoodOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, arg0: COccupancyGridMap3D.TLikelihoodOptions) -> None: ...
        ...
        @overload
        def saveToConfigFile(
            self, c: mrpt.pymrpt.mrpt.config.CConfigFileBase, s: str) -> None: ...
    ...
    class TRenderingOptions:
        ...
        @overload
        def __init__(
            self, arg0: COccupancyGridMap3D.TRenderingOptions) -> None: ...
        ...
        @overload
        def writeToStream(
            self, out: mrpt.pymrpt.mrpt.serialization.CArchive) -> None: ...
    ...
    @overload
    def resizeGrid(self, corner_min, corner_max,
                   new_voxels_default_value: float) -> None: ...
    ...
    def setCellFreeness(self, cx: int, cy: int, cz: int,
                        value: float) -> None: ...
    def setFreenessByPos(self, x: float, y: float,
                         z: float, value: float) -> None: ...

    @overload
    def setSize(self, corner_min, corner_max, resolution: float) -> None: ...

    @overload
    def setSize(self, corner_min, corner_max, resolution: float,
                default_value: float) -> None: ...
    def updateCell(self, cx_idx: int, cy_idx: int,
                   cz_idx: int, v: float) -> None: ...
...
class COctoMapBase_octomap_ColorOcTree_octomap_ColorOcTreeNode_t(CMetricMap):
    class TInsertionOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, parent: COctoMapBase_octomap_ColorOcTree_octomap_ColorOcTreeNode_t) -> None: ...
        ...
        @overload
        def __init__(
            self, arg0: COctoMapBase_octomap_ColorOcTree_octomap_ColorOcTreeNode_t.TInsertionOptions) -> None: ...
    ...
    class TLikelihoodOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, arg0: COctoMapBase_octomap_ColorOcTree_octomap_ColorOcTreeNode_t.TLikelihoodOptions) -> None: ...
        ...
        def assign(
            self) -> COctoMapBase_octomap_ColorOcTree_octomap_ColorOcTreeNode_t.TLikelihoodOptions: ...
    ...
    class TRenderingOptions:
        ...
        @overload
        def __init__(
            self, arg0: COctoMapBase_octomap_ColorOcTree_octomap_ColorOcTreeNode_t.TRenderingOptions) -> None: ...
        def assign(
            self) -> COctoMapBase_octomap_ColorOcTree_octomap_ColorOcTreeNode_t.TRenderingOptions: ...
    ...
    @overload
    def assign(
        self) -> COctoMapBase_octomap_ColorOcTree_octomap_ColorOcTreeNode_t: ...
    ...
    @overload
    def canComputeObservationsLikelihood(
        self, sf: mrpt.pymrpt.mrpt.obs.CSensoryFrame) -> bool: ...
    ...
    @overload
    def castRay(self, origin, direction, end,
                ignoreUnknownCells: bool) -> bool: ...

    @overload
    def castRay(self, origin, direction, end,
                ignoreUnknownCells: bool, maxRange: float) -> bool: ...
    ...
    def computeObservationLikelihood(
        self, obs: mrpt.pymrpt.mrpt.obs.CObservation, takenFrom: mrpt.pymrpt.mrpt.poses.CPose3D) -> float: ...
    def computeObservationsLikelihood(
        self, sf: mrpt.pymrpt.mrpt.obs.CSensoryFrame, takenFrom: mrpt.pymrpt.mrpt.poses.CPose3D) -> float: ...
    ...
    @overload
    def getOccupancyThresLog() -> float: ...
    def getPointOccupancy(self, x: float, y: float, z: float,
                          prob_occupancy: float) -> bool: ...
    ...
    @overload
    def insertObs(self, sf: mrpt.pymrpt.mrpt.obs.CSensoryFrame,
                  robotPose: mrpt.pymrpt.mrpt.poses.CPose3D) -> bool: ...
    def insertPointCloud(self, ptMap: CPointsMap, sensor_x: float,
                         sensor_y: float, sensor_z: float) -> None: ...
...
class COctoMapBase_octomap_OcTree_octomap_OcTreeNode_t(CMetricMap):
    class TInsertionOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, parent: COctoMapBase_octomap_OcTree_octomap_OcTreeNode_t) -> None: ...
        ...
        @overload
        def __init__(
            self, arg0: COctoMapBase_octomap_OcTree_octomap_OcTreeNode_t.TInsertionOptions) -> None: ...
    ...
    class TLikelihoodOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, arg0: COctoMapBase_octomap_OcTree_octomap_OcTreeNode_t.TLikelihoodOptions) -> None: ...
        ...
        def assign(
            self) -> COctoMapBase_octomap_OcTree_octomap_OcTreeNode_t.TLikelihoodOptions: ...
    ...
    class TRenderingOptions:
        ...
        @overload
        def __init__(
            self, arg0: COctoMapBase_octomap_OcTree_octomap_OcTreeNode_t.TRenderingOptions) -> None: ...
        def assign(
            self) -> COctoMapBase_octomap_OcTree_octomap_OcTreeNode_t.TRenderingOptions: ...
...
class CPointCloudFilterBase:
    ...
    @overload
    def filter(self, inout_pointcloud: CPointsMap, pc_timestamp: mrpt.pymrpt.std.chrono.time_point_mrpt_Clock_std_chrono_duration_long_std_ratio_1_10000000_t,
               pc_reference_pose: mrpt.pymrpt.mrpt.poses.CPose3D) -> None: ...

    @overload
    def filter(self, inout_pointcloud: CPointsMap, pc_timestamp: mrpt.pymrpt.std.chrono.time_point_mrpt_Clock_std_chrono_duration_long_std_ratio_1_10000000_t,
               pc_reference_pose: mrpt.pymrpt.mrpt.poses.CPose3D, params) -> None: ...
...
class CPointCloudFilterByDistance(CPointCloudFilterBase):
    class TOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, arg0: CPointCloudFilterByDistance.TOptions) -> None: ...
        ...
        @overload
        def saveToConfigFile(
            self, c: mrpt.pymrpt.mrpt.config.CConfigFileBase, section: str) -> None: ...
    ...
    @overload
    def filter(self, inout_pointcloud: CPointsMap, pc_timestamp: mrpt.pymrpt.std.chrono.time_point_mrpt_Clock_std_chrono_duration_long_std_ratio_1_10000000_t,
               pc_reference_pose: mrpt.pymrpt.mrpt.poses.CPose3D, params: CPointCloudFilterBase.TExtraFilterParams) -> None: ...
...
class CPointsMap(CMetricMap, mrpt.pymrpt.mrpt.opengl.PLY_Importer, mrpt.pymrpt.mrpt.opengl.PLY_Exporter, NearestNeighborsCapable):
    ...
    @overload
    def changeCoordinatesReference(
        self, b: mrpt.pymrpt.mrpt.poses.CPose2D) -> None: ...
    ...
    @overload
    def changeCoordinatesReference(
        self, b: mrpt.pymrpt.mrpt.poses.CPose3D) -> None: ...
    ...
    @overload
    def changeCoordinatesReference(
        self, other: CPointsMap, b: mrpt.pymrpt.mrpt.poses.CPose3D) -> None: ...
    ...
    def determineMatching2D(self, otherMap: CMetricMap, otherMapPose: mrpt.pymrpt.mrpt.poses.CPose2D,
                            correspondences: mrpt.pymrpt.mrpt.tfest.TMatchingPairListTempl_float_t, params: TMatchingParams, extraResults: TMatchingExtraResults) -> None: ...
    def determineMatching3D(self, otherMap: CMetricMap, otherMapPose: mrpt.pymrpt.mrpt.poses.CPose3D,
                            correspondences: mrpt.pymrpt.mrpt.tfest.TMatchingPairListTempl_float_t, params: TMatchingParams, extraResults: TMatchingExtraResults) -> None: ...
    ...
    def extractCylinder(self, center, radius: float, zmin: float,
                        zmax: float, outMap: CPointsMap) -> None: ...

    @overload
    def extractPoints(self, corner1, corner2, outMap: CPointsMap) -> None: ...

    @overload
    def extractPoints(self, corner1, corner2,
                      outMap: CPointsMap, R: float) -> None: ...

    @overload
    def extractPoints(self, corner1, corner2, outMap: CPointsMap,
                      R: float, G: float) -> None: ...
    ...
    @overload
    def getLargestDistanceFromOrigin() -> float: ...
    def getLargestDistanceFromOriginNoRecompute(
        self, output_is_valid: bool) -> float: ...
    ...
    def getPointFast(self, index: int, x: float,
    ...
    @overload
    def insertAnotherMap(self, otherMap: CPointsMap,
                         otherPose: mrpt.pymrpt.mrpt.poses.CPose3D) -> None: ...

    @overload
    def insertAnotherMap(self, otherMap: CPointsMap,
                         otherPose: mrpt.pymrpt.mrpt.poses.CPose3D, filterOutPointsAtZero: bool) -> None: ...
    ...
    def internal_computeObservationLikelihood(
        self, obs: mrpt.pymrpt.mrpt.obs.CObservation, takenFrom: mrpt.pymrpt.mrpt.poses.CPose3D) -> float: ...
    def internal_computeObservationLikelihoodPointCloud3D(
        self, pc_in_map: mrpt.pymrpt.mrpt.poses.CPose3D, xs: float, ys: float, zs: float, num_pts: int) -> float: ...
    ...
    def setPointFast(self, index: int, x: float,
                     y: float, z: float) -> None: ...
    def setPointRGB(self, index: int, x: float, y: float,
                    z: float, R: float, G: float, B: float) -> None: ...
...
class CPointsMapXYZI(CPointsMap):
    ...
    def getPointRGB(self, index: int, x: float, y: float, z: float,
                    R_intensity: float, G_intensity: float, B_intensity: float) -> None: ...
    ...
    @overload
    def insertPointField_Intensity(float) -> void: ...
    def insertPointRGB(self, x: float, y: float, z: float, R_intensity: float,
                       G_ignored: float, B_ignored: float) -> None: ...
    ...
    def setPointRGB(self, index: int, x: float, y: float, z: float,
                    R_intensity: float, G_ignored: float, B_ignored: float) -> None: ...
...
class CRandomFieldGridMap2D(CMetricMap, mrpt.pymrpt.mrpt.containers.CDynamicGrid_mrpt_maps_TRandomFieldCell_t):
    class ConnectivityDescriptor:
        ...
        def getEdgeInformation(self, parent: CRandomFieldGridMap2D, icx: int,
                               icy: int, jcx: int, jcy: int, out_edge_information: float) -> bool: ...
    ...
    class TInsertionOptionsCommon:
        ...
        @overload
        def __init__(
            self, arg0: CRandomFieldGridMap2D.TInsertionOptionsCommon) -> None: ...

        def assign(self) -> CRandomFieldGridMap2D.TInsertionOptionsCommon: ...

        @overload
        def internal_loadFromConfigFile_common(
            self, source: mrpt.pymrpt.mrpt.config.CConfigFileBase, section: str) -> None: ...

        @overload
        def internal_loadFromConfigFile_common(
            constclassmrpt, conststd) -> void: ...
    ...
    @overload
    def getAsBitmapFile(
        self, out_img: mrpt.pymrpt.mrpt.img.CImage) -> None: ...
    ...
    @overload
    def getAsMatrix(
        self, out_mat: mrpt.pymrpt.mrpt.math.CMatrixDynamic_double_t) -> None: ...

    @overload
    def getAsMatrix(classmrpt) -> void: ...
    def getMapType(self) -> CRandomFieldGridMap2D.TMapRepresentation: ...
    def getMeanAndCov(
        self, out_means, out_cov: mrpt.pymrpt.mrpt.math.CMatrixDynamic_double_t) -> None: ...
    ...
    @overload
    def insertIndividualReading(
        self, sensorReading: float, point, update_map: bool) -> None: ...

    @overload
    def insertIndividualReading(
        self, sensorReading: float, point, update_map: bool, time_invariant: bool) -> None: ...

    @overload
    def insertIndividualReading(self, sensorReading: float, point, update_map: bool,
                                time_invariant: bool, reading_stddev: float) -> None: ...
    ...
    @overload
    def predictMeasurement(self, x: float, y: float, out_predict_response: float,
                           out_predict_response_variance: float, do_sensor_normalization: bool) -> None: ...

    @overload
    def predictMeasurement(self, x: float, y: float, out_predict_response: float, out_predict_response_variance: float,
                           do_sensor_normalization: bool, interp_method: CRandomFieldGridMap2D.TGridInterpolationMethod) -> None: ...

    @overload
    def resize(self, new_x_min: float, new_x_max: float, new_y_min: float,
               new_y_max: float, defaultValueNewCells: TRandomFieldCell) -> None: ...

    @overload
    def resize(self, new_x_min: float, new_x_max: float, new_y_min: float, new_y_max: float,
               defaultValueNewCells: TRandomFieldCell, additionalMarginMeters: float) -> None: ...
    ...
    @overload
    def setSize(self, x_min: float, x_max: float, y_min: float, y_max: float,
                resolution: float, fill_value: TRandomFieldCell) -> None: ...
...
class CRandomFieldGridMap3D(mrpt.pymrpt.mrpt.containers.CDynamicGrid3D_mrpt_maps_TRandomFieldVoxel_double_t, mrpt.pymrpt.mrpt.serialization.CSerializable):
    class ConnectivityDescriptor:
        ...
        def getEdgeInformation(self, parent: CRandomFieldGridMap3D, icx: int, icy: int,
                               icz: int, jcx: int, jcy: int, jcz: int, out_edge_information: float) -> bool: ...
    ...
    class TInsertionOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, arg0: CRandomFieldGridMap3D.TInsertionOptions) -> None: ...
    ...
    @overload
    def __init__(self, x_min: float, x_max: float, y_min: float, y_max: float, z_min: float,
                 z_max: float, voxel_size: float, call_initialize_now: bool) -> None: ...
    ...
    def insertIndividualReading(self, sensorReading: float, sensorVariance: float, point,
                                method: CRandomFieldGridMap3D.TVoxelInterpolationMethod, update_map: bool) -> bool: ...

    @overload
    def resize(self, new_x_min: float, new_x_max: float, new_y_min: float, new_y_max: float,
               new_z_min: float, new_z_max: float, defaultValueNewvoxels: TRandomFieldVoxel) -> None: ...

    @overload
    def resize(self, new_x_min: float, new_x_max: float, new_y_min: float, new_y_max: float, new_z_min: float,
               new_z_max: float, defaultValueNewvoxels: TRandomFieldVoxel, additionalMarginMeters: float) -> None: ...
    ...
    @overload
    def setSize(self, x_min: float, x_max: float, y_min: float, y_max: float,
                z_min: float, z_max: float, resolution_xy: float) -> None: ...

    @overload
    def setSize(self, x_min: float, x_max: float, y_min: float, y_max: float,
                z_min: float, z_max: float, resolution_xy: float, resolution_z: float) -> None: ...

    @overload
    def setSize(self, x_min: float, x_max: float, y_min: float, y_max: float, z_min: float, z_max: float,
                resolution_xy: float, resolution_z: float, fill_value: TRandomFieldVoxel) -> None: ...
...
class CReflectivityGridMap2D(CMetricMap, mrpt.pymrpt.mrpt.containers.CDynamicGrid_signed_char_t, CLogOddsGridMap2D_signed_char_t):
    class TInsertionOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions):
        ...
        @overload
        def __init__(
            self, arg0: CReflectivityGridMap2D.TInsertionOptions) -> None: ...
...
class CSimpleMap(mrpt.pymrpt.mrpt.serialization.CSerializable):
    ...
    @overload
    def changeCoordinatesOrigin(
        self, newOrigin: mrpt.pymrpt.mrpt.poses.CPose3D) -> None: ...
...
class CVoxelMap(CVoxelMapOccupancyBase_mrpt_maps_VoxelNodeOccupancy_signed_char_t):
    ...
    @overload
    def __init__(self, resolution: float, inner_bits: int,
                 leaf_bits: int) -> None: ...
...
class CVoxelMapBase_mrpt_maps_VoxelNodeOccRGB_t(CMetricMap):
    ...
    @overload
    def assign(
        self, o: CVoxelMapBase_mrpt_maps_VoxelNodeOccRGB_t) -> CVoxelMapBase_mrpt_maps_VoxelNodeOccRGB_t: ...
...
class CVoxelMapBase_mrpt_maps_VoxelNodeOccupancy_t(CMetricMap):
    ...
    @overload
    def assign(
        self, o: CVoxelMapBase_mrpt_maps_VoxelNodeOccupancy_t) -> CVoxelMapBase_mrpt_maps_VoxelNodeOccupancy_t: ...
...
class CVoxelMapOccupancyBase_mrpt_maps_VoxelNodeOccRGB_signed_char_t(CVoxelMapBase_mrpt_maps_VoxelNodeOccRGB_t, NearestNeighborsCapable):
    ...
    @overload
    def assign(
        self) -> CVoxelMapOccupancyBase_mrpt_maps_VoxelNodeOccRGB_signed_char_t: ...
    ...
    @overload
    def nn_single_search(self, query, result, out_dist_sqr: float,
                         resultIndexOrIDOrID: int) -> bool: ...
    ...
    def updateCell_fast_free(
        self, theCell, logodd_obs: int, thres: int) -> None: ...
...
class CVoxelMapOccupancyBase_mrpt_maps_VoxelNodeOccupancy_signed_char_t(CVoxelMapBase_mrpt_maps_VoxelNodeOccupancy_t, NearestNeighborsCapable):
    ...
    @overload
    def assign(
        self) -> CVoxelMapOccupancyBase_mrpt_maps_VoxelNodeOccupancy_signed_char_t: ...
...
class CWeightedPointsMap(CPointsMap):
    class TMapDefinition(CWeightedPointsMap.TMapDefinitionBase):
        ...
        @overload
        def __init__(
            self, arg0: CWeightedPointsMap.TMapDefinition) -> None: ...
...
class CWirelessPowerGridMap2D(CRandomFieldGridMap2D):
    class TInsertionOptions(mrpt.pymrpt.mrpt.config.CLoadableOptions, CRandomFieldGridMap2D.TInsertionOptionsCommon):
        ...
        @overload
        def __init__(
            self, arg0: CWirelessPowerGridMap2D.TInsertionOptions) -> None: ...
...
class TRandomFieldCell:
    ...
    @overload
    def __init__(self, kfmean_dm_mean: float,
                 kfstd_dmmeanw: float) -> None: ...
...
class mrptEventMetricMapInsert(mrpt.pymrpt.mrpt.system.mrptEvent):
    ...
    @property
    def inserted_robotPose(
        self) -> Optional[mrpt.pymrpt.mrpt.poses.CPose3D]: ...
