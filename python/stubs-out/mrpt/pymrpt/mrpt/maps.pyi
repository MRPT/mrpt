...
class CMetricMap(mrpt.pymrpt.mrpt.serialization.CSerializable, mrpt.pymrpt.mrpt.system.CObservable, mrpt.pymrpt.mrpt.Stringifyable, mrpt.pymrpt.mrpt.opengl.Visualizable):
    ...
    def isEmpty() -> bool: ...
    @overload
    def loadFromProbabilisticPosesAndObservations(self, Map) -> None: ...
    @overload
    def loadFromProbabilisticPosesAndObservations(constclassmrpt) -> void: ...
    @overload
...
class COccupancyGridMap3D(CMetricMap, CLogOddsGridMap3D_signed_char_t):
    ...
    def getVisualizationInto(classmrpt) -> void: ...
    @overload
    def insertPointCloud(self, sensorCenter, pts: CPointsMap) -> None: ...
    @overload
    def insertPointCloud(self, sensorCenter, pts: CPointsMap, maxValidRange: float) -> None: ...
    @overload
    def insertPointCloud(conststructmrpt, constclassmrpt, constfloat) -> void: ...
    @overload
...
class COctoMapBase_octomap_ColorOcTree_octomap_ColorOcTreeNode_t(CMetricMap):
    ...
    def isEmpty() -> bool: ...
    @overload
    def loadFromProbabilisticPosesAndObservations(self, Map: CSimpleMap) -> None: ...
    @overload
    def loadFromProbabilisticPosesAndObservations(constclassmrpt) -> void: ...
    @overload
...
class CSimpleMap(mrpt.pymrpt.mrpt.serialization.CSerializable):
    class ConstPair:
        ...
        def __init__(self) -> None: ...
        @overload
        def __init__(self, p: CSimpleMap.Pair) -> None: ...
        @overload
        def __init__(self, arg0: CSimpleMap.ConstPair) -> None: ...
        def assign(self) -> CSimpleMap.ConstPair: ...
    ...
    class Pair:
        ...
        def __init__(self) -> None: ...
        @overload
        def __init__(self, arg0: CSimpleMap.Pair) -> None: ...
        def assign(self) -> CSimpleMap.Pair: ...
    @overload
    def __init__(self) -> None: ...
    @overload
    ...
    def GetRuntimeClass(self) -> mrpt.pymrpt.mrpt.rtti.TRuntimeClassId: ...
    def GetRuntimeClassIdStatic(self, *args, **kwargs) -> Any: ...
    def assign(self, o: CSimpleMap) -> CSimpleMap: ...
    @overload
    ...
    def empty() -> bool: ...
    @overload
    def get(self, index: int, out_posePDF: mrpt.pymrpt.mrpt.poses.CPose3DPDF, out_SF: mrpt.pymrpt.mrpt.obs.CSensoryFrame) -> None: ...
    @overload
    def get(self, index: int, out_posePDF: mrpt.pymrpt.mrpt.poses.CPose3DPDF, out_SF: mrpt.pymrpt.mrpt.obs.CSensoryFrame) -> None: ...
    @overload
    def get(self, index: int) -> Tuple[mrpt.pymrpt.mrpt.poses.CPose3DPDF,mrpt.pymrpt.mrpt.obs.CSensoryFrame]: ...
    def getAsPair(self, *args, **kwargs) -> Any: ...
    @overload
    def insert(self, in_posePDF: mrpt.pymrpt.mrpt.poses.CPose3DPDF, in_SF: mrpt.pymrpt.mrpt.obs.CSensoryFrame) -> None: ...
    @overload
    def insert(self, in_posePDF: mrpt.pymrpt.mrpt.poses.CPose3DPDF, in_SF: mrpt.pymrpt.mrpt.obs.CSensoryFrame) -> None: ...
    @overload
    def insert(self, poseSF) -> None: ...
    @overload
    def insert(conststructmrpt) -> void: ...
    @overload
    def insert(self, in_posePDF: mrpt.pymrpt.mrpt.poses.CPosePDF, in_SF: mrpt.pymrpt.mrpt.obs.CSensoryFrame) -> None: ...
    @overload
    def insert(self, in_posePDF: mrpt.pymrpt.mrpt.poses.CPosePDF, in_SF: mrpt.pymrpt.mrpt.obs.CSensoryFrame) -> None: ...
    @overload
...
class CVoxelMapOccupancyBase_mrpt_maps_VoxelNodeOccRGB_signed_char_t(CVoxelMapBase_mrpt_maps_VoxelNodeOccRGB_t):
    genericMapParams: TMapGenericParams
    ...
    def insertObs(self, sf: mrpt.pymrpt.mrpt.obs.CSensoryFrame, robotPose: mrpt.pymrpt.mrpt.poses.CPose3D) -> bool: ...
    @overload
    def insertPointCloudAsEndPoints(self, pts: CPointsMap, sensorPt) -> None: ...
    @overload
    def insertPointCloudAsEndPoints(constclassmrpt, conststructmrpt) -> void: ...
    @overload
    def insertPointCloudAsRays(self, pts: CPointsMap, sensorPt) -> None: ...
    @overload
    def insertPointCloudAsRays(constclassmrpt, conststructmrpt) -> void: ...
    @overload
    def isEmpty(self) -> bool: ...
    @overload
    def isEmpty() -> bool: ...
...
class CVoxelMapOccupancyBase_mrpt_maps_VoxelNodeOccupancy_signed_char_t(CVoxelMapBase_mrpt_maps_VoxelNodeOccupancy_t):
    genericMapParams: TMapGenericParams
    insertionOptions: TVoxelMap_InsertionOptions
    likelihoodOptions: TVoxelMap_LikelihoodOptions
    renderingOptions: TVoxelMap_RenderingOptions
